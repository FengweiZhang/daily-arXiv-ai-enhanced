...
### [6] [Scaling of Gaussian Kolmogorov--Arnold Networks](https://arxiv.org/abs/2604.21174)
...
### [7] [JAX-BEM: Gradient-Based Acoustic Shape Optimisation via a Differentiable Boundary Element Method](https://arxiv.org/abs/2604.21431)
...
### [8] [Biomedical systems biology workflow orchestration and execution with PoSyMed](https://arxiv.org/abs/2604.20906)
...
### [9] [Learning Reasoning World Models for Parallel Code](https://arxiv.org/abs/2604.20926)
...
### [10] [Residual Risk Analysis in Benign Code: How Far Are We? A Multi-Model Semantic and Structural Similarity Approach](https://arxiv.org/abs/2604.21051)
...
### [11] [Structural Quality Gaps in Practitioner AI Governance Prompts: An Empirical Study Using a Five-Principle Evaluation Framework](https://arxiv.org/abs/2604.21090)
*Christo Zietsman*
...
### [12] [A Ground-Truth-Based Evaluation of Vulnerability Detection Across Multiple Ecosystems](https://arxiv.org/abs/2604.21111)
...
### [13] [Hidden Dependencies and Component Variants in SBOM-Based Software Composition Analysis](https://arxiv.org/abs/2604.21278)
...
### [14] [Conjecture and Inquiry: Quantifying Software Performance Requirements via Interactive Retrieval-Augmented Preference Elicitation](https://arxiv.org/abs/2604.21380)
...
### [15] [Assessing the Impact of Requirement Ambiguity on LLM-based Function-Level Code Generation](https://arxiv.org/abs/2604.21505)
...
### [16] [SpecSyn: LLM-based Synthesis and Refinement of Formal Specifications for Real-world Program Verification](https://arxiv.org/abs/2604.21570)
...
### [17] [A Metamorphic Testing Approach to Diagnosing Memorization in LLM-Based Program Repair](https://arxiv.org/abs/2604.21579)
...
### [18] [DryRUN: On the Role of Public Tests in LLM-Driven Code Generation](https://arxiv.org/abs/2604.21598)
...
### [19] [Verifying Machine Learning Interpretability Requirements through Provenance](https://arxiv.org/abs/2604.21599)
...
### [20] [Can Large Language Models Assist the Comprehension of ROS2 Software Architectures?](https://arxiv.org/abs/2604.21699)
...
### [21] [Automated LTL Specification Generation from Industrial Aerospace Requirements](https://arxiv.org/abs/2604.21715)
...
### [22] [Agentic AI-assisted coding offers a unique opportunity to instill epistemic grounding during software development](https://arxiv.org/abs/2604.21744)
...
### [23] [Generalizing Test Cases for Comprehensive Test Scenario Coverage](https://arxiv.org/abs/2604.21771)
...
### [24] [Distributed Generative Inference of LLM at Internet Scales with Multi-Dimensional Communication Optimization](https://arxiv.org/abs/2604.21072)
...
### [25] [TorchGWAS : GPU-accelerated GWAS for thousands of quantitative phenotypes](https://arxiv.org/abs/2604.21095)
...
### [26] [A Task Decomposition and Planning Framework for Efficient LLM Inference in AI-Enabled WiFi-Offload Networks](https://arxiv.org/abs/2604.21399)
...
### [27] [A Cloud-Native Architecture for Human-in-Control LLM-Assisted OpenSearch in Investigative Settings](https://arxiv.org/abs/2604.21125)
...
### [28] [Risk-Aware and Stable Edge Server Selection Under Network Latency SLOs](https://arxiv.org/abs/2604.21483)
...
### [29] [Optimizing High-Throughput Distributed Data Pipelines for Reproducible Deep Learning at Scale](https://arxiv.org/abs/2604.21275)
...
### [30] [Systematizing Blockchain Research Themes and Design Patterns: Insights from the University Blockchain Research Initiative (UBRI)](https://arxiv.org/abs/2604.21517)
...
### [33] [An Alternate Agentic AI Architecture (It's About the Data)](https://arxiv.org/abs/2604.21413)
...
### [34] [Ternary Memristive Logic: Hardware for Reasoning Realized via Domain Algebra](https://arxiv.org/abs/2604.20891)
*Chao Li*
...
### [35] [AnalogMaster: Large Language Model-based Automated Analog IC Design Framework from Image to Layout](https://arxiv.org/abs/2604.20916)
...
### [36] [Efficient Batch Search Algorithm for B+ Tree Index Structures with Level-Wise Traversal on FPGAs](https://arxiv.org/abs/2604.21117)
...
### [37] [Enabling Mixed criticality applications for the Versal AI-Engines](https://arxiv.org/abs/2604.21124)
