...
### [2] [SiFAR: Synchronization-Free All-Reduce for Low-Latency LLM Inference](https://arxiv.org/abs/2607.08973)
...
### [3] [Distributed Symmetry Breaking on Hyperbolic Random Graphs](https://arxiv.org/abs/2607.09170)
...
### [5] [EcoKube: Simulating Carbon-Aware Scheduling Policies in Heterogeneous Edge-Cloud Environments](https://arxiv.org/abs/2607.09318)
...
### [6] [STEEL: Sparsity-Aware Fused Attention for Energy-Efficient Long-Sequence Inference on AMD's XDNA NPU](https://arxiv.org/abs/2607.09385)
...
### [7] [Short Graph Sketches Suffice for Error-resilient Leader Verification in CONGEST](https://arxiv.org/abs/2607.09522)
...
### [8] [New Complexity Classes in Locally Checkable Labeling for Local Computation Algorithms](https://arxiv.org/abs/2607.09626)
*Sijin Peng*
...
### [28] [Attention to Detail: Evaluating Energy, Performance, and Accuracy Trade-offs Across vLLM Configurations](https://arxiv.org/abs/2607.09172)
...
### [29] [Git-Assistant: Planning-Based Support for Updating Git Repositories](https://arxiv.org/abs/2607.09224)
...
### [30] [How Far Are We from Detecting Flaky Tests? On the Limits of Code-Based Detection](https://arxiv.org/abs/2607.09345)
...
### [31] [Diversifying to Verify: When Task-Equivalent Programs Differ in Verifiability](https://arxiv.org/abs/2607.09366)
...
### [32] [How Do Software Professionals Evaluate AI-Generated Code? (Registered Report)](https://arxiv.org/abs/2607.09434)
...
### [33] [Practical Source Code Recovery from Binary Functions Using Anchor-Based Retrieval and LLM Reasoning](https://arxiv.org/abs/2607.09452)
...
### [34] [Failure as a Process: An Anatomy of CLI Coding Agent Trajectories](https://arxiv.org/abs/2607.09510)
...
### [35] [Balancing Usefulness and Naturalness: An LLM-based Curation Pipeline for Code Review Comments](https://arxiv.org/abs/2607.09524)
...
### [36] [Writing Bug Reports for Software Repair Agents: What Information Matters Most?](https://arxiv.org/abs/2607.09553)
...
### [37] [Ortho2CAD: 3D CAD generation from orthographic drawings using vision language models](https://arxiv.org/abs/2607.08891)
...
### [38] [Impedance-Guided Programmable Transmission of Localized Deformation in Modular Soft Metamaterials](https://arxiv.org/abs/2607.08966)
...
### [39] [Instrumentation and field tests to evaluate a rollover risk estimator for mobile machinery with mobile tools](https://arxiv.org/abs/2607.09188)
...
### [40] [Topology-Preserving Mesh Adaptation for Sharp-Interface Multiphase PFEM](https://arxiv.org/abs/2607.09446)
...
### [41] [A Truckload of Satoshis: Detecting and Measuring One-Way Arbitrage in the Wild](https://arxiv.org/abs/2607.09491)
...
### [42] [Artificial Intelligence and the Generative Science of Food Formulation](https://arxiv.org/abs/2607.09529)
...
### [43] [A novel robust mixed integer linear programming model for index tracking problem under no rebalancing: heuristic optimization approach](https://arxiv.org/abs/2607.09556)
...
### [44] [Large-Scale Portfolio Optimization Problem Under Cardinality Constraint With Enhanced Multi-Objective Evolutionary Algorithms](https://arxiv.org/abs/2607.09566)
...
### [45] [Multi-Agent Reinforcement Learning for SLA-Aware Network Slicing in UAV-Enabled MEC](https://arxiv.org/abs/2607.09295)
