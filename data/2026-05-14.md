...
### [10] [Fine-Tuning Models for Automated Code Review Feedback](https://arxiv.org/abs/2605.12610)
...
### [11] [User Reviews as a Source for Usability Requirements: A Precursor Study on Using Large Language Models](https://arxiv.org/abs/2605.12657)
...
### [12] [Agentic Interpretation: Lattice-Structured Evidence for LLM-Based Program Analysis](https://arxiv.org/abs/2605.12694)
...
### [13] [Finding a Crab in the C: Assured Translation via Comparative Symbolic Execution](https://arxiv.org/abs/2605.12731)
...
### [14] [Project Life Cycles in Open-Source Software](https://arxiv.org/abs/2605.12738)
...
### [15] [AgentLens: Revealing The Lucky Pass Problem in SWE-Agent Evaluation](https://arxiv.org/abs/2605.12925)
...
### [16] [Protocol-Driven Development: Governing Generated Software Through Invariants and Evidence](https://arxiv.org/abs/2605.12981)
*Jun He,Deying Yu*
...
### [17] [Code-Centric Detection of Vulnerability-Fixing Commits: A Unified Benchmark and Empirical Study](https://arxiv.org/abs/2605.13138)
...
### [18] [SWE-Cycle: Benchmarking Code Agents across the Complete Issue Resolution Cycle](https://arxiv.org/abs/2605.13139)
...
### [19] [UIBenchKit: A unified toolkit for design-to-code model evaluation](https://arxiv.org/abs/2605.13141)
...
### [20] [ReproScore: Separating Readiness from Outcome in Research Software Reproducibility Assessment](https://arxiv.org/abs/2605.13275)
...
### [21] [Robust Mutation Analysis of Quantum Programs Under Noise](https://arxiv.org/abs/2605.13279)
...
### [22] [The Readability Spectrum: Patterns, Issues, and Prompt Effects in LLM-Generated Code](https://arxiv.org/abs/2605.13280)
...
### [23] [AI Harness Engineering: A Runtime Substrate for Foundation-Model Software Agents](https://arxiv.org/abs/2605.13357)
...
### [24] [SieveFL: Hierarchical Runtime-Aware Pruning for Scalable LLM-Based Fault Localization](https://arxiv.org/abs/2605.13491)
...
### [25] [Scalable Deductive Verification of Data-Level Parallel Programs](https://arxiv.org/abs/2605.13616)
...
### [26] [SkillOps: Managing LLM Agent Skill Libraries as Self-Maintaining Software Ecosystems](https://arxiv.org/abs/2605.13716)
...
### [27] [(How) Do Large Language Models Understand High-Level Message Sequence Charts?](https://arxiv.org/abs/2605.13773)
...
### [28] [Stochastic Smoothed Particle Hydrodynamics for Stochastic Mechanics Problems](https://arxiv.org/abs/2605.12540)
...
### [29] [Robust Matrix-Free Newton-Krylov Solvers via Automatic Differentiation](https://arxiv.org/abs/2605.13378)
...
### [30] [Elastica++: A high-performance, multiphysics framework for large interacting assemblies of Cosserat rods](https://arxiv.org/abs/2605.13766)
...
### [31] [Chrono::Ray: A Distributed Framework for High-Throughput Simulation-Based Analysis of Multibody Systems](https://arxiv.org/abs/2605.13767)
...
### [32] [Emergency Vehicle Preemption Strategies using Machine Learning to Optimize Traffic Operations](https://arxiv.org/abs/2605.13814)
...
### [33] [A detailed algorithmic study on a reuse-aware, near memory, all-digital Ising machine](https://arxiv.org/abs/2605.12959)
...
### [34] [FPGA-Accelerated Lock Management and Transaction Processing: Architecture, Optimization, and Design Space Exploration](https://arxiv.org/abs/2605.13398)
...
### [35] [PoisonCap: Efficient Hierarchical Temporal Safety for CHERI](https://arxiv.org/abs/2605.13210)
...
### [36] [Reward-Weighted On-Policy Distillation with an Open Property-Equivalence Verifier for NL-to-SVA Generation](https://arxiv.org/abs/2605.13501)
...
### [37] [Efficient Implementation of an Adaptive Transformer Accelerator for Massive MIMO Outdoor Localization](https://arxiv.org/abs/2605.13507)
...
### [38] [Memristor Technologies for Dynamic Vision Sensors: A Critical Assessment and Research Roadmap](https://arxiv.org/abs/2605.13699)
...
### [39] [DQN-Driven Adaptive Neighbor Discovery for Directional Aerial Networks](https://arxiv.org/abs/2605.12552)
...
### [40] [Decentralized Multi-Channel MANET Power Optimization Using Graph Neural Networks](https://arxiv.org/abs/2605.12612)
...
### [41] [Toward Communication-Efficient Space Data Centers: Bottlenecks, Architectures, and New Paradigms](https://arxiv.org/abs/2605.12681)
...
### [42] [Large Language Models for Agentic NetOps and AIOps: Architectures, Evaluation, and Safety](https://arxiv.org/abs/2605.12729)
...
### [43] [Bridge: Optimizing Collective Communication Schedules in Reconfigurable Networks with Reusable Subrings](https://arxiv.org/abs/2605.12766)
...
### [44] [NeuroRisk: Physics-Informed Neural Optimization for Risk-Aware Traffic Engineering](https://arxiv.org/abs/2605.12862)
...
### [45] [A Persistence-Aware Framework for Age Violation Control in Wireless Status Update Systems](https://arxiv.org/abs/2605.13002)
...
### [46] [Toward Practical Age-of-Information Scheduling in 5G Cellular](https://arxiv.org/abs/2605.13012)
...
### [47] [Content Caching Methods in Named Data Networks](https://arxiv.org/abs/2605.13104)
...
### [48] [Intelligence Delivery Network: Toward an Internet Architecture for the AI Age](https://arxiv.org/abs/2605.13235)
...
### [49] [Swarm Network-as-a-Service (SNaaS)](https://arxiv.org/abs/2605.13341)
...
### [50] [OxyEcomBench: Benchmarking Multimodal Foundation Models across E-Commerce Ecosystems](https://arxiv.org/abs/2605.13173)
