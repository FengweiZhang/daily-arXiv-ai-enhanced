...
### [1] [Velosiraptor: Code Synthesis for Memory Translation](https://arxiv.org/abs/2608.07966)
...
### [2] [FedSceneX: Time-to-Target Orchestration for Same-Scene Multimodal Federated Edge Learning](https://arxiv.org/abs/2608.07730)
...
### [3] [Coordinated Spectrum Coexistence Across Heterogeneous Commercial and Federal Services](https://arxiv.org/abs/2608.07789)
...
### [4] [Orchestrated Vulnerability Management for Heterogeneous Networks: Adaptive Two-Stage Vulnerability Assessment, Context-Aware Risk Prioritization, and Automated Mitigation](https://arxiv.org/abs/2608.08162)
...
### [5] [WirelessOpsAgent: A Benchmark and Agent Design for Action Assurance in Wireless Networks](https://arxiv.org/abs/2608.08277)
...
### [6] [PSP: Low-Overhead Packet-Level Load Balancing for Stale-State and Bandwidth-Asymmetric Networks](https://arxiv.org/abs/2608.08425)
...
### [7] [Carrier Leakage Suppression and Power Difference Equalization for TFDMA Coherent PON](https://arxiv.org/abs/2608.08444)
...
### [8] [Active Hemispherical Metasurface Transmitarray Antenna for Wide-Angle 3D Beam Steering and Target Tracking](https://arxiv.org/abs/2608.08991)
...
### [9] [SparsePilot: Belief-Guided Network Planning under Sparse Wireless Measurements](https://arxiv.org/abs/2608.09199)
...
### [10] [Automated Synthesis of Deterministic Cross-Domain Interfaces](https://arxiv.org/abs/2608.09312)
...
### [11] [Enabling Beyond-Visual-Line-of-Sight Drones Operation over Open RAN 5G Networks with Slicing](https://arxiv.org/abs/2608.09481)
...
### [12] [A Semantic Communication Approach to Fiducial Marker Processing in 5G-Enabled Edge SLAM](https://arxiv.org/abs/2608.09620)
...
### [13] [Abstractions for Network Intelligence: A Reference Architecture for AI at the Wireless Edge](https://arxiv.org/abs/2608.09640)
...
### [14] [ScaleSense: Cost-Intelligent Scaling Framework via Learned Resource Estimation in Alibaba AnalyticDB](https://arxiv.org/abs/2608.07945)
...
### [15] [Metadata Reconstruction from Values Alone: Recovering Column Semantics in Undocumented Warehouses](https://arxiv.org/abs/2608.07946)
*Mike Helwig*
...
### [16] [Scout: Scalable Document Extraction via Data Similarity](https://arxiv.org/abs/2608.08261)
...
### [17] [InSituANN: Revisiting IVF for PCIe-Efficient Billion-Scale Vector Search](https://arxiv.org/abs/2608.08751)
...
### [18] [SiriusDeliver: Automating Data Warehouse Delivery at Tencent](https://arxiv.org/abs/2608.09185)
...
### [19] [AkasicDB: Demonstrating Omni RAG with a Unified Vector-Graph-Relational DBMS](https://arxiv.org/abs/2608.09214)
...
### [20] [SafeQL: Search-based Refinement for Safe and Efficient LLM-based Text-to-SQL](https://arxiv.org/abs/2608.09260)
...
### [21] ["Will This Data Break My Task?" - Interactive Synthesis of Task-Aware Data Unit Tests](https://arxiv.org/abs/2608.09376)
...
### [22] [Monotonicity-Guided Bottom-Up Petri Net Discovery: The SPECpp Framework](https://arxiv.org/abs/2608.09398)
...
### [23] [Carnot: Interpretable, Interactive, and Optimized Execution of Deep Research Queries](https://arxiv.org/abs/2608.09532)
...
### [24] [DevIntent: How Much Does LLM-Generated Code Violate Developer Intent?](https://arxiv.org/abs/2608.07614)
...
### [25] [Refining LLM-based Directed Test Input Generation via Runtime Value Feedback](https://arxiv.org/abs/2608.07926)
*Narin Han,Shin Hong*
...
### [26] [Verication-driven closed-loop multi-agent large language modelframework for code-compliant structural design](https://arxiv.org/abs/2608.07978)
...
### [27] [Stateful Multi-Agent LLMs for Cross-View Interface Alignment in Automotive Model-Based Systems Engineering](https://arxiv.org/abs/2608.08038)
...
### [28] [HugSelect: An Explainable Multi-Criteria Decision-Support Framework for foundation-model selection](https://arxiv.org/abs/2608.08069)
...
### [29] [Synthesizing Behavioural Models of CPS Using Automata Learning and Statistical Machine Learning](https://arxiv.org/abs/2608.08214)
...
### [30] [On the Robustness of LLMs' Internal Representation of Code Correctness](https://arxiv.org/abs/2608.08266)
...
### [31] [Ouroboros: A Self-Developing Frontier Coding Agent with Reviewed Core Evolution](https://arxiv.org/abs/2608.08311)
...
### [32] [Do Stack Overflow Answer Edits Occur Beyond Java? A Replication on Python and JavaScript](https://arxiv.org/abs/2608.08361)
...
### [33] [White paper: A perspective on civilian-to-defence research transfer to SDD](https://arxiv.org/abs/2608.09349)
...
### [34] [Tangent: An Empirical Study of Testing Practices for LLM-Based Agent Applications](https://arxiv.org/abs/2608.08413)
...
### [35] [Generics-Aware Fuzz Target Generation for Rust Libraries via Structured API Analysis](https://arxiv.org/abs/2608.08637)
...
### [36] [Fusing UI Structure & Semantics for Feature-Oriented App Screen Retrieval & Clustering](https://arxiv.org/abs/2608.08880)
...
### [37] [Biomedical Knowledge Composition: A Software Engineering Perspective](https://arxiv.org/abs/2608.08927)
...
### [38] [Independent Patch Verification for Coding Agents with a Bidirectional Reconstruct-and-Verify Framework](https://arxiv.org/abs/2608.08950)
...
### [39] [GALA: Graph-Augmented LLM Agents for Root Cause Analysis and Incident Response in Microservices](https://arxiv.org/abs/2608.08968)
...
### [40] [Pseudo2CodeQA: A Benchmark for LLM-Based Structured Algorithmic Reasoning in Code Generation](https://arxiv.org/abs/2608.09068)
...
### [41] [A Unified Issue Resolution Benchmark for Requirement Clarification, Planning, and Code Generation for Coding Agents](https://arxiv.org/abs/2608.09072)
...
### [42] [Memoir: Learning, Verifying, and Evolving False-Positive Memories for Static Application Security Testing Tools](https://arxiv.org/abs/2608.09181)
...
### [43] [Software Engineering for and with GUI Agent](https://arxiv.org/abs/2608.09278)
...
### [44] [OpenCodeReview: Determinism over Non-Determinism for Cost-Effective Agent-Based Code Review](https://arxiv.org/abs/2608.09290)
...
### [45] [Search-Based Generation of Undetected Quantum Circuit Mutants](https://arxiv.org/abs/2608.09318)
...
### [46] [SmellCC: A Tool for Automated Code Smells Remediation](https://arxiv.org/abs/2608.09477)
...
### [47] [The Unseen Delta: Characterizing the Compiler Optimization Landscape via Top-Down Differential Analysis](https://arxiv.org/abs/2608.09530)
...
### [48] [Representative Dataset Generation Framework for AI-based Failure Analysis during real-time Validation of Automotive Software Systems](https://arxiv.org/abs/2608.09651)
...
### [49] [Security Tests as Executable Specifications for LLM Code Generation: Benefits, Trade-offs, and Coverage Limits](https://arxiv.org/abs/2608.09740)
...
### [50] [SpecPath: Testing Coding Agents Across Contract-Equivalent Specification Histories](https://arxiv.org/abs/2608.09799)
...
### [51] [Comprehending Python Repetition Structures: An Eye-Tracking Study with Novice Developers](https://arxiv.org/abs/2608.09875)
...
### [52] [Detecting Behavioral Changes in Python Refactoring Implementations with Foundation Models](https://arxiv.org/abs/2608.09919)
...
### [58] [Evaluating and Improving Weak Scalability Analysis of Visualization Algorithms](https://arxiv.org/abs/2608.08166)
...
### [59] [OpRAG: A Resource-Deterministic Runtime for GPU-Backed Multi-Stage RAG Workflows](https://arxiv.org/abs/2608.08340)
...
### [60] [Empirical Analysis of Cloud-Edge Infrastructure Complexity: Practitioner Pain Points and Architectural Directions](https://arxiv.org/abs/2608.08400)
...
### [61] [C2C-Explorer: An Exploration Framework for Chip-to-Chip Interconnect Architectures in LLM Cloud Computing Systems](https://arxiv.org/abs/2608.08611)
...
### [63] [A Resource-centric Analysis and Optimization of NoSQL Workloads using Distressed Resource Volume Metric](https://arxiv.org/abs/2608.09173)
...
### [64] [Randomized Tree-Intersection Leader Election](https://arxiv.org/abs/2608.08817)
...
### [65] [Universal Rendezvous of Anonymous Agents with Footprints](https://arxiv.org/abs/2608.08981)
*Bibhuti Das*
...
### [74] [HINT: Toward an Executable Hardware-Intent Representation Layer for LLM-Driven RTL Generation](https://arxiv.org/abs/2608.07625)
...
### [75] [Hybrid ASIC-FPAA Fabric for Performance Security Trade-off](https://arxiv.org/abs/2608.07896)
...
### [76] [ARMOR: Accelerating RTL Simulation by Mitigating the Front-End Bottleneck Using Node Compression](https://arxiv.org/abs/2608.08462)
...
### [77] [ReVolt: Power Delivery Network-Aware Voltage Droop Control for 2.5D PIM Chiplet Architectures](https://arxiv.org/abs/2608.08496)
...
### [78] [Eco-SoC: A Sustainable VLSI Architecture for Energy-Proportional Artificial Intelligence](https://arxiv.org/abs/2608.08761)
*Jatin Chopra*
...
### [79] [FSGen: Agile Fused and Sparse Accelerator Generator with Accurate Power Model for LLM Applications](https://arxiv.org/abs/2608.09252)
