...
### [1] [Switching Efficiency: A Novel Framework for Dissecting AI Data Center Network Efficiency](https://arxiv.org/abs/2604.14690)
...
### [2] [MLDAS: Machine Learning Dynamic Algorithm Selection for Software-Defined Networking Security](https://arxiv.org/abs/2604.14957)
...
### [3] [Expanding into Reality: Random Graphs for Datacenter Networks](https://arxiv.org/abs/2604.15261)
...
### [4] [Learning ultra-compressible hyperelasticity with splines: Constitutive asymmetries and non-unique representations](https://arxiv.org/abs/2604.14264)
...
### [5] [Weak-DMD: A Galerkin approach to the problem of noise in the Dynamic Mode Decomposition algorithm](https://arxiv.org/abs/2604.14350)
...
### [6] [Decoupling Identity from Utility: Privacy-by-Design Frameworks for Financial Ecosystems](https://arxiv.org/abs/2604.14495)
...
### [7] [Robust Optimal Experimental Design Accounting for Sensor Failure](https://arxiv.org/abs/2604.14497)
...
### [8] [A Stable SBP-SAT FDTD Subgridding Method Without Region Split](https://arxiv.org/abs/2604.14618)
...
### [9] [Fully Differentiable Ultrasound Simulation Utilizing Ray-Tracing](https://arxiv.org/abs/2604.15017)
...
### [15] [Incidence Constraints in Hypergraph Partitioning on GPU](https://arxiv.org/abs/2604.14411)
...
### [16] [CoCoDiff: Optimizing Collective Communications for Distributed Diffusion Transformer Inference Under Ulysses Sequence Parallelism](https://arxiv.org/abs/2604.14561)
...
### [17] [AgileLog: A Forkable Shared Log for Agents on Data Streams](https://arxiv.org/abs/2604.14590)
...
### [18] [Serving Chain-structured Jobs with Large Memory Footprints with Application to Large Foundation Model Serving](https://arxiv.org/abs/2604.14993)
...
### [19] [Efficient calculation of available space for multi-NUMA virtual machines](https://arxiv.org/abs/2604.15033)
...
### [20] [Prefill-as-a-Service: KVCache of Next-Generation Models Could Go Cross-Datacenter](https://arxiv.org/abs/2604.15039)
...
### [21] [Scepsy: Serving Agentic Workflows Using Aggregate LLM Pipelines](https://arxiv.org/abs/2604.15186)
...
### [22] [Wave-Based Dispatch for Circuit Cutting in Hybrid HPC--Quantum Systems](https://arxiv.org/abs/2604.15279)
...
### [23] [BitFlipScope: Scalable Fault Localization and Recovery for Bit-Flip Corruptions in LLMs](https://arxiv.org/abs/2512.22174)
...
### [24] [Dive into Claude Code: The Design Space of Today's and Future AI Agent Systems](https://arxiv.org/abs/2604.14228)
...
### [25] [Graph-Based ECO and Patch Generation for High-Level Synthesis](https://arxiv.org/abs/2604.14248)
...
### [26] [ToxiShield: Promoting Inclusive Developer Communication through Real-Time Toxicity Filtering](https://arxiv.org/abs/2604.14408)
...
### [27] [LLMs taking shortcuts in test generation: A study with SAP HANA and LevelDB](https://arxiv.org/abs/2604.14437)
...
### [28] [Asking What Matters: Reward-Driven Clarification for Software Engineering Tasks](https://arxiv.org/abs/2604.14624)
...
### [29] [AIPC: Agent-Based Automation for AI Model Deployment with Qualcomm AI Runtime](https://arxiv.org/abs/2604.14661)
...
### [30] [Bounded Autonomy for Enterprise AI: Typed Action Contracts and Consumer-Side Execution](https://arxiv.org/abs/2604.14723)
...
### [31] [SWE-TRACE: Optimizing Long-Horizon SWE Agents Through Rubric Process Reward Models and Heuristic Test-Time Scaling](https://arxiv.org/abs/2604.14820)
...
### [32] [Vibe-Coding: Feedback-Based Automated Verification with no Human Code Inspection, a Feasibility Study](https://arxiv.org/abs/2604.14867)
...
### [33] [Towards Understanding Android APIs: Official Lists, Vendor Customizations, and Real-World Usage](https://arxiv.org/abs/2604.14943)
...
### [34] [Applying SHAPR in AI-Assisted Research Software Development: Lessons Learnt from Building a Share Trading System](https://arxiv.org/abs/2604.15020)
*Ka Ching Chan*
...
### [35] [HintPilot: LLM-based Compiler Hint Synthesis for Code Optimization](https://arxiv.org/abs/2604.15041)
...
### [36] [Atropos: Improving Cost-Benefit Trade-off of LLM-based Agents under Self-Consistency with Early Termination and Model Hotswap](https://arxiv.org/abs/2604.15075)
...
### [37] [From Procedural Skills to Strategy Genes: Towards Experience-Driven Test-Time Evolution](https://arxiv.org/abs/2604.15097)
...
### [38] [AI-Assisted Requirements Engineering: An Empirical Evaluation Relative to Expert Judgment](https://arxiv.org/abs/2604.15222)
...
### [39] [Enhancing Large Language Models with Retrieval Augmented Generation for Software Testing and Inspection Automation](https://arxiv.org/abs/2604.15270)
...
### [40] [Parallel R-tree-based Spatial Query Processing on a Commercial Processing-in-Memory System](https://arxiv.org/abs/2604.14445)
...
### [41] [RELOAD: A Robust and Efficient Learned Query Optimizer for Database Systems](https://arxiv.org/abs/2604.14725)
...
### [42] [Efficient Community Search on Attributed Public-Private Graphs](https://arxiv.org/abs/2604.14988)
...
### [43] [Data Engineering Patterns for Cross-System Reconciliation in Regulated Enterprises: Architecture, Anomaly Detection, and Governance](https://arxiv.org/abs/2604.15108)
*Zhijun Qiu*
...
### [44] [DPC: Training-Free Text-to-SQL Candidate Selection via Dual-Paradigm Consistency](https://arxiv.org/abs/2604.15163)
