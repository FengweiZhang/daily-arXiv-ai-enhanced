...
### [5] [ITME: Inference Tiered Memory Expansion with Disaggregated CXL-Hybrid Memories](https://arxiv.org/abs/2606.12556)
...
### [7] [On the Limits of Performance Portability in Directive-Based GPU Programming](https://arxiv.org/abs/2606.12753)
...
### [8] [SemanticXR: Low Power and Real-time Queryable Semantic Mapping with an Object-Level Device-Cloud Architecture](https://arxiv.org/abs/2606.12849)
...
### [9] [High-Order Spectral Element Methods for Wave Propagation on ARM Multicore CPU with SME: Optimizations and Implications](https://arxiv.org/abs/2606.12850)
...
### [11] [JiRAIYA: A Reputation-Based Hierarchical Federated Learning Framework on Web3](https://arxiv.org/abs/2606.13180)
...
### [12] [Dynamic Resource Management in Production HPC Clusters](https://arxiv.org/abs/2606.13266)
...
### [13] [Skiplists with Foresight: Skipping Cache Misses](https://arxiv.org/abs/2606.13321)
...
### [14] [Work Stealing for the 2D-Mesh Topology of Satellite Constellations in Low Earth Orbit](https://arxiv.org/abs/2606.13329)
...
### [15] [Temporal Conductance and Bounds on the Voter Model for Dynamic Networks](https://arxiv.org/abs/2606.13374)
...
### [17] [Finding Conservation Laws of Large Dynamical Systems with Tasks and Futures: A Case Study in Utilizing Dynamic Data Dependencies](https://arxiv.org/abs/2606.13623)
*Rüdiger Nather*
...
### [18] [Free-Placement Optimization of Ground Station Locations for Low-Earth Orbit Satellites](https://arxiv.org/abs/2606.12667)
...
### [19] [ScaleAcross: Designing Multi-Data-Center Infrastructure for Geo-Distributed AI Training](https://arxiv.org/abs/2606.12963)
...
### [20] [Modular Multi-Domain Digital Twin Architecture: Sustainable Intent-Driven 6G Management](https://arxiv.org/abs/2606.13069)
...
### [21] [Revolutionizing Wireless Communications with Space Data Centers: Applications and Open Challenges](https://arxiv.org/abs/2606.13086)
...
### [22] [Feasibility Assessment of Remote Driving via Latency Analysis of ITS-G5 and Cellular Networks in the MASA Living Lab](https://arxiv.org/abs/2606.13292)
...
### [23] [Measurement-Based Performance Evaluation of SmartRSUs with Heterogeneous Antenna Architectures for V2X Communications](https://arxiv.org/abs/2606.13334)
...
### [24] [Experimental Insights into UDP-Based Video and Control Traffic over IEEE 802.11p ITS-G5](https://arxiv.org/abs/2606.13390)
...
### [25] [From Traditional Automation to Embodied Wireless Intelligence: Vision-Language-Action Empowered Physics-Aware Communication Networks](https://arxiv.org/abs/2606.13458)
...
### [26] [Graphical Causal Reasoning for Root Cause Analysis in Cloud Networks](https://arxiv.org/abs/2606.13532)
...
### [27] [NetCause: Counterfactual Learning for Root Cause Analysis in Large-Scale Networks](https://arxiv.org/abs/2606.13543)
...
### [28] [Characterizing Tests in IoT Software: Practices, Challenges and Opportunities](https://arxiv.org/abs/2606.12592)
...
### [29] [HybridCodeAuthorship: A Benchmark Dataset for Line-Level Code Authorship Detection](https://arxiv.org/abs/2606.12620)
...
### [30] [Beyond Problem Solving: UOJ-Bench for Evaluating Code Generation, Hacking, and Repair in Competitive Programming](https://arxiv.org/abs/2606.12864)
...
### [31] [The Rise of AI-Native Software Engineering: Implications for Practice, Education, and the Future Workforce](https://arxiv.org/abs/2606.12986)
*Mamdouh Alenezi*
...
### [32] [The End of Code Review: Coding Agents Supersede Human Inspection](https://arxiv.org/abs/2606.13175)
*Martin Monperrus*
...
### [33] [ComAct: Reframing Professional Software Manipulation via COM-as-Action Paradigm](https://arxiv.org/abs/2606.13239)
...
### [34] [Mining Architectural Quality Under Agentic AI Adoption: A Causal Study of Java Repositories](https://arxiv.org/abs/2606.13298)
...
### [35] [Toward Instructions-as-Code: Understanding the Impact of Instruction Files on Agentic Pull Requests](https://arxiv.org/abs/2606.13449)
...
### [36] [Understanding the Rejection of Fixes Generated by Agentic Pull Requests -- Insights from the AIDev Dataset](https://arxiv.org/abs/2606.13468)
...
### [37] [Non-Parametric Dual-Manifold Mapping via 8-Bit Bounded Transformation Matrices: Challenging FP-centric Hardware Paradigms in Low-Energy AI](https://arxiv.org/abs/2606.13328)
*Lars Kopp*
...
### [38] [SupraSNN: Exploiting Synapse-Level Parallelism in Spiking Neural Network Accelerators through Co-Optimized Mapping and Scheduling](https://arxiv.org/abs/2606.13354)
...
### [39] [ReSCom: A Reconfigurable Spiking Neural Network Accelerator Using Stochastic Computing](https://arxiv.org/abs/2606.13560)
