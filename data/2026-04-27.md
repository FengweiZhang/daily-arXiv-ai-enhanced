...
### [5] [Topology Optimization for Materially Efficient Reinforced Concrete Design: Development, Fabrication, and Structural Evaluation](https://arxiv.org/abs/2604.22070)
...
### [6] [AI-Driven Performance-to-Design Generation and Optimization of Marine Propellers](https://arxiv.org/abs/2604.22224)
...
### [15] [Feedback Over Form: Why Execution Feedback Matters More Than Pipeline Topology in 1-3B Code Generation](https://arxiv.org/abs/2604.21950)
...
### [16] [Documentless Assessments Using Nominal Group Interviews](https://arxiv.org/abs/2604.22003)
*Eduardo Miranda*
...
### [17] [FlyCatcher: Neural Inference of Runtime Checkers from Tests](https://arxiv.org/abs/2604.22028)
...
### [18] [Call-Chain-Aware LLM-Based Test Generation for Java Projects](https://arxiv.org/abs/2604.22046)
...
### [19] [TRACE: Topology-aware Reconstruction of Accidents in CARLA for AV Evaluation](https://arxiv.org/abs/2604.22068)
...
### [20] [Ethics Testing: Proactive Identification of Generative AI System Harms](https://arxiv.org/abs/2604.22089)
...
### [21] [Evaluating LLM-Based Goal Extraction in Requirements Engineering: Prompting Strategies and Their Limitations](https://arxiv.org/abs/2604.22207)
...
### [22] [RAG-Reflect: Agentic Retrieval-Augmented Generation with Reflections for Comment-Driven Code Maintenance on Stack Overflow](https://arxiv.org/abs/2604.22217)
...
### [23] [Enhancing a gamified tool for UML modeling education](https://arxiv.org/abs/2604.22400)
...
### [24] [R2Code: A Self-Reflective LLM Framework for Requirements-to-Code Traceability](https://arxiv.org/abs/2604.22432)
...
### [25] [Gamifying Architectural Governance to Reduce Organizational Coupling in Microservice Systems](https://arxiv.org/abs/2604.22454)
*Xiaozhou Li*
...
### [26] [Test Design and Review Argumentation in AI-Assisted Test Generation](https://arxiv.org/abs/2604.22473)
...
### [27] [A Comparison of ROS 2 and AUTOSAR Adaptive Platform Against Industry-Elicited Automotive Middleware Requirements](https://arxiv.org/abs/2604.22576)
...
### [28] [From Natural Language to Verified Code: Toward AI Assisted Problem-to-Code Generation with Dafny-Based Formal Verification](https://arxiv.org/abs/2604.22601)
...
### [29] [Quality-Driven Selective Mutation for Deep Learning](https://arxiv.org/abs/2604.22640)
...
### [30] [Verifier Warnings Do Not Improve Comprehensibility Prediction](https://arxiv.org/abs/2604.22653)
...
### [31] [RealBench: A Repo-Level Code Generation Benchmark Aligned with Real-World Software Development Practices](https://arxiv.org/abs/2604.22659)
...
### [32] [Inferring Equivalence Classes from Legacy Undocumented Embedded Binaries for ISO 26262-Compliant Testing](https://arxiv.org/abs/2604.22673)
...
### [33] [Code for All: Educational Applications of the "Vibe Coding" Hackathon in Programming Education across All Skill Levels](https://arxiv.org/abs/2604.22747)
...
### [34] [Implementation and Privacy Guarantees for Scalable Keyword Search on SOLID-based Decentralized Data with Granular Visibility Constraints](https://arxiv.org/abs/2604.22100)
...
### [35] [MCI: A Maximal Clique Index for Efficient Arbitrary-Filtered Approximate Nearest Neighbor Search](https://arxiv.org/abs/2604.22171)
...
### [36] [A Model-Driven Approach to Database Migration with a Unified Data Model](https://arxiv.org/abs/2604.22415)
...
### [37] [How Hard is it to Decide if a Fact is Relevant to a Query?](https://arxiv.org/abs/2604.22422)
...
### [38] [It's Time to Standardize RDF Messages](https://arxiv.org/abs/2604.22619)
...
### [39] [A dataset of early blockchain-registered AI agents on Ethereum](https://arxiv.org/abs/2604.22652)
*Yulin Liu*
...
### [40] [Hardware-Software Co-Design for Event-Driven SNN Deployment on Low-Cost Neuromorphic FPGAs](https://arxiv.org/abs/2604.22179)
...
### [41] [GR-Evolve: Design-Adaptive Global Routing via LLM-Driven Algorithm Evolution](https://arxiv.org/abs/2604.22234)
...
### [42] [AutoINV: Automated Invariant Generation Framework for Formal Verification on High-Level Synthesis Designs](https://arxiv.org/abs/2604.22285)
...
### [43] [HGQ-LUT: Fast LUT-Aware Training and Efficient Architectures for DNN Inference](https://arxiv.org/abs/2604.22293)
...
### [44] [Exploiting pre-optimized kernels with polyhedral transformations for CGRA compilation](https://arxiv.org/abs/2604.22297)
...
### [45] [Microarchitectural Co-Optimization for Sustained Throughput of RISC-V Multi-Lane Chaining Vector Processors](https://arxiv.org/abs/2604.22314)
