...
### [24] [KerColle: Unlocking Fine-Grained GPU Concurrency in Vision-Language-Action Models](https://arxiv.org/abs/2609.22335)
...
### [25] [Design-Space Exploration of Post-Quantum Cryptography Acceleration on an Open-Source RISC-V GPGPU](https://arxiv.org/abs/2609.22343)
...
### [26] [Verification Reward Model for Reinforcement Learning in Chip Design Verification](https://arxiv.org/abs/2609.22347)
*Shashank Chaurasia*
...
### [27] [UniCASE: A Unified 16-bit Floating-Point Format with Criticality-Aware Selective ECC for Efficient DNN Protection](https://arxiv.org/abs/2609.22590)
...
### [28] [Presage: Prefetch Search via Agent-Guided Experiments](https://arxiv.org/abs/2609.22636)
...
### [29] [TEMPO: A Tag-Based Framework for Efficient Memory Ordering](https://arxiv.org/abs/2609.22743)
...
### [30] [Quality over Quantity: Diversity-Aware Data Selection for Efficient Verilog Code Generation](https://arxiv.org/abs/2609.22765)
...
### [31] [Benchmarking StreamNTT with a Verilog-to-Routing Toolchain](https://arxiv.org/abs/2609.23116)
...
### [32] [WaveletECO: A Closed-Loop Physical ECO Platform and a Specialized Local Language Model](https://arxiv.org/abs/2609.23444)
...
### [33] [SPLASH: Co-Designing Sparse Attention with High-Bandwidth Flash for Efficient Long-Context Inference](https://arxiv.org/abs/2609.23816)
...
### [34] [Dissecting How Die Scaling Breaks GPU Fine-grained Scheduling](https://arxiv.org/abs/2609.24270)
...
### [35] [Circuit-Architecture-Training Co-Design with Regenerative-SA Similarity Sensing for Aggressive SAR Skipping in Analog Compute-in-Memory](https://arxiv.org/abs/2609.24288)
...
### [36] [NPU Accelerator: Quantized Real-Time Vehicle Detection on PYNQ-Z1 Using FINN](https://arxiv.org/abs/2609.24757)
...
### [37] [SPECTRA: Adaptive Execution of Speculative Decoding on a Runtime-Reconfigurable Tiled Architecture](https://arxiv.org/abs/2609.24847)
...
### [38] [Toward Multi-kW Power Delivery Methodologies for Advanced 3D Heterogeneous Integration](https://arxiv.org/abs/2609.24904)
...
### [39] [Element-dependent buckling loads of stiffened panels under cantilevered shear](https://arxiv.org/abs/2609.22656)
...
### [40] [Real-Validated UAV Audition Under Rotor Ego-Noise for Low-False-Alarm Human Detection](https://arxiv.org/abs/2609.22830)
...
### [41] [Cognitive behavior emerging in mechanical systems through reservoir encoding and active inference](https://arxiv.org/abs/2609.23013)
...
### [42] [Shading-Aware Rooftop PV Placement](https://arxiv.org/abs/2609.23021)
...
### [43] [Enterprise Process Control Tower for IT-Led Improvement](https://arxiv.org/abs/2609.23082)
...
### [44] [Human-guided physics-constrained AI agents construct an auditable model of soil-plug evolution](https://arxiv.org/abs/2609.23360)
...
### [45] [FinRankGRPO: Optimizing LLMs for Listwise Financial Asset Ranking via Group Relative Policy Optimization](https://arxiv.org/abs/2609.24175)
...
### [46] [Adaptive Parallel-in-Time Integration with Dynamic Resource Management](https://arxiv.org/abs/2609.24434)
...
### [47] [InvestorNerd: An Investment and Financial Insights System Based on User Profiles](https://arxiv.org/abs/2609.24658)
...
### [48] [Colour me shocked: Exact Molecular Hessians from local MLIPs in O(N) time using sparse differentiation!](https://arxiv.org/abs/2609.24720)
...
### [49] [io_uring in Oracle Database: A Hybrid Storage I/O Architecture at Production Scale](https://arxiv.org/abs/2609.22781)
...
### [50] [Same Pattern, Different Answer: A Reference Semantics and Divergence Map for GQL and SQL/PGQ Path Patterns](https://arxiv.org/abs/2609.23032)
...
### [51] [Exploiting Residual Reachability for Cross-Model Migration of Graph-Based Indexes in Approximate Nearest Neighbor Search](https://arxiv.org/abs/2609.23036)
...
### [52] [Graph Memory for LLM Agents: At What Cost? A Comparative Evaluation of Query, Ingest, and Update Performance Across Graph Database Engines](https://arxiv.org/abs/2609.23315)
...
### [53] [Structured Spatio-Temporal Evidence Graphs for Open-Vocabulary Object Retrieval in Videos](https://arxiv.org/abs/2609.23393)
...
### [54] [Data Agents: Agentic Data Systems](https://arxiv.org/abs/2609.24137)
...
### [55] [Efficient Dense Vector Search within Knowledge Graph Content Embeddings](https://arxiv.org/abs/2609.24236)
...
### [56] [Pierce: GPU Ray Tracing for Spatial Joins over Complex 3D Data](https://arxiv.org/abs/2609.24513)
...
### [57] [From OA colors to observable access states: A commentary on the 2026 OpenAlex proposal](https://arxiv.org/abs/2609.24730)
*Abdelghani Maddi*
...
### [58] [When Does Learning Beat Heuristics? A Case Study in Kubernetes Scheduler Score Plugins](https://arxiv.org/abs/2609.22142)
...
### [59] [The Tethys Dataset: Seven Years of Hourly Smart Water Metering and a Pipeline for Making It Usable](https://arxiv.org/abs/2609.22358)
...
### [60] [Trust-Aware Output Management for Physical Neural Network in Cloud-Continuum Systems](https://arxiv.org/abs/2609.22443)
...
### [61] [Mask-Aware Execution for Efficient JEPA Training](https://arxiv.org/abs/2609.22674)
...
### [62] [Replacing Large Language Models with Jev Decision Models for Low-Latency Edge Service Orchestration](https://arxiv.org/abs/2609.22753)
...
### [63] [NSP: Accelerating Variable-Length LLM Training via Nested Sequence Parallelism](https://arxiv.org/abs/2609.22755)
...
### [64] [From Idle to Urgent: A Resource-Harvested HPC Workflow for High-Fidelity Seismic Estimation](https://arxiv.org/abs/2609.22814)
...
### [65] [DeepSeek Elastic Compute (DSec): A Sandbox Infrastructure for Effective Agentic Training at Scale](https://arxiv.org/abs/2609.22978)
...
### [66] [Silent Failures at the $2^{32}$ Boundary: A Technical Report on Large-Tensor Matrix Multiplication in PyTorch's Apple MPS Backend](https://arxiv.org/abs/2609.22991)
*Junichiro Niimi*
...
### [67] [Accurate Simulation of Distributed Training Jobs with Network Contention Modeling](https://arxiv.org/abs/2609.23278)
...
### [68] [Accurate Distributed Tracing for Large-Scale AI Infrastructure: Time Synchronization as a Foundation for Reliable Observability](https://arxiv.org/abs/2609.23301)
...
### [69] [Co-occurrence Patterns of LoRA Adapters in Production Diffusion Model Inference Services](https://arxiv.org/abs/2609.23321)
...
### [70] [Economical and efficient big data sharing with i-Cloud](https://arxiv.org/abs/2609.23438)
...
### [71] [Conflicting Pattern Formation by Teams of Anonymous, Fully Disoriented Robots](https://arxiv.org/abs/2609.23454)
...
### [72] [Explicit State and Resource Contracts for Low-Precision Pipeline Parallel Training under Captured Graphs](https://arxiv.org/abs/2609.23536)
...
### [73] [SAGE: Optimal-Stopping Peer Selection for Decentralised Federated Learning](https://arxiv.org/abs/2609.23773)
...
### [74] [Byzantine Causal Reliable Broadcast (BCRB) with Constant-Size Message Metadata](https://arxiv.org/abs/2609.24018)
...
### [75] [MCP-GRANITE Benchmark: GRANularity Interface TEsting for MCP-Based LLM Agents](https://arxiv.org/abs/2609.24161)
...
### [76] [A principled approach for energy-efficient training via phase-aware GPU frequency tuning](https://arxiv.org/abs/2609.24205)
...
### [77] [Toward GPU-Resident Climate Models: A Feasibility Study on Lossy Compression for the Spherical Harmonic Transform's Communication Bottleneck](https://arxiv.org/abs/2609.24294)
...
### [78] [Conduit: An Experience Data Plane for Distributed Reinforcement Learning](https://arxiv.org/abs/2609.24456)
...
### [79] [Bridging the Vendor Gap: Enabling AMD GPU Support for Awkward Array via ROCm/HIP for the HL-LHC Era](https://arxiv.org/abs/2609.24628)
...
### [80] [Analytical Power-Aware Provisioning for Prefill-Decode Disaggregated AI Inference](https://arxiv.org/abs/2609.24639)
...
### [81] [Mitigating Front-Running Attacks through Fair and Resilient Transaction Dissemination](https://arxiv.org/abs/2609.24713)
...
### [82] [Tiga: Compiling Graph Message Passing at Scale](https://arxiv.org/abs/2609.24802)
*Mingyuan Chi*
...
### [83] [Who Pays for the KV Cache? Attributing Shared AI Inference Spend Across Kubernetes and LLM Provider Bills](https://arxiv.org/abs/2609.24991)
*Timothy Urista*
...
### [84] [WiNeRF: Measurement Constrained Radiance Fields for Actionable Wireless Channel Modeling](https://arxiv.org/abs/2609.22132)
...
### [85] [Toward Mission-Critical ISAC: Reliable Energy-Aware Coordination in UAV Swarms](https://arxiv.org/abs/2609.22292)
...
### [86] [Semantics Delivery Network: Rethinking Web Retrieval Infrastructure for LLM Agents](https://arxiv.org/abs/2609.22486)
...
### [87] [ANI-Gamut: Benchmarking Agent Reliability across the Gamut of Agent-Network Interface Abstractions](https://arxiv.org/abs/2609.22723)
...
### [88] [RoutingBench: Can Agentic Routing Analysis Scale to Production Datacenter Networks?](https://arxiv.org/abs/2609.22848)
...
### [89] [Fast Intent-Driven Service Orchestration with Jev for 6G Edge Networks](https://arxiv.org/abs/2609.23136)
*Delong Li,Xu Wang,Haochen Gong,Rui Lang,Guangsheng Yu*
...
### [90] [Orientation-Aware Control and Trajectory Design for Aerial RIS-Assisted Wireless Communications](https://arxiv.org/abs/2609.23157)
...
### [91] [Protocol-Flexible Custom NFC for Wire-Free Wearable Sensor Networks](https://arxiv.org/abs/2609.23347)
...
### [92] [SemDHT: Certified Semantic Discovery for Peer-to-Peer Agent Networks over Exact-Key DHTs](https://arxiv.org/abs/2609.23539)
...
### [93] [Zero-Knowledge Remote Adversarial Attack against Wi-Fi-based Human Activity Recognition for Privacy Protection](https://arxiv.org/abs/2609.24173)
...
### [94] [Joint Energy Efficiency and Fairness Optimization for D2D Communications in Aerial-Ground Integrated Heterogeneous Networks](https://arxiv.org/abs/2609.24365)
...
### [95] [ALARM: Adaptive Layer-Aware Resource Management for Power-Efficient vRANs](https://arxiv.org/abs/2609.24765)
