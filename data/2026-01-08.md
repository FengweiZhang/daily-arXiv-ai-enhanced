...
### [1] [SciNetBench: A Relation-Aware Benchmark for Scientific Literature Retrieval Agents](https://arxiv.org/abs/2601.03260)
...
### [2] [PIVONet: A Physically-Informed Variational Neuro ODE Model for Efficient Advection-Diffusion Fluid Simulation](https://arxiv.org/abs/2601.03397)
...
### [3] [Revisiting Speculative Leaderless Protocols for Low-Latency BFT Replication](https://arxiv.org/abs/2601.03390)
...
### [4] [Majorum: Ebb-and-Flow Consensus with Dynamic Quorums](https://arxiv.org/abs/2601.03862)
...
### [14] [On the Robustness of Fairness Practices: A Causal Framework for Systematic Evaluation](https://arxiv.org/abs/2601.03621)
...
### [15] [Verbatim Data Transcription Failures in LLM Code Generation: A State-Tracking Stress Test](https://arxiv.org/abs/2601.03640)
...
### [16] [From Laboratory to Real-World Applications: Benchmarking Agentic Code Reasoning at the Repository Level](https://arxiv.org/abs/2601.03731)
...
### [17] [Assessing and Improving the Representativeness of Code Generation Benchmarks Using Knowledge Units (KUs) of Programming Languages -- An Empirical Study](https://arxiv.org/abs/2601.03780)
...
### [18] [Once Upon a Team: Investigating Bias in LLM-Driven Software Team Composition and Task Allocation](https://arxiv.org/abs/2601.03857)
...
### [19] [Understanding Specification-Driven Code Generation with LLMs: An Empirical Study Design](https://arxiv.org/abs/2601.03878)
...
### [20] [Using Small Language Models to Reverse-Engineer Machine Learning Pipelines Structures](https://arxiv.org/abs/2601.03988)
...
### [21] [An Ontology-Based Approach to Security Risk Identification of Container Deployments in OT Contexts](https://arxiv.org/abs/2601.04010)
...
### [22] [Smells Depend on the Context: An Interview Study of Issue Tracking Problems and Smells in Practice](https://arxiv.org/abs/2601.04124)
...
### [23] [Prediction-Guided Control in Data Center Networks](https://arxiv.org/abs/2601.03593)
...
### [24] [Incentive Mechanism Design for Resource Management in Satellite Networks: A Comprehensive Survey](https://arxiv.org/abs/2601.03757)
...
### [25] [Monaas: Mobile Node as a Service for TSCH-based Industrial IoT Networks](https://arxiv.org/abs/2601.03917)
...
### [26] [Experimental Evaluation of a UAV-Mounted LEO Satellite Backhaul for Emergency Connectivity](https://arxiv.org/abs/2601.03958)
...
### [27] [Badanie Sieci Massive MIMO o Architekturze Zorientowanej na Uzytkownika](https://arxiv.org/abs/2601.04042)
*Marcin Hoffmann*
...
### [28] [Tutorial on Flow-Based Network Traffic Classification Using Machine Learning](https://arxiv.org/abs/2601.04089)
...
### [29] [The Pneuma Project: Reifying Information Needs as Relational Schemas to Automate Discovery, Guide Preparation, and Align Data with Intent](https://arxiv.org/abs/2601.03618)
