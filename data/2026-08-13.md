...
### [1] [Self-evolving network verifiers](https://arxiv.org/abs/2608.11340)
...
### [2] [Multi-Pair Fidelity-Aware Rate Allocation in a Quantum Network: Approximation Schemes](https://arxiv.org/abs/2608.11501)
...
### [3] [In QKD, Key Metadata is Key](https://arxiv.org/abs/2608.11502)
...
### [4] [Integrated Sensing and Communication in 3GPP: Evolution from 5G-Advanced to 6G](https://arxiv.org/abs/2608.11606)
*Xingqin Lin*
...
### [5] [On the Allocation of Transmit Power for Coordinated Spatial Reuse in IEEE 802.11bn Multi-Access Point Coordination](https://arxiv.org/abs/2608.11971)
...
### [7] [Predicting Mechanical Properties of Lignin-Containing Polyurethane Rigid Foams from Microstructure Using Convolutional Neural Networks](https://arxiv.org/abs/2608.11447)
...
### [8] [Stochastic Corridor Time Network Capacity Planning for Low Altitude Airspace Systems](https://arxiv.org/abs/2608.11477)
...
### [9] [Comparative Analysis of Low-Rank Adaptation in Large Language Models versus Dense Embedding Regression for Headline Click-Through Rate Prediction](https://arxiv.org/abs/2608.11912)
...
### [10] [An improved bond-associated peridynamic model and its adaptive coupling with CCM for fracture analysis](https://arxiv.org/abs/2608.11950)
...
### [11] [Physics-Constrained Co-Optimization and Data-Driven Layer-Resolved Classification of a Hybrid CZT/PIPS Detector for Mixed Radiation Fields](https://arxiv.org/abs/2608.12167)
...
### [12] [The Fallacy of Independent Ceilings: Characterizing Coupled Load-Branch Stall Interaction](https://arxiv.org/abs/2608.11380)
...
### [13] [Uni-SFU: Algorithm-HW Co-Design for Universal SFUs via Mixed-Degree Piecewise Approximation](https://arxiv.org/abs/2608.11577)
...
### [14] [A Full-Stack Characterization of High-Bandwidth Flash for KV-Centric LLM Serving](https://arxiv.org/abs/2608.11668)
...
### [15] [APEX: Adaptive Expert Prefetching for Memory-Efficient Edge MoE Inference](https://arxiv.org/abs/2608.11688)
...
### [16] [Spec Sheets Are Not Kernels: An ISA- and Source-Level Audit of INT8 Availability on NVIDIA Blackwell Ultra](https://arxiv.org/abs/2608.11693)
*Teng-Ruei Chen*
...
### [17] [NITRO: High-Performance 3D NAND Flash-Based In-Storage Computing with Enhanced Activation Dataflow](https://arxiv.org/abs/2608.11920)
...
### [18] [FQTree: Fine-grained Quantization and Hardware Generation of Boosted Decision Trees](https://arxiv.org/abs/2608.12140)
...
### [19] [Reinforcement Learning based DBMS Buffer Pool Auto-Tuning for Optimal Memory Utilization](https://arxiv.org/abs/2608.11239)
...
### [20] [Reverse Migration of Cloud Applications to On-premises](https://arxiv.org/abs/2608.11640)
...
### [21] [Guided Table Retrieval for Structured Data Search](https://arxiv.org/abs/2608.11644)
*Alekh Jindal,Jyoti Pandey,Christina Pavlopoulou,Ronith PR,Sharath Prakash,Shi Qiao,Shivani Tripathi,Wangda Zhang*
...
### [22] [Enabling Differentiated QoS Degradation for Replicated Databases under Failures](https://arxiv.org/abs/2608.11836)
...
### [23] [DexterSQL: Deep Schema Exploration and Rule-based Correction for Text-to-SQL Generation](https://arxiv.org/abs/2608.11889)
...
### [24] [An Extended Tutorial and Vocabulary for Relational Language Design in an Era of AI-Assisted Query Generation](https://arxiv.org/abs/2608.12272)
...
### [25] [An Event-Driven Cloud-Native Wearable Analytics Framework for Real-Time Clinical Workloads](https://arxiv.org/abs/2608.11402)
...
### [26] [Descriptive Dispatch of Computational Work](https://arxiv.org/abs/2608.11524)
...
### [27] [User-Assisted Collaborative Distributed Inference for Efficient QoS-Aware Autoscaling](https://arxiv.org/abs/2608.11840)
...
### [28] [Evaluating OpenMP Offloading for Intra-node Multi-GPU Programming across NVIDIA, AMD, and Intel Architectures: A 3D Heat Transfer Case Study](https://arxiv.org/abs/2608.11882)
...
### [29] [Ready Cohorts: Bounding GPU Opportunity and Avoiding Host Round Trips in LLM-Agent Control](https://arxiv.org/abs/2608.12123)
*Josef Liyanjun Chen*
...
### [30] [RoutePack: Expert Placement and Attention-Aware Data Packing for MoE Reinforcement Learning](https://arxiv.org/abs/2608.12146)
...
### [31] [MergirafSemi: A Language-Agnostic Semistructured Merge Tool](https://arxiv.org/abs/2608.11345)
...
### [32] [The Devil Is in the Interface: Evaluating How Tool Architecture Shapes Coding Agent Behavior](https://arxiv.org/abs/2608.11386)
...
### [33] [GraphAlignCoder: Aligning Program and Proof Graphs for Code Generation](https://arxiv.org/abs/2608.11394)
...
### [34] [Simplifying Requirements Engineering in the Context of the LGPD: An LLM-Based Investigation](https://arxiv.org/abs/2608.11454)
...
### [35] [Do Influence Tactics Matter? Investigating Prompt Framing Effects in LLM Code Generation](https://arxiv.org/abs/2608.11513)
...
### [36] [Harnessing LLMs for Document-Guided Fuzzing of Python Libraries](https://arxiv.org/abs/2608.11744)
...
### [37] [Instruction Alignment for Binary Code Representation Learning](https://arxiv.org/abs/2608.11766)
...
### [38] [Testing Deep Learning Library APIs via Cross-Framework Differential Fuzzing](https://arxiv.org/abs/2608.11886)
...
### [39] [Developing LLM-based Multi-Agent Systems in Software Engineering: A Mixed-Method Experience Report](https://arxiv.org/abs/2608.11965)
...
### [40] [RealisticTritonBench: A Benchmark for Triton-Kernel Generation in Real-World AI Frameworks](https://arxiv.org/abs/2608.12004)
...
### [41] [From Safety Documentation to Safety Knowledge Support: An Evidence-Grounded LLM Framework for Medical Devices](https://arxiv.org/abs/2608.12025)
...
### [42] [ADEPT: A Unified Framework for Deep Learning Test Adequacy](https://arxiv.org/abs/2608.12144)
...
### [43] [Towards Automated Domain Model Extraction from Source Code using Heuristics and Open-Source LLMs](https://arxiv.org/abs/2608.12228)
...
### [44] [The Role Specialization Model (RSM): Coordinating LLM-Based Tools in Agentic Software Development - An Exploratory Case Study](https://arxiv.org/abs/2608.12311)
...
### [45] [Who Should Own the Expert Cache? Kernel-Managed Tiering for Trillion-Parameter MoE Inference](https://arxiv.org/abs/2608.12103)
...
### [46] [The Ingestion Tax: Adopting File-Backed Weights in Tensor Frameworks](https://arxiv.org/abs/2608.12114)
*Yuan Si,Yufeng Lin,Daming Li,Jialu Zhang*
