...
### [1] [Accelerating Sparse Linear Solvers with an Optical Laser Processing Unit](https://arxiv.org/abs/2604.26377)
...
### [2] [A Matrix-Free Galerkin Multigrid Solver and Failure-Mode Screen for Single-GPU 3D SIMP Linear Systems](https://arxiv.org/abs/2604.26441)
...
### [3] [MappingEvolve: LLM-Driven Code Evolution for Technology Mapping](https://arxiv.org/abs/2604.26591)
...
### [4] [FeatureFox: Sample-Efficient Panoptic Graph Segmentation for Machining Feature Recognition in B-Rep 3D-CAD Models](https://arxiv.org/abs/2604.26770)
...
### [5] [Mining Negative Sequential Patterns to Improve Viral Genomic Feature Representation and Classification](https://arxiv.org/abs/2604.25968)
...
### [6] [CacheRAG: A Semantic Caching System for Retrieval-Augmented Generation in Knowledge Graph Question Answering](https://arxiv.org/abs/2604.26176)
*Yushi Sun,Lei Chen*
...
### [7] [Evergreen: Efficient Claim Verification for Semantic Aggregates](https://arxiv.org/abs/2604.26180)
...
### [8] [PiLLar: Matching for Pivot Table Schema via LLM-guided Monte-Carlo Tree Search](https://arxiv.org/abs/2604.26356)
...
### [9] [Digital Twin-assisted belief-state reinforcement learning for latency-robust ISAC in 6G networks](https://arxiv.org/abs/2604.25967)
...
### [10] [NeuralEmu: in situ Measurement-Driven, ML-based, High-Fidelity 5G Network Emulation](https://arxiv.org/abs/2604.26080)
...
### [11] [On the Role of Time Series Clustering in Traffic Matrix Prediction](https://arxiv.org/abs/2604.26081)
...
### [12] [Application-Aware Twin-in-the-Loop Planning for Federated Split Learning over Wireless Edge Networks](https://arxiv.org/abs/2604.26105)
...
### [13] [StreamGuard: Exploring a 5G Architecture for Efficient, Quality of Experience-Aware Video Conferencing](https://arxiv.org/abs/2604.26223)
...
### [14] [SWE-Bench 5G: Benchmarking AI Coding Agents on Telecom Network Engineering Tasks](https://arxiv.org/abs/2604.26278)
...
### [15] [A 3GPP Perspective on Spectrum Sharing for the 5G-to-6G Migration: From DSS to MRSS](https://arxiv.org/abs/2604.26853)
*Xingqin Lin*
...
### [16] [Efficient, VRAM-Constrained xLM Inference on Clients](https://arxiv.org/abs/2604.26334)
...
### [17] [SplitFT: An Adaptive Federated Split Learning System For LLMs Fine-Tuning](https://arxiv.org/abs/2604.26388)
...
### [18] [FloatSOM: GPU-Accelerated, Distributed, Topology-Flexible Self-Organizing Maps](https://arxiv.org/abs/2604.26555)
...
### [19] [DUAL-BLADE: Dual-Path NVMe-Direct KV-Cache Offloading for Edge LLM Inference](https://arxiv.org/abs/2604.26557)
...
### [20] [MPI Malleability Validation under Replayed Real-World HPC Conditions](https://arxiv.org/abs/2604.26576)
...
### [21] [DMRlib: Easy-coding and Efficient Resource Management for Job Malleability](https://arxiv.org/abs/2604.26624)
...
### [22] [FACT: Compositional Kernel Synthesis with a Three-Stage Agentic Workflow](https://arxiv.org/abs/2604.26666)
...
### [23] [COPUS: Co-adaptive Parallelism and Batch Size Selection in Large Language Model Training](https://arxiv.org/abs/2604.26687)
...
### [24] [A Semantic Quantum Circuit Cache for Scalable and Distributed Quantum-Classical Workflows](https://arxiv.org/abs/2604.26788)
...
### [25] [A Test Taxonomy and Continuous Integration Ecosystem for Dynamic Resource Management in HPC](https://arxiv.org/abs/2604.26824)
...
### [26] [Adaptive Self-Organization in Anonymous Dynamic Networks](https://arxiv.org/abs/2604.26931)
...
### [27] [AMMA: A Multi-Chiplet Memory-Centric Architecture for Low-Latency 1M Context Attention Serving](https://arxiv.org/abs/2604.26103)
...
### [28] [RAG-Enhanced Kernel-Based Heuristic Synthesis (RKHS): A Structured Methodology Using Large Language Models for Hardware Design](https://arxiv.org/abs/2604.26153)
...
### [29] [Sparse-on-Dense: Area and Energy-Efficient Computing of Sparse Neural Networks on Dense Matrix Multiplication Accelerators](https://arxiv.org/abs/2604.26587)
...
### [30] [Exploring the Efficiency of 3D-Stacked AI Chip Architecture for LLM Inference with Voxel](https://arxiv.org/abs/2604.26821)
...
### [31] [Large Language Models for Multilingual Code Intelligence: A Survey](https://arxiv.org/abs/2604.25960)
...
### [32] [SWE-Edit: Rethinking Code Editing for Efficient SWE-Agent](https://arxiv.org/abs/2604.26102)
...
### [33] [LLM-Guided Issue Generation from Uncovered Code Segments](https://arxiv.org/abs/2604.26118)
...
### [34] [ImproBR: Bug Report Improver Using LLMs](https://arxiv.org/abs/2604.26142)
...
### [35] [AI Observability for Large Language Model Systems: A Multi-Layer Analysis of Monitoring Approaches from Confidence Calibration to Infrastructure Tracing](https://arxiv.org/abs/2604.26152)
*Twinkll Sisodia*
...
### [36] [LLM-Assisted Empirical Software Engineering: Systematic Literature Review and Research Agenda](https://arxiv.org/abs/2604.26192)
...
### [37] [Agentic AI in the Software Development Lifecycle: Architecture, Empirical Evidence, and the Reshaping of Software Engineering](https://arxiv.org/abs/2604.26275)
*Happy Bhati*
...
### [38] [Asset Administration Shell-Based OCL Validation Framework for Model-Based System Engineering](https://arxiv.org/abs/2604.26384)
...
### [39] [Towards Intelligent Computation Offloading in Dynamic Vehicular Networks: A Scalable Multilayer Pipeline](https://arxiv.org/abs/2604.26416)
...
### [40] [An Empirical Study of Speculative Decoding on Software Engineering Tasks](https://arxiv.org/abs/2604.26469)
...
### [41] [RepoDoc: A Knowledge Graph-Based Framework to Automatic Documentation Generation and Incremental Updates](https://arxiv.org/abs/2604.26523)
...
### [42] [Identifying and Characterizing Semantic Clones of Solidity Functions](https://arxiv.org/abs/2604.26526)
...
### [43] [Graph Construction and Matching for Imperative Programs using Neural and Structural Methods](https://arxiv.org/abs/2604.26578)
...
### [44] [Recommendations for Efficient and Responsible LLM Adoption within Industrial Software Development](https://arxiv.org/abs/2604.26590)
...
### [45] [TDD Governance for Multi-Agent Code Generation via Prompt Engineering](https://arxiv.org/abs/2604.26615)
...
### [46] [Understanding the Skills Gap between Higher Education Institutions and the Software Engineering Industry](https://arxiv.org/abs/2604.26655)
...
### [47] [Will It Break in Production? Metric-Driven Prediction of Residual Defects in Python Systems](https://arxiv.org/abs/2604.26667)
...
### [48] [Which Types of Heterogeneity Matter for Root Cause Localization in Microservice Systems ?](https://arxiv.org/abs/2604.26670)
...
### [49] [What Makes Software Bugs Escape Testing? Evidence from a Large-Scale Empirical Study](https://arxiv.org/abs/2604.26672)
...
### [50] [Reproducible Automated Program Repair Is Hard -- Experiences With the Defects4J Dataset](https://arxiv.org/abs/2604.26674)
...
### [51] [When Model Editing Meets Service Evolution: A Knowledge-Update Perspective for Service Recommendation](https://arxiv.org/abs/2604.26686)
...
### [52] [Comparing Smart Contract Paradigms: A Preliminary Study of Security and Developer Experience](https://arxiv.org/abs/2604.26727)
...
### [53] [What Is the Cost of Energy Monitoring? An Empirical Study on the Overhead of RAPL-Based Tools](https://arxiv.org/abs/2604.26815)
...
### [54] [Cognitive Atrophy and Systemic Collapse in AI-Dependent Software Engineering](https://arxiv.org/abs/2604.26855)
*Frank Ginac*
...
### [55] [Hot Fixing in the Wild](https://arxiv.org/abs/2604.26892)
...
### [56] [ClassEval-Pro: A Cross-Domain Benchmark for Class-Level Code Generation](https://arxiv.org/abs/2604.26923)
