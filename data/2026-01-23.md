...
### [4] [FARM: Field-Aware Resolution Model for Intelligent Trigger-Action Automation](https://arxiv.org/abs/2601.15687)
...
### [5] [Evaluating and Achieving Controllable Code Completion in Code LLM](https://arxiv.org/abs/2601.15879)
...
### [6] [The Role of Cognitive Abilities in Requirements Inspection: Comparing UML and Textual Representations](https://arxiv.org/abs/2601.16009)
...
### [7] [Towards a Goal-Centric Assessment of Requirements Engineering Methods for Privacy by Design](https://arxiv.org/abs/2601.16080)
...
### [9] [A Case for Hypergraphs to Model and Map SNNs on Neuromorphic Hardware](https://arxiv.org/abs/2601.16118)
...
### [10] [NL4ST: A Natural Language Query Tool for Spatio-Temporal Databases](https://arxiv.org/abs/2601.15758)
...
### [11] [Efficient Cloud-edge Collaborative Approaches to SPARQL Queries over Large RDF graphs](https://arxiv.org/abs/2601.15992)
...
### [12] [EAIFD: A Fast and Scalable Algorithm for Incremental Functional Dependency Discovery](https://arxiv.org/abs/2601.16025)
...
### [13] [Securing LLM-as-a-Service for Small Businesses: An Industry Case Study of a Distributed Chatbot Deployment Platform](https://arxiv.org/abs/2601.15528)
...
### [15] [Resource Allocation and Sharing for UAV-Assisted Integrated TN-NTN with Multi-Connectivity](https://arxiv.org/abs/2601.15532)
...
### [16] [MapViT: A Two-Stage ViT-Based Framework for Real-Time Radio Quality Map Prediction in Dynamic Environments](https://arxiv.org/abs/2601.15578)
...
### [17] [Dynamic Server Allocation Under Stochastic Switchover on Time-Varying Links](https://arxiv.org/abs/2601.15904)
...
### [18] [Low-altitude Multi-UAV-assisted Data Collection and Semantic Forwarding for Post-Disaster Relief](https://arxiv.org/abs/2601.16146)
...
### [19] [NMRGym: A Comprehensive Benchmark for Nuclear Magnetic Resonance Based Molecular Structure Elucidation](https://arxiv.org/abs/2601.15763)
...
### [20] [ManuRAG: Multi-modal Retrieval Augmented Generation for Manufacturing Question Answering](https://arxiv.org/abs/2601.15434)
...
### [21] [MuSAlS: A Fast Multiple Sequence Alignment Approach Using Hierarchical Clustering](https://arxiv.org/abs/2601.15458)
...
### [22] [zkFinGPT: Zero-Knowledge Proofs for Financial Generative Pre-trained Transformers](https://arxiv.org/abs/2601.15716)
