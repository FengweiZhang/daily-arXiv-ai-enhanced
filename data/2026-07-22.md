...
### [1] [FinanceComplexQA: Benchmarking Agentic Reasoning on Industrial-grade Financial Documents](https://arxiv.org/abs/2607.19238)
...
### [2] [Efficient strain-space hyperreduction in large-deformation solid mechanics](https://arxiv.org/abs/2607.19330)
...
### [3] [Predictive RTO for CoAP using Lightweight Support Vector Regression in Internet of Things](https://arxiv.org/abs/2607.18273)
...
### [4] [What Governs Decode Throughput in Absolute-Offset GPU LZ77? A Work-Granularity Mechanism and an Encode-Time Min-Match-Length Lever](https://arxiv.org/abs/2607.18541)
*Yakiv Shavidze*
...
### [5] [Searching for Plans You Can Actually Build: A Realizability-Aware Full-Space Optimizer for MoE Training and Serving](https://arxiv.org/abs/2607.18631)
*Quan Yuan,Jie Zhao*
...
### [6] [Unstructured Hydrodynamics on Spatial Dataflow Architectures: A Joint Code and Data Decomposition Approach](https://arxiv.org/abs/2607.18650)
...
### [7] [Mapping Without Graphs: Learning Coherence Traffic for Task Placement](https://arxiv.org/abs/2607.18879)
...
### [8] [A User-oriented Portable, Reproducible, and Scalable Software Ecosystem](https://arxiv.org/abs/2607.18929)
...
### [9] [InstantInfer: Enabling Fast LLM Cold Start with Communicating Finite Automata](https://arxiv.org/abs/2607.18957)
...
### [10] [Enabling Multi-Dimensional Distributed Trace Comparison with Contrast](https://arxiv.org/abs/2607.19102)
...
### [11] [A Scalable Pattern Mining Workflow for Interpretable Machine Log Analysis in High-Performance Computing Environments](https://arxiv.org/abs/2607.19143)
...
### [12] [Coherence in Control: Bridging Many-Core Mapping and Routing through Cost Unification](https://arxiv.org/abs/2607.19158)
...
### [13] [ARBITER: Guarded Agentic Control for SLO-Oriented Kubernetes Remediation](https://arxiv.org/abs/2607.19182)
...
### [14] [Keeping the Cache Warm Pays: Keepalive Economics for Agentic Workloads](https://arxiv.org/abs/2607.19214)
*Maxim Khailo*
...
### [15] [A Progressive Approach to Synthesizable RTL Design Generation Using LLMs](https://arxiv.org/abs/2607.18519)
...
### [16] [PIP-NTT: Towards a Scalable Memory-Parallelized Accelerator for Iterative NTT in PQC](https://arxiv.org/abs/2607.18533)
...
### [17] [An Efficient Fault-Tolerance Scheme for CKKS Computation on CPUs](https://arxiv.org/abs/2607.18720)
...
### [18] [A Flexible Sparsity-Aware FPGA Accelerator with Column-Wise Compression for Efficient CNN Inference](https://arxiv.org/abs/2607.19248)
...
### [19] [Distributed Delay-Based BIST for Mixed-Signal Circuits in Flexible Electronics](https://arxiv.org/abs/2607.19310)
...
### [20] [Accelerating Heterogeneous Agent Collaboration in Dynamic Edge Networks](https://arxiv.org/abs/2607.18244)
...
### [21] [The Economics of Autonomy: Real-Time Risk Indexing for Insurable AI-Driven 6G Systems](https://arxiv.org/abs/2607.18267)
...
### [22] [Cost-Aware Uplink MPQUIC Scheduling via Multi-Objective Bayesian Optimization](https://arxiv.org/abs/2607.18444)
...
### [23] [Quality over Quantity: Value-Driven Distributed Congestion Control for the Collective Perception Service](https://arxiv.org/abs/2607.18495)
...
### [24] [Evaluating Power Control Strategies for UORA in IEEE 802.11be Systems with Capture Effect](https://arxiv.org/abs/2607.18543)
...
### [25] [Uplink SRS-Based Real-Time Indoor Localization System over OpenAirInterface](https://arxiv.org/abs/2607.18549)
...
### [26] [NSMA: Neuro-Symbolic Manifold Alignment for Generalizable Adaptive Bitrate Streaming under Texture Shift](https://arxiv.org/abs/2607.18845)
*Zhiqiang He,Zhi Liu*
...
### [27] [Online Stochastic Matchings: Stability on Hypergraphs](https://arxiv.org/abs/2607.18935)
*Fabien Mathieu*
...
### [28] [Structured Spectral Compression based Low-Bitrate Secure Speech Communications for Internet of Things assisted Non-Terrestrial Networks](https://arxiv.org/abs/2607.19092)
...
### [29] [HACO: Hedged Agent Computing for Reliable LLM Systems](https://arxiv.org/abs/2607.19215)
...
### [30] [AgentTrails: Towards Trust and Reuse for Agentic Tasks](https://arxiv.org/abs/2607.18816)
...
### [31] [Binding Drift in Multi-Step Tool-Augmented Agents](https://arxiv.org/abs/2607.18316)
...
### [32] [A Decision-Centered Reference Architecture for Trustworthy Agentic Commerce](https://arxiv.org/abs/2607.18347)
*Dimitrios S. Sfiris*
...
### [33] [CODENS: Transforming Code Changes into Living, Accessible, and Queryable Documentation](https://arxiv.org/abs/2607.18356)
...
### [34] [Beyond Resolved Rate: A Non-Functional Quality Study](https://arxiv.org/abs/2607.18462)
...
### [35] [Semantic Drift in Bug Resolution: How Behavioral Signals Propagate from Reports to Tests and Patches](https://arxiv.org/abs/2607.18550)
...
### [36] [LM2Alloy: Investigating LLM-Generated Formal Specifications for Automated Test Derivation in Production Software](https://arxiv.org/abs/2607.18555)
...
### [37] [Provably Lossless Acceleration of DNN Mutation Testing via Memoization](https://arxiv.org/abs/2607.18582)
...
### [38] [LLM-Based Invariant Testing for Software Functional Bugs](https://arxiv.org/abs/2607.18711)
...
### [39] [Beyond Text Editing: Algebraic Manipulation of Source Code](https://arxiv.org/abs/2607.18742)
*Kevin Pulo*
...
### [40] [TrapHunter: Exposing Covert Pathways in Trap Token Contracts](https://arxiv.org/abs/2607.18753)
...
### [41] [TraceDev: A Traceability-Driven Multi-agent Framework for Requirement-to-Code Development](https://arxiv.org/abs/2607.18886)
...
### [42] [Skillware: A Software Ontology and Engineering Lifecycle for Persistent Behavioral Artifacts](https://arxiv.org/abs/2607.18970)
...
### [43] [From Collaboration to Regulation: Characterizing Governance Practice in Three Deep Learning Open Source Communities](https://arxiv.org/abs/2607.19022)
...
### [44] [SciCodePile: A 128GB Corpus and Executable Benchmark for Challenging Scientific Code Generation](https://arxiv.org/abs/2607.19104)
...
### [45] [EmbeddedKittens: An Evaluation of Code Embeddings for Scratch](https://arxiv.org/abs/2607.19291)
