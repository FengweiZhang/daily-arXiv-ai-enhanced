...
### [1] [Data-Driven Time-Varying Control Barrier Functions for Adaptive Safe-Set Learning with Online Decremental Support Vector Machines](https://arxiv.org/abs/2608.19366)
...
### [2] [Time Series Forecasting based on Solana Digital Asset Dataset](https://arxiv.org/abs/2608.19521)
...
### [3] [Modular fabrication and design of thick rigid-foldable origami metamaterials](https://arxiv.org/abs/2608.19763)
...
### [4] [Online Scheduling for Throughput Maximization of Time-varying Markovian Channels with Unknown Statistics](https://arxiv.org/abs/2608.19398)
...
### [5] [Empirical Evaluation of Cross-Carrier MCPTT & OTT MCX Interoperability in High-Density Environments](https://arxiv.org/abs/2608.19554)
...
### [6] [Vorticity Dissipation Based Routing: A Fluid-Kinetic Framework for Loop-Free Transport in Ultra-Dense Networks](https://arxiv.org/abs/2608.19630)
...
### [7] [Digital Tides: A Fluid-Dynamic Framework for Flux-Aware Infrastructure Provisioning in UAV Logistics Networks](https://arxiv.org/abs/2608.19638)
...
### [8] [RFWM: Physics-Guided World Model for Dynamic Wireless Radiance Field Generation](https://arxiv.org/abs/2608.19709)
...
### [9] [Proper Sea Surface Roughness Enhances the Performance of Near-Shore Maritime Networks](https://arxiv.org/abs/2608.19730)
...
### [10] [Using Zone-Disjoint Multi-Path Routing Algorithm for Video Transmission over Ah-Hoc Networks](https://arxiv.org/abs/2608.20148)
...
### [11] [Rewriting Ontology-Mediated Property Graph Queries into GQL](https://arxiv.org/abs/2608.20092)
...
### [12] [Inductive Process Discovery from Partially Ordered Event Data](https://arxiv.org/abs/2608.20211)
...
### [13] [Which Eviction Policy Should an LLM Cache Use? A Systematic Study Across Workloads, Capacities, and Encoders](https://arxiv.org/abs/2608.20280)
...
### [14] [HyperCut: Fast Inter-Layer Scheduling via Directed Hypergraph and Early Filtering](https://arxiv.org/abs/2608.19296)
...
### [15] [Performance Verification of the AmpereOne CPU Core](https://arxiv.org/abs/2608.19300)
...
### [16] [HYDRA: A Heterogeneous Chiplet DSE Framework for Serving Dynamic Hybrid LLM Workloads](https://arxiv.org/abs/2608.19395)
...
### [17] [Exact Multistate Reliability and Upgrade Design for Heterogeneous HBM Systems via Threshold-Pruned BAT](https://arxiv.org/abs/2608.19471)
*Wei-Chang Yeh*
...
### [18] [A Thread-Register Decoupled GPU Execution Model for Efficient Tensor Computation](https://arxiv.org/abs/2608.19628)
...
### [19] [Automated Estimation of MBIST Area and Test Time in Heterogeneous Memory IPs via Stacked Ensemble Framework](https://arxiv.org/abs/2608.19705)
...
### [20] [Energy-Efficient Visual Inspection with FFT-Based CNNs and Adaptive Floating-Point Quantization](https://arxiv.org/abs/2608.19837)
...
### [21] [Experimental Verification of Fast Voltage Droop Correction Circuits](https://arxiv.org/abs/2608.19954)
...
### [22] [ODEONN: A Digital ODE Solver Architecture for Oscillatory Neural Networks](https://arxiv.org/abs/2608.20110)
...
### [23] [A Resource-Efficient CNN-Based EEG Auditory Attention Decoding ASIC](https://arxiv.org/abs/2608.20198)
...
### [24] [The Evaluation Context Protocol (ECP): A Portable Contract for AI Agent Evaluation](https://arxiv.org/abs/2608.19263)
...
### [25] [Stable Within, Unidentified Across: Semantic Identification of Benchmark Effects and Rankings](https://arxiv.org/abs/2608.19269)
*Xi Qin*
...
### [26] [Hype Meets Reality: Large Language Models as Mutators in Search-based Automated Program Repair of Simulink-Stateflow Models](https://arxiv.org/abs/2608.19347)
...
### [27] [RD-Gen: Random DAG Generator Considering Multi-rate Applications for Reproducible Scheduling Evaluation](https://arxiv.org/abs/2608.19460)
...
### [28] [Measuring What a Specification Determines: A Formal Semantic-Block Model and an Execution-Judged Benchmark](https://arxiv.org/abs/2608.19475)
...
### [29] [Accelerated Genetic Programming Hyper-Heuristics for Simulation-Based Scheduling via Agentic AI](https://arxiv.org/abs/2608.19487)
...
### [30] [An Agentic RAG and Evaluation Framework for Assurance Case Generation: Industrial Use Case for the EU Cyber Resilience Act Compliance](https://arxiv.org/abs/2608.19509)
...
### [31] [Trace-Based Execution-Level Observability of VDM-SL Specifications](https://arxiv.org/abs/2608.19510)
...
### [32] [Garbage Collection and Energy Consumption in Java: A Controlled Study Across Workloads and JDKs](https://arxiv.org/abs/2608.19520)
*Rahil Sharma*
...
### [33] [Auditing and Decomposing Feedback-Driven Evolution in LLM Test Generation under the Oracle Problem](https://arxiv.org/abs/2608.19626)
...
### [34] [Loreley: Repository-Scale Program Evolution with Quality-Diversity Search](https://arxiv.org/abs/2608.19703)
*Mohan Chen*
...
### [35] [A Fully Automated, Deployment-Aware Testing Pipeline for IoT-Based Automotive Applications](https://arxiv.org/abs/2608.19752)
...
### [36] [PRAXIS: Graph-Grounded Tacit Knowledge for Domain Code Generation](https://arxiv.org/abs/2608.19784)
...
### [37] [Further Progress Towards Operation Proof Obligation Generation for VDM](https://arxiv.org/abs/2608.19848)
...
### [39] [Evaluating Automated Testing on an Open-Source Web Application Using Cypress](https://arxiv.org/abs/2608.19960)
...
### [40] [BreakGuard: Towards Detecting Dependency Breaking Changes with LLM-Generated Tests](https://arxiv.org/abs/2608.20167)
...
### [41] [From Agent Behaviour to Agent-Friendly Documentation: An Empirical Study of How Coding Agents Discover, Read, and Write Technical Documentation](https://arxiv.org/abs/2608.20195)
...
### [42] [The Lazy Pod That Lies: Deferred Cost and Failure Semantics of Lazy Container Image Pulling for Model Serving on Kubernetes](https://arxiv.org/abs/2608.19412)
*Georgii Kliukovkin*
...
### [43] [When Do LLM Agents Help? Deadline-Aware Mixed-Criticality Task Scheduling at the Autonomous-Vehicle Edge](https://arxiv.org/abs/2608.19557)
*Reza Zakerian*
...
### [44] [Optimality and Trade-offs in Fast BFT SMR (Extended Version)](https://arxiv.org/abs/2608.19629)
...
### [45] [CacheRoute: Planned Prefix-Affinity Routing for Large-Scale LLM Serving](https://arxiv.org/abs/2608.19677)
*Huang Cheng*
...
### [46] [ParaWeb: Parallel Programming Patterns for Web Development](https://arxiv.org/abs/2608.19935)
*Suejb Memeti*
...
### [47] [Design and Empirical Evaluation of a Network-Centric, On-Premises Architecture for Earth Observation Data Access](https://arxiv.org/abs/2608.20283)
