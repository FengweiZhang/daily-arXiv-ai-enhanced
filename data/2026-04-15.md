...
### [4] [GRACE: A Dynamic Coreset Selection Framework for Large Language Model Optimization](https://arxiv.org/abs/2604.11810)
...
### [5] [Lit2Vec: A Reproducible Workflow for Building a Legally Screened Chemistry Corpus from S2ORC for Downstream Retrieval and Text Mining](https://arxiv.org/abs/2604.12498)
...
### [6] [ROSE: An Intent-Centered Evaluation Metric for NL2SQL](https://arxiv.org/abs/2604.12988)
...
### [7] [A Geometric Algebra-informed NeRF Framework for Generalizable Wireless Channel Prediction](https://arxiv.org/abs/2604.11983)
...
### [8] [BLAST: Blockchain-based LLM-powered Agentic Spectrum Trading](https://arxiv.org/abs/2604.12127)
...
### [9] [Traffic-Aware Domain Partitioning and Load-Balanced Inter-Domain Routing for LEO Satellite Networks](https://arxiv.org/abs/2604.12382)
...
### [10] [LightTune: Lightweight Forward-Only Online Fine-Tuning with Applications to Link Adaptation](https://arxiv.org/abs/2604.12406)
...
### [11] [Large-Scale Measurement of NAT Traversal for the Decentralized Web: A Case Study of DCUtR in IPFS](https://arxiv.org/abs/2604.12484)
...
### [12] [Advancing Network Digital Twin Framework for Generating Realistic Datasets](https://arxiv.org/abs/2604.12888)
...
### [13] [Joint Clustering and Prediction of the Quality of Service in Vehicular Cellular Networks](https://arxiv.org/abs/2604.12903)
...
### [14] [Graph-based Hierarchical Deep Reinforcement Learning for Deliverable Block Propagation with Optimal Hybrid Cost in Web 3.0](https://arxiv.org/abs/2604.12920)
...
### [15] [Improving Network Clock Synchronization by Marking Congestion](https://arxiv.org/abs/2604.12961)
...
### [16] [Understanding Large-Scale HPC System Behavior Through Cluster-Based Visual Analytics](https://arxiv.org/abs/2604.11965)
...
### [17] [Predictive Bayesian Arbitration: A Scalable Noisy-OR Model with Service Criticality Awareness](https://arxiv.org/abs/2604.11989)
...
### [18] [DySkew: Dynamic Data Redistribution for Skew-Resilient Snowpark UDF Execution](https://arxiv.org/abs/2604.13034)
...
### [19] [Accelerating Microswimmer Simulations via a Heterogeneous Pipelined Parallel-in-Time Framework](https://arxiv.org/abs/2604.12083)
...
### [20] [Evaluating Cross-Architecture Performance Modeling of Distributed ML Workloads Using StableHLO](https://arxiv.org/abs/2604.12090)
...
### [21] [A Periodic Space of Distributed Computing: Vision & Framework](https://arxiv.org/abs/2604.12259)
...
### [24] [Local-Splitter: A Measurement Study of Seven Tactics for Reducing Cloud LLM Token Usage on Coding-Agent Workloads](https://arxiv.org/abs/2604.12301)
...
### [25] [Three Birds, One Stone: Solving the Communication-Memory-Privacy Trilemma in LLM Fine-tuning Over Wireless Networks with Zeroth-Order Optimization](https://arxiv.org/abs/2604.12401)
...
### [26] [Beyond Pre-Training: The Full Lifecycle of Foundation Models on HPC Systems](https://arxiv.org/abs/2604.12599)
...
### [27] [Intelligent resource prediction for SAP HANA continuous integration build workloads](https://arxiv.org/abs/2604.12673)
...
### [28] [An Engineering Journey Training Large Language Models at Scale on Alps: The Apertus Experience](https://arxiv.org/abs/2604.12973)
...
### [29] [An Embedded Boundary Scheme for Three-Dimensional Flow Over Terrain on a Staggered Mesh](https://arxiv.org/abs/2604.11959)
...
### [30] [Divergence-Guided Particle Swarm Optimization](https://arxiv.org/abs/2604.12001)
...
### [31] [Multi-Agent Digital Twins for Strategic Decision-Making using Active Inference](https://arxiv.org/abs/2604.12657)
...
### [32] [The cross-sectional warping problem for hyperelastic beams: An efficient formulation in Voigt notation](https://arxiv.org/abs/2604.12886)
...
### [33] [Hybrid Adaptive Tuning for Tiered Memory Systems](https://arxiv.org/abs/2604.12165)
...
### [34] [TierBPF: Page Migration Admission Control for Tiered Memory via eBPF](https://arxiv.org/abs/2604.12300)
...
### [35] [AnyPoC: Universal Proof-of-Concept Test Generation for Scalable LLM-Based Bug Detection](https://arxiv.org/abs/2604.11950)
...
### [36] [GitFarm: Git as a Service for Large-Scale Monorepos](https://arxiv.org/abs/2604.11977)
...
### [37] [ORBIT: Guided Agentic Orchestration for Autonomous C-to-Rust Transpilation](https://arxiv.org/abs/2604.12048)
...
### [38] [Structured Safety Auditing for Balancing Code Correctness and Content Safety in LLM-Generated Code](https://arxiv.org/abs/2604.12088)
...
### [39] [Automated BPMN Model Generation from Textual Process Descriptions: A Multi-Stage LLM-Driven Approach](https://arxiv.org/abs/2604.12105)
...
### [40] [LLM-Based Automated Diagnosis Of Integration Test Failures At Google](https://arxiv.org/abs/2604.12108)
...
### [41] [Programming Language Co-Usage Patterns on Stack Overflow: Analysis of the Developer Ecosystem](https://arxiv.org/abs/2604.12123)
...
### [42] [From Plan to Action: How Well Do Agents Follow the Plan?](https://arxiv.org/abs/2604.12147)
...
### [43] [Structural Anchors and Reasoning Fragility:Understanding CoT Robustness in LLM4Code](https://arxiv.org/abs/2604.12214)
...
### [44] [Learning Project-wise Subsequent Code Edits via Interleaving Neural-based Induction and Tool-based Deduction](https://arxiv.org/abs/2604.12220)
...
### [45] [CodeSpecBench: Benchmarking LLMs for Executable Behavioral Specification Generation](https://arxiv.org/abs/2604.12268)
...
### [46] [Is Vibe Coding the Future? An Empirical Assessment of LLM Generated Codes for Construction Safety](https://arxiv.org/abs/2604.12311)
*S M Jamil Uddin*
...
### [47] [LLMs Are Not a Silver Bullet: A Case Study on Software Fairness](https://arxiv.org/abs/2604.12640)
...
### [48] [Pricing-Driven Resource Allocation in the Computing Continuum](https://arxiv.org/abs/2604.12642)
...
### [49] [Short Version of VERIFAI2026 Paper -- Learning Infused Formal Reasoning: Contract Synthesis, Artefact Reuse and Semantic Foundations](https://arxiv.org/abs/2604.12747)
...
### [50] [Evaluating LLMs Code Reasoning Under Real-World Context](https://arxiv.org/abs/2604.12881)
*Changshu Liu*
...
### [51] [CoDe-R: Refining Decompiler Output with LLMs via Rationale Guidance and Adaptive Inference](https://arxiv.org/abs/2604.12913)
...
### [52] [Personalizing LLM-Based Conversational Programming Assistants](https://arxiv.org/abs/2604.12998)
*Jonan Richards*
