...
### [2] [The Towers Were Standing: A Cause Decomposition of Cellular Outages During Hurricane Helene](https://arxiv.org/abs/2609.10944)
...
### [4] [IPv6 Hitlist Service: Lessons Learned From 10 Years of Operation](https://arxiv.org/abs/2609.11475)
...
### [5] [Comparative Performance Analysis of OTFS and OFDM Modulations for Mobile Wireless Communications](https://arxiv.org/abs/2609.11623)
...
### [6] [Unmanned Aerial Vehicle Propagation Channel over Vegetation and Lake Areas: First- and Second-Order Statistical Analysis](https://arxiv.org/abs/2609.11672)
...
### [7] [Electroencephalography Signal Analysis for Human Activities Classification: A Solution Based on Machine Learning and Motor Imagery](https://arxiv.org/abs/2609.11695)
...
### [8] [From Open RAN to Open Spectrum: A Programmable, Intelligent Architecture for Multi-Service Spectrum Coexistence](https://arxiv.org/abs/2609.11843)
...
### [9] [A Penalty-Aware, Blockchain-based Cloud Monitoring System](https://arxiv.org/abs/2609.10704)
...
### [10] [A Framework for Discharge Time Prediction of Energy Storage Units Based on Coupled Dynamics and Multi-Factor Aging Models](https://arxiv.org/abs/2609.11086)
...
### [11] [Node-Shift-Encoding Genetic Algorithm with fuzzy-enhanced reference tour to solve the bi-objective service-oriented TSP](https://arxiv.org/abs/2609.11257)
...
### [12] [When Passing Tests Hides Vulnerabilities: An Empirical Study of Silent Failures in Agentic Systems](https://arxiv.org/abs/2609.10548)
...
### [13] [Optimizing AI Inference Across the Deployment Stack](https://arxiv.org/abs/2609.10550)
...
### [14] [ReqEvolve: User-Oriented Software Self-Evolution through Automatic Requirement Interpretation](https://arxiv.org/abs/2609.10590)
...
### [15] [Generative AI for trustworthy systems - Towards a health check model](https://arxiv.org/abs/2609.10595)
...
### [16] [On the Relation between Code Quality and Machine Learning Performance: A Large-scale Empirical Study](https://arxiv.org/abs/2609.10610)
...
### [17] [AI Safety: Not Optional, Not Later](https://arxiv.org/abs/2609.10630)
...
### [18] [Numbat: Building and Verifying a Self-Contained Machine-Learning Stack](https://arxiv.org/abs/2609.10632)
*Thang Tran,Lan Dang*
...
### [19] [A Model-Centric DevOps Architecture for DEVS-Based Digital Twin Simulation Services](https://arxiv.org/abs/2609.11122)
...
### [20] [Governed Human-AI Prioritization Under Uncertainty: Adaptive Estimation and Dependency-Constrained Portfolio Selection](https://arxiv.org/abs/2609.10648)
...
### [21] [LLMVul: A Vulnerability-Labeled Dataset of LLM-Generated C/C++ Functions from Real Production Repositories](https://arxiv.org/abs/2609.10945)
...
### [22] [What a Random Draw from the MCP Registry Contains, and What Tool-Use Benchmarks Contain Instead](https://arxiv.org/abs/2609.10962)
...
### [23] [Engineering Reliable Commit Gates for Agentic AI: Cost-Aware Verification Portfolios under Common-Mode Data Failures](https://arxiv.org/abs/2609.10969)
...
### [24] [RCL: A Retrieval-Confidence Layer for Detecting Insufficient Context in Enterprise Retrieval-Augmented Code Generation](https://arxiv.org/abs/2609.11023)
...
### [25] [SaltBench: A Referee-Gated Protocol for Measuring Method Effects in Machine-Checked Software Work](https://arxiv.org/abs/2609.11076)
*Jason Hickey*
...
### [26] [FST Pay: Deterministic Safety-Gated Architecture for Youth Digital Payments](https://arxiv.org/abs/2609.11195)
...
### [27] [TripleBound: Triplet-Guided Heterogeneous Graph Learning for Microservice Decomposition](https://arxiv.org/abs/2609.11212)
...
### [28] [Exploring the Role of Security Experience and ChatGPT Usage Strategies on Secure Software Engineering Education](https://arxiv.org/abs/2609.11303)
...
### [29] [CoSTAR: Data Synthesis-Driven Constraint-Aware COBOL Section Summarization for Legacy System Modernization](https://arxiv.org/abs/2609.11332)
...
### [30] [Agent-Integrated Software: Interaction Contracts and Continuous Assurance](https://arxiv.org/abs/2609.11381)
...
### [31] [Deep Learning-based Bug Triage System](https://arxiv.org/abs/2609.11420)
*Sourabh Pal*
...
### [32] [ChurnBench: A Drift-Aware Benchmark Demonstrating That Refresh Scheduling, Not Cache Age, Governs Staleness in Agentic AI](https://arxiv.org/abs/2609.11515)
...
### [33] [PRISMA-LLM: An Empirical Reporting Framework for AI-Assisted Systematic Reviews](https://arxiv.org/abs/2609.11559)
...
### [34] [Ecdysis: Efficient and Effective Training of Runtime Harnesses for LLM Agents](https://arxiv.org/abs/2609.11677)
...
### [35] [Reproducibility in the Age of Agentic AI: Context Engineering at the Timescale of a Codebase](https://arxiv.org/abs/2609.11728)
*Lorena A. Barba*
...
### [36] [An analysis of the relationship of input metrics](https://arxiv.org/abs/2609.11824)
*Addison Crump*
...
### [37] [The Internet of Collaborating Things: Agentic Edge AI for Autonomous Cross-Domain Collaboration](https://arxiv.org/abs/2609.10542)
...
### [38] [MUC-FL: Block-Wise Marginal Utility Contribution for Communication-Efficient Federated Learning](https://arxiv.org/abs/2609.10545)
...
### [39] [From Token Interfaces to Token Semantics: A Formal Composition and Conformance Model for Implementation-Neutral Token Specifications](https://arxiv.org/abs/2609.10547)
*John deVadoss*
...
### [40] [Design and Operation of a Federated GPU Cluster for Digital Humanities within DHinfra.at](https://arxiv.org/abs/2609.10552)
...
### [41] [Memory Profiling and Migration for Heterogeneous Memory Architectures](https://arxiv.org/abs/2609.10554)
...
### [42] [Composable CXL Memory as a Kubernetes-Native Shared Memory for LLM Serving](https://arxiv.org/abs/2609.10790)
...
### [43] [ExaServe: Large-Scale LLM Serving on Exascale HPC Systems](https://arxiv.org/abs/2609.10812)
...
### [44] [Navigating Small-World Networks with Distance Predictions](https://arxiv.org/abs/2609.10885)
...
### [45] [Entwine: Coordinating Tiled Computation and Fine-Grained Communication across GPUs](https://arxiv.org/abs/2609.11562)
...
### [46] [Online Treasure Hunt in Vertex-Permuted Dynamic Rings](https://arxiv.org/abs/2609.11013)
...
### [47] [The Computing Channel: How Modulation Programs the Airwaves](https://arxiv.org/abs/2609.11145)
...
### [48] [Can AI Remediate Backend Failures Safely? GuardedAct with Blast-Radius-Aware Sandboxing](https://arxiv.org/abs/2609.11264)
...
### [49] [Rethinking Sparse Formats for RISC-V: A Hierarchical Approach to High-Performance SpMV](https://arxiv.org/abs/2609.11352)
...
### [50] [Taming Bitwise Behavior in GPU Kernels with Tensor Core: Black-Box Reconstruction, Compiler Enforcement, and Static Verification](https://arxiv.org/abs/2609.11356)
...
### [51] [Building py-kvcache: A Performance Characterization of External KV Caching for vLLM with NVMe SSDs](https://arxiv.org/abs/2609.11744)
...
### [52] [GPU-CFR: 80x Faster Counterfactual Regret Minimization by Compiling the Game to Static Dataflow and CUDA Graph Replay](https://arxiv.org/abs/2609.11923)
...
### [53] [OmniTable: A Unified Wide-Table System for Petabyte-Scale LLM Data Curation and Exploration](https://arxiv.org/abs/2609.11148)
...
### [54] [REACH: Controller-Managed Long-Span ECC for HBM AI Inference](https://arxiv.org/abs/2609.10861)
...
### [55] [Fengshui: Demystifying Chiplet Ecosystem and Bespoke Neural Network Accelerator Codesign](https://arxiv.org/abs/2609.10970)
...
### [56] [BEACON: A Versatile Accelerator for Computational Pathology Applications](https://arxiv.org/abs/2609.11044)
...
### [57] [Bio-inspired Learning and Decision-Making with Probabilistic In-Memory Computing Hardware: Part 2](https://arxiv.org/abs/2609.11288)
...
### [58] [PATTON: Enabling Commodity PIM for Production LLM Serving](https://arxiv.org/abs/2609.11392)
...
### [59] [CHERI-D Reincarnate: efficient multicore CHERI temporal memory safety through allocation reincarnation (draft version)](https://arxiv.org/abs/2609.11590)
...
### [60] [AccelForge: Comprehensive Modeling and Co-Design Framework for AI Accelerators](https://arxiv.org/abs/2609.11906)
