...
### [4] [Anomaly Detection and Root Cause Analysis for Microservice Systems](https://arxiv.org/abs/2606.09942)
*Luan Pham*
...
### [5] [Multi-task LLMs for Bug Classification: Efficient Inference with Auxiliary Decoding Heads](https://arxiv.org/abs/2606.09956)
*Nikolai Rozanov*
...
### [6] [Data-aware Static Analysis: Improving Detection of Semantic Faults in Machine Learning Code Using Data Characteristics](https://arxiv.org/abs/2606.09957)
...
### [7] [What makes a harness a harness: necessary and sufficient conditions for an agent harness](https://arxiv.org/abs/2606.10106)
...
### [8] [TestMap: Evidence Infrastructure for Foundation-Model-Assisted Test Generation](https://arxiv.org/abs/2606.10211)
...
### [9] [From Awareness to Action: How Developers Engage with Accessibility Innovation in LLM-Assisted Development](https://arxiv.org/abs/2606.10311)
...
### [10] [Communication Skills in Software Engineering: A Multivocal Review](https://arxiv.org/abs/2606.10320)
...
### [11] [Beyond Coverage and Kill Scores: Empirically Measuring Test Suite Behavioural Gaps](https://arxiv.org/abs/2606.10417)
...
### [12] [MASTOR: A Multi-Agent Approach to Semantic Test Oracle Generation for RESTful APIs](https://arxiv.org/abs/2606.10465)
...
### [13] [Exploring and Complementing End Users' Requirements in IoT enabled System](https://arxiv.org/abs/2606.10598)
...
### [14] [Watts and Debts of Agentic Frameworks: An Empirical Study (Registered Report)](https://arxiv.org/abs/2606.10702)
...
### [15] [DeNovoSWE: Scaling Long-Horizon Environments for Generating Entire Repositories from Scratch](https://arxiv.org/abs/2606.10728)
...
### [16] [Modular2Simple: A Tool for Modular Scenario Creation Based on the OpenSCENARIO Format](https://arxiv.org/abs/2606.10851)
...
### [17] [From Perception to Action: Can UI Interventions Foster Sustainable LLM Chatbot](https://arxiv.org/abs/2606.10861)
...
### [18] [Writing Better Software Explanations: A Guideline-Based Approach](https://arxiv.org/abs/2606.10880)
...
### [19] [From Quality Properties to Practice: A Guideline and Workflow for Explainability Requirements](https://arxiv.org/abs/2606.10882)
...
### [20] [Early Comparative Evaluation of Transformer Models for Multilingual Software Vulnerability Detection](https://arxiv.org/abs/2606.10925)
...
### [21] [GapFuzz: Cross-Plane Divergence Fuzzing for Distributed SDN Controllers](https://arxiv.org/abs/2606.11035)
...
### [22] [Making Software Meaningful](https://arxiv.org/abs/2606.11051)
...
### [23] [Operationalizing Property-Based Testing for Data-Intensive Scalable Computing Systems](https://arxiv.org/abs/2606.11132)
...
### [24] [Hardware-accelerated Aggregation: Unification and Specialization](https://arxiv.org/abs/2606.10030)
...
### [25] [RATrain: A Resource-Aware Training Runtime for Large Language Models on Bandwidth-Constrained Heterogeneous Supercomputing Platforms](https://arxiv.org/abs/2606.10415)
...
### [26] [ASTRA-sim 3.0: Next-Level Distributed Machine Learning Simulations via High-Fidelity GPU and Infrastructure Modeling](https://arxiv.org/abs/2606.10440)
...
### [27] [Achieving Cloud-Grade SLOs for Local Mixture-of-Experts Inference through CPU-GPU Hybrid Design](https://arxiv.org/abs/2606.10493)
...
### [28] [Generalizing LCL Complexity Gaps to Unbounded Degree via Monadic Second-Order Properties](https://arxiv.org/abs/2606.10693)
*Chiara Piombi*
...
### [29] [Dynamic Software Updates using CRDTs](https://arxiv.org/abs/2606.10920)
...
### [30] [FairWave : A Fairness-Aware Asynchronous DAG-BFT Consensus](https://arxiv.org/abs/2606.10982)
*Syariful Mujaddiq*
...
### [31] [A Neurosymbolic Prolog Skill for LLM-Driven Service Placement](https://arxiv.org/abs/2606.11113)
...
### [32] [Revisiting "Cooler is Better": ITD-Aware Per-CPU Thermal Optimization for Sustainable Data Center Operation](https://arxiv.org/abs/2606.11163)
...
### [33] [Piper: A Programmable Distributed Training System](https://arxiv.org/abs/2606.11169)
...
### [34] [EstRTL: Functional Estimation Guided RTL Code Generation](https://arxiv.org/abs/2606.09867)
...
### [35] [Toward a Small ML Runtime Stack for Raspberry Pi 5 QPUs](https://arxiv.org/abs/2606.09905)
...
### [36] [ARTA: Adaptive Reinforcement-Learning-Based Throttling Agent for RowHammer Vulnerabilities](https://arxiv.org/abs/2606.09915)
...
### [37] [SPARX: Secure and Privacy-Aware Approximate CNN Acceleration with Edge RISC-V SoC](https://arxiv.org/abs/2606.09946)
...
### [38] [Toward Intelligent Prefetching: A Survey on Complex Memory Access Prediction Techniques](https://arxiv.org/abs/2606.09955)
...
### [39] [A Generic Modulo-$(2^n\pmδ)$ RNS Multiplier Based on Twit Representation](https://arxiv.org/abs/2606.09965)
...
### [40] [Fault Characterization and Hardening of Combinational Standard Cells Using 3D-TCAD Simulations for Cyber-Physical Systems](https://arxiv.org/abs/2606.10015)
...
### [41] [Isolation-aware Scheduling Framework for DNN-based End-to-End Autonomous Driving System on Tile-based Accelerators](https://arxiv.org/abs/2606.10303)
...
### [42] [A 185 TOPS/W/mm2 Bayesian Inference Engine with 640 aJ Write-Free FeFET GRNG for Uncertainty-Aware Aerial Search and Rescue](https://arxiv.org/abs/2606.10822)
...
### [43] [Arithmetic Packing on Wide Integer Datapaths in DSP Primitives of Modern FPGA Devices](https://arxiv.org/abs/2606.11065)
...
### [44] [Coset Ensemble Decoder for Quantum Error Correction with Algorithm-Hardware Co-Design](https://arxiv.org/abs/2606.11076)
...
### [45] [Towards Autonomous Accelerator Design: FPGA Accelerator Generation with SECDA](https://arxiv.org/abs/2606.11117)
...
### [46] [Defeat the Heap: Zero-Copy Data Movement in AXI4MLIR](https://arxiv.org/abs/2606.11158)
...
### [47] [CAMASA: A CAM-based Dataset from the MASA Living Lab](https://arxiv.org/abs/2606.10641)
...
### [48] [High-Speed Generation of Periodic Traffic Patterns on P4TG for DDoS and Burst-Load Evaluation](https://arxiv.org/abs/2606.10708)
...
### [49] [A Unified Siamese Learning Framework for Zero-Day Anomaly Detection and Classification in Optical Networks](https://arxiv.org/abs/2606.10827)
...
### [50] [Generative Explainability for Next-Generation Networks: LLM-Augmented XAI with Mutual Feature Interactions](https://arxiv.org/abs/2606.10942)
...
### [51] [Internet Quality Barometer (IQB): A preliminary data-driven evaluation of the IQB framework](https://arxiv.org/abs/2606.11040)
...
### [52] [VQA for Dynamic Portfolio Optimization: Sampling Strategies, Optimizer Scheduling, and Hardware-Aware Ansatz Design](https://arxiv.org/abs/2606.10098)
...
### [53] [BENI Global 10: A Multilingual Economic Narrative Corpus for the Global South](https://arxiv.org/abs/2606.10225)
*Ann Naser Nabil*
...
### [54] [Decomposing Firm-Level Crisis Responses from Incomplete Market Signals: Evidence from China's IT Sector During COVID-19](https://arxiv.org/abs/2606.10297)
*Xiao Han,Yao Xiao*
...
### [55] [On the Localization of Checkerboarding in Multiaxial Stress Regions under SIMP Penalization](https://arxiv.org/abs/2606.10509)
...
### [56] [Curved Mesh Adaptation for High-Order Finite Element Simulations](https://arxiv.org/abs/2606.10763)
...
### [57] [Viable Supply Chain Network Design: Machine Learning-Derived Chance-Constrained Programming](https://arxiv.org/abs/2606.10766)
...
### [58] [A Numerical Approach to Operator Filtering within the Adaptive Integral Method for Electromagnetic Integral Equations](https://arxiv.org/abs/2606.10784)
...
### [59] [Non-linear mechanical field reconstruction coupling recurrent neural networks with physics-informed graph neural networks](https://arxiv.org/abs/2606.10909)
...
### [60] [A Constrained Natural-Language Interface for Variational Multi-Physics Finite Element Simulations in FEniCS](https://arxiv.org/abs/2606.10928)
