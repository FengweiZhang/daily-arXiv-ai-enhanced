...
### [3] [On the Semantics of Generative SPARQL](https://arxiv.org/abs/2606.23875)
...
### [4] [Unified Dominance Graph for Interval-Predicate Approximate Nearest Neighbor Search](https://arxiv.org/abs/2606.24204)
...
### [5] [Entity Resolution via Batched Oracle Queries](https://arxiv.org/abs/2606.24407)
...
### [6] [Accelerating Presto with GPUs](https://arxiv.org/abs/2606.24647)
...
### [7] [One Index for Subsumption and Roll-up across Time, Geography, and Ontology](https://arxiv.org/abs/2606.24677)
...
### [9] [An Efficient Construction of Completely Independent Spanning Trees in Dense Gaussian Networks](https://arxiv.org/abs/2606.23935)
...
### [10] [The Serialized Bridge: Understanding and Recovering LLM Serving Performance under Blackwell GPU Confidential Computing](https://arxiv.org/abs/2606.23969)
*Hang Yin,Kevin Wang*
...
### [11] [Hash Table Design for RDMA:Challenges and Opportunities](https://arxiv.org/abs/2606.24073)
...
### [12] [Aquifer: Hierarchical Memory Pooling with CXL and RDMA for MicroVM Snapshots](https://arxiv.org/abs/2606.24079)
...
### [13] [Semi-asynchronous Federated Learning in Flower: Framework Extension and Performance Assessment](https://arxiv.org/abs/2606.24230)
...
### [14] [Semantic Lock: Synchronization Based on the Analysis of the Operation Conflict Graph](https://arxiv.org/abs/2606.24250)
...
### [15] [BiJuTy: An Interactive HPC-Aware Big Data Cluster Lifecycle Manager and Performance Assessment Utility for JupyterHub](https://arxiv.org/abs/2606.24412)
...
### [16] [cuSBF: A Minimizer-Aware Bloom Filter for Genomic Sequence Data on Modern GPUs](https://arxiv.org/abs/2606.24417)
...
### [17] [CrossPool: Efficient Multi-LLM Serving for Cold MoE Models through KV-Cache and Weight Disaggregation](https://arxiv.org/abs/2606.24506)
...
### [21] [Kops: Safely Extending the eBPF Compilation Pipeline with Native Operations](https://arxiv.org/abs/2606.24213)
...
### [22] [Beyond the Autoregressive Horizon: A Comprehensive Survey of Diffusion Models, World Modelling, and State Space Models for Code](https://arxiv.org/abs/2606.23690)
...
### [23] [From Heuristics to Transformers: A Comprehensive Survey of Type Inference from Stripped Binaries](https://arxiv.org/abs/2606.23692)
...
### [24] [Privacy Engineering: A Systematic Literature Review](https://arxiv.org/abs/2606.23696)
...
### [25] [SemChunk-C: Semantic Segmentation for C Code](https://arxiv.org/abs/2606.23697)
...
### [26] [A Unified Framework for Runtime Verification and Model-Based Diagnosis in LOLA](https://arxiv.org/abs/2606.23720)
...
### [27] [ESAA-Conversational: An Event-Sourced Memory Layer for Continuity, Handoff, and Curation Across Heterogeneous LLM Coding Agents](https://arxiv.org/abs/2606.23752)
...
### [28] [From Task-Guided Conversational Graphs to Goal-Oriented Dialogue Runtimes](https://arxiv.org/abs/2606.23797)
...
### [29] [JupOtter: Cell-Level Bug Detection in Jupyter Notebooks](https://arxiv.org/abs/2606.23877)
...
### [30] [Domain-Driven Design in Practice: A Mining Study of Maintenance and Evolution in Open-Source Repositories](https://arxiv.org/abs/2606.23984)
...
### [31] [Collaborative and AI-Supported Requirements Elicitation: An Empirical Study](https://arxiv.org/abs/2606.24060)
...
### [32] [Agon: An Autonomous Large-Scale Omnidisciplinary Research System Built on Prompt Economy](https://arxiv.org/abs/2606.24177)
...
### [33] [AutoSpec: Safety Rule Evolution for LLM Agents via Inductive Logic Programming](https://arxiv.org/abs/2606.24245)
...
### [34] [Architecting Hybrid Quantum-Classical Software Systems: Exploration of the Design Trade-off Space with Quantitative Guarantees](https://arxiv.org/abs/2606.24260)
...
### [35] [Detecting AI Coding Agents in Open Source: A Validated Multi-Method Census of 180 Million Repositories](https://arxiv.org/abs/2606.24429)
...
### [36] [Agentic Generation of AST Transformation Rules for Fixing Breaking Updates](https://arxiv.org/abs/2606.24446)
...
### [37] [Toward Self-Evolution-Ready Workflow Harnesses: A Reversible Migration Path and Convertibility Taxonomy for Expert LLM Pipelines](https://arxiv.org/abs/2606.24598)
...
### [38] [Automated Summarization of Software Documents: An LLM-based Multi-Agent Approach](https://arxiv.org/abs/2606.24689)
...
### [39] [Bit-Precise Conformance Testing of Simulink Model Checkers](https://arxiv.org/abs/2606.24719)
...
### [40] [Two-Level vs. Multi-Level Modelling: An Empirical Study of Cascading Maintenance Burden](https://arxiv.org/abs/2606.24721)
...
### [41] [MANGO: Automated Multi-Agent Test Oracle Generation for Vision-Language-Action Models](https://arxiv.org/abs/2606.24815)
...
### [42] [Overconfident Coordinates: Quantifying Confidence in Traceroute Geolocation](https://arxiv.org/abs/2606.24027)
...
### [43] [SkyChain Intelligence: A Blockchain-Secured Multi-Agent DRL Framework for Low-Altitude Embodied Artificial Intelligence](https://arxiv.org/abs/2606.24193)
...
### [44] [FORESEE: A Cooperative Lane Change Model for Connected and Automated Driving](https://arxiv.org/abs/2606.24201)
...
### [45] [Importance of Intent-Sharing for V2X-based Maneuver Coordination](https://arxiv.org/abs/2606.24203)
*Rafael Molina-Masegosa,Sergei S. Avedisov,Miguel Sepulcre,Javier Gozalvez,Yashar Z. Farid,Onur Altintas*
...
### [46] [BRAVR: An AP-Assisted Online DRL Mechanism for Interactive VR Bitrate Adaptation over Wi-Fi](https://arxiv.org/abs/2606.24389)
...
### [47] [Building a Low-cost Network Digital Twin for the IoT-Edge-Cloud Continuum Using Open-Source Tooling](https://arxiv.org/abs/2606.24853)
...
### [48] [Efficient implementation of graph autoencoders for model-order reduction of systems with sharp gradients](https://arxiv.org/abs/2606.23834)
...
### [49] [Neural Network-Based Parametric Model Reduction for Predicting Turbulent Flow for Different Vehicle Geometries](https://arxiv.org/abs/2606.24265)
...
### [50] [A Step Towards Inherently Interpretable Causal Machine Learning Models For Decision Support](https://arxiv.org/abs/2606.24348)
...
### [51] [Development of a Programming Based Kinetic Model for Two Stage Composting of Solid Waste](https://arxiv.org/abs/2606.24556)
