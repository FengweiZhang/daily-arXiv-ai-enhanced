...
### [4] [Full-Field Calibration of Coupled Thermomechanical Material Models at Finite Strain](https://arxiv.org/abs/2606.05465)
...
### [5] [VITO: Vascular Geometry and Blood Flow Estimation Using Inverse Topology Optimization](https://arxiv.org/abs/2606.05487)
...
### [6] [AGI and the Limits of Value Production](https://arxiv.org/abs/2606.05715)
*Zichen Song*
...
### [7] [Data valuation model for non-monetary exchanges](https://arxiv.org/abs/2606.06325)
...
### [8] [Bridging CAD and Data-Driven Design: Attributed Feature Graphs for Engineering Design](https://arxiv.org/abs/2606.06405)
...
### [9] [BIDENT: Heterogeneous Operator-level Mapping for Efficient Edge Inference](https://arxiv.org/abs/2606.05271)
...
### [10] [FQA: A Full-Space Quantization-Driven Architecture for Hardware-Efficient Piecewise Approximation of Nonlinear Activation Functions](https://arxiv.org/abs/2606.05627)
...
### [14] [Where Do Large Language Models Fail on Competitive Programming? A Taxonomy of Failures by Algorithm Type and Difficulty Rating](https://arxiv.org/abs/2606.05228)
...
### [15] [DeployBench: Benchmarking LLM Agents for Research Artifact Deployment](https://arxiv.org/abs/2606.05238)
...
### [16] [SWE-InfraBench: Evaluating Language Models on Cloud Infrastructure Code](https://arxiv.org/abs/2606.05249)
...
### [17] [A Taxonomy of Runtime Faults in Model Context Protocol Servers](https://arxiv.org/abs/2606.05339)
...
### [18] [Human oversight of agentic systems in practice: Examining the oversight work, challenges, and heuristics of developers using software agents](https://arxiv.org/abs/2606.05391)
...
### [19] [REStack: A Large-Scale Dataset of Reverse Engineering Discussions from Stack Exchange](https://arxiv.org/abs/2606.05493)
...
### [21] [SmellBench: Towards Fine-Grained Evaluation of Code Agents on Refactoring Tasks](https://arxiv.org/abs/2606.05574)
...
### [22] [The End of Software Engineering: How AI Agents Are Fundamentally Restructuring the Software Paradigm](https://arxiv.org/abs/2606.05608)
*Zhenfeng Cao*
...
### [23] [Enhancing Software Engineering Through Closed-Loop Memory Optimization](https://arxiv.org/abs/2606.05646)
...
### [24] [When Surface Form Changes Moderation Decisions: A Paired Study of Code-Mixed Workflow Instability](https://arxiv.org/abs/2606.05654)
...
### [25] [Human Oversight and Overload: Two Hidden and Costly Burdens of AI-Assisted Software Engineering](https://arxiv.org/abs/2606.05770)
*Vahid Garousi*
...
### [27] [Metamorphic Testing with the Rashomon Set: Explanation Faithfulness in Machine Learning](https://arxiv.org/abs/2606.06056)
...
### [28] [TLA-Prover: Verifiable TLA+ Specification Synthesis via Preference-Optimized Low-Rank Adaptation](https://arxiv.org/abs/2606.06133)
...
### [29] [Towards the Readability of LLM-Generated Codes through Multitask Representation Engineering](https://arxiv.org/abs/2606.06214)
...
### [30] [Domain Diversity, Motivation, Inclusion, and Feedback in Software Modelling Education](https://arxiv.org/abs/2606.06275)
...
### [31] [More than a Judge: An Empirical Study of Agent-Human Interaction in Crowdsourced Testing Assessment](https://arxiv.org/abs/2606.06301)
...
### [33] [Scaffold, Not Vocabulary? A Controlled, Two-Tier, Pre-Registered Study of a Popperian Code-Generation Skill](https://arxiv.org/abs/2606.06454)
*Mehmet Iscan*
...
### [34] [Code2LoRA: Hypernetwork-Generated Adapters for Code Language Models under Software Evolution](https://arxiv.org/abs/2606.06492)
...
### [35] [SET: Stream-Event-Triggered Scheduling for Efficient CUDA Graph Pipelines](https://arxiv.org/abs/2606.05495)
...
### [36] [Beyond Greedy Chunking: SLO-Aware Sliding-Window Scheduling for LLM Inference](https://arxiv.org/abs/2606.05933)
...
### [37] [Demystifying NVSHMEM: A System-Level Analysis on Symmetric Memory and Device-Initiated Operations in GPU Communication](https://arxiv.org/abs/2606.05951)
...
### [38] [LLM-Based Porting of Optimized C++ to CUDA Through Deoptimization and Reoptimization](https://arxiv.org/abs/2606.06063)
...
### [39] [Discrete Incremental Voting: New Bounds for General Graphs and Expanders](https://arxiv.org/abs/2606.06381)
...
### [40] [On GPU Implementation for Multi-Precision Integer Division](https://arxiv.org/abs/2606.06386)
...
### [41] [CarbonSim: A Lifecycle-Aware Framework for Evaluating Carbon Tradeoffs in Hardware Upgrade Decisions](https://arxiv.org/abs/2606.06438)
...
### [42] [Availability-Aware and Efficiency-Driven AI Service Chain Provisioning in Multi-Domain Edge Intelligence Cloud](https://arxiv.org/abs/2606.05637)
...
### [43] [AISC deployment in dynamic UAV-assisted MEC network: a reinforcement learning method based on heterogeneous graph attention neural network](https://arxiv.org/abs/2606.05722)
...
### [44] [BeGREEN Intelligent Plane for AI-driven Energy Efficient O-RAN management](https://arxiv.org/abs/2606.05747)
...
### [45] [Quantifying the Energy-Saving and QoS Trade-Off in Traffic Offloading for Real 4G/5G Scenarios](https://arxiv.org/abs/2606.05752)
...
### [46] [Toward Mobile and Converged Backhaul: The Promise of Wireless Access and Backhaul](https://arxiv.org/abs/2606.06075)
...
### [47] [DAST: A VLM-LLM Framework for Cross-Interface Anomaly Detection in O-RAN](https://arxiv.org/abs/2606.06261)
