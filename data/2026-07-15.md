...
### [4] [Overcoming Orchestration Bottlenecks at Exascale: A Decentralized, Policy-Driven Approach for Sim-AI Ensembles](https://arxiv.org/abs/2607.12211)
...
### [5] [Decentralized Gradient Descent: Bottleneck Regimes and Budget Complexity](https://arxiv.org/abs/2607.12172)
*Nicolò Michelusi*
...
### [8] [HeteroMosaic: Exposing and Exploiting Heterogeneous Execution Opportunities for Energy-Efficient Edge LLM Inference](https://arxiv.org/abs/2607.12839)
...
### [9] [Scaling Synthetic-Image Pre-Training for Federated Fine-Tuning of Large Vision Models](https://arxiv.org/abs/2607.12583)
...
### [12] [SkillComm: Skill-Driven Semantic Communication for Sequential Workflows via Incremental Token Transmission](https://arxiv.org/abs/2607.11972)
*Ziyang Meng,Lu Lu*
...
### [13] [OSNR/GSNR Prediction in Brownfield Links via a DLM-Anchored Hybrid Physics/ML Model](https://arxiv.org/abs/2607.12152)
...
### [14] [High-Precision Hybrid FA-PSO Based Inversion of Building Material Parameters for Fundamental Wireless Performance Evaluation](https://arxiv.org/abs/2607.12721)
...
### [15] [FPGA-Based Mini X-Ray Detector Front-End](https://arxiv.org/abs/2607.12126)
...
### [16] [ORRAM: An OpenROAD-Integrated RAM Generator Using Standard Cells](https://arxiv.org/abs/2607.12244)
...
### [17] [Emulated Integrity Replica: Enabling Self-Healing on FPGA SoCs via Hierarchical Twins](https://arxiv.org/abs/2607.12298)
...
### [18] [ArchSim: Computer Architecture Simulation as a Service](https://arxiv.org/abs/2607.12359)
...
### [19] [Realizable N:M Sparse Transformer Inference via Search-Kernel Co-Design](https://arxiv.org/abs/2607.12505)
...
### [20] [CLIP-3D: Closed-Loop Evaluation of Performance and Physical Constraints for 3D ICs](https://arxiv.org/abs/2607.12788)
...
### [21] [A 32-channel event-based bio-signal analog front-end with adaptive delta and pulse frequency encoding](https://arxiv.org/abs/2607.12901)
...
### [22] [Predicting Acceptance and Review Effort in Human and Agent Pull Requests](https://arxiv.org/abs/2607.12057)
...
### [23] [AutoTrace: From Patches to Triggers via Agentic Interprocedural Exploration](https://arxiv.org/abs/2607.12058)
...
### [24] [Beyond Test Presence: Assessing the Quality and Robustness of Agent-Generated Tests in Open-Source Projects](https://arxiv.org/abs/2607.12068)
...
### [25] [Fault Injection in OpenAPI Specifications for Evaluating Black-Box Testing Effectiveness](https://arxiv.org/abs/2607.12101)
...
### [26] [TraceSynth: Generating Production-Quality Kernel Traces with Constraint-Guided Diffusion Models](https://arxiv.org/abs/2607.12104)
...
### [27] [TestMiner: Software Testing Analysis for GitHub Repositories](https://arxiv.org/abs/2607.12223)
...
### [28] [WIP: Software Engineering Competencies in the Age of AI](https://arxiv.org/abs/2607.12259)
...
### [29] [Code-MUE: Measuring Code LLMs' Uncertainty through Execution-based Semantic Interaction Graphs](https://arxiv.org/abs/2607.12273)
...
### [30] [XScientist: A Git-Like Research Protocol for Long-Running Autonomous Scientific Discovery](https://arxiv.org/abs/2607.12301)
*Jixiang Luo*
...
### [31] [How Many Interviews Are Enough in a Software Engineering Study? Preliminary Findings on Sample Size and Saturation](https://arxiv.org/abs/2607.12326)
...
### [32] [Skills That Don't Exist: A Large-Scale Study of Hallucinated Skill Recommendation in LLM Agents](https://arxiv.org/abs/2607.12340)
...
### [33] [Detecting Rendering Bugs in Imperative Data Visualization Libraries via Equivalent Mutations](https://arxiv.org/abs/2607.12363)
...
### [34] [Automatic Testing of Interacting Autonomous Vehicles](https://arxiv.org/abs/2607.12452)
...
### [35] [CodeOwl: Automatic Generation of Tiered Parsons Problems for Introductory Programming](https://arxiv.org/abs/2607.12460)
...
### [36] [Understanding before Naming! Enhancing LLM-based Method Name Prediction with Code Summarization](https://arxiv.org/abs/2607.12467)
...
### [37] [Agent-Safety Evaluations as Load-Bearing Evidence: A Vendor-Neutral, Cross-Harness Reconstructability Metric](https://arxiv.org/abs/2607.12469)
*Oleg Solozobov*
...
### [38] [Taming the Drift: Context-aware Repair of Dockerfile Drift during Software Evolution](https://arxiv.org/abs/2607.12541)
...
### [39] [Evaluation Bias and Epistemic Inequality in Global Software Development](https://arxiv.org/abs/2607.12563)
...
### [40] [Hierarchical Fault Localization for Autonomous Driving Systems with Hypothesis Validation and Intent Analysis](https://arxiv.org/abs/2607.12598)
...
### [41] [Multi-Perspective Agentic Program Repair via Code Property Graphs and Temporal Execution Graphs](https://arxiv.org/abs/2607.12605)
...
### [42] [Line-Anchored Feedback Cuts Token Costs and Improves Correctness in AI Code Editing](https://arxiv.org/abs/2607.12713)
...
### [43] [Toward Localizing and Repairing Bias in Transformer Attention Heads](https://arxiv.org/abs/2607.12863)
*Sigma Jahan*
...
### [44] [Deep4ge: DNN Training Trajectories for Fault Detection and Diagnosis](https://arxiv.org/abs/2607.12868)
*Sigma Jahan*
...
### [45] [Salesforce Messaging Architecture: Platform Events, Async Sends, and Multi-Tenancy at Scale](https://arxiv.org/abs/2607.12943)
*Devam Gupta*
...
### [48] [Inference Pipelines as Operating-System Objects: Priority Scheduling and Constant-Footprint Streaming for Microcontroller Neural Inference](https://arxiv.org/abs/2607.12614)
*Dimitrios Kafetzis*
...
### [49] [Cross-Core Inference Offload as an Operating-System Service on Dual-Core Microcontrollers](https://arxiv.org/abs/2607.12620)
*Dimitrios Kafetzis*
...
### [50] [Singular and nearly singular quadrature in arbitrary dimensions](https://arxiv.org/abs/2607.12440)
...
### [51] [A 2.5D NURBS-Trace Infinite-Element Method for Moving-Load Wave Propagation and Soil--Structure Interaction in Semi-Infinite Ground](https://arxiv.org/abs/2607.12582)
