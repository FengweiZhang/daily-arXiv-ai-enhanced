...
### [1] [DDB: Source-Level Interactive Debugging for Distributed Applications](https://arxiv.org/abs/2607.06107)
...
### [2] [Adaptive Snapshots Require Visible Reads](https://arxiv.org/abs/2608.13705)
...
### [3] [Balancing Workload Performance and Slurm Stress: Four Nextflow Deployment Strategies](https://arxiv.org/abs/2608.13824)
...
### [4] [Could Model Partitioning Make Federated Learning More Sustainable?](https://arxiv.org/abs/2608.14242)
...
### [5] [Large-scale workflow placement in serverless computing using integer nonlinear programming](https://arxiv.org/abs/2608.14427)
...
### [6] [Validating LLM-Modernized Scientific Software Through Differential Fault Injection](https://arxiv.org/abs/2608.14527)
...
### [7] [Over the Memory Wall, Into the Instruction Wall: The New Bottleneck in GPU Data Processing](https://arxiv.org/abs/2608.13696)
...
### [8] [Agentic Transaction: Towards ACID-Compliant Agent Systems](https://arxiv.org/abs/2608.13900)
...
### [19] [Exploring High-Bandwidth Flash for Modern LLM Inference: Opportunities and Challenges](https://arxiv.org/abs/2608.13868)
...
### [20] [MoE Expert Execution in Disaggregated LLM Serving with a High-Bandwidth ReRAM Near-Memory Architecture](https://arxiv.org/abs/2608.13962)
...
### [21] [Experimental Study on System-Level Performance Impact of Read Disturbance in Modern SSDs](https://arxiv.org/abs/2608.14073)
...
### [22] [Beyond Capacity: Scalable MoE LLM Inference via High-Bandwidth Flash with Direct GPU and HBM Paths](https://arxiv.org/abs/2608.14333)
...
### [23] [AlphaSeek: Trajectory-Level Self-Iterative Factor Mining Framework for Multi-Source Financial Data](https://arxiv.org/abs/2608.13913)
...
### [24] [MMDynOpt-Agent: Dynamic Optimization for Multimodal Large Language Model Reasoning via Reinforcement Learning](https://arxiv.org/abs/2608.14026)
...
### [25] [Robust Constraint-Aware Bayesian Tuning of BBRv2 for QUIC under Tactile Internet Constraints](https://arxiv.org/abs/2608.14318)
...
### [26] [Scaling 5G-TSN Bridges: Operating Regimes, Scheduling, and Time Synchronisation Under Heterogeneous Industrial Traffic](https://arxiv.org/abs/2608.14386)
...
### [27] [A Bounded Reclaim Actuator for PSI-Guided Compressed Memory: A Controlled Ablation](https://arxiv.org/abs/2608.13689)
...
### [28] [CoRun: Padding is Simple and Efficient for Deterministic LLM Inference](https://arxiv.org/abs/2608.14376)
