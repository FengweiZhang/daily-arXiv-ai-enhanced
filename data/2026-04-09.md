...
### [14] [Ontology-based knowledge graph infrastructure for interoperable atomistic simulation data](https://arxiv.org/abs/2604.06230)
...
### [15] [Automating Database-Native Function Code Synthesis with LLMs](https://arxiv.org/abs/2604.06231)
...
### [16] [CobbleDB: Modelling Levelled Storage by Composition](https://arxiv.org/abs/2604.06273)
...
### [17] [Database Querying under Missing Values Governed by Missingness Mechanisms](https://arxiv.org/abs/2604.06520)
...
### [18] [AI-Driven Research for Databases](https://arxiv.org/abs/2604.06566)
...
### [19] [SonicDB S6: A Storage-Efficient Verkle Trie for High-Throughput Blockchains](https://arxiv.org/abs/2604.06579)
...
### [20] [CubeGraph: Efficient Retrieval-Augmented Generation for Spatial and Temporal Data](https://arxiv.org/abs/2604.06616)
...
### [21] [LASER: A Data-Centric Method for Low-Cost and Efficient SQL Rewriting based on SQL-GRPO](https://arxiv.org/abs/2604.06804)
...
### [22] [AV-SQL: Decomposing Complex Text-to-SQL Queries with Agentic Views](https://arxiv.org/abs/2604.07041)
...
### [23] [CoverAssert: Iterative LLM Assertion Generation Driven by Functional Coverage via Syntax-Semantic Representations](https://arxiv.org/abs/2604.06607)
...
### [24] [SwarmIO: Towards 100 Million IOPS SSD Emulation for Next-generation GPU-centric Storage Systems](https://arxiv.org/abs/2604.06668)
...
### [25] [CBM-Dual: A 65-nm Fully Connected Chaotic Boltzmann Machine Processor for Dual Function Simulated Annealing and Reservoir Computing](https://arxiv.org/abs/2604.06808)
...
### [26] [TRAPTI: Time-Resolved Analysis for SRAM Banking and Power Gating Optimization in Embedded Transformer Inference](https://arxiv.org/abs/2604.06955)
...
### [27] [Symbolic Polyhedral-Based Energy Analysis for Nested Loop Programs](https://arxiv.org/abs/2604.07287)
...
### [28] [Code Sharing In Prediction Model Research: A Scoping Review](https://arxiv.org/abs/2604.06212)
...
### [29] [All LCA models are wrong. Are some of them useful? Towards open computational LCA in ICT](https://arxiv.org/abs/2604.06290)
...
### [30] ["Don't Be Afraid, Just Learn": Insights from Industry Practitioners to Prepare Software Engineers in the Age of Generative AI](https://arxiv.org/abs/2604.06342)
...
### [31] [A Survey of Algorithm Debt in Machine and Deep Learning Systems: Definition, Smells, and Future Work](https://arxiv.org/abs/2604.06363)
...
### [32] [Beyond Functional Correctness: Design Issues in AI IDE-Generated Large-Scale Projects](https://arxiv.org/abs/2604.06373)
...
### [33] [ExplainFuzz: Explainable and Constraint-Conditioned Test Generation with Probabilistic Circuits](https://arxiv.org/abs/2604.06559)
...
### [34] [It's Not About Whom You Train: An Analysis of Corporate Education in Software Engineering](https://arxiv.org/abs/2604.06580)
...
### [35] [Benchmarking Requirement-to-Architecture Generation with Hybrid Evaluation](https://arxiv.org/abs/2604.06683)
...
### [36] [Stabilization Without Simplification: A Two-Dimensional Model of Software Evolution](https://arxiv.org/abs/2604.06709)
*Masaru Furukawa*
...
### [37] [Fine-grained Approaches for Confidence Calibration of LLMs in Automated Code Revision](https://arxiv.org/abs/2604.06723)
...
### [38] [Evaluating LLM-Based 0-to-1 Software Generation in End-to-End CLI Tool Scenarios](https://arxiv.org/abs/2604.06742)
...
### [39] [Babbling Suppression: Making LLMs Greener One Token at a Time](https://arxiv.org/abs/2604.06755)
...
### [40] [Improving Random Testing via LLM-powered UI Tarpit Escaping for Mobile Apps](https://arxiv.org/abs/2604.06763)
...
### [41] [Evaluating Repository-level Software Documentation via Question Answering and Feature-Driven Development](https://arxiv.org/abs/2604.06793)
...
### [42] [REAgent: Requirement-Driven LLM Agents for Software Issue Resolution](https://arxiv.org/abs/2604.06861)
...
### [43] [An empirical study of LoRA-based fine-tuning of large language models for automated test case generation](https://arxiv.org/abs/2604.06946)
...
### [44] [Assessing REST API Test Generation Strategies with Log Coverage](https://arxiv.org/abs/2604.07073)
...
### [45] [Compact Constraint Encoding for LLM Code Generation: An Empirical Study of Token Economics and Constraint Compliance](https://arxiv.org/abs/2604.07192)
*Hanzhang Tang*
...
### [46] [Chatbot-Based Assessment of Code Understanding in Automated Programming Assessment Systems](https://arxiv.org/abs/2604.07304)
...
### [47] [ReCodeAgent: A Multi-Agent Workflow for Language-agnostic Translation and Validation of Large-scale Repositories](https://arxiv.org/abs/2604.07341)
...
### [48] [Hyperfastrl: Hypernetwork-based reinforcement learning for unified control of parametric chaotic PDEs](https://arxiv.org/abs/2604.06497)
...
### [49] [Multiscale topology optimization of compressible and nearly incompressible anisotropic hyperelastic structures using physics-augmented neural networks](https://arxiv.org/abs/2604.06519)
...
### [50] [Shocks without shock capturing: Information geometric regularization of finite volume methods for Navier--Stokes-like problems](https://arxiv.org/abs/2604.06546)
...
### [51] [A Rolling-Horizon Stochastic Optimization Framework for NBA Franchise Management with Distributionally Robust Risk Constraints](https://arxiv.org/abs/2604.06548)
...
### [52] [When Agent Markets Arrive](https://arxiv.org/abs/2604.06688)
...
### [53] [From Perception to Autonomous Computational Modeling: A Multi-Agent Approach](https://arxiv.org/abs/2604.06788)
*Daniel N. Wilke*
...
### [54] [SentinelSphere: Integrating AI-Powered Real-Time Threat Detection with Cybersecurity Awareness Training](https://arxiv.org/abs/2604.06900)
...
### [55] [XR-CareerAssist: An Immersive Platform for Personalised Career Guidance Leveraging Extended Reality and Multimodal AI](https://arxiv.org/abs/2604.06901)
...
### [56] [Immersed boundary-conformal isogeometric methods for magnetostatics](https://arxiv.org/abs/2604.07155)
...
### [57] [Dead Code Doesn't Talk: Authentic Requirements Elicitation in Introductory Software Engineering](https://arxiv.org/abs/2604.07211)
...
### [58] [Improved Implementation of Approximate Full Mass Matrix Inverse Methods into Material Point Method Simulations](https://arxiv.org/abs/2604.07307)
*John A. Nairn*
...
### [59] [Towards National Quantum Communication in Europe: Planning and Sizing Terrestrial QKD Networks](https://arxiv.org/abs/2604.06764)
...
### [60] [Enhancing Secure Intent-Based Networking with an Agentic AI: The EU Project MARE Approach](https://arxiv.org/abs/2604.06856)
...
### [61] [Aerial Booster-Cell Enabled Inter-Cell Interference Coordination for 5G NR Networks](https://arxiv.org/abs/2604.07145)
...
### [62] [Multiprotocol Wireless Timer Synchronization for IoT Systems](https://arxiv.org/abs/2604.07199)
