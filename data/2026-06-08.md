...
### [13] [StageFrontier: Synchronization-Aware Stage Accounting for Distributed ML Training](https://arxiv.org/abs/2606.06751)
...
### [14] [Terastal: Layer-Variant-based Scheduling for Real-Time Multi-DNN Workloads on Heterogeneous Accelerators](https://arxiv.org/abs/2606.06818)
...
### [15] [Communication Strategy Selection for Multi-GPU 3D FDTD with Convolutional Perfectly Matched Boundary Layers](https://arxiv.org/abs/2606.06910)
*Victory C. Obieke*
...
### [16] [PCCL: Process Group-Aware Scalable and Generic Collective Algorithm Synthesizer](https://arxiv.org/abs/2606.07019)
...
### [17] [Predictive Autoscaling in Cloud-Native and Federated Cloud-Edge Computing Environments: A Taxonomy and Future Directions](https://arxiv.org/abs/2606.07046)
...
### [18] [Clairvoyant: Predictive SJF Scheduling to Mitigate Head-of-Line Blocking in Serial LLM Backends](https://arxiv.org/abs/2606.07248)
*Aravind Sundaresan*
...
### [19] [Twelve quick tips for designing AI-driven HPC workflows](https://arxiv.org/abs/2606.07491)
*Jamie J. Alnasir*
...
### [20] [A Comparative Study of Deep Learning Models for Geological Carbon Sequestration](https://arxiv.org/abs/2606.07215)
...
### [21] [CaliPPer: quantifying, predicting and improving AI model performance for binding prediction](https://arxiv.org/abs/2606.07258)
...
### [22] [High-Frequency Preconditioners for Electromagnetic Integral Equations Based on Helmholtz Regularizations](https://arxiv.org/abs/2606.07427)
...
### [23] [Tracing Stablecoin Contagion during the USDC Depeg after the Silicon Valley Bank Collapse](https://arxiv.org/abs/2606.07442)
...
### [24] [DataEvolver: Automatic Data Preparation for Large Language Models through Multi-Level Self-Evolving](https://arxiv.org/abs/2606.07001)
...
### [25] [Auto-Relate: A Unified Approach to Discovering Reliable Functional Relationships Leveraging Statistical Tests](https://arxiv.org/abs/2606.07060)
...
### [26] [Efficient $(α,β)$-core Computation and On-the-fly Query at Billion Scale with GPUs](https://arxiv.org/abs/2606.07148)
...
### [28] [Queen-Bee Agents: A BeeSpec-Centered Architecture for Governed Enterprise MCP Orchestration](https://arxiv.org/abs/2606.06545)
...
### [29] [AI-Driven Test Case Generation from Natural Language Requirements: A Survey of Techniques and Research Gaps](https://arxiv.org/abs/2606.06563)
...
### [30] [NTILC: Neural Tool Invocation via Learned Compression](https://arxiv.org/abs/2606.06566)
...
### [31] [AutoPipelineAI: Context-Aware CI/CD Pipeline Generation from Natural Language](https://arxiv.org/abs/2606.06662)
...
### [32] [Tensor Algebraic Property Skeletons: Amplifying Property-Based Testing for AI Compilers](https://arxiv.org/abs/2606.06747)
...
### [33] [Pomona: Continuous Code Quality Improvement via Small, Automated Changes at Bloomberg](https://arxiv.org/abs/2606.06752)
...
### [34] [Chiseling Out Efficiency: Structured Skeleton Supervision for Efficient Code Generation](https://arxiv.org/abs/2606.06821)
...
### [35] [SkelDPO: A Skeleton-Guided Direct Preference Optimization Framework for Efficient Code Generation](https://arxiv.org/abs/2606.06826)
*Yu Yu,Chen Lyu*
...
### [36] [LLM Agent-Assisted Reverse Engineering with Quantitative Readability Metrics](https://arxiv.org/abs/2606.06838)
...
### [37] [Empirical Study on the Characteristics and Evolution of AI-usage in GitHub Repositories: Evidence from Code Comments](https://arxiv.org/abs/2606.06843)
...
### [38] [From Custom Logic to APIs: Understanding and Recommending API Replacement Refactorings](https://arxiv.org/abs/2606.06912)
...
### [39] [Porting Declarative UI to HarmonyOS: A Heuristic-guided LLM Approach](https://arxiv.org/abs/2606.07085)
...
### [40] [MetaConfigurator: AI-Assisted RDF Authoring from JSON Data](https://arxiv.org/abs/2606.07094)
...
### [41] [SWE-Explore: Benchmarking How Coding Agents Explore Repositories](https://arxiv.org/abs/2606.07297)
...
### [42] [QBugLM: An Agentic Benchmarking Framework for LLM-based Quantum Software Debugging](https://arxiv.org/abs/2606.07314)
...
### [43] [Is US Defense Acquisition Ready to Acquire AI-Enabled Capabilities? Assessing the DoD Software Acquisition Pathway Through a Scenario-Based Policy Analysis](https://arxiv.org/abs/2606.07393)
...
### [44] [Socratic-SWE: Self-Evolving Coding Agents via Trace-Derived Agent Skills](https://arxiv.org/abs/2606.07412)
...
### [45] [Agentic Very Much! Adoption of Coding Agent in New GitHub Projects](https://arxiv.org/abs/2606.07448)
