...
### [1] [SoliDualSPHysics: An extension of DualSPHysics for solid mechanics with hyperelasticity, plasticity, and fracture](https://arxiv.org/abs/2602.15149)
...
### [2] [Efficient Road Renovation Scheduling under Uncertainty using Lower Bound Pruning](https://arxiv.org/abs/2602.15554)
...
### [3] [Distributed Semi-Speculative Parallel Anisotropic Mesh Adaptation](https://arxiv.org/abs/2602.15204)
...
### [4] [Co-Design and Evaluation of a CPU-Free MPI GPU Communication Abstraction and Implementation](https://arxiv.org/abs/2602.15356)
...
### [5] [FlashMem: Supporting Modern DNN Workloads on Mobile with GPU Memory Hierarchy Optimizations](https://arxiv.org/abs/2602.15379)
...
### [6] [Service Orchestration in the Computing Continuum: Structural Challenges and Vision](https://arxiv.org/abs/2602.15794)
...
### [7] [CircuChain: Disentangling Competence and Compliance in LLM Circuit Analysis](https://arxiv.org/abs/2602.15037)
*Mayank Ravishankara*
...
### [8] [The Agentic Automation Canvas: a structured framework for agentic AI project design](https://arxiv.org/abs/2602.15090)
...
### [9] [An Empirical Study on the Effects of System Prompts in Instruction-Tuned Models for Code Generation](https://arxiv.org/abs/2602.15228)
...
### [10] [GenAI for Systems: Recurring Challenges and Design Principles from Software to Silicon](https://arxiv.org/abs/2602.15241)
...
### [11] [SACS: A Code Smell Dataset using Semi-automatic Generation Approach](https://arxiv.org/abs/2602.15342)
...
### [12] [A Differential Fuzzing-Based Evaluation of Functional Equivalence in LLM-Generated Code Refactorings](https://arxiv.org/abs/2602.15761)
...
### [17] [Crane: An Accurate and Scalable Neural Sketch for Graph Stream Summarization](https://arxiv.org/abs/2602.15360)
...
### [18] [Efficient Approximate Nearest Neighbor Search under Multi-Attribute Range Filter](https://arxiv.org/abs/2602.15488)
...
### [19] [A universal LLM Framework for General Query Refinements](https://arxiv.org/abs/2602.15681)
...
### [20] [Hierarchical Decomposition of Separable Workflow-Nets](https://arxiv.org/abs/2602.15739)
...
### [21] [Efficient Densest Flow Queries in Transaction Flow Networks (Complete Version)](https://arxiv.org/abs/2602.15773)
...
### [22] [Exploring Performance Tradeoffs in Age-Aware Remote Monitoring with Satellites](https://arxiv.org/abs/2602.15145)
...
### [23] [High-Fidelity Network Management for Federated AI-as-a-Service: Cross-Domain Orchestration](https://arxiv.org/abs/2602.15281)
