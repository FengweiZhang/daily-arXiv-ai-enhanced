...
### [2] [Lightweight Adaptation of EEG Foundation Models for Stroke Motor Imagery Decoding: Domain Shift and Subject-Level Robustness](https://arxiv.org/abs/2609.00282)
...
### [3] [Hidden relationships in a document-derived property graph: top-k chunk embeddings and inverse-distance weighting over a dynamically evolving ontology](https://arxiv.org/abs/2609.00387)
...
### [4] [MUFASA: An Information Utility-Aware Preprocessing Framework for Reliable Model Reasoning in Computational Pathology](https://arxiv.org/abs/2609.00424)
...
### [5] [Aerodynamic Shape Design Space Exploration with Deep Latent Diffusion Model](https://arxiv.org/abs/2609.00812)
...
### [6] [VPID: An Integrated Framework for Vulnerability Prioritization and Intrusion Detection in Enterprise Networks](https://arxiv.org/abs/2609.00819)
...
### [7] [Connectome-Based Modelling Reveals Orientation Maps in the Drosophila Optic Lobe](https://arxiv.org/abs/2609.01330)
...
### [8] [WiSDoM: Wireless Sparse Decision Transformer with Mixture-of-Experts for Multi-Task Mobile Network Optimization](https://arxiv.org/abs/2609.00284)
...
### [9] [SkyShare: Constellation-wide Sky Sharing for LEO-Radio Astronomy Coexistence](https://arxiv.org/abs/2609.00821)
...
### [10] [Lacan: Making Accountability in Anonymous Networks Real](https://arxiv.org/abs/2609.01075)
...
### [11] [Sentinel-Based Failover for QKD-Augmented IPsec Tunnels](https://arxiv.org/abs/2609.01121)
...
### [12] [Highly Detailed Simulation for Connected Automated Vehicle Cooperative Driving](https://arxiv.org/abs/2609.01254)
...
### [13] [TriSLA: A Preventive and Closed-Loop SLA-Aware Architecture for Multidomain Decision-Making with Explainable Artificial Intelligence in 5G Networks](https://arxiv.org/abs/2609.01293)
...
### [14] [Mobile Backscatter Communication for the Battery-less Internet of Things](https://arxiv.org/abs/2609.01465)
...
### [15] [The Role of Collective Perception and 5G NR-V2X Sidelink in Road Safety](https://arxiv.org/abs/2609.01478)
...
### [16] [Data-Driven Case Study of gNB Placement Optimization in a Private Indoor 5G Testbed](https://arxiv.org/abs/2609.01510)
...
### [17] [mzCache: On-Device LLM Memory Management under Multitasking](https://arxiv.org/abs/2609.01338)
...
### [18] [BlockMGARD: Accelerating Adaptive Scientific Data Reduction with Region-of-Interest Error Control on GPUs](https://arxiv.org/abs/2609.00205)
...
### [19] [Operation-Type-Aware Client Routing for Leader-Based Consensus Datastores](https://arxiv.org/abs/2609.00392)
...
### [20] [Client-side transparent caching for remote ROOT data analysis](https://arxiv.org/abs/2609.00400)
...
### [21] [DRLM: Deep Reinforcement Learning-Based LLM Query Orchestration in Edge Environments](https://arxiv.org/abs/2609.00442)
...
### [22] [Comparison of Algebraic Block Multi-Coloring and Leiden Methods for Parallel Preconditioning in the ICCG Method](https://arxiv.org/abs/2609.00561)
*Tomohiro Suzuki*
...
### [23] [Characterizing the Scalability and Performance of Large-Scale AI Training Under Multi-Tenancy](https://arxiv.org/abs/2609.00817)
...
### [24] [Breaking Cycles for Scalable Fair Ordering in Blockchain Systems](https://arxiv.org/abs/2609.00837)
...
### [25] [Shared-Memory Range-Tiled CDF Sort for Small-Range Integer Keys on GPUs](https://arxiv.org/abs/2609.00843)
...
### [26] [Prediction-Robust Service Deployment with Capacity-Aware Edge Admission](https://arxiv.org/abs/2609.00877)
...
### [27] [Update for Decisions, Not Freshness: Goal-Oriented Status Updating and Selective Offloading at the Network Edge](https://arxiv.org/abs/2609.01082)
...
### [28] [AInfer-PD: Communication-Safe In-Place Prefill-Decode Multiplexing for Distributed MoE Rollouts](https://arxiv.org/abs/2609.00993)
...
### [29] [MakoXC: Rearchitecting DFT Exchange-Correlation with Matrix-Aligned and Knowledge-Organized Sparsity](https://arxiv.org/abs/2609.01025)
...
### [30] [Just Talk Once: Communication-Efficient Split Federated LLM Fine-Tuning on Edge Devices](https://arxiv.org/abs/2609.01457)
...
### [31] [Faster Convergence of Multidimensional Approximate Agreement via Smallest Enclosing Balls](https://arxiv.org/abs/2609.01490)
*Darya Melnyk*
...
### [32] [Intelligent Edge Computing](https://arxiv.org/abs/2609.00181)
...
### [33] [Bounded, Indeterminate, or a Bug: A Condition-Aware Oracle for Differential Testing of SQL Aggregates](https://arxiv.org/abs/2609.00381)
...
### [34] [Time-Decayed Vector Search in the Rhythm of TANGO: Jointly Modeling Semantic Similarity and Temporal Freshness](https://arxiv.org/abs/2609.00548)
...
### [35] [Efficient discovery of unique column combinations on disk-resident data with limited memory](https://arxiv.org/abs/2609.00783)
...
### [36] [Relational-Core Graph Analytics Querying graphs at SQL scale, and why the node/edge model is a performance tax, not a truer picture of connected data](https://arxiv.org/abs/2609.01525)
*Gene Zhang*
...
### [37] [DynaNDE: Dynamic Near-Data Expert Scheduling for Batched MoE Inference](https://arxiv.org/abs/2609.00407)
...
### [38] [VARA: A Voltage-Aware ReRAM-Based Accelerator for Energy-Efficient Computing](https://arxiv.org/abs/2609.00421)
...
### [39] [LLM Inference on IMC-NoC Architecture with Balanced Dataflow and Fine-Grained Parallelism](https://arxiv.org/abs/2609.00857)
...
### [40] [Hardware Acceleration of Block-Diffusion LLM for Edge Devices](https://arxiv.org/abs/2609.01084)
...
### [41] [Performance Characterization of SPEC CPU 2026 on AMD EPYC 9755 Processor](https://arxiv.org/abs/2609.01527)
...
### [42] [Harness Engineering: Anatomy, Architecture, and Evolution of Coding Agents -- A Source-Code Study of Eleven Systems](https://arxiv.org/abs/2609.00006)
...
### [43] [Structure-Behavior Coalescence and the Limits of Traditional Systems Theory](https://arxiv.org/abs/2609.00042)
*William S. Chao*
...
### [44] [What Is a System? An Interaction-Based Account of Structure-Behavior Coalescence in General Systems Theory](https://arxiv.org/abs/2609.00043)
*William S. Chao*
...
### [45] [Towards Agentic Cloud Engineering: Graph and Loop Engineering with a Zero-Trust Agent Harness](https://arxiv.org/abs/2609.00050)
...
### [46] [Can MCP Clients Decide What to Do After Failure? A Result-Only Actionability Audit](https://arxiv.org/abs/2609.00072)
*Rishabh Mehan*
...
### [47] [Framework and Benchmark for Code-Driven Agentic Testing in Web Development](https://arxiv.org/abs/2609.00081)
...
### [48] [Commit-first LLM judging inherits the judge's own errors](https://arxiv.org/abs/2609.00088)
*Idil Gozel*
...
### [49] [Don't Let the Model Write the YAML: Deterministic, Minimal-Diff GitOps Remediation from LLM-Proposed Field Changes](https://arxiv.org/abs/2609.00227)
*Pruthvi Davineni*
...
### [50] [Empirical Software Engineering in Practice: Insights from Google](https://arxiv.org/abs/2609.00247)
...
### [51] [Spec-Driven Development for Agentic Software Engineering: Harnessing Human-Agent Teamwork](https://arxiv.org/abs/2609.00252)
...
### [52] [Exploring Quantum Software Testing Across Research and Practice: Emerging Results from a Multivocal Literature Review](https://arxiv.org/abs/2609.00354)
...
### [61] [Fine-Tuning Large Language Models to Classify Pull Request-Issue Alignments: Going Beyond Prompting](https://arxiv.org/abs/2609.01087)
...
### [62] [Reliable LLM-Generated Programs for High-Energy Physics Experiments through Graph-Grounded Software Knowledge](https://arxiv.org/abs/2609.01095)
...
### [63] [Hints Help But Do They Teach? Evaluating Skills Transfer in Code Generation](https://arxiv.org/abs/2609.01106)
*Will Badr*
...
### [64] [Athena: Vulnerability-Affected Library Identification via Knowledge Graph Completion](https://arxiv.org/abs/2609.01187)
...
### [65] [Continuous Autonomous Refactoring: A Research Roadmap for AI-Driven Code Quality Maintenance](https://arxiv.org/abs/2609.01236)
...
### [66] [What Does an Agentic Software Engineering Benchmark Measure? Profiling Task Demands and Agent Behaviour Beyond What Category Labels Reveal](https://arxiv.org/abs/2609.01271)
...
### [67] [HarnessDev: Can LLMs Create and Evolve Their Own Agent Harness?](https://arxiv.org/abs/2609.01437)
...
### [68] [The Data Problem in Software Vulnerability Analysis: Artifacts, Quality, and Consumption](https://arxiv.org/abs/2609.01503)
...
### [69] [Adaptive Critical Token-Aware Retrieval for Repository-Level Code Generation](https://arxiv.org/abs/2609.01601)
...
### [70] [Efficient SWE Agent Benchmarking via Trajectory-Aware Evaluation](https://arxiv.org/abs/2609.01603)
