...
### [1] [Risk-Sensitive Reward Composition for Conditional GFlowNets](https://arxiv.org/abs/2609.01929)
...
### [2] [A physics-enhanced bidirectional multi-order graph fusion network for interpretable bearing remaining useful life prediction](https://arxiv.org/abs/2609.02190)
...
### [3] [A meshfree solver for coupled bulk-surface problems with self-organizing surface geometry](https://arxiv.org/abs/2609.02489)
...
### [4] [RunSoC 2.0: Scheduling and Allocating Automotive Software Tasks to Hardware Partitions in Heterogeneous MPSoCs](https://arxiv.org/abs/2609.01614)
...
### [5] [An Emerging NVM-Based On-Chip Training Architecture with Non-Ideality Mitigation Through Bipolar Weight Distributions](https://arxiv.org/abs/2609.01948)
...
### [6] [Atlas: Algorithm-Hardware Co-Design for On-Device City-Scale 3D Gaussian Splatting in VR](https://arxiv.org/abs/2609.02352)
...
### [7] [Batch Before You Time: Decision-Scoped Proxy Execution for Timing-Aware Logic Rewriting](https://arxiv.org/abs/2609.02470)
*Pujun Su*
...
### [8] [Barriers to Using Static Application Security Testing (SAST) Tools: A Literature Review](https://arxiv.org/abs/2609.01669)
...
### [9] [RosettaBitcoin: An Artifact-Backed Experience Report on Verification Infrastructure for Agent-Assisted Consensus Validators](https://arxiv.org/abs/2609.01702)
*Donavon Guyot*
...
### [10] [Harness Engineering in LLM Tool Use via Agent-Native Reusable Tool Primitives](https://arxiv.org/abs/2609.01736)
...
### [11] [From Silicon to Boot Code: Extending Automated Program Repair to Firmware-Layer Security Workarounds](https://arxiv.org/abs/2609.01769)
...
### [12] [Modelstamp: Pre-Deserialization Verification of Machine-Learning Artifacts and Runtime Environment State](https://arxiv.org/abs/2609.01781)
*Anagha Dhekne*
...
### [13] [ExecRetrieval: Measuring the Functional-Correctness Gap in Code-Embedding Retrieval](https://arxiv.org/abs/2609.01865)
...
### [14] [From Prompting to Engineering: A Research Agenda for Prompt Engineering in Software Engineering](https://arxiv.org/abs/2609.02248)
...
### [15] [AgOSS: A Dataset and Multi-Layer Characterization of Open-Source Agricultural Software](https://arxiv.org/abs/2609.02591)
...
### [17] [The Import Tax: A Longitudinal Measurement of Startup Cost in the Python Ecosystem](https://arxiv.org/abs/2609.02753)
...
### [18] [Type Hints in Python Libraries and Frameworks: An Empirical Analysis of Adoption and Maintenance](https://arxiv.org/abs/2609.02782)
...
### [19] [ShikumiMiner: Mining Recurring Implementation Patterns in AI Codebases](https://arxiv.org/abs/2609.02789)
...
### [27] [SchedBlame: Who Ran While You Waited? Culprit-Attributed CPU Contention for Containers on Stock Kernels](https://arxiv.org/abs/2609.02052)
...
### [28] [Curriculum-Guided Reinforcement Learning for Energy-Efficient UAV-ISAC in Post-Disaster Search-and-Rescue Operations](https://arxiv.org/abs/2609.01764)
...
### [29] [Agents That Model Agents: Five Principles Toward a Theory of Mind for 6G Networks](https://arxiv.org/abs/2609.01779)
...
### [30] [Will there be a 7G?](https://arxiv.org/abs/2609.01877)
*Adnan Aijaz*
...
### [31] [Network-Aware Forecasting on Wireless Access Points](https://arxiv.org/abs/2609.01957)
...
### [32] [Bridging the Gap: A Longitudinal Analysis of Extended Identifiers in the Post-Cookie Era](https://arxiv.org/abs/2609.02069)
...
### [33] [SoK: Where Do Flow Labels Come From? Auditing Label Provenance in Encrypted Traffic Benchmarks](https://arxiv.org/abs/2609.02140)
...
### [34] [WiP: Characterizing and Defending Against Mobile-Agent-Driven MFA Automation](https://arxiv.org/abs/2609.02154)
...
### [35] [Connectivity of HAPS-Based Solutions for Large-Scale Wireless Networks: A Percolation Theory Analysis](https://arxiv.org/abs/2609.02536)
...
### [36] [Integrating Wi-Fi into 3GPP 5G Network Slicing: An Experimental Prototype Study](https://arxiv.org/abs/2609.02625)
...
### [37] [Microcell Hot Spot and Smart Antennas Evaluation in WCDMA Macrocell System](https://arxiv.org/abs/2609.02636)
...
### [38] [Zeta-Lite: A Concurrent, Branchable In-Browser SQL Database for Agentic Memory](https://arxiv.org/abs/2609.01818)
*Gene Zhang*
...
### [39] [Dual-Metric Partitioning with Adaptive Kernel Execution for Efficient GCN Acceleration](https://arxiv.org/abs/2609.01983)
...
### [40] [Git4Data: Database-Native Version Control for AI Agents](https://arxiv.org/abs/2609.02106)
...
### [41] [A Power Law in Logarithm's Clothing: On the Scalability of Graph-Based Vector Search](https://arxiv.org/abs/2609.02143)
...
### [42] [Poisoning Attacks on the PGM-index](https://arxiv.org/abs/2609.02328)
...
### [43] [Decoupling Disaggregated Memory Optimizations from Indexing: A Compiler-Runtime Approach](https://arxiv.org/abs/2609.02669)
