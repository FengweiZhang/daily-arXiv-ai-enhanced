...
### [3] [Resource Utilization of Differentiable Logic Gate Networks Deployed on FPGAs](https://arxiv.org/abs/2605.04109)
...
### [4] [täkōFormal: Enabling Robust Software for Programmable Memory Hierarchies (Extended Version)](https://arxiv.org/abs/2605.04172)
...
### [5] [The Anatomy of Silent Data Corruption: GPU Error Pattern Study and Modeling Guidance](https://arxiv.org/abs/2605.04213)
...
### [6] [RangeGuard: Efficient, Bounded Approximate Error Correction for Reliable DNNs](https://arxiv.org/abs/2605.04563)
...
### [7] [Ultra Low-Power SDM-based Circuit-Switching for Networks-on-Chip](https://arxiv.org/abs/2605.04679)
...
### [8] [UVMarvel: an Automated LLM-aided UVM Machine for Subsystem-level RTL Verification](https://arxiv.org/abs/2605.04704)
...
### [9] [Not All Faults Are Equal: Transient-Fault Sensitivity Characterization of an Open-Source RISC-V Vector Cluster](https://arxiv.org/abs/2605.04803)
...
### [10] [MCFlash: Bulk Bitwise Processing in 3D NAND with Dynamic Sensing and Multi-level Encoding](https://arxiv.org/abs/2605.05119)
...
### [11] [How Do Ice Shelves Calve? Peridynamic Modeling of Ice Shelf Fracture Driven by Wave Erosion, Basal Melting, and Buoyancy Flexure](https://arxiv.org/abs/2605.04365)
...
### [12] [A Hybrid Method for Low-Resource Named Entity Recognition](https://arxiv.org/abs/2605.04489)
...
### [13] [A Blockchain-as-a-Service Solution for TAFES-Compliant Verification of Fair Trade Certifications](https://arxiv.org/abs/2605.04600)
...
### [14] [Sequential topology optimization: SIMP initialization for level-set boundary refinement](https://arxiv.org/abs/2605.04735)
...
### [15] [From Classical to Quantum-Mechanical Data Assimilation: A Comparison between DATO and QMDA](https://arxiv.org/abs/2605.04881)
...
### [16] [OpenCLAW-Nexus: A Self-Reinforcing Trust Framework for Byzantine-Resilient Decentralized Federated Learning](https://arxiv.org/abs/2605.04091)
...
### [17] [Resilient AI Supercomputer Networking using MRC and SRv6](https://arxiv.org/abs/2605.04333)
...
### [18] [Worst-Case Discovery and Runtime Protection for RL-Based Network Controllers](https://arxiv.org/abs/2605.04373)
...
### [19] [Joint Optimization of Trajectory Control, Resource Allocation, and Task Offloading for Multi-UAV-Assisted IoV](https://arxiv.org/abs/2605.04436)
...
### [20] [Queue-Aware and Resilient Routing in LEO Satellite Networks Using Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2605.04448)
...
### [21] [Look Once, Beam Twice: Camera-Primed Real-Time Double-Directional mmWave Beam Management for Vehicular Connectivity](https://arxiv.org/abs/2605.05071)
...
### [22] [SADE: Symptom-Aware Diagnostic Escalation for LLM-Based Network Troubleshooting](https://arxiv.org/abs/2605.04530)
...
### [23] [A Separation Between Optimal Demand-Oblivious and Demand-Aware Network Throughput](https://arxiv.org/abs/2605.04699)
...
### [24] [Traffic Chunk Sizing vs. Optical Switching Speed in Future All-Optical Satellite Networks](https://arxiv.org/abs/2605.04829)
...
### [25] [SILC: Lookahead Caching for Short-form Video Delivery Systems](https://arxiv.org/abs/2605.05188)
...
### [26] [ipc_shared_ptr: A Publish/Subscribe-Aware Smart Pointer for Cross-Process Object Lifetime Management](https://arxiv.org/abs/2605.04226)
...
### [27] [Semantic Reverse Engineering Legacy Software Applications with ChatGPT, Gemini AI, and Claude AI](https://arxiv.org/abs/2605.04114)
...
### [28] [Shedding Light onto Safety Integrity Level and Basic Software Constraints in a Real-World Automotive Application: Case Study with Driverator Framework](https://arxiv.org/abs/2605.04837)
...
### [29] [Two Integration Pathways in Human-Centered Requirements Engineering: A Systematic Mapping Study of Structural Gaps](https://arxiv.org/abs/2605.04132)
...
### [30] [A Multi-Agent Consensus Protocol for Stable Software Remodularization](https://arxiv.org/abs/2605.04188)
*Ahmed F. Ibrahim*
...
### [31] [EngThrive: Make It Fast and Easy to Do Great Work](https://arxiv.org/abs/2605.04259)
...
### [32] [Reproduction Test Generation for Java SWE Issues](https://arxiv.org/abs/2605.04320)
...
### [33] [Towards Robust LLM Post-Training: Automatic Failure Management for Reinforcement Fine-Tuning](https://arxiv.org/abs/2605.04431)
...
### [34] [Accountable Agents in Software Engineering: An Analysis of Terms of Service and a Research Roadmap](https://arxiv.org/abs/2605.04532)
*Christoph Treude*
...
### [35] [Beyond Retrieval: A Multitask Benchmark and Model for Code Search](https://arxiv.org/abs/2605.04615)
...
### [36] [CodeEvolve: LLM-Driven Evolutionary Optimization with Runtime-Enriched Target Selection for Multi-Language Code Enhancement](https://arxiv.org/abs/2605.04677)
...
### [37] [How Does Chunking Affect Retrieval-Augmented Code Completion? A Controlled Empirical Study](https://arxiv.org/abs/2605.04763)
...
### [38] [A meta-analysis of the effect of generative AI on productivity and learning in programming](https://arxiv.org/abs/2605.04779)
...
### [39] [Toward an Understanding of Developer Behaviour while Using Bug Localization Tools](https://arxiv.org/abs/2605.04828)
...
### [40] [Patterns of Developer Adoption of LLM-Generated Code Refactoring Suggestions](https://arxiv.org/abs/2605.04835)
...
### [41] [Agentic Repository Mining: A Multi-Task Evaluation](https://arxiv.org/abs/2605.04845)
*Johannes Härtel*
...
### [42] [SynConfRoute: Syntax-Aware Routing for Efficient Code Completion with Small CodeLLMs](https://arxiv.org/abs/2605.04894)
...
### [43] [Conflict Essences for Transformation Rules with Nested Application Conditions -- Long Version](https://arxiv.org/abs/2605.04947)
...
### [44] [Architectural Constraints Alignment in AI-assisted, Platform-based Service Development](https://arxiv.org/abs/2605.04973)
...
### [45] [Constraint-Aware Execution Planning for Hybrid Space-Ground Compute Workloads](https://arxiv.org/abs/2605.04052)
*Subhadip Mitra*
...
### [46] [Microbenchmark-Driven Analytical Performance Modeling Across Modern GPU Architectures](https://arxiv.org/abs/2605.04178)
...
### [47] [phys-MCP: A Control Plane for Heterogeneous Physical Neural Networks](https://arxiv.org/abs/2605.04256)
...
### [48] [ClusterLess: Deadline-Aware Serverless Workflow Orchestration on Federated Edge Clusters](https://arxiv.org/abs/2605.04310)
...
### [49] [Orchestrating Serverless Applications in the Edge Cloud Space Continuum: What Breaks and What is Next?](https://arxiv.org/abs/2605.04316)
...
### [50] [Coral: Cost-Efficient Multi-LLM Serving over Heterogeneous Cloud GPUs](https://arxiv.org/abs/2605.04357)
...
### [51] [One Pool, Two Caches: Adaptive HBM Partitioning for Accelerating Generative Recommender Serving](https://arxiv.org/abs/2605.04450)
...
### [52] [CCL-D: A High-Precision Diagnostic System for Slow and Hang Anomalies in Large-Scale Model Training](https://arxiv.org/abs/2605.04478)
...
### [53] [Delay-Aware Large-Small Model Collaboration over LEO Satellite Networks](https://arxiv.org/abs/2605.04565)
...
### [54] [Communication Offloading on SmartNIC DPUs: A Quantitative Approach](https://arxiv.org/abs/2605.04842)
...
### [55] [Piper: Efficient Large-Scale MoE Training via Resource Modeling and Pipelined Hybrid Parallelism](https://arxiv.org/abs/2605.05049)
...
### [56] [Toward a Risk Assessment Framework for Institutional DeFi: A Nine-Dimension Approach](https://arxiv.org/abs/2605.05145)
