...
### [1] [Bayesian Posterior Sampling for Synthetic Shape Generation of Heart Valves](https://arxiv.org/abs/2607.28914)
...
### [2] [Mechanical Modeling of Braided Neurovascular Flow Diverters using a Beam-to-Beam and Beam-to-Surface Contact Formulation](https://arxiv.org/abs/2607.29446)
...
### [3] [DeltaServe: Host-Agnostic Co-Serving of Inference and Fine-Tuning for LLMs](https://arxiv.org/abs/2607.28848)
...
### [4] [LayoutBench: Performance Benchmarking of Cloud Storage Layouts for Multimedia Data](https://arxiv.org/abs/2607.28880)
...
### [5] [Rethinking AI Cloud Infrastructure for Agentic Serving Systems with the Aries Experimentation Framework](https://arxiv.org/abs/2607.29069)
...
### [6] [Knox: Fortifying Smart Spaces With Safety Guarantees](https://arxiv.org/abs/2607.29198)
...
### [7] [Allocation Tracking and Parameter Checking for Parallel Programming Models using Contracts](https://arxiv.org/abs/2607.29303)
...
### [8] [CARA: Exact Local Repair with Fresh One-Action Certification for Cloud Consolidation](https://arxiv.org/abs/2607.29465)
...
### [9] [System-Wide Termination in Distributed Betweenness Centrality Computation](https://arxiv.org/abs/2607.29474)
...
### [10] [SLIM: Saturation-Aware Lightweight Performance Modeling for LLM Serving](https://arxiv.org/abs/2607.29575)
...
### [11] [Sovereign Cognitive Digital Twins: Fusing 6G ISAC, AI-RAN, and Zero-Trust Edge Grids for National Resilience in the Global South](https://arxiv.org/abs/2607.28756)
...
### [12] [When Unlearning Fails: Reliable Data Deletion under Post-Training in Agent Networks](https://arxiv.org/abs/2607.28829)
...
### [13] [Point2Radio: A Foundation Model for Cross-Scene Radio Fields from Material-Aware Point Clouds](https://arxiv.org/abs/2607.28994)
...
### [14] [Mind the Gap: Policy vs Reality in Post-Quantum TLS Deployment](https://arxiv.org/abs/2607.29005)
...
### [15] [METIS: A Declarative Slice Orchestrator for Application-Centric 5G/6G Networks](https://arxiv.org/abs/2607.29282)
...
### [16] [RIGEL: Real-time Optical Anomaly Diagnosis with Stateful In-Network Inference based on Distributed On-switch GNNs](https://arxiv.org/abs/2607.29306)
...
### [17] [Query Density-Driven Partitioning for Spatiotemporal Load Balancing on Processing-in-Memory Systems](https://arxiv.org/abs/2607.29070)
...
### [18] [MERIT: Efficient In-Place Deletion for Dynamic Graph-Based Approximate Nearest Neighbor Indexes](https://arxiv.org/abs/2607.29173)
...
### [19] [From C to Idiomatic Rust: A Ship-of-Theseus Agentic Translation](https://arxiv.org/abs/2607.28835)
*Vasily A. Sartakov*
...
### [27] [Validation Evidence in LLM Repair Agents: How Much of What Passes Actually Tests the Bug?](https://arxiv.org/abs/2607.28871)
...
### [28] [To Add Is Machine, To Delete Is Human: Measuring and Mitigating Deletion Avoidance in LLM Code Editing](https://arxiv.org/abs/2607.28887)
...
### [29] [Reducing Data Movement in the Galerkin Product of Block Algebraic Multigrid on GPUs](https://arxiv.org/abs/2607.28891)
*Mark F. Adams*
...
### [30] [Automated Testing and Repair for Verified Compilers Generated by a Coding Agent](https://arxiv.org/abs/2607.28928)
*Martin Rinard*
...
### [31] [A Formalism-Aware Reward Loop for Handwritten UML-to-PlantUML Generation](https://arxiv.org/abs/2607.28987)
...
### [32] [Execution-First Synthetic Tool-Use Trace Generation for LLM Agents](https://arxiv.org/abs/2607.29175)
...
### [33] [Quick Build, Careful Check? Generative AI Use in Hackathons](https://arxiv.org/abs/2607.29178)
...
### [34] [Metamorphic Testing of Transpilers via Mutation Consistency of Programs](https://arxiv.org/abs/2607.29247)
...
### [35] [BRHC: Backend-driven Reactive Hypermedia Controls with a Statically Typed Kotlin DSL](https://arxiv.org/abs/2607.29338)
...
### [36] [AgenticRepair: Multi-Faceted Program Context Engineering for Agentic Vulnerability Repair](https://arxiv.org/abs/2607.29422)
...
### [37] [From Code Review to Code Critique: Intent, Drift, and Spotlight for AI-Generated Diffs at Scale](https://arxiv.org/abs/2607.29516)
...
### [38] [Students' Practices and Skills in the LLM-Era: "You Can't Outsource the Struggle and Still Get the Skill"](https://arxiv.org/abs/2607.29519)
...
### [39] [AuditCoder: Responsibility-Preserving Task Graphs for Auditable Code Generation and Bounded Repair](https://arxiv.org/abs/2607.29529)
...
### [40] [Improving the Understandability of Conceptual Models via Abstract Notation Engineering](https://arxiv.org/abs/2607.29552)
...
### [41] [Alteron: A Tool for Behavioral Regression Testing Across NLP Classifier Versions](https://arxiv.org/abs/2607.29557)
...
### [42] [Educating the Agentic Engineer: Curricula, Collaboration, and Continuous Learning in the AI Era](https://arxiv.org/abs/2607.29610)
*Mamdouh Alenezi*
...
### [43] [Reusing Past Repairs Through Hierarchical Trajectory Abstraction for Coding Agents](https://arxiv.org/abs/2607.29658)
...
### [44] [Optical Flow Sensor: A Direction-Selective Bionic Retina Design](https://arxiv.org/abs/2607.28686)
...
### [45] [WitCert: Sound Runtime Risk Observability and Gating for KV-Cache Quantization](https://arxiv.org/abs/2607.28699)
*Fanzhe Wei,Li Liu*
...
### [46] [Characterizing LLM Kernel Access and Memory Interaction in Multi-Partition NUMA GPUs](https://arxiv.org/abs/2607.28824)
...
### [47] [Open-Source LLM-Driven Formal Verification: A Multi-Agent Pipeline for RTL Repair](https://arxiv.org/abs/2607.28877)
*Ha Trung Tran*
...
### [48] [Selective KV Cache Protection for Noise-Resilient LLM Inference on Analog Compute-In-Memory Systems](https://arxiv.org/abs/2607.29076)
...
### [49] [RTLCurator: Label-Efficient Data Curation for RTL Generation](https://arxiv.org/abs/2607.29283)
...
### [50] [Low-Power PLL-Based Clock Stabilization for Flexible IGZO AMS Systems](https://arxiv.org/abs/2607.29357)
