...
### [17] [Spec2Vision: Contract-Guided Delivery of AI-Generated Computer Vision Pipelines](https://arxiv.org/abs/2608.26400)
...
### [18] [STILL: Recovering Lowered STL Semantics for LLM-assisted C++ Decompilation](https://arxiv.org/abs/2608.26408)
...
### [19] [DeepRepro: State-Aware Subplanning for Paper-to-Code Reproduction in Evolving Repositories](https://arxiv.org/abs/2608.26557)
...
### [20] [The Thousand-Graph Hypothesis: A Testable Hypothesis of Task-Conditioned Relation Materialization in Repository-Level Code Reasoning](https://arxiv.org/abs/2608.26602)
*Fei Ding*
...
### [21] [Processing/p5 Defined through Practice and Learning](https://arxiv.org/abs/2608.26614)
...
### [22] [FaultLens: Learning Compact Behavioral Test Suites for Generated Operational Programs](https://arxiv.org/abs/2608.26746)
...
### [23] [Beyond Execution: Auditing Experimental Fidelity in LLM-Driven Scientific Research](https://arxiv.org/abs/2608.26753)
...
### [24] [An Empirical Evaluation of Using Large Language Models for Automated Model-Based Test Generation](https://arxiv.org/abs/2608.27094)
...
### [25] [Mutation Testing for Reproducibility Safeguards in Machine Learning Research Software: An Empirical Study](https://arxiv.org/abs/2608.27100)
*Ilya Shulepov*
...
### [26] [AROMA+: A Study of Factors Affecting Reproducible Builds in the Maven Ecosystem](https://arxiv.org/abs/2608.27125)
...
### [27] [AgentDV: Closed-Loop Agentic AI for Hardware Design Verification](https://arxiv.org/abs/2608.27148)
...
### [28] [A Trans-Domain Digital Twin for Bio-Aware Control of Climate and Energy in Cattle Fattening Barns Using Single-Episode Optimizer Learning](https://arxiv.org/abs/2608.27185)
*Mansoorali Amiri*
...
### [29] [Twelve Quick Tips for Managing IT Disasters in Small Research Software Teams](https://arxiv.org/abs/2608.27196)
*Greg Wilson*
...
### [30] [Persona-Execution Separation: An Architecture Pattern for Evolving LLM Agents under Execution Audit](https://arxiv.org/abs/2608.27427)
*Yisen Xi*
...
### [31] [From Static to Dynamic: Benchmarking Real-World Code Review with MCR-Bench](https://arxiv.org/abs/2608.27442)
...
### [32] [SWE-Prime: Fewer Trajectories, Better Performance](https://arxiv.org/abs/2608.27449)
...
### [33] [Report of the 2026 Workshop on Next-Generation Ecosystems for Scientific Computing: Harnessing Community, Software, and AI for Cross-Disciplinary Team Science](https://arxiv.org/abs/2608.26519)
...
### [34] [Exploring the Role of LLMs in HPC Programming: A Survey](https://arxiv.org/abs/2608.26110)
...
### [35] [Multi-Dataset Inverse Problem Solving with Distributed Generative AI](https://arxiv.org/abs/2608.26283)
...
### [36] [VPP: Virtual Pipeline Parallelism for Efficient Chunked Prefill in Long-Context LLM Inference](https://arxiv.org/abs/2608.26523)
...
### [37] [Optimizing API Gateway Placement in Multi-Cloud Kubernetes](https://arxiv.org/abs/2608.26573)
...
### [38] [Benchmarking Confidential Computing Performance on NVIDIA Blackwell GPUs](https://arxiv.org/abs/2608.26575)
...
### [39] [Sintr: Safe Interactive Transactions in the Presence of Byzantine Clients](https://arxiv.org/abs/2608.27091)
...
### [40] [Decoupled I/O-Dominant Pipelines for Large-Scale Whole-Slide Image Embedding Extraction](https://arxiv.org/abs/2608.27278)
...
### [41] [Consensus with Stochastic Broadcast](https://arxiv.org/abs/2608.27336)
...
### [42] [Ankhdjet: An Open-Source Compiler for Mask-Programmed Ternary Compute-in-ROM on an Open PDK](https://arxiv.org/abs/2608.26206)
*Mohnish Pai*
...
### [43] [MeshReduce-U: Compiler-Guided Communication Reduction for Irregular Neural Reductions on Mesh NoCs](https://arxiv.org/abs/2608.26220)
...
### [44] [Beyond Edge Cuts: Activity-Weighted Multicast Hypergraph Mapping for Spiking Neural Networks on Mesh NoCs](https://arxiv.org/abs/2608.26223)
*Amirreza Khorasanian*
...
### [45] [Redwood: A Frontier AI Accelerator Designed, Verified, and Deployed from Scratch in 2 Weeks by AI](https://arxiv.org/abs/2608.26418)
*Architect Labs*
...
### [46] [HOLMES: In-Context Failure-Center Localization for High-Dimensional Yield Estimation](https://arxiv.org/abs/2608.26758)
...
### [47] [LLMs in Digital EDA: A perspective on shifting roles from Generation to Orchestration](https://arxiv.org/abs/2608.27184)
...
### [48] [From SQL to Knowledge Graphs: An LLM-Driven Multi-Agent Approach with Data Schema Improvement](https://arxiv.org/abs/2608.26117)
...
### [49] [DRL: A Deterministic Relational Middleware Layer for Transaction-Safe Enterprise NL2SQL Under Schema-Graph Scaling](https://arxiv.org/abs/2608.26172)
...
### [50] [Realistic Counterfactual Explanations via Denial Constraints](https://arxiv.org/abs/2608.26335)
...
### [51] [VoS: Variate Ordering Strategies for Skyline Query Optimization](https://arxiv.org/abs/2608.26464)
...
### [52] [IBLTs Measure Before They Decode: Self-Sizing Set Reconciliation from Pre-Peeling Counts](https://arxiv.org/abs/2608.26537)
...
### [53] [Size Bounds for CQs Under Acyclic Constraints](https://arxiv.org/abs/2608.26775)
...
### [54] [Incremental Delta-Shapley: A Standalone Runtime for Predicate Attribution on Sliding Windows](https://arxiv.org/abs/2608.26930)
...
### [55] [Compositional Online Learning for Semantic Data Processing Systems](https://arxiv.org/abs/2608.27244)
