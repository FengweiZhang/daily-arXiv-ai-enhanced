...
### [4] [OptBench: An Interactive Workbench for AI/ML-SQL Co-Optimization[Extended Demonstration Proposal]](https://arxiv.org/abs/2603.08880)
...
### [5] [Evaluating the Practical Effectiveness of LLM-Driven Index Tuning with Microsoft Database Tuning Advisor](https://arxiv.org/abs/2603.09181)
...
### [6] [The Virtuous Cycle: AI-Powered Vector Search and Vector Search-Augmented AI](https://arxiv.org/abs/2603.09347)
...
### [7] [GeoBenchr: An Application-Centric Benchmarking Suite for Spatiotemporal Database Platforms](https://arxiv.org/abs/2603.09398)
...
### [8] [No Cliques Allowed: The Next Step Towards BDD/FC Conjecture](https://arxiv.org/abs/2603.09558)
...
### [9] [Local Stability of Rankings](https://arxiv.org/abs/2603.09724)
...
### [10] [Epistemic Closure: Autonomous Mechanism Completion for Physically Consistent Simulation](https://arxiv.org/abs/2603.09756)
...
### [11] [Expressive Power of Property Graph Constraint Languages](https://arxiv.org/abs/2603.09806)
...
### [12] [How to Write to SSDs](https://arxiv.org/abs/2603.09927)
...
### [13] [On the Multi-Commodity Flow with convex objective function: Column-Generation approaches](https://arxiv.org/abs/2603.08714)
...
### [14] [Mobile Base Station Optimal Tour in Wide Area IoT Sensor Networks](https://arxiv.org/abs/2603.08828)
*Sachin Kadam*
...
### [15] [Why Channel-Centric Models are not Enough to Predict End-to-End Performance in Private 5G: A Measurement Campaign and Case Study](https://arxiv.org/abs/2603.08865)
*Nils Jörgensen*
...
### [16] [Optimizing Reinforcement Learning Training over Digital Twin Enabled Multi-fidelity Networks](https://arxiv.org/abs/2603.08931)
...
### [17] [The 802.11 MAC protocol leads to inefficient equilibria](https://arxiv.org/abs/2603.09902)
...
### [18] [Role Classification of Hosts within Enterprise Networks Based on Connection Patterns](https://arxiv.org/abs/2603.09910)
...
### [19] [A Hybrid Residue Floating Numerical Architecture with Formal Error Bounds for High Throughput FPGA Computation](https://arxiv.org/abs/2603.08712)
*Mostafa Darvishi*
...
### [20] [Unveiling the Potential of Quantization with MXFP4: Strategies for Quantization Error Reduction](https://arxiv.org/abs/2603.08713)
...
### [21] [VeriInteresting: An Empirical Study of Model Prompt Interactions in Verilog Code Generation](https://arxiv.org/abs/2603.08715)
...
### [22] [Design Conductor: An agent autonomously builds a 1.5 GHz Linux-capable RISC-V CPU](https://arxiv.org/abs/2603.08716)
...
### [23] [CktEvo: Repository-Level RTL Code Benchmark for Design Evolution](https://arxiv.org/abs/2603.08718)
...
### [24] [SiliconMind-V1: Multi-Agent Distillation and Debug-Reasoning Workflows for Verilog Code Generation](https://arxiv.org/abs/2603.08719)
...
### [25] [AnalogToBi: Device-Level Analog Circuit Topology Generation via Bipartite Graph and Grammar Guided Decoding](https://arxiv.org/abs/2603.08720)
...
### [26] [KernelCraft: Benchmarking for Agentic Close-to-Metal Kernel Generation on Emerging Hardware](https://arxiv.org/abs/2603.08721)
...
### [27] [ALADIN: Accuracy-Latency-Aware Design-space Inference Analysis for Embedded AI Accelerators](https://arxiv.org/abs/2603.08722)
...
### [28] [PhD Thesis Summary: Methods for Reliability Assessment and Enhancement of Deep Neural Network Hardware Accelerators](https://arxiv.org/abs/2603.08724)
*Mahdi Taheri*
...
### [29] [Performance Analysis of Edge and In-Sensor AI Processors: A Comparative Review](https://arxiv.org/abs/2603.08725)
...
### [30] [Data-Rate-Aware High-Speed CNN Inference on FPGAs](https://arxiv.org/abs/2603.08726)
...
### [31] [Fair and Square: Replacing One Real Multiplication with a Single Square and One Complex Multiplication with Three Squares When Performing Matrix Multiplication and Convolutions](https://arxiv.org/abs/2603.08732)
*Vincenzo Liguori*
...
### [32] [Sensitivity-Guided Framework for Pruned and Quantized Reservoir Computing Accelerators](https://arxiv.org/abs/2603.08737)
...
### [33] [Measurement-Free Ancilla Recycling via Blind Reset: A Cross-Platform Study on Superconducting and Trapped-Ion Processors](https://arxiv.org/abs/2603.08733)
*Sangkeum Lee*
...
### [34] [Adaptive Multi-Objective Tiered Storage Configuration for KV Cache in LLM Service](https://arxiv.org/abs/2603.08739)
...
### [35] [FormalRTL: Verified RTL Synthesis at Scale](https://arxiv.org/abs/2603.08738)
...
### [36] [Architectural Design and Performance Analysis of FPGA based AI Accelerators: A Comprehensive Review](https://arxiv.org/abs/2603.08740)
...
### [37] [The AetherFloat Family: Block-Scale-Free Quad-Radix Floating-Point Architectures for AI Accelerators](https://arxiv.org/abs/2603.08741)
*Keita Morisaki*
...
### [38] [ChatNeuroSim: An LLM Agent Framework for Automated Compute-in-Memory Accelerator Deployment and Optimization](https://arxiv.org/abs/2603.08745)
...
### [39] [Diagnosing FP4 inference: a layer-wise and block-wise sensitivity analysis of NVFP4 and MXFP4](https://arxiv.org/abs/2603.08747)
...
### [40] [TrainDeeploy: Hardware-Accelerated Parameter-Efficient Fine-Tuning of Small Transformer Models at the Extreme Edge](https://arxiv.org/abs/2603.09511)
...
### [41] [Nemo: A Low-Write-Amplification Cache for Tiny Objects on Log-Structured Flash Devices](https://arxiv.org/abs/2603.09605)
...
### [42] [The Missing Memory Hierarchy: Demand Paging for LLM Context Windows](https://arxiv.org/abs/2603.09023)
*Tony Mason*
...
### [43] [Ensuring Data Freshness in Multi-Rate Task Chains Scheduling](https://arxiv.org/abs/2603.09738)
...
### [44] [Test-Driven AI Agent Definition (TDAD): Compiling Tool-Using Agents from Behavioral Specifications](https://arxiv.org/abs/2603.08806)
*Tzafrir Rehan*
...
### [45] [GenAI Is No Silver Bullet for Qualitative Research in Software Engineering](https://arxiv.org/abs/2603.08951)
...
### [48] [ToolRosetta: Bridging Open-Source Repositories and Large Language Model Agents through Automated Tool Standardization](https://arxiv.org/abs/2603.09290)
...
### [49] [Automating Detection and Root-Cause Analysis of Flaky Tests in Quantum Software](https://arxiv.org/abs/2603.09029)
...
### [50] [The Future of Software Engineering Conferences: A New Zealand Perspective](https://arxiv.org/abs/2603.09035)
...
### [51] [Class Model Generation from Requirements using Large Language Models](https://arxiv.org/abs/2603.09100)
...
### [52] [Can ChatGPT Generate Realistic Synthetic System Requirement Specifications? Results of a Case Study](https://arxiv.org/abs/2603.09335)
...
### [53] [Declarative Scenario-based Testing with RoadLogic](https://arxiv.org/abs/2603.09455)
...
### [54] [Experience Report on the Adaptable Integration of Requirements Engineering Courses into Curricula for Professionals](https://arxiv.org/abs/2603.09467)
...
### [55] [Towards Viewpoint-centric Artifact-based Regulatory Requirements Engineering for Compliance by Design](https://arxiv.org/abs/2603.09492)
*Oleksandr Kosenkov*
...
### [56] [EmbC-Test: How to Speed Up Embedded Software Testing Using LLMs and RAG](https://arxiv.org/abs/2603.09497)
...
### [57] [Preparing Students for AI-Driven Agile Development: A Project-Based AI Engineering Curriculum](https://arxiv.org/abs/2603.09599)
...
### [58] [An Empirical Study of Interaction Smells in Multi-Turn Human-LLM Collaborative Code Generation](https://arxiv.org/abs/2603.09701)
...
### [59] [RSH-SpMM: A Row-Structured Hybrid Kernel for Sparse Matrix-Matrix Multiplication on GPUs](https://arxiv.org/abs/2603.08734)
...
### [60] [Benchmarking Federated Learning in Edge Computing Environments: A Systematic Review and Performance Evaluation](https://arxiv.org/abs/2603.08735)
...
### [61] [Autonomous Edge-Deployed AI Agents for Electric Vehicle Charging Infrastructure Management](https://arxiv.org/abs/2603.08736)
*Mohammed Cherifi*
...
### [62] [Zipage: Maintain High Request Concurrency for LLM Reasoning through Compressed PagedAttention](https://arxiv.org/abs/2603.08743)
...
### [63] [Extension of ACETONE C code generator for multi-core architectures](https://arxiv.org/abs/2603.08744)
...
### [64] [Serving Compound Inference Systems on Datacenter GPUs](https://arxiv.org/abs/2603.08797)
...
### [65] [DeZent: Decentralized z-Anonymity with Privacy-Preserving Coordination](https://arxiv.org/abs/2603.08854)
...
### [66] [FedLECC: Cluster- and Loss-Guided Client Selection for Federated Learning under Non-IID Data](https://arxiv.org/abs/2603.08911)
...
### [67] [Accelerating High-Order Finite Element Simulations at Extreme Scale with FP64 Tensor Cores](https://arxiv.org/abs/2603.09038)
...
### [68] [Nezha: A Key-Value Separated Distributed Store with Optimized Raft Integration](https://arxiv.org/abs/2603.09122)
...
### [69] [Hierarchical Observe-Orient-Decide-Act Enabled UAV Swarms in Uncertain Environments: Frameworks, Potentials, and Challenges](https://arxiv.org/abs/2603.09191)
...
### [70] [PIM-SHERPA: Software Method for On-device LLM Inference by Resolving PIM Memory Attribute and Layout Inconsistencies](https://arxiv.org/abs/2603.09216)
...
### [71] [Flash-KMeans: Fast and Memory-Efficient Exact K-Means](https://arxiv.org/abs/2603.09229)
...
### [72] [Case Study: Performance Analysis of a Virtualized XRootD Frontend in Large-Scale WAN Transfers](https://arxiv.org/abs/2603.09568)
...
### [73] [Multi-DNN Inference of Sparse Models on Edge SoCs](https://arxiv.org/abs/2603.09642)
...
### [74] [Configurable Runtime Orchestration for Dynamic Data Retrieval in Distributed Systems](https://arxiv.org/abs/2603.06980)
*Abhiram Kandiraju*
