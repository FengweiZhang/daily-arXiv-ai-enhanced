...
### [12] [HySpecPro: Scalable Hypergraph Partitioning via Spectral Projection Optimization](https://arxiv.org/abs/2607.00055)
...
### [14] [Query-Centric Optimization of AI Workflows via Approximate Query Processing and Proxy Models](https://arxiv.org/abs/2607.00254)
...
### [15] [When Classic Cache Policies Fail: Learning-Augmented Replacement for Semantic Retrieval Buffers](https://arxiv.org/abs/2607.00394)
...
### [16] [TVA: A Version-aware Temporal Graph Storage System for Real-time Analytics](https://arxiv.org/abs/2607.00406)
...
### [17] [Approximate Nearest Neighbor Search with Graph Range Filters](https://arxiv.org/abs/2607.00727)
...
### [18] [When to Repair a Graph ANN Index: Navigability-Signal-Triggered Local Repair Protects Tail Recall Under Bursty Churn](https://arxiv.org/abs/2607.00728)
...
### [19] [SessionBound: Turning Enterprise Task Approval into Budgeted Database Sessions](https://arxiv.org/abs/2607.00751)
*Minmin Wu*
...
### [20] [RACORN-1: Adaptive Recall-Preserving Speedup for Low-Selectivity Filtered Vector Search](https://arxiv.org/abs/2607.00768)
...
### [21] [Exploring the Semantic Gap in Agentic Data Systems: A Formative Study of Operationalization Failures in Analytical Workflows](https://arxiv.org/abs/2607.00828)
...
### [22] [Generative Retrieval for Table Union Search](https://arxiv.org/abs/2607.00833)
...
### [23] [From Single to Multiple Attributes: Experimental Insights on Sampling-Based Distinct Combination Estimation in GROUP-BY Queries](https://arxiv.org/abs/2607.00868)
...
### [24] [The Decode-Work Law: Margin-Governed, Provably-Exact Spatial Joins over Compressed Geometry](https://arxiv.org/abs/2607.01182)
*Madhulatha Mandarapu,Sandeep Kunkunuru*
...
### [25] [Generalized Normal Constraint (GNC): A Complete Geometric Generalization of the NNC Method](https://arxiv.org/abs/2607.00405)
...
### [26] [Explainable quantum neural networks for multi-material topology optimization](https://arxiv.org/abs/2607.00438)
...
### [27] [A Multi-Resolution Finite-Volume Inspired Deep Learning Framework for Spatiotemporal Dynamics Prediction](https://arxiv.org/abs/2607.00460)
...
### [28] [Stacked Ensemble Learning for Abdominal Aortic Aneurysm Segmentation in CT Angiography](https://arxiv.org/abs/2607.00633)
...
### [29] [An SOA-Based Big Data Management Framework for Primary Healthcare Centers in Bahrain](https://arxiv.org/abs/2607.00021)
...
### [30] [Stop Hand-Holding Your Coding Agent: Engineering the Loops that Replace Step-by-Step Prompting](https://arxiv.org/abs/2607.00038)
*Sandeco Macedo*
...
### [31] [Evaluating Hardware Abstraction Layer Concepts for Software Defined Vehicles: Insights into Applicability and Effectiveness](https://arxiv.org/abs/2607.00039)
...
### [32] [ATM: CID-Brokered Pre-Write Admission for Multi-Agent Code Co-Synthesis](https://arxiv.org/abs/2607.00041)
*Eagl Huang*
...
### [33] [A Taxonomy of Single-Turn Textual Prompt Patterns](https://arxiv.org/abs/2607.00043)
...
### [34] [Comparing Large Language Models on Scrum Certification-Style Questions: Accuracy, Stability, and Error Patterns](https://arxiv.org/abs/2607.00048)
...
### [35] [Stochastic Connectivity as the Foundation of a Runtime Model for Microservice Availability Analysis](https://arxiv.org/abs/2607.00740)
...
### [36] [Prompting GPT-5 on Scrum Certification Questions: An Empirical Accuracy Study](https://arxiv.org/abs/2607.00049)
...
### [37] [SWE-Router: Routing in Multi-turn Agentic Software Engineering Tasks](https://arxiv.org/abs/2607.00053)
...
### [38] [A Quantitative Framework for Estimating System Complexity and Cost via Component Interface Analysis](https://arxiv.org/abs/2607.00054)
*Ken Y. Chan*
...
### [39] [AlgoBench: Benchmarking Algorithmic Adaptation in Code Generation](https://arxiv.org/abs/2607.00062)
...
### [40] [The Illusion of Safety: Multi-Tier Verification of AI vs. Human C++ Code](https://arxiv.org/abs/2607.00107)
...
### [41] [Registry-Governed Agent Lifecycle:Completing EDDOps with Evaluation-DrivenRegistration, Promotion, and Retirement on AWS AgentCore](https://arxiv.org/abs/2607.00345)
...
### [42] [BT-APE: A Computationally Light Backtracking Approach to Automatic Prompt Engineering for Requirements Classification](https://arxiv.org/abs/2607.00427)
...
### [43] [Social Popularity of GitHub Projects: A Lifeline or a Liability?](https://arxiv.org/abs/2607.00435)
...
### [44] [Large Language Models for Multi-Lingual Equivalent Mutant Detection: An Extended Empirical Study](https://arxiv.org/abs/2607.00511)
...
### [45] [Auditing Empirical Comparisons in Quantum Software](https://arxiv.org/abs/2607.00516)
...
### [46] [Rise From The Ashes: LLM-based Static Analysis for Deep Learning Framework Bugs](https://arxiv.org/abs/2607.00555)
...
### [47] [A Methodology for Investigating AI Patterns Prevalence in Software Repositories](https://arxiv.org/abs/2607.00558)
...
### [48] [Towards Better Linux Kernel Fault Localization: Leveraging Contrastive Reasoning and Hierarchical Context Analysis](https://arxiv.org/abs/2607.00562)
...
### [49] [SchedCheck: Schedule-Robustness Analysis for Event-Driven Block Programs](https://arxiv.org/abs/2607.00623)
*Yuan Si,Jialu Zhang*
...
### [50] [The Perception and Impact of Non-inclusive Language in Software Artifacts](https://arxiv.org/abs/2607.00626)
...
### [51] [Checked Program Recovery from Execution Video: A Sound Oracle for Untrusted Generators](https://arxiv.org/abs/2607.00635)
*Yuan Si,Jialu Zhang*
...
### [52] [LLVM-Bench: Benchmarking and Advancing Large Language Models for LLVM Compiler Issue Resolution](https://arxiv.org/abs/2607.00700)
...
### [53] [ClarifyCodeBench: Evaluating LLMs on Clarifying Ambiguous Requirements for Code Generation](https://arxiv.org/abs/2607.00711)
...
### [54] [Knowledge-Enhanced Agentic Vulnerability Repair](https://arxiv.org/abs/2607.00820)
...
### [55] [Petrify: Petri-net Based Analysis of Concurrency Properties in Java Bytecode](https://arxiv.org/abs/2607.00830)
...
### [56] [From Registry to Repository: How AI Agent Skills Are Written, Adapted, and Maintained](https://arxiv.org/abs/2607.00911)
...
### [57] [Delta Debugging in the Absence of Test Oracles Through Metamorphic Testing](https://arxiv.org/abs/2607.00929)
...
### [58] [Leveraging LLM-Based Agentic Systems to Generate Quantum Applications for Test Optimization](https://arxiv.org/abs/2607.00939)
...
### [59] [SWE-Doctor: Guiding Software Engineering Agents with Runtime Diagnosis from Multi-Faceted Bug Reproduction Tests](https://arxiv.org/abs/2607.00990)
...
### [60] [Identifying Effective Program Comprehension Strategies through Gaze Transitions over Syntactic Elements](https://arxiv.org/abs/2607.01042)
...
### [61] [AutoRestTest at the SBFT 2026 Tool Competition](https://arxiv.org/abs/2607.01063)
...
### [62] [Cheap Code, Costly Judgment: A Case Study on Governable Agentic Software Engineering](https://arxiv.org/abs/2607.01087)
...
### [63] [A Model-based Testing Technique for Amazon Lex Task-based Chatbots](https://arxiv.org/abs/2607.01094)
...
### [64] [SAGE: Structured Agentic Graph Editing for Software Diagrams](https://arxiv.org/abs/2607.01102)
...
### [65] [Skills Are Not Islands: Measuring Dependency and Risk in Agent Skill Supply Chains](https://arxiv.org/abs/2607.01136)
...
### [66] [Are Performance-Optimization Benchmarks Reliably Measuring Coding Agents?](https://arxiv.org/abs/2607.01211)
...
### [67] [RepoRescue: An Empirical Study of LLM Agents on Whole-Repository Compatibility Rescue](https://arxiv.org/abs/2607.01213)
...
### [68] [SmoothAgent: Efficient Long-Horizon LLM-Based Agent Serving with Lookahead Context Engineering](https://arxiv.org/abs/2607.00151)
...
### [69] [Promise-Future Synchronization for Cluster Asynchronous Many-Task Runtimes via MPI One-Sided Communication](https://arxiv.org/abs/2607.00303)
*Mia Reitz*
...
### [70] [CloudyGUI: A Novel Python-based Framework for Auto-Scaling and Cloud Workload Analysis](https://arxiv.org/abs/2607.00455)
...
### [71] [ELDR: Expert-Locality-Aware Decode Routing for PD-Disaggregated MoE Serving](https://arxiv.org/abs/2607.00466)
...
### [72] [Modeling and Chasing the Energy-Efficiency Sweet Spots in Modern GPUs](https://arxiv.org/abs/2607.00819)
...
### [73] [Next-Generation Agentic Reinforcement Learning Systems Enable Self-Evolving Agents](https://arxiv.org/abs/2607.01120)
