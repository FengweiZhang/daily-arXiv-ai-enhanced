...
### [3] [Cloud-Native Operation of Roadside Infrastructure Enabling Demand-Driven Collective Perception via V2X](https://arxiv.org/abs/2605.21145)
...
### [5] [PlexRL: Cluster-Level Orchestration of Serviceized LLM Execution for RLVR](https://arxiv.org/abs/2605.20863)
...
### [6] [Ark: Offchain Transaction Batching in Bitcoin](https://arxiv.org/abs/2605.20952)
...
### [7] [Diagnosing Overhead in Dispatch Operations: Cross-architecture Observatory](https://arxiv.org/abs/2605.20982)
...
### [8] [NanoCP: Request-Level Dynamic Context Parallelism for Data-Expert Parallel Decoding](https://arxiv.org/abs/2605.21100)
...
### [9] [Automated Byzantine-Resilient Clustered Decentralized Federated Learning for Battery Intelligence in Connected EVs](https://arxiv.org/abs/2605.21115)
...
### [11] [Clove: Object-Level CXL Memory Management in Managed Runtimes](https://arxiv.org/abs/2605.20370)
...
### [12] [ParaCell: Paravirtualized Secure Containers with Lightweight Intra-Container Isolation and Intent-Driven Memory Management](https://arxiv.org/abs/2605.20906)
...
### [13] [Modern Portfolio Theory in the Crypto-Wilderness](https://arxiv.org/abs/2605.20528)
...
### [14] [HyFrac.fun: A 3D Hydraulic Fracturing Simulator on Cloud](https://arxiv.org/abs/2605.20764)
...
### [15] [Distance between Road Networks: A Macroscopic Method for Road Network Datasets Comparison Using Traffic-weighted Geographic Distribution](https://arxiv.org/abs/2605.20921)
...
### [16] [KSOS-BO: Improving Sampling in Bayesian Optimization via Kernel Sum of Squares](https://arxiv.org/abs/2605.21179)
...
### [17] [The Statistical Significance of the Inclusion of Graph Neural Networks in the Financial Time Series Forecasting Problem](https://arxiv.org/abs/2605.21192)
...
### [18] [A Meshtastic-based LoRa Mesh System for Smart Campus Applications: From Solar-Powered Sensing to Containerized Data Management](https://arxiv.org/abs/2605.20379)
...
### [19] [LoRa and LoRaWAN simulator-cum-emulator with CAD and capture effect in Python](https://arxiv.org/abs/2605.21136)
...
### [20] [High-speed Networking for Giga-Scale AI Factories](https://arxiv.org/abs/2605.21187)
...
### [21] [Enhanced-BLE: A Hybrid BLE-ESB Framework for Dynamically Reconfigurable and Energy-Efficient 2.4 GHz IoT Communication](https://arxiv.org/abs/2605.21270)
...
### [22] [SAOITHE: Sustainable Age-of-Information-Based Timely Status Updating for Hardware-constrained Edge networks](https://arxiv.org/abs/2605.21328)
...
### [23] [ELSA: An ELastic SNN Inference Architecture for Efficient Neuromorphic Computing](https://arxiv.org/abs/2605.20802)
...
### [24] [Supporting Dynamic Control-Flow Execution for Runtime Reconfigurable Processors](https://arxiv.org/abs/2605.21203)
...
### [25] [Fifty Years of Transaction Processing Research (extended)](https://arxiv.org/abs/2605.20466)
*Philip A. Bernstein*
...
### [26] [ProcBench: Evaluating Process-Level Defects and Control Preservation in LLM Coding Agents](https://arxiv.org/abs/2605.20251)
...
### [27] [Combined Program Analysis Techniques: A Systematic Mapping Study](https://arxiv.org/abs/2605.20310)
...
### [28] [A Semantic-Web Oriented Competency Model for Engineering Programs](https://arxiv.org/abs/2605.20401)
...
### [29] [Agentic Agile-V: From Vibe Coding to Verified Engineering in Software and Hardware Development](https://arxiv.org/abs/2605.20456)
*Christopher Koch*
...
### [30] [Code Generation by Differential Test Time Scaling](https://arxiv.org/abs/2605.20473)
...
### [31] [RSE of a Quantum Transport Code and its Effects](https://arxiv.org/abs/2605.21334)
...
### [32] [A Multi-Layer Testing Framework for Automated Data Quality Assurance in Cloud-Native ELT Pipelines](https://arxiv.org/abs/2605.20500)
...
### [33] [An Event-Driven Tool for Context-Aware Code Smell Detection Using SmellDSL](https://arxiv.org/abs/2605.20675)
...
### [34] [BioDefect: The First Dataset for Defect Detection in Bioinformatics Software](https://arxiv.org/abs/2605.20788)
...
### [35] [Beyond the Tip of the Iceberg: Understanding SATD in Dockerfiles through the Lens of Co-evolution](https://arxiv.org/abs/2605.21238)
...
### [36] [Transforming Privacy Artifacts into Accessible Reports for Non-Technical Stakeholders](https://arxiv.org/abs/2605.21269)
...
### [37] [Validating Navmesh using Geometry: Voxel-Based Analysis with Prioritized Exploration](https://arxiv.org/abs/2605.21397)
...
### [38] [Stdlib or Third-Party? Empirical Performance and Correctness of LLM-Assisted Zero-Dependency Python Libraries](https://arxiv.org/abs/2605.21405)
...
### [39] [Agentic Model Checking](https://arxiv.org/abs/2605.21434)
...
### [40] [Quality and Security Signals in AI-Generated Python Refactoring Pull Requests](https://arxiv.org/abs/2605.21453)
