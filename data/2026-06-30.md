...
### [18] [Weak Dominant Balance for Robust Identification of Dynamically Consistent Fluid Flow Structure](https://arxiv.org/abs/2606.29047)
...
### [19] [Toward Exascale AI for Science: A Scalable AI Skill for Autonomous Microkinetics Discovery](https://arxiv.org/abs/2606.29100)
...
### [20] [Structure-preserving dynamical low-rank approximation for parametric elastic guided waves](https://arxiv.org/abs/2606.30469)
*Dimitri Goutaudier*
...
### [21] [Reinforcement Learning for Software Vulnerability Analysis: A Systematic Review with Emphasis on C/C++ Source Code and Static Analysis](https://arxiv.org/abs/2606.28403)
...
### [22] [Building to the Test: Coding Agents Deliver What You Check, Not What You Requested](https://arxiv.org/abs/2606.28430)
...
### [23] [SWE-MeM: Learning Adaptive Memory Management for Long-Horizon Coding Agents](https://arxiv.org/abs/2606.28434)
...
### [24] [Dockerless: Environment-Free Program Verifier for Coding Agents](https://arxiv.org/abs/2606.28436)
...
### [25] [When AI Reviews Its Own Code: Recursive Self-Training Collapse in Code LLMs](https://arxiv.org/abs/2606.28438)
...
### [26] [TUA-Bench: A Benchmark for General-Purpose Terminal-Use Agents](https://arxiv.org/abs/2606.28480)
...
### [27] [Evaluating LLMs on Java Code Snippet Adaptation Using a Mutation-Injection Framework](https://arxiv.org/abs/2606.28618)
...
### [28] [From Determinism to Delegation: AI-Native Software Engineering and the Evolution of the Agentic Engineer](https://arxiv.org/abs/2606.28791)
*Mamdouh Alenezi*
...
### [29] [SAKE: Software Architectural Knowledge Evaluation Benchmark for Large Language Models](https://arxiv.org/abs/2606.29520)
...
### [30] [Reward-Free Code Alignment from Pretrained or Fine-Tuned LLM: Unpacking the Trade-offs for Code Generation](https://arxiv.org/abs/2606.28998)
...
### [31] [Automated SysML-Based Verification of Discipline-Specific Models](https://arxiv.org/abs/2606.29006)
...
### [32] [Diff-Based Code Corruption using LLMs for Large-Scale Bugfix Benchmarking](https://arxiv.org/abs/2606.29088)
...
### [33] [OASIF: An Efficient Obfuscation-Aware Self-Improving Framework for LLM-Based Assembly Code Instruction Following and Comprehension](https://arxiv.org/abs/2606.29155)
...
### [34] [A Multi-Dataset Benchmark for Evaluating LLM Agents in Microservice Failure Diagnosis](https://arxiv.org/abs/2606.29193)
...
### [35] [On the JI-RADAR: Uncovering Sustainability Tool Support for Requirements Engineering](https://arxiv.org/abs/2606.29439)
...
### [36] [RESOURCE2SKILL: Distilling Executable Agent Skills from Human-Created Multimodal Resources](https://arxiv.org/abs/2606.29538)
...
### [37] [Deforking the World of Code: A Project-Provenance Map that Recovers Cross-Forge Fork Families that Platform Graphs Cannot See](https://arxiv.org/abs/2606.29550)
*Audris Mockus*
...
### [38] [Connecting the Models: A Global Mega-model of MDE Projects on GitHub](https://arxiv.org/abs/2606.29606)
...
### [39] [Bash-Commenter: Leveraging Syntax-Aware Preference Optimization to Reinforce Large Language Model for Bash Code Comment Generation](https://arxiv.org/abs/2606.29709)
...
### [40] [MicroAgent: Context-Augmented Multi-Agent Framework for Automatic Microservice Decomposition](https://arxiv.org/abs/2606.29742)
...
### [41] [Uncovering Similar but Different Packages in PyPI and Potential Security Threats](https://arxiv.org/abs/2606.29785)
...
### [42] [Rethinking Build vs. Buy Decisions in Enterprise Software: Navigating Trade-offs through a Structured Decision-Support Approach](https://arxiv.org/abs/2606.29816)
...
### [44] [SWE-Together: Evaluating Coding Agents in Interactive User Sessions](https://arxiv.org/abs/2606.29957)
...
### [45] [MCP Server Architecture Patterns for LLM-Integrated Applications](https://arxiv.org/abs/2606.30317)
...
### [46] [How do Execution Features Improve Statistical Fault Localization? An Empirical Study](https://arxiv.org/abs/2606.30324)
...
### [47] [The Illusion of Agentic Complexity in README.md Generation: Evaluating Single-Agent vs. Multi-Agent RAG Systems](https://arxiv.org/abs/2606.30524)
...
### [48] [PyMETA: A Benchmark Dataset for Hierarchical Student Code Error Classification with Python-Interpreter-Based Labels](https://arxiv.org/abs/2606.30610)
...
### [49] [Multi-Agent DRL for QoS and Energy Optimization in RIS-Enabled Open-RAN Industrial 6G TN/NTN Networks](https://arxiv.org/abs/2606.28339)
...
### [50] [Latency Components in 5G for Edge Application Discovery and Proximity Services: Targets, Measurements, and Practical Working Points](https://arxiv.org/abs/2606.28341)
*David Rico Menéndez*
...
### [51] [Operating Regimes of Decentralized Learning Under Mobility and Bandwidth Constraints](https://arxiv.org/abs/2606.28342)
...
### [52] [Intent-Driven 6G Service Orchestration: Grounded Translation, Validation, and Decomposition](https://arxiv.org/abs/2606.28348)
...
### [53] [CornerCase: Automated Extremal Testing of Protocol Implementations using LLMs](https://arxiv.org/abs/2606.29124)
...
### [54] [Stateless Network-Aware Adaptive Bitrate Streaming over IPFS](https://arxiv.org/abs/2606.29574)
...
### [55] [Cooperative RSU Sleep Scheduling for Green V2I Corridors](https://arxiv.org/abs/2606.29609)
*Yousef AlSaqabi*
...
### [56] [Scalable Intention Sharing for ETSI VAMs](https://arxiv.org/abs/2606.30034)
...
### [57] [Selective Deployment of Bidirectional Hollow-Core Fibers in Hybrid SMF/HCF Optical Networks](https://arxiv.org/abs/2606.30260)
...
### [58] [LLMs and Optical Networks: A Symbiotic Relationship](https://arxiv.org/abs/2606.30278)
...
### [59] [COHORT: Collaborative Orchestration for Hardening via Offensive Replay on Emulated Topologies](https://arxiv.org/abs/2606.30479)
...
### [60] [SubEdge: A Subscriber-Centric Edge Computing Subsystem in 6G Networks for AI](https://arxiv.org/abs/2606.30554)
...
### [61] [Wireless Backdoor Attack and Defense for Semantic Communications over Multiple Access Channel](https://arxiv.org/abs/2606.30595)
...
### [62] [Database Context Compression for Text-to-SQL on Real-World Large Databases](https://arxiv.org/abs/2606.28601)
...
### [63] [Algebraic Subgraph Counting](https://arxiv.org/abs/2606.29128)
...
### [64] [CADENZA: Compiling Natural-Language Intent into Task-Specific Operator DAGs for Semantic Query Processing](https://arxiv.org/abs/2606.29151)
...
### [65] [Enterprise Data Modelling Methodologies: A Comparative Analysis of Inmon, Kimball, and Data Vault](https://arxiv.org/abs/2606.29355)
*Issar Arab*
...
### [66] [SemJoin: Semantic Join Optimization](https://arxiv.org/abs/2606.29532)
...
### [67] [Mandol: An Agglomerative Agent Memory System for Long-Term Conversations](https://arxiv.org/abs/2606.29778)
...
### [68] [Experience Graphs: The Data Foundation for Self-Improving Agents](https://arxiv.org/abs/2606.29823)
...
### [69] [CLIP: Lightweight Cosine-Law-Based Inverted-List Pruning for IVF-Based Vector Search](https://arxiv.org/abs/2606.29968)
...
### [70] [MaDI-Bench: An End-to-End Data Integration Benchmark](https://arxiv.org/abs/2606.30371)
...
### [71] [Evidence-Driven LLM Agent for C-to-Synthesizable-C Conversion and Verification](https://arxiv.org/abs/2606.28409)
...
### [72] [SHIFT: Dynamic Compute Relocation Framework for Communication-Aware Chiplet-Based Systems](https://arxiv.org/abs/2606.28754)
...
### [73] [Harvesting AI Computation at the Edge via Generic Approximation](https://arxiv.org/abs/2606.29518)
...
### [74] [HBM Is Not All You Need: Efficient Disaggregated LLM Serving across Memory-heterogeneous Accelerators](https://arxiv.org/abs/2606.29986)
...
### [75] [Mega: A 22 nm Convolutional Spiking Neural Network Accelerator Achieving 0.375 pJ/SOP for Efficient Edge Vision](https://arxiv.org/abs/2606.30039)
...
### [76] [RQP: Resource-Oriented Quantiser Pruning for Neural Networks on FPGAs](https://arxiv.org/abs/2606.30382)
...
### [77] [COSM: A Cooperative Scheduling Framework for Concurrent PIM and CPU Execution on Mobile Devices](https://arxiv.org/abs/2606.30553)
