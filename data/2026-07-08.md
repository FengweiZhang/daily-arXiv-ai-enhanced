...
### [8] [BaCon: Efficient Batch Processing of Counting Queries [Full Version]](https://arxiv.org/abs/2607.05832)
...
### [9] [Discovering Frequent Closed Embedded Sub-DAGs in Spatio-Temporal Event Data](https://arxiv.org/abs/2607.05995)
*Piotr S. Maciąg*
...
### [10] [Efficient and Robust Lock-Free Multi-Word Compare-and-Swap via Contention-Aware Helping](https://arxiv.org/abs/2607.06034)
...
### [11] [A robust and versatile parallel FFT-based mechanical solver for general non-periodic and periodic boundary conditions](https://arxiv.org/abs/2607.05929)
...
### [12] [A Decomposition-Based Framework for Joint Optimization and Spatial Packaging of Interconnected Systems with Physical Interactions](https://arxiv.org/abs/2607.06087)
...
### [13] [Hybrid electrolyzer systems: Smart strategy or economic fallacy?](https://arxiv.org/abs/2607.06093)
...
### [14] [The Documentation and Traceability Burden of the Indian EV Transition](https://arxiv.org/abs/2607.06170)
...
### [15] [Bounded-Memory Parallel Image Pulling for Large Container Images](https://arxiv.org/abs/2607.05596)
...
### [16] [Layer 2 Coordinated Trusted Setup for Continuous CRS Generation](https://arxiv.org/abs/2607.05776)
...
### [17] [MatrixFSDP: communication-free matrix optimizers under ZeRO-3 parameter sharding](https://arxiv.org/abs/2607.05895)
...
### [18] [The Surplus Parking Gathering Problem in Infinite Grids](https://arxiv.org/abs/2607.05983)
...
### [19] [A Dual-CRDT Architecture for Decentralized Trust Governance and Evolution](https://arxiv.org/abs/2607.06068)
*Amos Brocco*
...
### [20] [DDB: Source-Level Interactive Debugging for Distributed Applications](https://arxiv.org/abs/2607.06107)
...
### [21] [Ordering by Unanimity: Giving Applications Sequencing Rights Without Breaking Composability](https://arxiv.org/abs/2607.06144)
*Andrea Canidio*
...
### [22] [UBEP: Re-architecting Expert Parallelism Communication Library for Production Superpods](https://arxiv.org/abs/2607.06202)
...
### [23] [BitFair: A 12nm Bit-Serial CNN Accelerator with Learnable Early Termination and Adaptive Bit Ordering for Ultra-Low-Power XR Vision](https://arxiv.org/abs/2607.05445)
*Ang Li,Chang Gao*
...
### [24] [Neuromorphic Silicon Neuron Controller for Adaptive Deep Brain Stimulation in Parkinson's Disease](https://arxiv.org/abs/2607.05453)
...
### [25] [Is Your NPU Ready for LLMs? Dissecting the Hidden Efficiency Bottlenecks in Mobile LLM Inference](https://arxiv.org/abs/2607.05475)
...
### [26] [NEMESIS: NEtlist-Driven Modeling and Equation Synthesis with Inversion-Aware SPICE Anchoring](https://arxiv.org/abs/2607.05657)
...
### [27] [Boosting FPGA Performance with Direct BRAM-DSP Paths](https://arxiv.org/abs/2607.05756)
...
### [28] [GPU-Accelerated Effective Resistance Analysis for 3D IC Power Delivery Network](https://arxiv.org/abs/2607.05818)
...
### [29] [KAT-Coder-V2.5 Technical Report](https://arxiv.org/abs/2607.05471)
...
### [30] [TypeGo: An OS Runtime for Embodied Agents](https://arxiv.org/abs/2607.05482)
...
### [31] [A Mechanistic Lens on Semantic Conflicts: Using Activation Patching to Understand LLM Behavior](https://arxiv.org/abs/2607.05587)
...
### [32] [Industry Classification of GitHub Repositories Using the North American Industry Classification System (NAICS)](https://arxiv.org/abs/2607.06505)
...
### [33] [Bridging Stakeholder and Product Requirements: An Empirical Study of Requirement Engineering in the Automotive Industry](https://arxiv.org/abs/2607.05632)
...
### [34] [EvalLoop: A Methodology for Evaluation-Driven Iterative Improvement of Business AI Systems](https://arxiv.org/abs/2607.05638)
...
### [35] [Agents with Feelings? Personality and Emotion in Multi-Agent Software Teams](https://arxiv.org/abs/2607.05659)
...
### [36] [What Do AI Agents Actually Change? An Empirical Taxonomy of Mutation Patterns in Performance-Improving Pull Requests](https://arxiv.org/abs/2607.05666)
...
### [37] [The Cathedral and the Bazaar of Software Vulnerabilities: From the NVD to the CNAs](https://arxiv.org/abs/2607.05670)
...
### [38] [From Conversation to Contribution: Characterizing Coding Agent in Open-Source Software](https://arxiv.org/abs/2607.05677)
...
### [39] [Articulating Assumptions in AI-Generated Scientific Analyses through Task Decomposition](https://arxiv.org/abs/2607.05762)
...
### [40] [Detecting Vulnerability-Inducing Commits via Multi-Stage Reasoning with LLM-Based Agents](https://arxiv.org/abs/2607.05772)
...
### [41] [Can Large Language Models Generate Observability-Aware Code?](https://arxiv.org/abs/2607.05785)
...
### [42] [SCOPE: Leveraging Subgoal Critiques for Code Generation](https://arxiv.org/abs/2607.05810)
...
### [43] [Beyond Refusal: A Same-Lineage Study of Aligned and Abliterated LLMs for Vulnerability Analysis](https://arxiv.org/abs/2607.05842)
...
### [44] [DebugTracker: Lightweight Process Evidence for Classroom Debugging](https://arxiv.org/abs/2607.05871)
...
### [45] [Hidden Amplifiers: Cross-Level Risk in Software Supply Chains](https://arxiv.org/abs/2607.05894)
...
### [46] [xDECAF: An Extensible Data Flow Diagram Analysis Framework for Information Security](https://arxiv.org/abs/2607.05913)
...
### [47] [Mitigating Errors in LLM-Generated Web API Invocations via Retrieval-Augmented Generation and Constrained Decoding](https://arxiv.org/abs/2607.05936)
...
### [48] [Large Language Models Have Unreliable Understanding of Software Engineering Terminology](https://arxiv.org/abs/2607.06004)
...
### [49] [Automating Quality Assessment with NLP of LLM-Generated Defeaters](https://arxiv.org/abs/2607.06039)
...
### [50] [SWE-Review: Closing the Loop on Issue Resolution with Agentic Code Review](https://arxiv.org/abs/2607.06065)
...
### [51] [Prompt Coach: An Empirical Evaluation of an Agentic Tutor for Learning Prompt Engineering in Software Development](https://arxiv.org/abs/2607.06074)
...
### [52] [Collaborative Multi-Agent Testing for Emergent Failure Discovery in Autonomous Driving Systems](https://arxiv.org/abs/2607.06078)
...
### [53] [Agents That Teach: Towards Designing Incidental Learning Back into AI-Assisted Software Development](https://arxiv.org/abs/2607.06101)
...
### [54] [Static Metrics Are Insufficient: Predicting Java Method Energy Usage with Execution Time](https://arxiv.org/abs/2607.06124)
...
### [55] [Evaluating Fine-Tuning and Metrics for Neural Decompilation of Dart AOT Binaries](https://arxiv.org/abs/2607.06125)
...
### [56] [Property-Driven Synthetic Data Engineering for Data-Scarce Software Systems: Reflections from the Breast Cancer Domain](https://arxiv.org/abs/2607.06133)
...
### [57] [A Global Author-Identity Map for the World of Code:62.7M Developer Identities from 106.8M Author Strings over 5.87B Commits](https://arxiv.org/abs/2607.06183)
*Audris Mockus*
...
### [58] [What Resolve Rate Hides: Trajectory Structure Diagnostics for Coding Agents](https://arxiv.org/abs/2607.06184)
...
### [59] [LogicHunter: Testing LLM Agent Frameworks with an Agentic Oracle](https://arxiv.org/abs/2607.06195)
...
### [60] [AgentTether: Graph-Guided Diagnosis and Runtime Intervention for Reliable LLM Agent Operation](https://arxiv.org/abs/2607.06273)
...
### [61] [UI2App: Benchmarking Visual Interaction Inference in Executable Web Application Generation](https://arxiv.org/abs/2607.06306)
...
### [62] [RuBench: A Repository-Level Agentic Coding Benchmark with Natively Authored Russian Task Specifications](https://arxiv.org/abs/2607.06411)
*Evgeny Shilov*
...
### [63] [Domain-Driven Design in Practice: A Large-Scale Empirical Characterisation of the Open-Source Ecosystem](https://arxiv.org/abs/2607.06471)
...
### [64] [Complets: Universal Compartmentalisation and Programming Model For Arm Permission Overlay Extension 2](https://arxiv.org/abs/2607.05569)
*Vasily A. Sartakov*
