...
### [3] [Hierarchical Online-Scheduling for Energy-Efficient Split Inference with Progressive Transmission](https://arxiv.org/abs/2601.08135)
...
### [4] [Joint Communication and Sensing in RIS-Assisted MIMO System Under Mutual Coupling](https://arxiv.org/abs/2601.08142)
...
### [5] [Multi-Objective Optimization for Joint Communication and Sensing in Multi-user MIMO Systems: Characterizing the Pareto Boundary](https://arxiv.org/abs/2601.08152)
...
### [6] [Tiny-Twin: A CPU-Native Full-stack Digital Twin for NextG Cellular Networks](https://arxiv.org/abs/2601.08217)
...
### [7] [Unleashing Tool Engineering and Intelligence for Agentic AI in Next-Generation Communication Networks](https://arxiv.org/abs/2601.08259)
...
### [8] [Statistical Characterization and Prediction of E2E Latency over LEO Satellite Networks](https://arxiv.org/abs/2601.08439)
...
### [9] [A decentralized academic certificate issuance system using smart contracts on the tron network](https://arxiv.org/abs/2601.08513)
...
### [10] [Efficient Parameter Calibration of Numerical Weather Prediction Models via Evolutionary Sequential Transfer Optimization](https://arxiv.org/abs/2601.08663)
...
### [11] [A New Tool to Find Lightweight (And, Xor) Implementations of Quadratic Vectorial Boolean Functions up to Dimension 9](https://arxiv.org/abs/2601.08368)
...
### [12] [SECite: Analyzing and Summarizing Citations in Software Engineering Literature](https://arxiv.org/abs/2601.07939)
...
### [13] [Towards Verifiably Safe Tool Use for LLM Agents](https://arxiv.org/abs/2601.08012)
...
### [14] [Automating API Documentation from Crowdsourced Knowledge](https://arxiv.org/abs/2601.08036)
...
### [15] [Cognitive Biases in LLM-Assisted Software Development](https://arxiv.org/abs/2601.08045)
...
### [16] [Coverage-Guided Road Selection and Prioritization for Efficient Testing in Autonomous Driving Systems](https://arxiv.org/abs/2601.08609)
...
### [17] [LLMs in Code Vulnerability Analysis: A Proof of Concept](https://arxiv.org/abs/2601.08691)
...
### [18] ["Where is My Troubleshooting Procedure?": Studying the Potential of RAG in Assisting Failure Resolution of Large Cyber-Physical System](https://arxiv.org/abs/2601.08706)
...
### [19] [Revisiting "Revisiting Neuron Coverage for DNN Testing: A Layer-Wise and Distribution-Aware Criterion": A Critical Review and Implications on DNN Coverage Testing](https://arxiv.org/abs/2601.08729)
...
### [20] [TerraFormer: Automated Infrastructure-as-Code with LLMs Fine-Tuned via Policy-Guided Verifier Feedback](https://arxiv.org/abs/2601.08734)
...
### [21] [Reliable Graph-RAG for Codebases: AST-Derived Graphs vs LLM-Extracted Knowledge Graphs](https://arxiv.org/abs/2601.08773)
...
### [22] [APEX-SWE](https://arxiv.org/abs/2601.08806)
...
### [23] [Where to Split? A Pareto-Front Analysis of DNN Partitioning for Edge Inference](https://arxiv.org/abs/2601.08025)
...
### [24] [Matrix-PIC: Harnessing Matrix Outer-product for High-Performance Particle-in-Cell Simulations](https://arxiv.org/abs/2601.08277)
...
### [25] [Shifting the Sweet Spot: High-Performance Matrix-Free Method for High-Order Elasticity](https://arxiv.org/abs/2601.08374)
...
### [26] [MixServe: An Automatic Distributed Serving System for MoE Models with Hybrid Parallelism Based on Fused Communication Algorithm](https://arxiv.org/abs/2601.08800)
