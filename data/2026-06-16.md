...
### [7] [Recurring Public Transit Schedules: Stable Identification from GTFS and Similarity Analysis](https://arxiv.org/abs/2606.14713)
...
### [8] [Schema-Agnostic Process Trace Construction: From Raw Tables to Execution Behavior](https://arxiv.org/abs/2606.14775)
...
### [9] [CoeusBI: A Comprehensive Interactive Business Intelligence System Powered by LLMs at Baidu [Extended Version]](https://arxiv.org/abs/2606.15384)
...
### [10] [When Does q-error Predict Plan Regret? Three Regimes of Cardinality-Estimation Error](https://arxiv.org/abs/2606.15600)
...
### [11] [C^2: Cache-Conscious Succinct Tries with Adaptive Unary Path Compression](https://arxiv.org/abs/2606.16104)
...
### [12] [Improved Join Order Optimization for Database Queries using Hybrid Quantum-Classical Approaches for QUBO Problems](https://arxiv.org/abs/2606.16247)
...
### [13] [Directory-Aware Query and Maintenance in Vector Databases](https://arxiv.org/abs/2606.16903)
...
### [14] [Decoupling Inference from State Updates in Low-Latency Feature Engines via Probabilistic Thinning](https://arxiv.org/abs/2606.16981)
...
### [15] [uringscope: Portable, Low-Overhead Observability for io_uring](https://arxiv.org/abs/2606.15137)
*Rajarshi Chowdhury*
...
### [16] [From MWM to iSLIP: A Linear-Algebraic Tutorial on Input-Queued Switch Scheduling](https://arxiv.org/abs/2606.14771)
...
### [17] [Towards Ubiquitous 6G Computing and Networking Convergence: Architecture and Mechanism for Cross-Domain Resource Coordination](https://arxiv.org/abs/2606.15073)
...
### [18] [Sub Terahertz LEO Satellite Communication: Vision, Opportunities, and Challenges toward the First Prototype in Space](https://arxiv.org/abs/2606.15410)
...
### [19] [Single-Connection Mixed-Criticality Transport with CATS: Bounded Guarantees, Three Structural Limits, and a QUIC Escape](https://arxiv.org/abs/2606.16924)
...
### [20] [IoT-Zoo: A Container-Based Framework for Heterogeneous IoT Device Profiles and Reproducible Traffic Capture](https://arxiv.org/abs/2606.15653)
...
### [21] [SINR-Aware Base Station Deployment in Wide Area IoT Sensor Networks](https://arxiv.org/abs/2606.15952)
*Sachin Kadam*
...
### [22] [Hidden Degradation Costs in Energy-Cost-Only HEMS Optimisation: Study on Battery and PV Sensitivity](https://arxiv.org/abs/2606.16051)
...
### [23] [Impact of ADAS and V2X Penetration Rates on Cooperative Active Safety](https://arxiv.org/abs/2606.16453)
...
### [24] [Predictive Dynamic Scheduling for Deterministic Communications in Beyond 5G](https://arxiv.org/abs/2606.16471)
...
### [25] [Poster: EdgeCitadel -- Hybrid NATS-MQTT Orchestration for Edge Multi-Agent Systems](https://arxiv.org/abs/2606.14710)
...
### [26] [StorRep: Storage Research Experiment Patterns on Chameleon Cloud and Trovi](https://arxiv.org/abs/2606.16252)
...
### [27] [SWARM-LLM: Collaborative Inference for Edge-based Small Language Models](https://arxiv.org/abs/2606.14711)
...
### [28] [CacheWise: Understanding Workloads and Optimizing KVCache Management for Efficiently Serving LLM Coding Agents](https://arxiv.org/abs/2606.16824)
...
### [29] [Secure and Low-Latency IoT Analytics Using an Edge-Based Streaming Architecture](https://arxiv.org/abs/2606.14712)
...
### [30] [Evaluating Gemma4 Models as AI Teaching Assistants for Introductory Parallel Programming: A DataRaceBench Study](https://arxiv.org/abs/2606.14881)
...
### [31] [NEURON-Fabric: CXL-Side Low-Bit Gradient Aggregation for Distributed Training](https://arxiv.org/abs/2606.15045)
...
### [32] [Solyx AI Grid: Hardware-Telemetry-Aware Routing Across Geographically Distributed GPU Clusters](https://arxiv.org/abs/2606.15050)
...
### [33] [A RAG-Enhanced Bi-Level Cognitive Orchestration Framework for LEO Satellite Networks](https://arxiv.org/abs/2606.15076)
...
### [34] [Coordinated Scheduling for MoE LLM Serving](https://arxiv.org/abs/2606.15177)
...
### [35] [Generation Quality-Latency Tradeoff-Aware Inference Offloading for Multimodal LLMs in Cloud-Edge Continuum](https://arxiv.org/abs/2606.15210)
...
### [36] [Adaptive Resource Management and Quality Control for Streaming Video Generation](https://arxiv.org/abs/2606.15319)
...
### [37] [Robust and Automated Reconfiguration of Byzantine Wide-Area Replication](https://arxiv.org/abs/2606.16740)
...
### [38] [CoAgent: Concurrency Control for Multi-Agent Systems](https://arxiv.org/abs/2606.15376)
...
### [39] [A Unified Constant-Time Switch Rule for Constructing Edge-Disjoint Hamiltonian Cycles in Gaussian Networks](https://arxiv.org/abs/2606.16892)
*Bader Albader*
...
### [40] [Is RISC-V Ready for Massively Parallel Astrophysical Codes?](https://arxiv.org/abs/2606.15490)
...
### [41] [Re-Rooting-Based Fault-Tolerant Broadcasting in Dense Gaussian Networks](https://arxiv.org/abs/2606.16954)
...
### [42] [Quantifying the Impact of Lossy Compression on Neural Generative Surrogate Modeling](https://arxiv.org/abs/2606.15959)
...
### [43] [PreLort: Prefix-Nested LoRA for Federated Fine-Tuning under Rank Heterogeneity](https://arxiv.org/abs/2606.15963)
...
### [44] [Raiders of the Lost Log: Synchronous Parallel In-Place Models and Algorithms](https://arxiv.org/abs/2606.15969)
...
### [45] [SwiftCache: Efficient LLM Serving for Multi-turn Conversations with Heterogeneous KV Cache Sharing](https://arxiv.org/abs/2606.16135)
...
### [46] [Efficient Data Availability Sampling via Coded Distributed Arrays](https://arxiv.org/abs/2606.16200)
...
### [47] [Tropical: Enhancing SLO Attainment in Disaggregated LLM Serving via SLO-Aware Multiplexing](https://arxiv.org/abs/2606.16264)
...
### [48] [From the NYU Ultracomputer to Modern Exascale: A Historical and Architectural Survey of In-Network Computing and Scalable Synchronization](https://arxiv.org/abs/2606.16819)
*Lars Warren Ericson*
...
### [50] [Generated, Parallel, Scalable? A Study of Agentic AI-Generated Julia Code on Supercomputers](https://arxiv.org/abs/2606.16534)
...
### [51] [Incentives and Evidence in Learned Service Orchestration](https://arxiv.org/abs/2606.16555)
...
### [52] [DRIFT: Risk-Constrained Diffusion with Imitation Priors for Mixed-Autonomy Traffic Generation](https://arxiv.org/abs/2606.16589)
...
### [53] [Tangram: Hiding GPU Heterogeneity for Efficient LLM Parallelization](https://arxiv.org/abs/2606.16907)
...
### [54] [Faster Code, Deeper Debt? A Multivocal Literature Review on Technical Debt and Its Early Signs in LLM-Assisted Software Development](https://arxiv.org/abs/2606.14796)
...
### [55] [Knowledge-Based Zero-Replay Debugging of Multi-Agent LLM Traces](https://arxiv.org/abs/2606.14805)
...
### [56] [Pandas for Reproducible Data Analysis: From Spreadsheets to Research-Grade Python Workflows](https://arxiv.org/abs/2606.14924)
...
### [57] [Beyond Correctness: Enhancing Architectural Reasoning in Code LLMs via Scalable Labeling with Agentic Judgment](https://arxiv.org/abs/2606.14948)
...
### [58] [Specifications for Humans, Agents, and Tooling](https://arxiv.org/abs/2606.15084)
*Mark Marron*
...
### [59] [The Hitchhiker's Guide to Program Analysis, Part III: Mostly Harmless LLMs](https://arxiv.org/abs/2606.15122)
...
### [60] [AI-driven Software Development: A Pragmatic Path to Agentic Development Processes](https://arxiv.org/abs/2606.15283)
...
### [61] [A Scalability Analysis of Quantitative Confidence Assessment Methods for Assurance Cases](https://arxiv.org/abs/2606.15480)
...
### [62] [SDVDiag: Multimodal Causal Discovery for Online Diagnosis in Software-defined Vehicles](https://arxiv.org/abs/2606.15559)
...
### [63] [Minimal Comparison of Octagonal Abstract Domains](https://arxiv.org/abs/2606.15582)
...
### [64] [Q-READY: Predictive Feasibility Assessment for Hybrid Quantum-Classical Applications](https://arxiv.org/abs/2606.16201)
*Tao Yue,Man Zhang*
...
### [65] [Teaching testing seriously in academia](https://arxiv.org/abs/2606.15677)
...
### [66] [Applications of Causality in Software Testing: A Rapid Review](https://arxiv.org/abs/2606.15683)
...
### [67] [Bigger Isn't Always Better: A Comparative Evaluation of LLMs for Automated Code Review](https://arxiv.org/abs/2606.15689)
...
### [68] [Imperfect Visual Verification for Code Edition : A Case Study on TikZ](https://arxiv.org/abs/2606.15693)
...
### [69] [Configuration Smells in AGENTS.md Files: Common Mistakes in Configuring Coding Agents](https://arxiv.org/abs/2606.15828)
...
### [70] [Graphical-Probabilistic Modeling of Generative Flows in LLM-Native Software Systems](https://arxiv.org/abs/2606.15943)
...
### [71] [Green SARC: Predictive Cost and Carbon Governance for Agentic AI Systems](https://arxiv.org/abs/2606.15954)
*Gaston Besanson*
...
### [72] [Open-SWE-Traces: Advancing Dual-Mode Multilingual Distillation for Software Engineering Agents](https://arxiv.org/abs/2606.16038)
...
### [73] [Binary Decompilation LLM with Feedback-Driven Multi-Turn Refinement](https://arxiv.org/abs/2606.16162)
...
### [74] [UXBench: Measuring the Actionability of LLM-Generated UX Critiques](https://arxiv.org/abs/2606.16262)
...
### [75] [AI Supply Chain Galaxy: 3D Visual Analytics for License Compliance](https://arxiv.org/abs/2606.16292)
...
### [76] [Understanding Automated Web GUI Testing: An Empirical Study Across Exploration Strategies and State Abstractions](https://arxiv.org/abs/2606.16650)
...
### [77] [Trust by design -- in praise of modularization: a case study](https://arxiv.org/abs/2606.16670)
...
### [78] [Reference Architecture for Metadata-driven Services to Promote Reusability in Software Systems](https://arxiv.org/abs/2606.16692)
...
### [79] [Organizational Cohesion in Microservice Architectures: A Multi-Project Empirical Study](https://arxiv.org/abs/2606.16725)
...
### [80] [No Resource, No Benchmarks, No Problem? Evaluating and Improving LLMs for Code Generation in No-Resource Languages](https://arxiv.org/abs/2606.16827)
...
### [81] [Towards LLM Accelerated Rapid Reviews for Software Tool Discovery -- Case for Log Anomaly Detection](https://arxiv.org/abs/2606.16839)
...
### [82] [Beyond Models: Reflections on Engineering AI-enabled Systems in a Project-Based Course](https://arxiv.org/abs/2606.16842)
...
### [83] [Neuro-Symbolic Software Verification: Hyper-charging Local Language Models with Symbolic Reasoning at Scale](https://arxiv.org/abs/2606.16886)
...
### [84] [Agent trajectories as programs: fingerprinting and programming coding-agent behavior](https://arxiv.org/abs/2606.16988)
*Hamidah Oderinwale*
...
### [85] [Selection Without Signal, Recovery Through Expression: A Measurement Study of Post-Hoc Falsification Operators for Frozen Small Code Models](https://arxiv.org/abs/2606.16999)
*Mehmet Iscan*
...
### [86] [Unified KV Pooling to Accelerate Long-Context LLM Serving](https://arxiv.org/abs/2606.14779)
...
### [87] [Running hardware-aware neural architecture search on embedded devices under 512MB of RAM](https://arxiv.org/abs/2606.14824)
...
### [88] [KATANA: A Fast, Low-Power Mapping of Kalman Filters onto Edge NPUs for Real-Time Tracking](https://arxiv.org/abs/2606.14992)
...
### [89] [PANDA: An LLM-Enhanced Performance-Driven Analog Design Framework Bridging Design Intent and Layout Generation](https://arxiv.org/abs/2606.15052)
...
### [90] [A Spatio-Temporal Expert Prefetching Framework for Efficient MoE-based LLM Inference](https://arxiv.org/abs/2606.15453)
...
### [91] [In-DRAM Signature Generation Using Simultaneous Multiple-Row Activation: An Experimental Study of Off-The-Shelf DRAM Chips](https://arxiv.org/abs/2606.15470)
...
### [92] [LLM4RTL: Tool-Assisted LLM for RTL Generation](https://arxiv.org/abs/2606.15500)
...
### [93] [Approaching Shannon Bound with Lossless LLM Weight Compression](https://arxiv.org/abs/2606.15789)
...
### [94] [EPIC: A System Framework for Efficient Egocentric Perception on Embodied AR Glasses](https://arxiv.org/abs/2606.15859)
...
### [95] [Google's Training Supercomputers from TPU v2 to Ironwood: Architectural Stability, Scale, Resilience, Power Efficiency, and Sustainability Across Five Generations](https://arxiv.org/abs/2606.15870)
...
### [96] [AIA: A Customized Multi-core RISC-V SoC for Discrete Sampling Workloads in 16 nm](https://arxiv.org/abs/2606.16143)
...
### [97] [When Proofs Meet Hardware: Comparing NTT and SumCheck in Zero-Knowledge Systems](https://arxiv.org/abs/2606.16146)
...
### [98] [AIA: A 16nm Multicore SoC for Approximate Inference Acceleration Exploiting Non-normalized Knuth-Yao Sampling and Inter-Core Register Sharing](https://arxiv.org/abs/2606.16148)
*Shirui Zhao,Nimish Shah,Wannes Meert,Marian Verhelst*
...
### [99] [Embedded Arena: Iterative Optimization via Hardware Feedback](https://arxiv.org/abs/2606.16190)
...
### [100] [NeuronFabric: A Software Reference Architecture for On-Chip Transformer Training with Local Adam](https://arxiv.org/abs/2606.16440)
*Evgeny Ukladchikov*
...
### [101] [Towards Delta Aware Training: Efficient DNN Weight Storage for Resource-Constrained FPGAs](https://arxiv.org/abs/2606.16516)
...
### [102] [TreeGRNG: Binary Tree Gaussian Random Number Generator for Efficient Probabilistic AI Hardware](https://arxiv.org/abs/2606.16599)
...
### [103] [DataGuard: Guaranteeing Private Training in Systolic-array Based Accelerators](https://arxiv.org/abs/2606.16809)
...
### [104] [Architecture Carbon Tool v3: Enabling Sustainability-aware Silicon System Design Exploration](https://arxiv.org/abs/2606.16889)
