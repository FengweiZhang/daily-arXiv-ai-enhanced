...
### [6] [A Practical AI-Driven Strategy for Cell On/Off Switching under Adaptable QoS Constraints](https://arxiv.org/abs/2606.05019)
...
### [7] [Bridging High-Level Intent and Network Execution: Detecting Violations and Intent Drift Through Low-Level Traffic Analysis](https://arxiv.org/abs/2606.05076)
...
### [8] [RAMC: Remote Access Memory Channels over HPE Slingshot](https://arxiv.org/abs/2606.05094)
...
### [9] [Puffin-Backed Vector Indexes: Attaching Approximate Nearest Neighbor Indexes to Apache Iceberg Snapshots for Compute-Disaggregated Query Engines](https://arxiv.org/abs/2606.04196)
*Artur Borycki*
...
### [10] [GraftDB: Dynamic Folding of Concurrent Analytical Queries](https://arxiv.org/abs/2606.04303)
...
### [11] [Selectivity Estimation for Semantic Filters on Image Data](https://arxiv.org/abs/2606.04610)
...
### [12] [Bridge the Last-Mile Gap to Semantic Analytics: Compiling Natural-Language Queries into Semantic Operator Pipelines](https://arxiv.org/abs/2606.04641)
...
### [13] [Indexicon: A Spatial Indexing Library](https://arxiv.org/abs/2606.04676)
...
### [14] [GraphAlg Playground: An Online Platform for Learning and Experimenting with the GraphAlg Language](https://arxiv.org/abs/2606.04813)
...
### [15] [Neither Layer Alone: Epistemic Integrity Requires Hierarchical Joint Design for Long-Running AI Agents](https://arxiv.org/abs/2606.04017)
*Zhihong Shen*
...
### [16] [CodegenBench: Can LLMs Write Efficient Code Across Architectures?](https://arxiv.org/abs/2606.04023)
...
### [17] [The Biomimetic Architecture of Software 4.0](https://arxiv.org/abs/2606.04025)
...
### [18] [Unpredictable Safety: Domain-Dependent Compliance and the Transparency Gap in Open-Weight LLMs](https://arxiv.org/abs/2606.04035)
*Zacharie Bugaud*
...
### [19] [Analyzing the Evolution of Structural Communities within Microservice Architecture](https://arxiv.org/abs/2606.04047)
...
### [20] [Token Budgets: An Empirical Catalog of 63 LLM-Agent Budget-Overrun Incidents, with an Affine-Typed Rust Mitigation as a Case Study](https://arxiv.org/abs/2606.04056)
*Sajjad Khan*
...
### [21] [The Invisible Lottery: How Subtle Cues Steer Algorithm Choice in LLM Code Generation](https://arxiv.org/abs/2606.04057)
...
### [22] [Proof-Carrying Agent Actions: Model-Agnostic Runtime Governance for Heterogeneous Agent Systems](https://arxiv.org/abs/2606.04104)
*Zexun Wang*
...
### [23] [Towards Process Mining Use Case Map Models with PM4Py-UCM](https://arxiv.org/abs/2606.04350)
*Daniel Amyot*
...
### [24] [Beyond Single-Policy: Evaluating Composed Organization-Specific Policy Alignment in LLM Chatbots](https://arxiv.org/abs/2606.04394)
...
### [25] [Context-as-a-Service: Surfacing Cross-File Dependency Chains for LLM-Generated Developer Documentation](https://arxiv.org/abs/2606.04397)
...
### [26] [The State of Peer Review in Empirical Software Engineering: A Community Survey on Review Load, Quality, and GenAI Use](https://arxiv.org/abs/2606.04716)
...
### [27] [Revisiting Vul-RAG: Reproducibility and Replicability of RAG-based Vulnerability Detection with Open-Weight Models](https://arxiv.org/abs/2606.04739)
...
### [28] [UModel: An Agent-Ready Observability Data Modeling Method at Scale](https://arxiv.org/abs/2606.04799)
...
### [29] [Code Lifespan Survival Analysis (CLSA): Predicting the Survival of Source Code Lines Using AST-Aware Mining](https://arxiv.org/abs/2606.04993)
*Pavel Gurov*
...
### [30] [TeleSWEBench: A Commit-Driven Benchmark for Evaluating LLM-Powered Software Engineering in Telecommunications](https://arxiv.org/abs/2606.05001)
...
### [31] [Self-Reflective APIs: Structure Beats Verbosity for AI Agent Recovery](https://arxiv.org/abs/2606.05037)
...
### [32] [How Software Engineering Students Use LLMs to Write Research Papers: An Experience Report](https://arxiv.org/abs/2606.05114)
...
### [33] [UltraEP: Unleash MoE Training and Inference on Rack-Scale Nodes with Near-Optimal Load Balancing](https://arxiv.org/abs/2606.04101)
...
### [34] [ACEAPEX: Parallel LZ77 Decoding via Encode-Time Absolute Offset Resolution](https://arxiv.org/abs/2606.04268)
*Yakiv Shavidze*
...
### [35] [FlexNPU: Transparent NPU Virtualization for Dynamic LLM Prefill-Decode Co-location](https://arxiv.org/abs/2606.04415)
...
### [36] [D^2SD: Accelerating Speculative Decoding with Dual Diffusion Draft Models](https://arxiv.org/abs/2606.04446)
...
### [37] [Multi-SPIN: Multi-Access Speculative Inference for Cooperative Token Generation at the Edge](https://arxiv.org/abs/2606.04581)
...
### [38] [Ekka: Automated Diagnosis of Silent Errors in LLM Inference](https://arxiv.org/abs/2606.04594)
...
### [39] [Rectangular Matrix Multiplication in the Low-Bandwidth Model](https://arxiv.org/abs/2606.04652)
...
### [40] [Clownfish: Scaling DAG-based BFT Consensus via Sparse Edges](https://arxiv.org/abs/2606.04687)
...
### [41] [The local complexity of certifying parity](https://arxiv.org/abs/2606.04934)
...
### [42] [Graph Traversal on Tensor Cores: A BFS Framework for Modern GPUs](https://arxiv.org/abs/2606.05081)
...
### [43] [HighTide: An Agent-Curated Open-Source VLSI Benchmark Suite](https://arxiv.org/abs/2606.04126)
...
### [44] [GoldenFloat: A Phi-Derived Static-Split Floating-Point Family from GF4 to GF256 with a Lucas-Exact Integer Identity](https://arxiv.org/abs/2606.05017)
*Dmitrii Vasiliev*
...
### [45] [Polymarket-v1 Database](https://arxiv.org/abs/2606.04217)
*Boka Qin,Rui Yang*
...
### [46] [Dead Science Walking: Publication Bias and the AI Scientist Pipeline](https://arxiv.org/abs/2606.04220)
*Kargi Chauhan*
...
### [47] [When Does Structure Help? The Information Bonus of AlphaFold2 Representations over Protein Language Models](https://arxiv.org/abs/2606.04228)
*Kargi Chauhan*
