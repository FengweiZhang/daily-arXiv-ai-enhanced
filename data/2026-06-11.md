...
### [10] [Predictive and Spatially Aware Scheduling in Flexible Duplexing for Deterministic Communications](https://arxiv.org/abs/2606.11398)
...
### [11] [LLM-Enabled NWDAF: A Step Toward AI-Native 6G Network Intelligence](https://arxiv.org/abs/2606.11877)
...
### [12] [Exploratory Analysis of Wi-Fi 6 Dynamic Resource Unit Sharing in Small-Scale Network Scenarios](https://arxiv.org/abs/2606.11934)
...
### [13] [Greenness-Driven Scheduling in Far Edge Kubernetes: A CODECO Evaluation](https://arxiv.org/abs/2606.12136)
...
### [14] [LLMs+Graphs: Toward Graph-Native, Synergistic AI Systems](https://arxiv.org/abs/2606.11560)
...
### [15] [Querying Cohesive Subgraph regarding Span-Constrained Triangles on Temporal Graphs with Dynamic Index Maintenance](https://arxiv.org/abs/2606.11582)
...
### [16] [Efficient Graph Indexing for Interval-Aware Vector Search](https://arxiv.org/abs/2606.11789)
...
### [17] [Neuro-Relational Programs: Unifying Queries and Neural Computation over Structured Data](https://arxiv.org/abs/2606.11946)
...
### [18] [TAHOE: Text-to-SQL with Automated Hint Optimization from Experience](https://arxiv.org/abs/2606.12387)
...
### [19] [Neural-Parameterized Cellular Automata for Wildfire Spread](https://arxiv.org/abs/2606.11676)
...
### [20] [A Computational Model for Measuring Adaptability Among U.S. Farmers: Evidence from 1997-2022](https://arxiv.org/abs/2606.11995)
*Hossein Sabzian*
...
### [21] [From Agent Identity to Agent Economy: Measuring the Operational Readiness of ERC-8004 AI Agents](https://arxiv.org/abs/2606.12128)
...
### [22] [Local Stress Redistribution Controls Interactions between Hydraulic Fractures and Pre-existing Fractures](https://arxiv.org/abs/2606.12347)
...
### [23] [A coupled finite element formulation for chemo-mechano-thermodynamical contact and its application to bonding and debonding](https://arxiv.org/abs/2606.12375)
*Roger A. Sauer*
...
### [24] [SPEAR: A System for Post-Quantization Error-Adaptive Recovery Enabling Efficient Low-Bit LLM Serving](https://arxiv.org/abs/2606.11244)
...
### [25] [A Fast Locality Simulator for GEMM Design-Space Exploration on Multi-Chiplet GPUs](https://arxiv.org/abs/2606.11716)
...
### [26] [Making Locality-aware GEMM Compatible with Page-Granularity Placement on Chiplet GPUs](https://arxiv.org/abs/2606.11718)
...
### [27] [BenDi: An Energy-Efficient Quasi-Stochastic Systolic Architecture for Edge Bioelectronics](https://arxiv.org/abs/2606.12235)
...
### [28] [Web-Native Graphical EMF Model Editors](https://arxiv.org/abs/2606.11442)
...
### [29] [Defeater Cards: Characterizing and Managing Safety Assurance Case Defeaters](https://arxiv.org/abs/2606.11462)
...
### [30] [SentTrack: Sentiment-Driven Bottleneck Detection in GitHub Issue Repositories](https://arxiv.org/abs/2606.11476)
...
### [31] [Acoda: Adversarial Code Obfuscation for Defending against LLM-based Analysis](https://arxiv.org/abs/2606.11755)
...
### [32] [Understanding and Detecting Scalability Faults in Large-Scale Distributed Systems](https://arxiv.org/abs/2606.11815)
...
### [33] [How Requirements Quality Makes (or Breaks) Traceability Link Recovery](https://arxiv.org/abs/2606.11834)
...
### [34] [Enhancing LLM-Based Code Translation with Verified Multi-Semantic Representations](https://arxiv.org/abs/2606.11863)
...
### [35] [Agents All the Way Down; A Methodology for Building Custom AI Agents from Substrate to Production](https://arxiv.org/abs/2606.11869)
...
### [36] [Characterizing Software Aging in GPU-Based LLM Serving Systems](https://arxiv.org/abs/2606.11916)
...
### [37] [Exploration Structure in LLM Agents for Multi-File Change Localization](https://arxiv.org/abs/2606.11976)
...
### [38] [Undefined Behavior in C and C++: An Experiment With Desktop Use Cases](https://arxiv.org/abs/2606.12064)
...
### [39] [Mind your key: An Empirical Study of LLM API Credential Leakage in iOS Apps](https://arxiv.org/abs/2606.12212)
...
### [40] [Rule Taxonomy and Evolution in AI IDEs: A Mining and Survey Study](https://arxiv.org/abs/2606.12231)
