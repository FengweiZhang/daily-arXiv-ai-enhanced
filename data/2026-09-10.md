...
### [1] [Violet: Enabling Full Virtualization for M-mode RTOS on RISC-V](https://arxiv.org/abs/2609.09833)
...
### [2] [Introducing Consort: A Spec-First Agent Framework for Enforced, Test-Driven Development on Live Database Branches](https://arxiv.org/abs/2609.09671)
*Kevin Hartman*
...
### [3] [OASIS: A Rubric-Based Multimodal Assessment Platform Using Large Language Models](https://arxiv.org/abs/2609.09180)
...
### [4] [Evaluating Enterprise Analytics Agents: An End-to-End, Trace-Backed Methodology](https://arxiv.org/abs/2609.09182)
...
### [5] [The Double Measurement Confound in Agent Benchmarks: De-Scaffolding, Ground-Truth Scoring, and Reliability Beyond the Mean](https://arxiv.org/abs/2609.09218)
...
### [6] [Cost-Aware Post-Hoc Deferral Under Calibration and Shift: An Environmental AI Case Study](https://arxiv.org/abs/2609.09235)
...
### [7] [Talking to Itself While Coding: What Makes Comments Help Code Generation?](https://arxiv.org/abs/2609.09242)
...
### [8] [How effective are traditional test criteria at detecting bugs in large language models generated code?](https://arxiv.org/abs/2609.09315)
...
### [9] [The Vibe Shift in Software Engineering: Evaluating AI-Led Conversational Programming for Performance, Cognition, and Responsible Adoption](https://arxiv.org/abs/2609.09560)
...
### [10] [XAgent: eXecution-guided Agentic AI for Effective Localization and Resolution of GitHub Issues](https://arxiv.org/abs/2609.09769)
...
### [11] [Keep Evaluation Fair: Detecting Data Leakage in Code Generation Benchmarks via Membership Inference Attacks](https://arxiv.org/abs/2609.09865)
...
### [12] [Socio-technical and Ethical Dimensions of Architecture Practices in FLOSS](https://arxiv.org/abs/2609.09975)
*Sven Thielen*
...
### [13] [Beyond Repository Boundaries: Cross-Repository Graph Retrieval for Code Generation](https://arxiv.org/abs/2609.09987)
...
### [14] [GraphDroid: Asynchronous LLM-Based Mobile App GUI Testing via History-Aware Exploration and Hybrid Intent Fulfillment](https://arxiv.org/abs/2609.10031)
...
### [15] [If It's Not Buggy, Don't Fix It: On the Dynamics of Iterative Bug-fixing with LLMs](https://arxiv.org/abs/2609.10123)
...
### [16] [A-JIT: Agentic Just-In-Time Software Construction](https://arxiv.org/abs/2609.10248)
...
### [17] [Ensembling LLMs for AI-Augmented Cybersecurity Software Requirements Generation](https://arxiv.org/abs/2609.10316)
...
### [18] [Retrofitting Code Using LLMs to Support Exceptional Behavior](https://arxiv.org/abs/2609.10397)
...
### [19] [Towards Scalable and Cost-Efficient Vulnerability Detection: A Study on Automatic Query Generation](https://arxiv.org/abs/2609.10412)
...
### [20] [Shift-Accumulate Attention: Multiplier-Free Query--Key Products for Transformer Decoding](https://arxiv.org/abs/2609.09208)
...
### [21] [Academia x Industry: The Role of Fundamentals for Silicon in an AI Native Era](https://arxiv.org/abs/2609.09344)
...
### [22] [HLSFactory-Agent: Large-Scale Agentic HLS Dataset Construction from Academic and Open-Source Projects](https://arxiv.org/abs/2609.09519)
...
### [23] [Benchmarking Agentic HLS Design Tasks With HLS-Eval](https://arxiv.org/abs/2609.09526)
...
### [24] [Differential Stochastic Simulated Annealing Processor for Fully Connected 2048-Spin Optimization](https://arxiv.org/abs/2609.09559)
...
### [25] [UNISON: A Co-Designed Near-Memory Scheduler of Session KV Residency for LLM Agents](https://arxiv.org/abs/2609.09643)
...
### [26] [Minimal Deadlock-Free Routing for Degree-Six Triangular-Lattice Meshes and Tori with Two Forbidden Turns](https://arxiv.org/abs/2609.09746)
...
### [27] [HBFSim: Fast and Faithful Simulation of High-Bandwidth Flash Under Real GPU Execution](https://arxiv.org/abs/2609.09800)
...
### [28] [AMEND: Audited Margins Enable Nonblocking Drops in GPU-PIM LLM Decoding](https://arxiv.org/abs/2609.09823)
...
### [29] [SAGE: Semantic-Aware Geographic Error Recovery for AI Data Movement](https://arxiv.org/abs/2609.10126)
...
### [30] [CertiFlash: A Formal Verification Framework for Flash Translation Layers in Computational Solid State Drives](https://arxiv.org/abs/2609.10347)
...
### [31] [When Does Low-Bit Quantization Preserve the Decisions of Vector Search?](https://arxiv.org/abs/2609.09854)
*Wenxuan Xiao,Xu Cao*
...
### [32] [Contextual Utility of Quantization Moves in Extreme Low-Bit LLMs](https://arxiv.org/abs/2609.09867)
*Wenxuan Xiao,Xu Cao*
...
### [33] [Few Rows Tell Them Apart: Equivalence of Queries Mixing Set and Bag Semantics](https://arxiv.org/abs/2609.09978)
*Sara Cohen*
...
### [34] [Improving 5G AI-RAN MCS Selection by Predicting Retransmissions](https://arxiv.org/abs/2609.09324)
...
### [35] [Efficient User Association and Wireless Scheduling with Shorter Time-Scale Rate Adaptation](https://arxiv.org/abs/2609.09387)
...
### [36] [QPS-ToR: A Parallel Iterative Switching Algorithm for Reconfigurable Optical Datacenter Switching](https://arxiv.org/abs/2609.09400)
...
### [37] [Prototyping QoE-Aware Rate Adaptation in Cellular Networks with Commercial Applications](https://arxiv.org/abs/2609.09490)
...
### [38] [Automated Mobile Video Objective Testing System](https://arxiv.org/abs/2609.09579)
...
### [39] [Contextual Bandit-Based Decomposition of Network Slice Requirements under Cumulative Resource Budget Constraints](https://arxiv.org/abs/2609.09624)
...
### [40] [Can AI Agents Detect and Repair Artifact Drift in Network Experiments?](https://arxiv.org/abs/2609.09849)
...
### [41] [Can AI Agents Deliver Verifiable Network-Wide Outcomes Across Authority Boundaries?](https://arxiv.org/abs/2609.10181)
...
### [42] [HybridFLow: SDN-Orchestrated Client Partitioning for Hybrid Federated Learning](https://arxiv.org/abs/2609.10404)
...
### [43] [HAPS-RIS or HAPS-Relay: Which Outperforms Under Impairments with NOMA in 6G NTN?](https://arxiv.org/abs/2609.10468)
...
### [44] [Fixed-mesh based approach for modeling of superconducting magnetic bearings](https://arxiv.org/abs/2609.09347)
...
### [45] [Geometric organization of olfactory descriptor data in the Poincaré disk](https://arxiv.org/abs/2609.09573)
...
### [46] [Joint nonlinearity in a stiffened aluminium wingbox panel and what it requires of a reduced basis](https://arxiv.org/abs/2609.10088)
...
### [47] [Embedding Model-form Uncertainty in Probabilistic Calibration of Digital Twins for Bridges](https://arxiv.org/abs/2609.10171)
...
### [48] [Integrated Population Balance and Multiphysics Modeling for Predicting Undesired Agglomeration in Small Molecule Manufacturing](https://arxiv.org/abs/2609.10256)
...
### [49] [LBFAST: A Lightweight Moment-Represented Lattice Boltzmann Solver for Multi-GPU Architectures](https://arxiv.org/abs/2609.09160)
...
### [50] [SMCC-Empowered Digital Twins for Sensorless Monitoring in Large-Scale AI-Driven IoT Systems](https://arxiv.org/abs/2609.09161)
*Vincenzo Sammartino*
...
### [51] [HELIOS: Guardrailed LLM-Driven Evolution of Autonomous Resource Orchestration Policies for Multi-Cloud Distributed Systems](https://arxiv.org/abs/2609.09164)
...
### [52] [TFR-GNN: Topology- and Fault-Aware Graph Neural Scheduling for Heterogeneous Distributed Computing Systems](https://arxiv.org/abs/2609.09165)
...
### [53] [Smart Adaptive Computing Across the Continuum: LLMs in IoT-Edge-Cloud Resource Management](https://arxiv.org/abs/2609.09348)
...
### [54] [Breaking Fault Lines: Unifying TEE-Assisted BFT Consensus in Partially Trusted Worlds](https://arxiv.org/abs/2609.09742)
...
### [55] [Epoch: Compiling Diffusion Blocks for Sparse MoE Serving](https://arxiv.org/abs/2609.09748)
...
### [56] [Introvert Clustering for Distributed Graph Algorithms](https://arxiv.org/abs/2609.10044)
...
### [57] [CEDD-optimizer: Enabling Cost-Efficient Dataset Distillation on Geographically Distributed Edge Systems](https://arxiv.org/abs/2609.10151)
...
### [58] [Stencil Computation at the Intersection of AI and HPC](https://arxiv.org/abs/2609.10368)
...
### [59] [Avatar: Toward Autonomous End-to-End Orchestration of Scientific Workflows using LLMs](https://arxiv.org/abs/2609.10509)
