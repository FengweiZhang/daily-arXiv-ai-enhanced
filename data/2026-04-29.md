...
### [11] [The role of physical models in the validation and calibration of numerical models -- The example of the Lillebælt Bridge](https://arxiv.org/abs/2604.25623)
...
### [12] [Data Driven Calibration of Analytical Concrete Creep Models Considering Preloading Effects Using Gaussian Processes](https://arxiv.org/abs/2604.25690)
...
### [13] [Unfitted Multi-Level hp Refinement for Localized and Moving Solution Features](https://arxiv.org/abs/2604.25797)
...
### [14] [Spark Policy Toolkit: Semantic Contracts and Scalable Execution for Policy Learning in Spark](https://arxiv.org/abs/2604.25061)
*Zeyu Bai*
...
### [15] [CacheFlow: Efficient LLM Serving with 3D-Parallel KV Cache Restoration](https://arxiv.org/abs/2604.25080)
...
### [16] [Adaptive Management of Microservices in Dynamic Computing Environments: A Taxonomy and Future Directions](https://arxiv.org/abs/2604.25222)
...
### [17] [CUDA Kernel Optimization and Counter-Free Performance Analysis for Depthwise Convolution in Cloud Environments](https://arxiv.org/abs/2604.25422)
...
### [18] [Economical and ecological impact of sector coupling applied to computing clusters](https://arxiv.org/abs/2604.25540)
...
### [19] [Volitional Multiagent Atomic Transactions: Describing People and their Machines](https://arxiv.org/abs/2604.25596)
...
### [20] [SWE-QA: A Dataset and Benchmark for Complex Code Understanding](https://arxiv.org/abs/2604.24814)
...
### [21] [Programming with Data: Test-Driven Data Engineering for Self-Improving LLMs from Raw Corpora](https://arxiv.org/abs/2604.24819)
...
### [22] [A systematic literature Review for Transformer-based Software Vulnerability detection](https://arxiv.org/abs/2604.24822)
...
### [23] [FGDM: Reasoning Aware Multi-Agentic Framework for Software Bug Detection using Chain of Thought and Tree of Thought Prompting](https://arxiv.org/abs/2604.24831)
...
### [24] [Supporting Belonging in Software Engineering Through Role Models Exposure](https://arxiv.org/abs/2604.25099)
...
### [25] [R$^3$-SQL: Ranking Reward and Resampling for Text-to-SQL](https://arxiv.org/abs/2604.25325)
...
### [26] [Commit-Aware Learning-Based Test Case Prioritization for Continuous Integration](https://arxiv.org/abs/2604.25363)
...
### [27] [CoRE: A Fine-Grained Code Reasoning Benchmark Beyond Output Prediction](https://arxiv.org/abs/2604.25399)
...
### [28] [Recommending Usability Improvements with Multimodal Large Language Models](https://arxiv.org/abs/2604.25420)
...
### [29] [AI as Consumer and Participant: A Co-Design Agenda for MBSE Substrates and Methodology](https://arxiv.org/abs/2604.25526)
*Siyuan Ji*
...
### [30] [An Empirical Analysis of Mobile Energy Consumption Across User Configurations](https://arxiv.org/abs/2604.25587)
*Wellington Oliveira*
...
### [31] [PLMGH: What Matters in PLM-GNN Hybrids for Code Classification and Vulnerability Detection](https://arxiv.org/abs/2604.25599)
...
### [32] [Using Large Language Models for Black-Box Testing of FMU-Based Simulations](https://arxiv.org/abs/2604.25650)
...
### [33] [Spreadsheet Modeling Experiments Using GPTs on Small Problem Statements and the Wall Task](https://arxiv.org/abs/2604.25689)
...
### [34] [Bug-Report-Driven Fault Localization: Industrial Benchmarking and Lesson Learned at ABB Robotics](https://arxiv.org/abs/2604.25700)
...
### [35] [Learning Generalizable Multimodal Representations for Software Vulnerability Detection](https://arxiv.org/abs/2604.25711)
...
### [36] [SAFEdit: Does Multi-Agent Decomposition Resolve the Reliability Challenges of Instructed Code Editing?](https://arxiv.org/abs/2604.25737)
...
### [37] [Scenario-based System Testing for Distributed Robotics Applications](https://arxiv.org/abs/2604.25772)
...
### [38] [Can Code Evaluation Metrics Detect Code Plagiarism?](https://arxiv.org/abs/2604.25778)
...
### [39] [Key Developer Roles and Organizational Coupling in Microservices: A Longitudinal Analysis](https://arxiv.org/abs/2604.25804)
...
### [40] [Does social identity matter in software engineering? Assessing the case of research software engineers](https://arxiv.org/abs/2604.25831)
...
### [41] [RESTestBench: A Benchmark for Evaluating the Effectiveness of LLM-Generated REST API Test Cases from NL Requirements](https://arxiv.org/abs/2604.25862)
...
### [42] [From Threads to Trajectories: A Multi-LLM Pipeline for Community Knowledge Extraction from GitHub Issue Discussions](https://arxiv.org/abs/2604.25880)
...
### [43] [Carbon-Taxed Transformers: A Green Compression Pipeline for Overgrown Language Models](https://arxiv.org/abs/2604.25903)
...
### [44] [VisualNeo: Bridging the Gap between Visual Query Interfaces and Graph Query Engines](https://arxiv.org/abs/2604.25283)
...
### [45] [On the Benefits of Traffic "Reprofiling" -- The Multiple Hops Case -- Part II](https://arxiv.org/abs/2604.24930)
...
### [46] [Optimization of Model Splitting, Placement, and Chaining for Multi-hop Split Learning and Inference](https://arxiv.org/abs/2604.25197)
...
### [47] [Probing for Better Age of Information in Energy-Harvesting Random Access Networks](https://arxiv.org/abs/2604.25479)
...
### [48] [Design Insights into Partition Placement and Routing for DNN Inference in Multi-Hop Edge Networks](https://arxiv.org/abs/2604.25571)
...
### [49] [Chorusing Synchronization Signals for Ambient 5G Backscatter](https://arxiv.org/abs/2604.25641)
...
### [50] [EOS-Bench: A Comprehensive Benchmark for Earth Observation Satellite Scheduling](https://arxiv.org/abs/2604.25782)
...
### [51] [Slice Agent: Identifying and Isolating Slices in Shared Open Radio Unit](https://arxiv.org/abs/2604.25857)
...
### [52] [Decoding Delay Guarantees of Space Regulated Multiple Access Random Wireless Networks using Successive Interference Cancellation](https://arxiv.org/abs/2604.25868)
