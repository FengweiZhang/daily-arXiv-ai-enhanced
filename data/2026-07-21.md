...
### [20] [MechMem-RTL: Reusing Verified Mechanism Memories for LLM-Based RTL Repair](https://arxiv.org/abs/2607.17053)
...
### [21] [Schema-Bound LLM Control of Scientific Instrumentation through Model Context Protocol Skills](https://arxiv.org/abs/2607.17012)
...
### [22] [Can LLM Code Explanations Adapt to Diverse Problem-Solvers' Needs?](https://arxiv.org/abs/2607.17022)
...
### [23] [Where Does Agent Reliability Come From? A Cross-Benchmark Decomposition of Verification Loops, Specialist Models, and Scaffolding in a Production Enterprise Agent](https://arxiv.org/abs/2607.17044)
...
### [47] [AirMoE: Statistic-Augmented Over-the-Air MoE for Collaborative Intelligence](https://arxiv.org/abs/2607.16562)
...
### [48] [Wait-Free Locks Should Not Fear Later Arrivals](https://arxiv.org/abs/2607.16571)
*Tong Che*
...
### [49] [Hardware-Transparent I/O Governance in Disaggregated Heterogeneous Storage](https://arxiv.org/abs/2607.16578)
...
### [50] [Cold-Start Model Delivery in Kubernetes Inference Serving: An Empirical Study of OCI-Based Distribution and Its Integrity](https://arxiv.org/abs/2607.16596)
*Georgii Kliukovkin*
...
### [51] [Roomie: Interference-Aware Colocation for Efficient Model Serving](https://arxiv.org/abs/2607.16784)
...
### [52] [Technical Report: AI-Assisted Gated DeltaNet Optimization on NVIDIA Blackwell](https://arxiv.org/abs/2607.16831)
...
### [53] [Beyond Storage: State as a Runtime Control Problem in Parallel and Distributed Systems](https://arxiv.org/abs/2607.16836)
...
### [54] [EdgeCoInfer: Hierarchical Collaborative Inference for On-Device Multimodal Large Models](https://arxiv.org/abs/2607.17143)
...
### [55] [LMEdge: QoS-Aware LLM Inference Orchestration on Edge Clusters](https://arxiv.org/abs/2607.17175)
...
### [56] [Talaria: Session-Aware Serverless Serving of Hundred-Billion-Parameter LLMs](https://arxiv.org/abs/2607.17181)
...
### [57] [Taurus: Accelerating Out-of-Core Graph Neural Network Inference on Billion-Scale Graphs](https://arxiv.org/abs/2607.17374)
...
### [58] [A Training-Memory Regression in MLA Sequence Parallelism: Why Megatron-Core Forbids Absorption, and LAGA -- a Communication-Efficient Fix](https://arxiv.org/abs/2607.17644)
*Changzheng Ma*
...
### [59] [Byzantine Fault-Tolerant Post-Quantum Distributed Quorum Signatures](https://arxiv.org/abs/2607.17700)
...
### [60] [AutoEncoder-Compressed Parallel Split Learning for Pre-trained Model Fine-Tuning](https://arxiv.org/abs/2607.17913)
...
### [61] [ExpertPlex: A High-Goodput Disaggregated Serving System for MoE LLMs with Adaptive Persistent Kernels](https://arxiv.org/abs/2607.18002)
...
### [62] [HyMCache: A KV Cache Framework for Multi-Turn LLM Serving with CXL-Hybrid Memory](https://arxiv.org/abs/2607.18141)
...
### [63] [uSTM: A Lightweight and Efficient STM Supporting General Types and Deferred Aborts](https://arxiv.org/abs/2607.18178)
...
### [64] [Reproducible Research in Network Modeling](https://arxiv.org/abs/2607.16433)
...
### [65] [Robust KV Cache Management for LLM Serving under Output Token Length Uncertainty](https://arxiv.org/abs/2607.16892)
...
### [66] [PERA: A Perceive-Reason-Act Interface Bridging Sensing, Cognitive Reasoning, and Trustworthy Agentic Response for 6G](https://arxiv.org/abs/2607.16896)
...
### [67] [A Multi-Agent System for 5G Throughput Prediction in Multi-Operator Urban Environments](https://arxiv.org/abs/2607.16930)
...
### [68] [OrderMoE: An expert similarity driven distributed edge MoE inference](https://arxiv.org/abs/2607.17154)
...
### [69] [DAN-Scheduler: Deterministic Three-Stage Co-Optimization of Scheduling, Memory Layout, and Pipeline Overlap for General-Purpose NPUs](https://arxiv.org/abs/2607.17422)
...
### [70] [Diverge-Merge Formation and MAC Control in Structured Airspace](https://arxiv.org/abs/2607.17489)
...
### [71] [Self-Directed Spectrum Allocation Framework for Integrated TN-NTN 6G Networks](https://arxiv.org/abs/2607.17561)
...
### [72] [Token Communications (TokCom): A Unified AI-Native Communication Framework](https://arxiv.org/abs/2607.17628)
...
### [73] [Mobile Network Control with a World Model](https://arxiv.org/abs/2607.17747)
...
### [74] [Beyond Car Sharing: Uncertainty-Aware Pooling of Vehicular Compute at the Network Edge](https://arxiv.org/abs/2607.17893)
...
### [75] [Enhanced Dynamic Beamwidth Selection-based THz MAC Protocol for Wireless Data Center Networks](https://arxiv.org/abs/2607.17996)
...
### [76] [Human Grounded Evaluation of Large Language Models for Optical Network Automation](https://arxiv.org/abs/2607.18068)
...
### [77] [ClouDens: Operational Context-Aware Anomaly Detection for Large-scale Cloud System Monitoring](https://arxiv.org/abs/2607.18127)
...
### [78] [AI Agent Communications in AI-Native 6G Network: Status, Challenges and Opportunities](https://arxiv.org/abs/2607.18138)
*Qiang Duan*
...
### [79] [Causality and Minimal Supports in Recursive Datalog](https://arxiv.org/abs/2607.16443)
...
### [80] [I-Rex: An Interactive Debugger for SQL](https://arxiv.org/abs/2607.16452)
...
### [81] [Semantic Conformance of Concurrency Control Protocols under Mixed Isolation Levels](https://arxiv.org/abs/2607.16696)
...
### [82] [Towards Inference-Aware Privacy Guidance for Data Preparation](https://arxiv.org/abs/2607.16710)
...
### [83] [STEM2: A Fast and Space-efficient Data Structure for Exact Multi-Set Membership Query](https://arxiv.org/abs/2607.16990)
...
### [84] [SAGA: Synthetic Agentic Graph Architecture for Temporal Benchmark Generation](https://arxiv.org/abs/2607.17288)
...
### [85] [Extending Elle for Transaction Workloads with Duplicate Values](https://arxiv.org/abs/2607.17515)
...
### [86] [Terascale Query Processing in the Browser: Rethinking GPU Acceleration](https://arxiv.org/abs/2607.17571)
...
### [87] [From Blind Search to Memory-Aware Evolution: Efficient DBMS Tuning via Collaborative Diagnosis and Utility-Aware Retrieval](https://arxiv.org/abs/2607.17841)
...
### [88] [Natural Language Access to Domain-Specific Metadata: A Reusable Framework for LLM Query Generation](https://arxiv.org/abs/2607.18029)
...
### [89] [Rethinking Polling Efficiency in Service Core Network Stacks](https://arxiv.org/abs/2607.16408)
...
### [90] [SuperPass: Fast-Tracking Blocking Threads to Mitigate Priority Inversion on Mobile Devices](https://arxiv.org/abs/2607.18097)
...
### [91] [On Hardware-Aware Design and Optimization of Edge Intelligence](https://arxiv.org/abs/2607.16297)
...
### [92] [Enabling Spatially Fine-Grained DVFS in Neural Processing Units for Energy-Efficient LLM Serving](https://arxiv.org/abs/2607.16473)
...
### [93] [Auto-Scaling Heterogeneous Neural Processing Units for Energy and Cost-Efficient LLM Serving](https://arxiv.org/abs/2607.16488)
...
### [94] [Mitigating Compiler Fusion-Induced Power Bursts in Mobile NPU Inference as the Battery Depletes](https://arxiv.org/abs/2607.16555)
...
### [95] [Rtl2lean: Automated RTL-to-Lean Translation with Hierarchical Theorem Generation and Lemma Reuse](https://arxiv.org/abs/2607.16855)
...
### [96] [Provably Good Prim-Dijkstra Revisited: New Theory and a Practical Algorithm for a Classical VLSI Routing Problem with LLMs](https://arxiv.org/abs/2607.17005)
*Keren Zhu*
...
### [97] [ThAME: 3D Memory-Enabled Heterogeneous Accelerator for LLM Mixture of Experts](https://arxiv.org/abs/2607.17074)
...
### [98] [ThRIve: Thermally Robust CNN Inference via Low-Rank Adaptation in Heterogeneous PIM Architectures](https://arxiv.org/abs/2607.17091)
...
### [99] [Inter-Set Correlation-Aware Replacement Policy for Energy Efficient RTM-based Caches](https://arxiv.org/abs/2607.17274)
...
### [100] [ADEPT: Architecture-Driven Energy-Efficient CNN Fine-Tuning on PIM Accelerators](https://arxiv.org/abs/2607.17371)
...
### [101] [Transition-Aware Backend Dispatch for Edge LLM Inference](https://arxiv.org/abs/2607.17415)
...
### [102] [D-NOVA: In-Storage Retrieval Accelerator via Dual-Bound 3D NAND-Optimized Similarity Search with Vector Adaptation](https://arxiv.org/abs/2607.17538)
...
### [103] [Isolation Failure From Shared Storage: Characterizing and Exploiting Page-Cache SCA Leakage Across Containers and VMs](https://arxiv.org/abs/2607.17518)
...
### [104] [Cross-Domain Acceleration of Open Modification Search: From Commodity Platforms to Emerging Memory and Storage Devices](https://arxiv.org/abs/2607.17569)
...
### [105] [New Number Formats for FFT IP Cores in Optical OFDM Transceivers](https://arxiv.org/abs/2607.17835)
...
### [106] [SEAM-V: A Hybrid-Decoupled RISC-V Vector Processor with Backend-Visible EP Context for Sustained Vector Throughput](https://arxiv.org/abs/2607.17899)
...
### [107] [Fixed Point Exploration For CV-QKD IR QC-MET-LDPC Toward Hardware Implementation](https://arxiv.org/abs/2607.17960)
...
### [108] [Hardware Mechanisms to Dynamically Throttle AI Performance](https://arxiv.org/abs/2607.18069)
...
### [109] [A Practical Guide to Simulating Correlated Binary Outcomes](https://arxiv.org/abs/2607.16801)
...
### [110] [Efficient Bayesian Optimal Experimental Design for Expensive Computational Models over Finite Design Sets](https://arxiv.org/abs/2607.16933)
...
### [111] [Learning Dispute Structure for Settlement Prediction in Financial ADR: A Multi-Task and Cross-Institutional Approach](https://arxiv.org/abs/2607.17112)
*Koutarou Tamura*
...
### [112] [DiLLSUE: a differentiable GPU solver for link-based logit stochastic user equilibrium](https://arxiv.org/abs/2607.17344)
...
### [113] [Modeling elasto-viscoplastic free-surface flows with different yield surfaces](https://arxiv.org/abs/2607.17380)
...
### [114] [A Predict-then-Schedule framework for Power Distribution Networks with AI Data Centers](https://arxiv.org/abs/2607.17514)
...
### [115] [Contact-based inverse analysis for nonlinear material identification in spatially heterogeneous solids](https://arxiv.org/abs/2607.18156)
