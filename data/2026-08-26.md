...
### [10] [Place, Slice and Schedule: Hierarchical O-RAN Control of a Tethered mmWave UAV-gNB](https://arxiv.org/abs/2608.23824)
...
### [11] [BotScan: An adaptive active probing approach for identifying live IoT Botnet C2 servers at scale](https://arxiv.org/abs/2608.23854)
...
### [12] [Ray-Traced Augmentation for Signal Strength Based Localization](https://arxiv.org/abs/2608.23901)
...
### [13] [Centrality-Based Deployment of Queue Policies in Acyclic Multipath Routing Networks](https://arxiv.org/abs/2608.24131)
...
### [14] [WiCi: Wireless GPU Computing Infrastructure](https://arxiv.org/abs/2608.24204)
...
### [15] [LEMONS: Leveraging Model-Based Techniques to Enable Non-Intrusive Semantic Enrichment in Wireless Sensor Networks](https://arxiv.org/abs/2608.24277)
...
### [16] [A Capability Broker for Workflow-Network QoS Coordination in B5G/6G Industrial Services](https://arxiv.org/abs/2608.24496)
...
### [17] [ECO-COMM: An Ultra Low-Latency Event Camera based Optical Communication System](https://arxiv.org/abs/2608.24705)
...
### [18] [Decomposing Browser Pipeline Architectures for DOM-Sourced Particle Effects: Worker Offload, WebGL, and WebAssembly](https://arxiv.org/abs/2608.23609)
*Hossein Asadi*
...
### [19] [From Traceability to Justifiability: Accountability Structures in Agentic Software Engineering](https://arxiv.org/abs/2608.23610)
*Rashid Azarang*
...
### [20] [REFINE: A Multi-Agent LLM Approach for Evidence-Guided Code Refactoring](https://arxiv.org/abs/2608.23611)
...
### [21] [The Empire, Long Divided, Must Unite: Architectural Convergence in Three LLM Agent Harnesses](https://arxiv.org/abs/2608.23953)
*Dai Jiahong*
...
### [22] [SDR Driver for Precise Timing Applications](https://arxiv.org/abs/2608.23614)
*Fabrizio Pollastri*
...
### [23] [Rebuild Dossier: Mechanically-Enforced Specs for Agentic App Rebuilds, and What Model-Tier Failures Reveal](https://arxiv.org/abs/2608.23616)
*Parker Fawcett*
...
### [24] [Identifying Latent Declarative Representations of Code for Assisting Repository Migration](https://arxiv.org/abs/2608.23619)
...
### [25] [When May an Agent Stop? Evidence-Carrying Termination for Tool-Using LLMs](https://arxiv.org/abs/2608.23623)
*Jason Liu*
...
### [26] [Callability Is Not Operability: Controlled Interface Interventions for LLM Agents](https://arxiv.org/abs/2608.23628)
*Zihao Wang*
...
### [27] [FPGAgent: An LLM-Assisted Framework for Autonomous HLS Code Generation and Verification in FPGA Environments](https://arxiv.org/abs/2608.23630)
...
### [28] [ToolRobustBench: Stage-Wise Perturbation Evaluation and Failure Diagnosis for Tool-Calling Agents](https://arxiv.org/abs/2608.23635)
...
### [29] [Automated Synthesis of Cloud Emulators](https://arxiv.org/abs/2608.23842)
...
### [30] [Feedback That Backfires: Why Small Language Model Agents Repeat the Call They Just Watched Fail](https://arxiv.org/abs/2608.23651)
*Esmail Gumaan*
...
### [31] [Beyond Executable Models: The Pufibara Agent Harness and the Modelica Agent Workflow Benchmark for Physical System Modeling](https://arxiv.org/abs/2608.23653)
*Zizhe Wang*
...
### [32] [Confidently Wrong, Silently So: Auditing Undetectable Failures of a Deployed On-Device Language Model](https://arxiv.org/abs/2608.23663)
...
### [33] [Enhancing Bug Report Templates in the TianoCore UEFI Firmware Development Community](https://arxiv.org/abs/2608.23754)
...
### [34] [SPIDER4TianoCore: Enhancing Patch-Propagation for the TianoCore UEFI Firmware Development Ecosystem](https://arxiv.org/abs/2608.23755)
...
### [35] [Scale, Concentration, and Entry Timing in the Shopify App Ecosystem: A Longitudinal Study of Platform Governance and Application Survival](https://arxiv.org/abs/2608.23771)
...
### [36] [Evaluating Language Models on Cross-Language Code Functional Equivalence](https://arxiv.org/abs/2608.23961)
...
### [37] [DeepRepoQA: Code Repository Question Answering with Deep Agent Exploration](https://arxiv.org/abs/2608.24221)
...
### [38] [Mutation Testing of Simulink Cyber-Physical System Models: Challenges and Solutions in Practice](https://arxiv.org/abs/2608.24250)
...
### [39] [Cross-Stack Validation of Language-Model Training: A Clinical Fine-Tuning Case Study](https://arxiv.org/abs/2608.24267)
*Thang Tran,Lan Dang*
...
### [40] [Towards LLM-Enhanced Android Taint Analysis](https://arxiv.org/abs/2608.24269)
...
### [41] [Observability and Fault Injection for LLM-Based Multi-Agent Systems in Software Engineering](https://arxiv.org/abs/2608.24271)
...
### [42] [Ockhamareto: Pareto-Gated Segment-Level Credit Assignment for Concise Unit-Test Generation with Reinforcement Learning](https://arxiv.org/abs/2608.24473)
...
### [43] [LumiXAI: A Modular Full-Stack Framework for Feature Attribution](https://arxiv.org/abs/2608.24524)
...
### [44] [Quantifying the Relationship Between Team Dysfunctions and Performance in Capstone Projects](https://arxiv.org/abs/2608.24634)
...
### [45] [Aging of Prompt Engineering Techniques Across LLM Versions](https://arxiv.org/abs/2608.24641)
...
### [46] [A Literate Programming Environment for Human and Machine Agents](https://arxiv.org/abs/2608.24644)
*Adam T. Burke*
...
### [47] [Causal Explanations of Process Monitor Predictions](https://arxiv.org/abs/2608.24672)
...
### [48] [''You Can't Open an LLM With a Screwdriver'': The De-Democratization of Software](https://arxiv.org/abs/2608.24720)
...
### [49] [From Natural Language Requirements to Graphical User Interfaces: Automated Prototyping and Verification with Pretrained Language Models](https://arxiv.org/abs/2608.24749)
*Kristian Kolthoff*
...
### [50] [Automatic Model Card Generation Using an LLM](https://arxiv.org/abs/2608.24807)
...
### [51] [A co-rotational formulation for arbitrarily shaped planar beams under large displacements and rotations](https://arxiv.org/abs/2608.23883)
...
### [52] [IC-ThermBench: An Open, Progressive Benchmark for Generalizable 2.5D/3D-IC Thermal Learning](https://arxiv.org/abs/2608.23977)
...
### [53] [Topology optimization of force densities for form finding of cable structures](https://arxiv.org/abs/2608.24177)
*Nicolò Pollini*
...
### [54] [Concept of Time-Reversal Characteristic Modes in Non-Free-Space Environments](https://arxiv.org/abs/2608.24489)
*Chenbo Shi,Jin Pan*
...
### [55] [MoRF-AST: Calibrated Probabilistic Virtual Sensing for Structural Monitoring under Changing Operating Conditions](https://arxiv.org/abs/2608.24531)
...
### [56] [A Co-Simulation Platform Coupling Land Use, Transportation, and Building Energy: Development and Case Study](https://arxiv.org/abs/2608.24817)
...
### [57] [A Survey of Timing Variability in Microservice-Based Software-Defined Vehicles](https://arxiv.org/abs/2608.23649)
...
### [58] [Memory-Sovereign Inference: Output-Exact Execution Beyond Full Residency](https://arxiv.org/abs/2608.23805)
*Lukas Stepanek*
...
### [59] [ShardMeter: Sharded and Geo-Distributed Training Without the Guesswork](https://arxiv.org/abs/2608.23840)
...
### [60] [A Few Shared Random Bits Suffice for Constant-Round Almost Stable Matching](https://arxiv.org/abs/2608.24102)
...
### [61] [pigzpp: Fast, Parallel, Portable Compression for the Whole Stack](https://arxiv.org/abs/2608.24153)
*Thamme Gowda*
...
### [62] [An HPC Approach to Accelerate Tensor Decompositions](https://arxiv.org/abs/2608.24307)
...
### [63] [Mixed-Precision SEM-Based CFD Simulations on GPUs: A Taylor-Green Vortex case](https://arxiv.org/abs/2608.24348)
...
### [64] [SatDL: Jointly Optimizing Data Redistribution and Training for Satellite-Based Distributed Learning](https://arxiv.org/abs/2608.24516)
...
### [65] [Scalable datacenter replication with mostly-synchronous consensus on hardware](https://arxiv.org/abs/2608.24622)
...
### [66] [Asynchronous Verifiable Information Dispersal with Low Space and Communication Complexity](https://arxiv.org/abs/2608.24636)
