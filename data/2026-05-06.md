...
### [1] [FINER-SQL: Boosting Small Language Models for Text-to-SQL](https://arxiv.org/abs/2605.03465)
...
### [2] [In-memory Multidimensional Indexing Using the skd-tree](https://arxiv.org/abs/2605.03640)
...
### [3] [ConRAD: Conformal Risk-Aware Neural Databases](https://arxiv.org/abs/2605.03806)
...
### [4] [Inconsistent Databases and Argumentation Frameworks with Collective Attacks](https://arxiv.org/abs/2605.03954)
...
### [5] [ARIS: Autonomous Research via Adversarial Multi-Agent Collaboration](https://arxiv.org/abs/2605.03042)
...
### [6] [ARISE: A Repository-level Graph Representation and Toolset for Agentic Fault Localization and Program Repair](https://arxiv.org/abs/2605.03117)
...
### [7] [Kerncap: Automated Kernel Extraction and Isolation for AMD GPUs](https://arxiv.org/abs/2605.03208)
...
### [8] [TeamUp: Semantic Project Matching and Team Formation for Learning at Scale](https://arxiv.org/abs/2605.03237)
...
### [9] [Exploring Sustainability in Scientific Software through Code Quality & Test Coverage Metrics](https://arxiv.org/abs/2605.03243)
...
### [10] [Operationalizing Software Engineering Theories for Practical Validation](https://arxiv.org/abs/2605.03257)
...
### [11] [POSTCONDBENCH: Benchmarking Correctness and Completeness in Formal Postcondition Inference](https://arxiv.org/abs/2605.03356)
...
### [12] [Multi-Agent Systems for Root Cause Analysis in Microservices](https://arxiv.org/abs/2605.03505)
...
### [14] [Geographic Variation in Stack Overflow Code Quality: Evidence from a Cross-Regional Study of Coding Practices](https://arxiv.org/abs/2605.03670)
...
### [15] [Deep Graph-Language Fusion for Structure-Aware Code Generation](https://arxiv.org/abs/2605.03689)
...
### [16] [AI Advocate: Educational Path to Transform Squads to the Future](https://arxiv.org/abs/2605.03800)
...
### [17] [KVerus: Scalable and Resilient Formal Verification Proof Generation for Rust Code](https://arxiv.org/abs/2605.03822)
...
### [18] [Beyond Rules: LLM-Powered Linting for Quantum Programs](https://arxiv.org/abs/2605.03943)
...
### [19] [Randomized and Diverse Input State Generation for Quantum Program Testing](https://arxiv.org/abs/2605.03957)
...
### [20] [Mitigating False Positives in Static Memory Safety Analysis of Rust Programs via Reinforcement Learning](https://arxiv.org/abs/2605.04000)
...
### [21] [Design and Implementation of BNN-Based Object Detection on FPGA](https://arxiv.org/abs/2605.03396)
...
### [22] [SPEC CPU2026: Characterization, Representativeness, and Cross-Suite Comparison](https://arxiv.org/abs/2605.03713)
...
### [23] [Tutti: Making SSD-Backed KV Cache Practical for Long-Context LLM Serving](https://arxiv.org/abs/2605.03375)
...
### [24] [Degeneracy-Aware Functional and Algorithmic Resilience in Virtualized 6G Networks Under Correlated Failures](https://arxiv.org/abs/2605.03035)
...
### [25] [Sensitivity Analysis of Tactical Wireless Network Design Under Realistic Operational Constraints](https://arxiv.org/abs/2605.03072)
...
### [26] [PERFECT: Personalized Federated Learning for CBRS Radar Detection](https://arxiv.org/abs/2605.03199)
...
### [27] [Surviving the Edge: Federated Learning under Networking and Resource Constraints](https://arxiv.org/abs/2605.03870)
...
### [28] [Renewables Power the Orbit? Achieving Sustainable Space Edge Computing via QoS-Aware Offloading](https://arxiv.org/abs/2605.03232)
...
### [29] [Single-Step Six-Dimensional Movable Antenna Reconfiguration for High-Mobility IoV: Modeling, Analysis, and Optimization](https://arxiv.org/abs/2605.03321)
...
### [30] [QoS Assurance Mechanism for 5G Network Slicing Based on the Deep Reinforcement Learning PPO Algorithm](https://arxiv.org/abs/2605.03345)
*Qingyang Li*
...
### [31] [CRT: Collision-Tolerant Residence Time for Deterministic Transmission in LEO Satellite Networks](https://arxiv.org/abs/2605.03382)
...
### [32] [DACP: A Scientific Data Access and Collaboration Protocol](https://arxiv.org/abs/2605.03411)
...
### [33] [Dynamic Hypergame for Task Assignment in Multi-platform Mobile Crowdsensing Under Incomplete Information](https://arxiv.org/abs/2605.03569)
...
### [34] [Cross-Slice Co-Location Risk-Aware SFC Provisioning in Multi-Slice LEO Satellite Networks](https://arxiv.org/abs/2605.03656)
...
### [35] [SprayCheck: Finding Gray Failures in Adaptive Routing Networks](https://arxiv.org/abs/2605.03702)
...
### [36] [Nested array design of extended coprime sets for DOA estimation of non-circular signals](https://arxiv.org/abs/2605.03856)
...
### [37] [From Barrier to Bridge: The Case for AI Data Center/Power Grid Co-Design](https://arxiv.org/abs/2605.03090)
...
### [38] [VDCores: Resource Decoupled Programming and Execution for Asynchronous GPU](https://arxiv.org/abs/2605.03190)
...
### [39] [On Solving Problems of Substantially Super-linear Complexity in $N^{o(1)}$ Rounds in the MPC Model](https://arxiv.org/abs/2605.03376)
*Andrzej Lingas*
...
### [40] [Enhancing Performance Insight at Scale: A Heterogeneous Framework for Exascale Diagnostics](https://arxiv.org/abs/2605.03561)
*Dragana Grbic*
...
### [41] [Lifting to tensors when compiling scientific computing workloads for AI Engines](https://arxiv.org/abs/2605.03566)
...
### [42] [A Workflow-Oriented Framework for Asynchronous Human-AI Collaboration in Hybrid and Compute-Intensive HPC Environments](https://arxiv.org/abs/2605.03743)
...
### [43] [Implementing True MPI Sessions and Evaluating MPI Initialization Scalability](https://arxiv.org/abs/2605.03983)
...
### [44] [Hybrid Machine Learning and Physical Modeling of Feedstock Deformation During Robotic 3D Printing of Continuous Fiber Thermoplastic Composites](https://arxiv.org/abs/2605.03186)
...
### [45] [Device-Induced Thrombus Formation in Cerebral Aneurysms: Linking Patient-Specific Clot Modeling and Functional Occlusion to Virtual Angiographic Assessment](https://arxiv.org/abs/2605.03536)
...
### [46] [Carbon-Aware Compute--Power Scheduling for AI Data Centers with Microgrid Prosumer Operations](https://arxiv.org/abs/2605.03751)
...
### [47] [Globally adaptive and locally regular point discretization of curved surfaces](https://arxiv.org/abs/2605.03803)
