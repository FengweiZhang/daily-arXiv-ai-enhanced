...
### [15] [Code Smells in Clojure: Initial Findings from a Grey Literature Review](https://arxiv.org/abs/2605.24049)
...
### [16] [More Skills, Worse Agents? Skill Shadowing Degrades Performance When Expanding Skill Libraries](https://arxiv.org/abs/2605.24050)
...
### [17] [TRACER: A Semantic-Aware Framework for Fine-Grained Contamination Detection in Code LLMs](https://arxiv.org/abs/2605.24079)
...
### [18] [Empirical Analysis and Detection of Hallucinations in LLM-Generated Bug Report Summaries](https://arxiv.org/abs/2605.24137)
...
### [19] [Understanding Conversational Patterns in Multi-agent Programming: A Case Study on Fibonacci Game Development](https://arxiv.org/abs/2605.24138)
...
### [20] [Towards Evaluation Engineering: An Empirical Study of ML Evaluation Harnesses in the Wild](https://arxiv.org/abs/2605.24213)
...
### [21] [Can Graph-Based Microservice Performance Detection Be Used for Microservice Intrusion Detection?](https://arxiv.org/abs/2605.24283)
*Yunjian Ma*
...
### [22] [Breaking Changes in Software Ecosystems: A Systematic Literature Review](https://arxiv.org/abs/2605.24397)
...
### [23] [Beyond AI Delegation: A Prompt Pattern Framework for Productive Struggle and Evaluative Judgement in Secure Coding Education](https://arxiv.org/abs/2605.24447)
...
### [24] [Code2UML: Agentic LLMs with context engineering for scalable software visualization](https://arxiv.org/abs/2605.24453)
...
### [25] [SmellDoc: Extending Elastic Stack for Microservice Bad Smell Detection and Visualization](https://arxiv.org/abs/2605.24471)
...
### [26] [From Prompting to Verification: How Experience Shapes Vibe Coding Practices](https://arxiv.org/abs/2605.24521)
...
### [27] [Multi-Agent Specification-based Metamorphic Testing of FMU-Based Simulations](https://arxiv.org/abs/2605.25101)
...
### [28] [Specification-Based Code-Text-Code Reengineering for LLM-Mediated Software Evolution](https://arxiv.org/abs/2605.25232)
...
### [29] [PR-Aware Automated Unit Test Generation: Challenges and Opportunities](https://arxiv.org/abs/2605.25285)
...
### [30] [Names Are All You Need: Effective and Safe Regression Test Selection for Python](https://arxiv.org/abs/2605.25356)
...
### [31] [Leveraging Language Models for Log Statement Generation in Multilingual Scenarios: How Far Are We?](https://arxiv.org/abs/2605.25374)
...
### [32] [A Heuristic Approach to Localize CSS Properties for Responsive Layout Failures](https://arxiv.org/abs/2605.25476)
...
### [33] [A Tertiary Review of Large Language Model-Based Code Generating Tasks: Trends, Challenges, and Future Directions](https://arxiv.org/abs/2605.25536)
...
### [34] [Meta-Engineering Harnesses for AI-Native Software Production: A Contract-Driven Adversarial Verification Architecture with Early Deployment Report](https://arxiv.org/abs/2605.25665)
...
### [35] [How Agentic AI Coding Assistants Become the Attacker's Shell](https://arxiv.org/abs/2605.25871)
...
### [39] [Federated Semantic Knowledge Graphs for Laboratory Workflows: A Structured Expert Elicitation Methodology Demonstrated Through Bioanalytical Workflow Twins](https://arxiv.org/abs/2605.23985)
...
### [40] [MemForest: An Efficient Agent Memory System with Hierarchical Temporal Indexing](https://arxiv.org/abs/2605.23986)
...
### [41] [Extending the (Elementary) Mathematical Data Model and MatBase with two new constraint types: inexistence and anti-existence](https://arxiv.org/abs/2605.24021)
*Christian Mancas*
...
### [42] [The Time is Here for Just-in-Time Systems: Challenges and Opportunities](https://arxiv.org/abs/2605.24096)
...
### [43] [AvalancheBench: Evaluating Enterprise Data Agents Through Latent World Recovery](https://arxiv.org/abs/2605.24183)
...
### [44] [Incorporating Deep Learning Design in Database Queries](https://arxiv.org/abs/2605.24207)
...
### [45] [LEARNT: A Practical Estimator for Cardinality of LIKE Queries with Formal Accuracy Guarantees](https://arxiv.org/abs/2605.24308)
...
### [46] [MetaboKG: An Analysis-centric Knowledge Graph Framework for Untargeted Metabolomics](https://arxiv.org/abs/2605.24706)
...
### [47] [Top-k Approximate Functional Dependency Discovery](https://arxiv.org/abs/2605.24925)
...
### [48] [CS-PQ: Cache-Friendly SIMD Product Quantization for Large-Scale ANNS Index Construction](https://arxiv.org/abs/2605.25521)
...
### [49] [Same Data, Different Schemas: Robustness of LLM-based Text-to-SQL](https://arxiv.org/abs/2605.25838)
...
### [50] [No Certificate, No Execution: Certified Traces as a Foundation for Trustworthy AI Agents](https://arxiv.org/abs/2605.24462)
...
### [51] [Toward Secure Operation and Management (O&M) of Satellite Constellations: Efficiency, Resilience, and Reliability in a Network Perspective](https://arxiv.org/abs/2605.24464)
...
### [52] [Fractional-gradient Sparsity with Autoencoding Sequential Deep Image Prior for 3D CT Reconstruction](https://arxiv.org/abs/2605.24670)
...
### [53] [Scalable High-Dimensional Bayesian Field Reconstruction with Finite Elements: Application to 3D Porous Media Flow](https://arxiv.org/abs/2605.24682)
...
### [54] [Exascale Hybrid Numerical-AI Ensembles for Operational Flood-Season Forecasting in East Asia: 15-km Decadal Hindcasts and 1-km High-Resolution Capability](https://arxiv.org/abs/2605.24896)
...
### [55] [Data-Driven Structural Health Monitoring of Short Carbon Fiber-Reinforced Polymer Composites via Multiphysics Phase-Field Simulation](https://arxiv.org/abs/2605.25287)
...
### [56] [AeroTSBoost: Temporal-Statistical Boosting for Real-World UAV Telemetry Anomaly Mining](https://arxiv.org/abs/2605.25639)
...
### [57] [From Reports to Ontologies: Ontology-Guided Representation Learning for 12-Lead ECG](https://arxiv.org/abs/2605.25883)
...
### [58] [The Evolution of Digital Twins from Reactive to Agentic Systems](https://arxiv.org/abs/2605.26066)
...
### [59] [AI-Powered Sustainable Finance: An Integrative Taxonomy and Framework of AI Applications for Sustainable Investment Decision-Making](https://arxiv.org/abs/2605.26076)
...
### [60] [Cross-Platform Fused MoE Dispatch in Triton: Portable Expert Routing Without CUDA](https://arxiv.org/abs/2605.23911)
*Subhadip Mitra*
...
### [61] [Can LoRA Fusion Support Cross-Domain Tasks in Cloud-Edge Collaboration?](https://arxiv.org/abs/2605.23913)
...
### [62] [VineLM: Trie-Based Fine-Grained Control for Agentic Workflows](https://arxiv.org/abs/2605.23914)
...
### [63] [The Model Parking Tax: Quantifying the Hidden Energy Cost of Always-On GPU Model Deployment](https://arxiv.org/abs/2605.23918)
*Sai Sathvik Vadari*
...
### [64] [RASC: Region-Aware Self-Calibration for Dense 2D Sensor Arrays](https://arxiv.org/abs/2605.23963)
*Yinglei Ma,Fei Xiao*
...
### [65] [TSFLora: Token-Compressed Split Fine-Tuning for Wireless Edge Networks](https://arxiv.org/abs/2605.23988)
...
### [66] [A Tabular Schedule Abstraction for Communication-Aware Evaluation of Pipeline-Parallel LLM Training](https://arxiv.org/abs/2605.24006)
...
### [67] [Polar: Agentic RL on Any Harness at Scale](https://arxiv.org/abs/2605.24220)
...
### [68] [Resident KV Claims: A Conformance Contract for Future Reuse under Active KV Pressure](https://arxiv.org/abs/2605.24259)
*Lukas Stepanek*
...
### [69] [ScaleAcross Explorer: Exploring Communication Optimization for Scale-Across AI Model Training](https://arxiv.org/abs/2605.24326)
...
### [70] [Energy-Aware Computing in the Year 2026](https://arxiv.org/abs/2605.24569)
...
### [71] [Optimus: Elastic Decoding for Efficient Diffusion LLM Serving](https://arxiv.org/abs/2605.24832)
...
### [72] [Kavier: Exploring Performance, Sustainability, and Efficiency of LLM Ecosystems under Inference through Cache-Aware Discrete-Event Simulation](https://arxiv.org/abs/2605.25247)
...
### [73] [DECICE: AI-Driven Scheduling and Digital Twin Integration for the Cloud-HPC-Edge Compute Continuum](https://arxiv.org/abs/2605.25292)
...
### [74] [Beyond Thread States: Diagnosing Performance Degradation with eBPF and Thread Dynamics](https://arxiv.org/abs/2605.25298)
...
### [75] [Multithreaded Fine-Grained Asynchronous BSP for Integer Sorting with LCI and OpenMP](https://arxiv.org/abs/2605.25340)
...
### [76] [Neural Router: Semantic Content Matching for Agentic AI](https://arxiv.org/abs/2605.25701)
...
### [78] [Bandwidth-Aware and Cost-Efficient Pipeline Parallel Scheduling in Geo-Distributed LLM Training](https://arxiv.org/abs/2605.25375)
...
### [79] [DisagFusion: Asynchronous Pipeline Parallelism and Elastic Scheduling for Disaggregated Diffusion Serving](https://arxiv.org/abs/2605.25550)
...
### [80] [Fine-Tuning and Serving Gemma 4 31B on Google Cloud TPU: A Technical Comparison with GPU Baselines](https://arxiv.org/abs/2605.25645)
...
### [81] [When Agents Control Robots: A Zero Trust Policy Model for Agentic Cyber-Physical Systems](https://arxiv.org/abs/2605.25653)
...
### [82] [Bandwidth-Aware LLM Inference on Heterogeneous Many-Core Supercomputers](https://arxiv.org/abs/2605.25655)
...
### [83] [Profiling-Driven Adaptive Distributed Transformer Inference on Embedded Edge Deployment](https://arxiv.org/abs/2605.25682)
...
### [84] [Decompose, Optimize, and Reconstruct: Very Large Constant Multiplication at Scale](https://arxiv.org/abs/2605.23998)
...
### [85] [SA-Kura: An Energy-Efficient Systolic Array Accelerator for Locally-Coupled Kuramoto Drift in Diffusion Sampling](https://arxiv.org/abs/2605.24016)
...
### [86] [CMAX-CAMEL: A Coarse-to-Fine Adaptive, Memory-Efficient, and Low-Power Edge Processor for Contrast Maximization](https://arxiv.org/abs/2605.24017)
...
### [87] [Adaptive KV Cache Reuse for Fast Long-Context LLM Serving](https://arxiv.org/abs/2605.24022)
...
### [88] [A Per-Access Upper Bound for Shared-Resource Interference in Direct-Mapped Multicore Architectures](https://arxiv.org/abs/2605.24026)
*Felipe T. Pedroni*
...
### [89] [EVA: Accelerating LLM Decoding via an Efficient Vector Quantization Architecture](https://arxiv.org/abs/2605.24144)
...
### [90] [MX-SAFE: Versatile Inference- and Training-Proof Microscaling Format with On-the-Fly Exponent and Mantissa Bit Allocation](https://arxiv.org/abs/2605.24391)
...
### [91] [Provisioning to Runtime Optimization of a +100 MW AI Cluster](https://arxiv.org/abs/2605.24461)
...
### [92] [XL-HD: Extended Learning in Hyperdimensional Computing via Deterministic Projections for In-Memory Accelerators](https://arxiv.org/abs/2605.24788)
...
### [93] [Architectural Limits of Cloud TPUs in Finite-Field Cryptography](https://arxiv.org/abs/2605.25367)
...
### [94] [ZK-Tracer: A High-Performance Heterogeneous Accelerator for Zero-Knowledge VM Trace Generation](https://arxiv.org/abs/2605.25493)
...
### [95] [Co-Designing Graph-based Approximate Nearest Neighbor Search at Billion Scale for Processing-in-Memory](https://arxiv.org/abs/2605.25522)
...
### [96] [Code size reduction by advanced near addressing modes](https://arxiv.org/abs/2605.25602)
...
### [97] [DiSC: Resolution-Scalable Acceleration of Diffusion Models by Exploiting Sparsity and Cached Token Reuse with Hash-based Distribution](https://arxiv.org/abs/2605.25798)
