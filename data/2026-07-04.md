...
### [1] [A global predicted-fMRI drive signal from TRIBE does not predict YouTube replay heatmaps](https://arxiv.org/abs/2607.01400)
...
### [2] [Risk Architecture for AI-Native Engineering Teams: An Organizational Framework for Agentic System Governance](https://arxiv.org/abs/2607.01421)
...
### [3] [Enabling Real-Time AI in O-RAN: Deploying andMeasuring AI Inside a Near-RT RIC xApp](https://arxiv.org/abs/2607.01583)
...
### [4] [CSI Simulation: Why Additive Noise Fails and How to Fix It](https://arxiv.org/abs/2607.01882)
...
### [5] [CADENZA in Action: Breaking the Monolith with Intent-Dependent Plan Spaces for Semantic Queries](https://arxiv.org/abs/2607.01468)
...
### [6] [FUSE: A Partitioned Field-Exchange Framework for Coupling Physics Simulations in FEBio](https://arxiv.org/abs/2607.01428)
...
### [7] [Predicting Heterogeneous Treatment Effects Of Building Energy Saving Retrofits Using Causal Machine Learning](https://arxiv.org/abs/2607.01891)
...
### [8] [SLFS: a Flexible, Low-Cost Distributed File System Using Serverless Designs](https://arxiv.org/abs/2607.01486)
