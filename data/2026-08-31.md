...
### [4] [Network Topologies for QKD Networks](https://arxiv.org/abs/2608.28036)
...
### [5] [xTRUCE: A Provably Safe Arbiter for Multi-xApp Conflict Mitigation in Agentic O-RAN](https://arxiv.org/abs/2608.28532)
...
### [6] [Real-time SQL Plan Management in Oracle](https://arxiv.org/abs/2608.27758)
...
### [7] [ANCHOR: A Vision for Secure Persistent Key-Value Stores in Disaggregated Data Centers](https://arxiv.org/abs/2608.27819)
...
### [8] [DBRepro: Automated Database Synthesis via a Hybrid Constraint-Solving Approach for Reproducing Slow Queries](https://arxiv.org/abs/2608.27822)
...
### [9] [VeriTS: Verifiable Model-Enhanced Time-Series Queries on Blockchain Systems](https://arxiv.org/abs/2608.28318)
...
### [10] [No Silver Bullet: Boosting GaussDB Performance on the 30TB TPC-H Workload](https://arxiv.org/abs/2608.28352)
...
### [11] [Grounded Checklist Partial Credit for Agent Skill Trajectories](https://arxiv.org/abs/2608.27487)
...
### [12] [Image Augmentation as Test Generation for Deep Learning-Based Image Retrieval Systems](https://arxiv.org/abs/2608.27502)
...
### [13] [Predicting LLM Performance from Prompt Linguistic Features: An Empirical Study in Requirements Engineering](https://arxiv.org/abs/2608.27621)
...
### [14] [Operationalizing Regulations into Code: A Model to Enhance Governance and Compliance in LLM Selection for Software Engineering](https://arxiv.org/abs/2608.27703)
...
### [15] [Decoupling is a Necessity: Transformation-Agnostic Decompiled Code Recovery under Optimization and Obfuscation](https://arxiv.org/abs/2608.27889)
...
### [16] [Antipatterns in AI-assisted Qualitative Data Analysis: A Catalog of Temptations and Pitfalls for Software Engineering Researchers](https://arxiv.org/abs/2608.27927)
...
### [17] [CC4M: Code Clone Analysis and Visualization for Microservices](https://arxiv.org/abs/2608.28111)
...
### [18] [RESTCov: A Tool for Structural Coverage Analysis of REST APIs](https://arxiv.org/abs/2608.28114)
...
### [19] [Post-Edit Re-Verification in Simulator-Backed Engineering Agents: A Controlled Comparison of Verification-Cadence Guidance](https://arxiv.org/abs/2608.28147)
...
### [20] [From Architecture to Binary: Ensuring Cross-Domain Consistency in Model-Based Airborne Software Development](https://arxiv.org/abs/2608.28156)
...
### [21] [Adaptive Strategy Generation for Boundary Value Exploration Beyond Numeric Inputs](https://arxiv.org/abs/2608.28230)
...
### [22] [Where Does Balance Break? Boundary Discovery for Game Balance Testing under a Finite Simulation Budget](https://arxiv.org/abs/2608.28364)
...
### [23] [Sustainability of Open-Source Machine Learning Robustness Assessment Tools: A Repository Mining Study](https://arxiv.org/abs/2608.28396)
...
### [24] [Recovering Software Architecture Intent from Historical Work Items using Generative AI: A Mixed-Methods Industry Case Study](https://arxiv.org/abs/2608.28403)
...
### [25] [On the Maintenance and Co-evolution of Agent Plugins: An Empirical Study of Claude Code Plugin Marketplaces](https://arxiv.org/abs/2608.28497)
...
### [26] [A System-of-Systems Case Study for the Verification of Composed Digital Twins](https://arxiv.org/abs/2608.28498)
...
### [27] [Rethinking Vulnerability Remediation as a Capacity Allocation Problem](https://arxiv.org/abs/2608.28509)
*Jana Stucke*
...
### [28] [Characterizing the I/O Behavior of HPC Applications through Modeling and Simulation](https://arxiv.org/abs/2608.27642)
...
### [29] [TerraceMoE: A Cost Model for Hierarchical MoE All-to-All Communication](https://arxiv.org/abs/2608.27874)
...
### [30] [Learning-Augmented Heuristics: Simple, yet Smart, Robust and Interpretable Cache Eviction](https://arxiv.org/abs/2608.27975)
...
### [31] [Great Expectations: Benchmarking the Real-World Performance of RVV 1.0 in HPC](https://arxiv.org/abs/2608.28097)
...
### [32] [Memory-efficient GPU pipelines for real-time non-line-of-sight reconstruction](https://arxiv.org/abs/2608.28183)
...
### [33] [Dimension Bridging for 3D RANS with Neural Network Accelerated Gaussian Functional Regression](https://arxiv.org/abs/2608.27639)
...
### [34] [Investigating Forecast Proficiency of Hurricane-Induced Compound Flooding With a Discontinuous Galerkin Shallow Water Equation Solver](https://arxiv.org/abs/2608.27778)
...
### [35] [A Compact Selective State-Space Model for Cross-Sectional Stock Return Ranking from Raw Intraday Bars](https://arxiv.org/abs/2608.28060)
...
### [36] [Towards Stellarator Geometry Optimisation for Nuclear Fusion](https://arxiv.org/abs/2608.28224)
...
### [37] [Machine-learning-assisted multiscale topology optimization of functionally graded superimposed lattice structures](https://arxiv.org/abs/2608.28513)
