...
### [8] [A Low-Latency ASIC Architecture for Real-Time Line Segment Detection](https://arxiv.org/abs/2608.06439)
...
### [9] [Retention-Aware RISC-V ISA Extension and Memory Controller on FPGA for MLC NVM](https://arxiv.org/abs/2608.06725)
...
### [10] [HLSmith: An Expert-Guided Agentic Framework for C/C++-to-HLS Translation](https://arxiv.org/abs/2608.06791)
...
### [11] [G-Power: Architecture-level GPU Power Modeling with Aggregated Knowledge Foundations from Known GPUs](https://arxiv.org/abs/2608.06870)
...
### [12] [Rethinking Unified Memory for NPU-PIM Systems: Dual-View Memory for Dynamic Inference of LLM](https://arxiv.org/abs/2608.06989)
...
### [13] [Dual-Node NVIDIA DGX Spark over Tailscale: A Remote-Access Testbed for Distributed LLM Training and Cyber-Threat-Intelligence Fine-Tuning](https://arxiv.org/abs/2608.07226)
*Vasanth Iyer*
...
### [14] [From Interpretation to Compilation: A Compilation-Based Execution Engine for Semantic Operator Systems](https://arxiv.org/abs/2608.06677)
...
### [15] [Duration-constrained Interval Joins](https://arxiv.org/abs/2608.06856)
...
### [16] [MIRA: Evidence-Verified Repair Memory for Text-to-SQL Correction](https://arxiv.org/abs/2608.06950)
...
### [17] [RECAST: A Region-Scoped Adaptive Index for Exact Similarity Search](https://arxiv.org/abs/2608.06962)
*Yining Liu,Rui Mao*
...
### [18] [Toward a Causal Data Management Ecosystem for Decision Making and Agentic AI](https://arxiv.org/abs/2608.07214)
...
### [19] [Load-Path Redistribution and Damage Asymmetry in Reinforced Concrete Beams under Eccentric Drop-Weight Impact: A Coupled SPH--FEM Study](https://arxiv.org/abs/2608.06874)
...
### [20] [Linguistic Pattern Based Optimization of Economic and Spatial Uniformity Criteria in Facility Layout Problems](https://arxiv.org/abs/2608.07011)
...
### [21] [Tabular Image: a method to convert tabular data to images for convolutional neural networks](https://arxiv.org/abs/2608.07132)
...
### [22] [Towards trajectory-unsupervised physics-informed neural solvers for molecular dynamics](https://arxiv.org/abs/2608.07232)
...
### [23] [An Explainable Physics-Informed Neural Frequency-Response Framework for Shunt-Parameter Identification in Semi-Active Piezoelectric Tuned Mass Dampers](https://arxiv.org/abs/2608.07255)
...
### [24] [Flaky Test Recognition when Testing CPSs Using Hybrid Models](https://arxiv.org/abs/2608.06535)
...
### [25] [Understanding the Energy Impact of Software Refactoring: A Workload-Aware Study of Controlled Examples and Real-World Commits](https://arxiv.org/abs/2608.06620)
...
### [26] [Characterizing the Quality Profile of AI-Generated C++ in Production](https://arxiv.org/abs/2608.06640)
...
### [27] [Online Monitoring and Corrective Steering of Programming Agents](https://arxiv.org/abs/2608.06701)
...
### [28] [Translation Tag Team: Formal Rules and LLMs Translate More Macros Together than Apart](https://arxiv.org/abs/2608.06705)
...
### [29] [AgentChaos: Chaos Engineering for Agent Systems via Programmatic Fault Injection](https://arxiv.org/abs/2608.06790)
...
### [30] [Coupling Planning with Episodic Memory in LLM Agents for Software Issue Resolution](https://arxiv.org/abs/2608.06811)
...
### [31] [How Reasoning Shapes Social Bias in LLM-Generated Code?](https://arxiv.org/abs/2608.06829)
...
### [32] [Statistical Analysis of Executability and Program Equivalence in Decompilation for IoT Vulnerability Detection](https://arxiv.org/abs/2608.06960)
...
### [33] [What Are Developers Actually Discussing When Visual Regression Tests Fail?](https://arxiv.org/abs/2608.07020)
...
### [34] [CAS2UML: A Handwritten Sketch-to-PlantUML Dataset for Class and Activity Diagrams](https://arxiv.org/abs/2608.07036)
...
### [36] [Explanation-Guided Metamorphic Testing of Specialized Language Models: An Empirical Study](https://arxiv.org/abs/2608.07076)
...
### [37] [Rust Coreutils: Rebuilding Unix Foundations in a Modern Language](https://arxiv.org/abs/2608.07135)
...
### [38] [Towards Assurance Closure in AI-Native Large-Scale Agile Software Development](https://arxiv.org/abs/2608.07317)
*Ricardo Britto*
...
### [39] [PACE: Primitive-Aware Code Evolution for Automated Algorithm Design](https://arxiv.org/abs/2608.07395)
...
### [40] [Circuit-Based Program Verification: Sequential Circuits as an Intermediate Representation for Verifying C Programs](https://arxiv.org/abs/2608.07397)
...
### [41] [Taxonomy-Driven Analysis of Open-Source AI Risk Mitigation Tools](https://arxiv.org/abs/2608.07446)
...
### [42] [Rendezvous of Mobile Deterministic Automata in Graphs](https://arxiv.org/abs/2608.06482)
...
### [43] [Cascade: Exploiting SLO-Aware latency budget for fair and high goodput LLM inference serving](https://arxiv.org/abs/2608.06557)
...
### [44] [MARS: A Monte Carlo Tree Search-based Adaptive and Responsive Scheduler](https://arxiv.org/abs/2608.06629)
...
### [45] [DGEMM with Ozaki Scheme I/II on FP4 Tensor Cores: A Base-13 E2M1 Limb Representation](https://arxiv.org/abs/2608.06812)
...
### [46] [StateFlow: Sequence Pipeline Parallelism for Long-Context Modeling with Linear Recurrence](https://arxiv.org/abs/2608.06838)
...
### [47] [Stream Learning: Partition-Fair Gossip Learning Without Tokens](https://arxiv.org/abs/2608.06946)
...
### [48] [A Self-Adaptive Extensible CEP framework for the Cloud-Edge Continuum](https://arxiv.org/abs/2608.06966)
...
### [49] [A Kubernetes Scheduler Plugin for Cluster-Wide Placement Optimisation](https://arxiv.org/abs/2608.06987)
...
### [50] [HiSparse: Scaling Sparse-Attention Decoding with Hierarchical KV Cache Management](https://arxiv.org/abs/2608.07009)
...
### [51] [Scalable High-Fidelity Macromolecular Docking for GPU-Accelerated Supercomputers](https://arxiv.org/abs/2608.07078)
...
### [52] [Fast end-to-end cloud application cold-start with initscripts](https://arxiv.org/abs/2608.07358)
