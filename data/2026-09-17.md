...
### [7] [Analysis of Measurements in a Microwave Oven with High Level of Non-Ionizing Radiation (NIR) Before and After Repair](https://arxiv.org/abs/2609.17934)
...
### [8] [Open-source emulation-based test environment to settle O-RAN-compliant trials](https://arxiv.org/abs/2609.17949)
...
### [9] [Human Exposure to Non-Ionizing Radiation from Indoor Distributed Antenna System: Shopping Mall Measurement Analysis](https://arxiv.org/abs/2609.17961)
...
### [10] [The Operable Pareto Front: Distilling Offline Search into Run-Time Control for Multi-Objective UAV Edge-Computing Scheduling](https://arxiv.org/abs/2609.17992)
...
### [11] [Jamming Detection in 5G/6G Networks: From O-RAN Concept to OCUDU Deployment](https://arxiv.org/abs/2609.18499)
...
### [12] [Toward Composable Network Digital Twins: A Subgraph-Based Latency Prediction Study](https://arxiv.org/abs/2609.18704)
...
### [13] [Reliability-Guided Trusted Repeater Node Selection in QKD-Enabled Metro Optical Networks](https://arxiv.org/abs/2609.18797)
...
### [14] [Taming the Agentic RAN: Stability-Guaranteed Arbitration of Autonomous AI Agents in O-RAN](https://arxiv.org/abs/2609.18857)
...
### [15] [SpecReuse: Spectral Graph Reuse for Efficient Vision GNN Inference on FPGAs](https://arxiv.org/abs/2609.17718)
...
### [16] [Large Language Model based air quality monitoring and localized alert generation](https://arxiv.org/abs/2609.17954)
...
### [17] [Towards Training Private LLMs: Exploring Fine-Tuning Language Models on Apple Silicon with RDMA over Thunderbolt](https://arxiv.org/abs/2609.18066)
...
### [18] [Ask the Tool, Don't Guess: Agent Tool Calls Hold Their Progress, and the Serving System Should Read It](https://arxiv.org/abs/2609.18849)
...
### [19] [SSD-LLaMA: SSD-Native Inference for Trillion-Parameter MoE at 1+ Token/s on a Consumer PC](https://arxiv.org/abs/2609.18110)
...
### [20] [Token Latency Fairness: Performance Isolation for Multi-Tenant LLM Serving](https://arxiv.org/abs/2609.18112)
...
### [21] [Zero-I/O Fault Recovery for Sharded Deep Learning via Dynamic Framework Dependency Rebinding](https://arxiv.org/abs/2609.18178)
...
### [22] [GeoMesh: Workload-Balanced and Sign-Compressed Geo-Distributed LLM Training](https://arxiv.org/abs/2609.18388)
...
### [23] [From Pixels to Semantics: Edge AI for UAV-Based Critical Infrastructure Inspection](https://arxiv.org/abs/2609.18448)
...
### [24] [DiverseFT: Diversifying Fault-Tolerant Systems using LLMs](https://arxiv.org/abs/2609.18512)
...
### [25] [COMPASS-ABS: Reducing Fragmentation in Shared GPU Clusters for Deep Learning Training Workloads](https://arxiv.org/abs/2609.18519)
...
### [26] [A Distributed Computing Framework for Satellite Swarms](https://arxiv.org/abs/2609.18839)
...
### [27] [AUPE: Collaborative byzantine fault-tolerant peer-sampling](https://arxiv.org/abs/2609.18563)
...
### [28] [RayOrch: Programming and Executing Lineage-Controlled Multi-Grain Dataflows for Foundation-Model Data Preparation](https://arxiv.org/abs/2609.18703)
...
### [29] [Vigil: Accountable Liveness against Selective Silence](https://arxiv.org/abs/2609.18778)
...
### [30] [Fluid Notarization: Verifiable Evolution of Concurrently Edited Structured Documents](https://arxiv.org/abs/2609.18886)
...
### [31] [Ermes: a Stateful Serverless Platform for the Edge-to-Cloud Continuum](https://arxiv.org/abs/2609.18924)
...
### [32] [Replication-Aware Placement of Functions and Data in the Edge-Cloud Continuum](https://arxiv.org/abs/2609.18932)
...
### [33] [OAK: Restart- and Age-Aware Scheduling for Distributed Machine Learning on Shared GPU Clusters](https://arxiv.org/abs/2609.19024)
...
### [34] [Linking Speakers of the German Parliament to Wikidata: Scope and Coverage of Metadata](https://arxiv.org/abs/2609.18289)
...
### [35] [Distribution-Aware Distributed Database Testing (Extended Version)](https://arxiv.org/abs/2609.18501)
...
### [36] [GroupKV: Hierarchical KV Cache Management for Long-Context Diffusion LLM Inference](https://arxiv.org/abs/2609.17573)
...
### [37] [Netkit: Specializing Linux Packet Delivery for Container Networks](https://arxiv.org/abs/2609.18633)
...
### [38] [Not All Agents Are Equal: Code Quality and Post-Merge Maintenance Across Five Autonomous Coding Agents in the Wild](https://arxiv.org/abs/2609.17598)
*Obada Kraishan*
...
### [39] [Quiescence in Concert: Composing Multi-Channel Time-Outs for IOCO](https://arxiv.org/abs/2609.17640)
...
### [40] [CARE: A Responsibility-Oriented Architecture for Domain-Scoped Resolution in Modular and Upgradeable Smart Contracts](https://arxiv.org/abs/2609.17647)
...
### [41] [A Large-Scale Empirical Study of Quality Assurance Practices and Gaps in AI Agents](https://arxiv.org/abs/2609.17698)
...
### [42] [Detecting Argument-Swap Bugs Using Context-Enhanced Code Representations](https://arxiv.org/abs/2609.17844)
...
### [43] [Experimental Settings in LLM-Based Program Repair: A Study of Inputs, Tool Access, Feedback, and Validation](https://arxiv.org/abs/2609.17993)
...
### [44] [An Empirical Evaluation of Cost-Efficient Large Language Models on Algorithmic Programming Tasks](https://arxiv.org/abs/2609.18052)
...
### [45] [Relationally Guided Use Case Modeling with LLMs](https://arxiv.org/abs/2609.18291)
...
### [46] [A Study of the Reliability of Agentic AI-Generated Programs](https://arxiv.org/abs/2609.18298)
...
### [47] [A Study on the Impact of Natural Language Differences in Prompts on Automatic Code Generation Using LLMs](https://arxiv.org/abs/2609.18311)
...
### [48] [From Component Snapshots to Lifecycle Traces: Agent-Based Software Composition Analysis](https://arxiv.org/abs/2609.18391)
...
### [49] [Evaluating the Health of Open-Source Smart City Platforms](https://arxiv.org/abs/2609.18801)
...
### [50] [ProgramDistill: From Interactive Web Apps to Verifiable Reference-Guided SWE Tasks](https://arxiv.org/abs/2609.18805)
...
### [51] [Removing Noise or Introducing Bias? The Hidden Cost of MSR Filtering](https://arxiv.org/abs/2609.18953)
...
### [52] [Code Consistency Preference Optimization Verification for Language Model Alignment](https://arxiv.org/abs/2609.19002)
...
### [53] [REQAP: Resilient Weight Packing and Quantization for Edge DNN Acceleration](https://arxiv.org/abs/2609.17555)
...
### [54] [WARD: Runtime Workload-Adaptive Vision TRansformer Framework for Dependable Edge AI](https://arxiv.org/abs/2609.17556)
...
### [55] [Lyapunov-based analysis of functional stability for edge computing systems](https://arxiv.org/abs/2609.17569)
*Oleksii S. Bychkov*
...
### [56] [FAME: An FPGA-Based Platform for Approximate Multipliers Evaluation with Pattern-Guided DNN Retraining](https://arxiv.org/abs/2609.17730)
...
### [57] [Demystifying Gate-Level Localization of RTL Trojans](https://arxiv.org/abs/2609.17922)
...
### [58] [VeriBugBench: An Empirically Grounded Framework for Constructing Verilog RTL Debugging Benchmarks](https://arxiv.org/abs/2609.18022)
...
### [59] [Automated Instruction Encoding Synthesis for Modern GPU ISA Compression](https://arxiv.org/abs/2609.18662)
*Mingyuan Ma,Hu He*
...
### [60] [HBFlex: A Flexible Memory System for Bridging Fine-Grained LLM States and Coarse-Grained HBF Parallel Execution](https://arxiv.org/abs/2609.18675)
...
### [61] [Quantifying the Effect of HCLs on a Fixed-Microarchitecture MXFP4 Accelerator](https://arxiv.org/abs/2609.18792)
...
### [62] [Locus: A Framework for Exploring and Optimizing Point Addition Hardware for Zero-Knowledge Proofs](https://arxiv.org/abs/2609.18846)
...
### [63] [Rect3D: A Unified Analytical Framework for 3D-IC Rectilinear Floorplanning](https://arxiv.org/abs/2609.18946)
