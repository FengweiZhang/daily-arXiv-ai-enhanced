...
### [5] [Performance Study of Serverless Workloads in Confidential Virtual Machines](https://arxiv.org/abs/2609.04478)
...
### [6] [Atlas: Optimizing Deployment of Compound AI Workflows on Heterogeneous Clusters](https://arxiv.org/abs/2609.04513)
...
### [7] [Revisiting MemGuard Overhead: A Reproduction Report](https://arxiv.org/abs/2609.04547)
...
### [8] [Improving Progressive Compression with Adaptive Interpolation and Coefficient Decomposition](https://arxiv.org/abs/2609.04573)
...
### [9] [CIERA: Cross-Iteration Exponent Reuse for Lossless Allgather in Sharded MoE Training](https://arxiv.org/abs/2609.04609)
...
### [10] [GreenPipe: Power Modeling for Containerized DNN Inference on Kubernetes Edge Nodes](https://arxiv.org/abs/2609.04952)
...
### [11] [Budgeting Bytes: A Windowed Storage Roofline and Dual-Budget Architecture Ablations for Storage-Bound LLM Decoding](https://arxiv.org/abs/2609.04238)
*Hanhaodi Zhang*
...
### [12] [MonoMoE: An Efficient Fused Mega-kernel for Quantized MoE Decoding](https://arxiv.org/abs/2609.04244)
...
### [13] [Hardware-conscious Software Training for Deep Neural Network Inference Accelerator Chips to Recover Accuracy Degradation due to Hardware Variabilities](https://arxiv.org/abs/2609.04259)
...
### [14] [Quality Recovery for Quantized KV Caches via Low-Rank Attention Adaptation](https://arxiv.org/abs/2609.04263)
...
### [15] [Compute-in-Memory Attention: A Time-Domain Analog Softmax Circuit with RC-Tunable Temperature](https://arxiv.org/abs/2609.04266)
...
### [16] [Huawei's $τ$ Chip Was Supposed to Melt?](https://arxiv.org/abs/2609.04287)
*Tingbo He*
...
### [17] [Sustainable Edge Vision via Empirically Calibrated DVFS: Eliminating Thermal Throttling on Passively Cooled Hardware](https://arxiv.org/abs/2609.04705)
...
### [18] [FlexPosit: Tunable Fractional Precision for LLM Inference Accelerators](https://arxiv.org/abs/2609.04724)
...
### [19] [A Piecewise-Linear Approximation-based Energy-Efficient Error-Optimized Unsigned Square Rooter for Accuracy-Critical Applications](https://arxiv.org/abs/2609.04783)
...
### [20] [TreeFI: Value-Aware Statistical Fault Injection for Deep Neural Networks](https://arxiv.org/abs/2609.04912)
...
### [21] [APEX-RBD: Mixed-Precision Exploration Framework for Hardware-Efficient Robot Dynamics Accelerator Design](https://arxiv.org/abs/2609.05161)
...
### [22] [Proton Irradiation Characterization of an Open-Source ML Accelerator on a Zynq UltraScale+ MPSoC](https://arxiv.org/abs/2609.05249)
...
### [23] [Network Availability Enhancement in Low-Altitude HetNets: A Cross-Layer Design Perspective](https://arxiv.org/abs/2609.04406)
...
### [24] [Tuning Collective Patterns to Alleviate Congestion in Shared AI Clusters](https://arxiv.org/abs/2609.04417)
...
### [25] [Waves on the Walls: Empirical Characterization of mmWave Lateral Waves for Enhanced Indoor Coverage](https://arxiv.org/abs/2609.04429)
...
### [26] [Uncertainty Signals for Network Intent Translation: Risk Ranking and Ambiguity Localization](https://arxiv.org/abs/2609.04486)
...
### [27] [A Wavelength Borrowing Architecture for Optical Data Center Networks - Extended Version](https://arxiv.org/abs/2609.04874)
...
### [28] [QUASAR: Quantum Satellite Architecture and Routing Simulator](https://arxiv.org/abs/2609.04920)
...
### [29] [Performance Evaluation of HAPS-enabled Coverage Enhancement in Hard-to-Reach Areas](https://arxiv.org/abs/2609.05067)
...
### [30] [On the Delay-Constrained Maximum Concurrent Flow Problem](https://arxiv.org/abs/2609.05068)
...
### [31] [Towards Federated, Green, and Resilient 6G Non-Terrestrial Networks](https://arxiv.org/abs/2609.05184)
...
### [32] [DTM: Deterministic Approaches for Black-box Test Suite Minimization with Tree-based Similarity](https://arxiv.org/abs/2609.04205)
...
### [33] [Breaking the Alphabet: Rethinking File Ordering in Code Review](https://arxiv.org/abs/2609.04207)
...
### [34] [AI Writes Code, Humans Pay the Debt. An Empirical Study on the Sustainability and Evolution of Agent-Generated Code](https://arxiv.org/abs/2609.04208)
...
### [35] [The Prompt Triangle: A Registered Report on Prompts as Hybrid Artifacts](https://arxiv.org/abs/2609.04209)
...
### [36] [SH-PDOPS: AI-Driven Cloud Native Enterprise Reliability Framework for Predictive Analytics and Intelligent DevOps Automation](https://arxiv.org/abs/2609.04210)
*Ayushman Bosu Roy*
...
### [37] [Data-Related Challenges and Requirements for Event Log Generation in Process Mining: A Systematic Literature Review](https://arxiv.org/abs/2609.04211)
...
### [38] [Big Questions on Software Architecture: Report of the ICSE 2026 BoF on Software Architecture](https://arxiv.org/abs/2609.04212)
...
### [39] [Same Request, Different Answer: Quantization Amplifies Cache-Induced Divergence in LLM Serving](https://arxiv.org/abs/2609.04748)
*Aditi Patodiya*
...
### [40] [Toward Model-Driven Digital Twin Configuration: Separating Structure Semantics and Runtime with SysML SAREF and Ditto](https://arxiv.org/abs/2609.04213)
...
### [41] [A Mixed-Method Empirical Study of LLM Assistance in Software Engineering Workflows](https://arxiv.org/abs/2609.04214)
...
### [42] [A systematic literature review on logging smell detection](https://arxiv.org/abs/2609.04215)
...
### [43] [Engineering as Code: Bringing Software Engineering Methodology to Engineering Design](https://arxiv.org/abs/2609.04216)
*Song Difei*
...
### [44] [A Governance Methodology Layer for AI-Assisted Software Development: Defect Taxonomy, Controlled Ablation, and Process-Over-Capability Evidence](https://arxiv.org/abs/2609.04218)
*Sungjin Kwon*
...
### [45] [Large Language Models for Fuzz Testing in Microservices: A Systematic Literature Review](https://arxiv.org/abs/2609.04219)
...
### [46] [Robustness and Trade-offs for Code LLMs on Protected Code](https://arxiv.org/abs/2609.04220)
...
### [47] [Automated Deployment of Real-Time Tasks for Phased Execution on Scratchpad-Based Multicore Platforms](https://arxiv.org/abs/2609.04221)
...
### [48] [Physics-Direct FPGA Tooth-Contact Computation for Deterministic Gear Digital Twins](https://arxiv.org/abs/2609.04248)
*Jiacheng Miao*
...
### [49] [Reviewer Capability Governs Rejection Targeting, Not Repair Skill: Evidence from LLM Execute-Review-Revise Pipelines](https://arxiv.org/abs/2609.04270)
*Faizan Tanveer*
...
### [50] [Integrating Crash Report Mining and LLMs for Bug Localization and Repair: An Industrial Report](https://arxiv.org/abs/2609.04483)
...
### [51] [An Empirical Analysis of CodeQL False Positives and Query Refinements for Java Vulnerabilities](https://arxiv.org/abs/2609.04535)
...
### [52] [Dynamic Adaptation of the LLM Context for Generating Routines with Coupled Semantics](https://arxiv.org/abs/2609.04570)
...
### [53] [Software Engineering in the Agent Era From Trustworthy Change to Human Agent Software Organizations](https://arxiv.org/abs/2609.04630)
...
### [54] [How Developers Discuss Generative AI: A Longitudinal Study of the Visual Studio Code Community](https://arxiv.org/abs/2609.04680)
...
### [55] [Beyond Code Generation: Reliability, Verification, and Cost Economics in the Agentic Software Development Lifecycle](https://arxiv.org/abs/2609.04681)
*Happy Bhati*
...
### [56] [Building a research-software catalog with a coding agent: from hackathon prototype to public deployment](https://arxiv.org/abs/2609.04711)
...
### [57] [Better Understanding, Better Fixes? A Study of Hallucination in LLM-based Automated Program Repair](https://arxiv.org/abs/2609.04909)
...
### [58] [ARIA - An Agentic Framework for Autonomous Testing of Infotainment Systems](https://arxiv.org/abs/2609.04913)
...
### [59] [An Empirical Study on Learning Paths and Gender Dynamics in Scrum Master Roles](https://arxiv.org/abs/2609.05186)
...
### [60] [T(r)opical Islands: Visualizing & Understanding Socio-Technical Artifacts](https://arxiv.org/abs/2609.05254)
...
### [61] [Ritgard: T(r)opical Islands of Socio-Technical Artifacts on GitHub](https://arxiv.org/abs/2609.05278)
