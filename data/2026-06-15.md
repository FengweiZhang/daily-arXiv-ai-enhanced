...
### [1] [Price-Discovery Admissibility in Tokenized Fixed Income: Identification, Affine Characterization, and the Structure of the Token-to-Fiat Mapping](https://arxiv.org/abs/2606.13822)
...
### [2] [Machine Learning-Accelerated Time Integration of Plasticity Models](https://arxiv.org/abs/2606.14548)
...
### [3] [CANN-EUCLID: unsupervised constitutive artificial neural network model discovery from full-field data](https://arxiv.org/abs/2606.14565)
...
### [4] [Towards In Silico Cancer Therapy Design: An Agent-Based Approach for GPU-Accelerated Molecular Pathway Simulation](https://arxiv.org/abs/2606.14603)
*Stefano Maestri*
...
### [5] [Robust Network Flow Interdiction Problems with Applications to Counter-Narcotics](https://arxiv.org/abs/2606.14611)
...
### [6] [Algebraic Operations on Tensor Trains](https://arxiv.org/abs/2606.14627)
*Petr Tichavsky*
...
### [7] [Lattice Aggregation in Distributed Verification under Crash and Byzantine Failures](https://arxiv.org/abs/2606.13954)
...
### [8] [STREAM: Multi-Tier LLM Inference Middleware with Dual-Channel HPC Token Streaming](https://arxiv.org/abs/2606.13968)
...
### [9] [VaultxGPU: GPU-Accelerated Blockchain Consensus](https://arxiv.org/abs/2606.14007)
...
### [10] [Extreme-Scale Atomistic Simulation of Real-Temperature Magnetic Skyrmion Dynamics by Coupled Spin-Lattice Modeling](https://arxiv.org/abs/2606.14073)
...
### [11] [On the Limits of Causal Observation in Shared-Memory Systems](https://arxiv.org/abs/2606.14093)
...
### [12] [Design Methodology and Performance Trade-offs Management for Distributed and Compound AI Systems](https://arxiv.org/abs/2606.14350)
...
### [13] [PLAIground: SLO-Driven Runtime Model Selection for Compound AI Systems in the Edge-Cloud-Space Continuum](https://arxiv.org/abs/2606.14356)
...
### [14] [Simulation-Based Performance Evaluation of Sharded Blockchain Architectures](https://arxiv.org/abs/2606.14394)
...
### [15] [Simple-IT: Practical Low-Latency Signature-Free BFT Consensus](https://arxiv.org/abs/2606.14404)
...
### [16] [parRSB: Exascale Spectral Element Mesh Partitioning](https://arxiv.org/abs/2606.14659)
...
### [17] [A Tutorial on IEEE 802.11bn Multi-AP Coordination for Wi-Fi 8: From Standardization to Performance Evaluation](https://arxiv.org/abs/2606.13759)
...
### [18] [Temporally Consistent Graph Q-Networks for Intelligent Network Control](https://arxiv.org/abs/2606.13848)
...
### [19] [ARTSN: Exact and Adaptive Self-triggered Traffic Scheduling for ARTS Networks](https://arxiv.org/abs/2606.13899)
...
### [20] [Agon: A Semi-Supervised Framework for Robust Satellite Interference Detection](https://arxiv.org/abs/2606.14147)
...
### [21] [Aidos: A Hybrid Optimization Algorithm for Beam Hopping Scheduling in NGSO Mega-Constellations](https://arxiv.org/abs/2606.14151)
...
### [22] [StreamRTPS: Increasing DDS Bandwidth Efficiency by Reducing Protocol Overhead](https://arxiv.org/abs/2606.14214)
...
### [23] [Selective Field Transmission: Bandwidth Efficient Communication under Standardized Message Schemas](https://arxiv.org/abs/2606.14228)
...
### [24] [When the UE Turns Adversary: Real-Time Uplink Jamming from Within 5G Networks](https://arxiv.org/abs/2606.14465)
...
### [25] [An Agentic Retrieval Framework for Autonomous Context-Aware Data Quality Assessment](https://arxiv.org/abs/2606.13692)
...
### [26] [A Multimodal Machine Learning Framework for Enterprise Database Workload-Aware Root Cause Analysis](https://arxiv.org/abs/2606.13699)
...
### [27] [Towards an open registry of Earth observation instruments](https://arxiv.org/abs/2606.13923)
...
### [28] [Vivace: Exact Temporal OLAP over Interval Histories via Independent Serverless Execution](https://arxiv.org/abs/2606.14069)
...
### [29] [Revisiting Filtered ANN Benchmarks: A Hardness-Controlled Benchmark Generator for Realistic Evaluation](https://arxiv.org/abs/2606.14193)
...
### [30] [TACO: A Benchmark for Open-Domain Text-to-SQL with Ambiguous and Cross-Database Queries](https://arxiv.org/abs/2606.14201)
...
### [31] [WikiKV: Schema-Evolving Path-Indexed Storage for Hierarchical Knowledge Navigation](https://arxiv.org/abs/2606.14275)
...
### [32] [Transforming Shape Schemas with Composable Property-Graph Queries (Extended Version)](https://arxiv.org/abs/2606.14309)
...
### [33] [PLRTune: Importance Pre-Sampling and LLM-Guided Reinforcement Learning for Automatic Database Tuning](https://arxiv.org/abs/2606.14312)
...
### [34] [Evaluating and Generating Query Workloads for High Dimensional Vector Similarity Search](https://arxiv.org/abs/2606.14511)
...
### [35] [A Principled Framework for Safe Algorithm Updates in Automated Insulin Delivery Systems](https://arxiv.org/abs/2606.13882)
...
### [38] [An Empirical Study of Gemini 3 for Detecting Natural Language Test Smells in Manual Test Cases](https://arxiv.org/abs/2606.13804)
...
### [39] [Bayesian-Calibrated Detection of Hallucinated Package Imports in AI-Assisted Code](https://arxiv.org/abs/2606.13918)
...
### [40] [LLM Agents Can See Code Repositories](https://arxiv.org/abs/2606.14061)
...
### [41] [FastContext: Training Efficient Repository Explorer for Coding Agents](https://arxiv.org/abs/2606.14066)
...
### [42] [Simulating Students' Java Programming Errors with Large Language Models](https://arxiv.org/abs/2606.14113)
...
### [43] [Investigating Metamorphic Fuzz Oracle Enhancement via Large Language Models](https://arxiv.org/abs/2606.14164)
...
### [44] [Evaluating LLMs for Obfuscation Detection and Classification in Android Apps](https://arxiv.org/abs/2606.14233)
...
### [45] [I'm Sorry Driver, I'm Afraid I Can't Do That: Appraising the Safety of LLMs within Automotive Contexts](https://arxiv.org/abs/2606.14327)
...
### [46] [No Accidental Software Agent First Canonical Code for Human Code Entropy Reduction and 30 to 500 times Lower Frontier Model Requirements](https://arxiv.org/abs/2606.14357)
*Jepson Taylor*
...
### [47] [tap: A File-Based Protocol for Heterogeneous LLM Agent Collaboration](https://arxiv.org/abs/2606.14445)
*Minseo Kim*
...
### [48] [When Errors Become Narratives: A Longitudinal Taxonomy of Silent Failures in a Production LLM Agent Runtime](https://arxiv.org/abs/2606.14589)
*Wei Wu*
...
### [49] [Security Threats and Their Impact on Blockchain Interoperability: Identification and Countermeasures](https://arxiv.org/abs/2606.14554)
...
### [50] [Empowering Student Debugging in Parallel Programming with Execution Traces and Large Language Models](https://arxiv.org/abs/2606.14607)
...
### [51] [Regulating the Machine Contributor: Governance and Policy Alignment in Open Source](https://arxiv.org/abs/2606.14594)
...
### [52] [GitHub Template Repositories: Served Domains, Maintenance, and Practitioner Guidelines](https://arxiv.org/abs/2606.14616)
...
### [53] [Teaching Machine Learning to Software Engineers](https://arxiv.org/abs/2606.14618)
...
### [54] [HierSVA: A Data Synthesis Pipeline, Dataset, and Benchmark for LLM-Driven Hierarchical Hardware Formal Verification](https://arxiv.org/abs/2606.13706)
...
### [55] [Tiara: A Programmable Line-Rate ISA for Remote Memory Access](https://arxiv.org/abs/2606.13708)
*Bojie Li*
...
### [56] [A Modern Large-Scale Memory Characterization Laboratory](https://arxiv.org/abs/2606.13725)
...
### [57] [VHDLSuite: Unified Pipeline for LLM VHDL Generation with Data Synthesis and Evaluation](https://arxiv.org/abs/2606.13735)
...
### [58] [BigPower: Hierarchical Source-Level Module Power Estimation for CPUs with Large Language Models](https://arxiv.org/abs/2606.13747)
...
### [59] [Ramulator 2.1: A Composable Memory System Simulator for Modern DRAM Systems](https://arxiv.org/abs/2606.13844)
...
### [60] [Extended Abstract: Re-Evaluating the Real-System Modeling Accuracy of Ramulator 2.0](https://arxiv.org/abs/2606.14566)
