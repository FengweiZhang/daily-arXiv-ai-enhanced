...
### [1] [Markovian Shock-Source Tracing and Multidimensional Asset Roles in Exchange Rates, Gold Futures, and Bitcoin](https://arxiv.org/abs/2609.03437)
...
### [2] [Calibration of neural viscoelastic models via full-field data](https://arxiv.org/abs/2609.03645)
...
### [3] [What Do CAE Simulation Agents Really Need Beyond a Generic Harness?](https://arxiv.org/abs/2609.03718)
...
### [4] [sp-DBA: a general framework for adaptive transform-domain computation](https://arxiv.org/abs/2609.03922)
...
### [5] [Differentiable Hybrid Modelling for Learning and Optimising Chemical Transport Processes from Experimental Data](https://arxiv.org/abs/2609.04011)
...
### [6] [Influence of Extruded Filament Shape on Buildability in 3D Concrete Printing: A Geometry-Informed Deep Learning-FEM Approach](https://arxiv.org/abs/2609.04028)
...
### [7] [A Time-Encoded Analog Photonic Interposer for Energy-EfficientIntegration of Analog Vision Sensors and Analog Accelerators](https://arxiv.org/abs/2609.03125)
...
### [8] [A single-precision floating-point systolic Givens-QRD Triangular Solver for MVDR Beamforming](https://arxiv.org/abs/2609.03137)
...
### [9] [LevelSyn: Physical-Aware Logic Synthesis via Level-Asynchronous Graph Neural Networks](https://arxiv.org/abs/2609.03594)
...
### [10] [Confidence-Gated Admission for Hardware Prefetching: When the Gate Matters More Than the Predictor](https://arxiv.org/abs/2609.04040)
...
### [11] [Requirements After the First Edit: Mining Late Requirement Emergence and Rework in Real-World Coding-Agent Sessions](https://arxiv.org/abs/2609.03028)
...
### [12] [Large Language Models and Language Server Protocol: a match made in context](https://arxiv.org/abs/2609.03086)
...
### [13] [Compound Prompt Constraints in LLM Code Generation: A Factorial Study of Format, Persona, and Urgency](https://arxiv.org/abs/2609.03156)
...
### [14] [Two Truths and A Lie? Benchmarking Off-the-Shelf LLMs for Requirements Quality Assessment: Performance, False Alarms, and Misses](https://arxiv.org/abs/2609.03230)
...
### [15] [Refusing the Impossible: A Taxonomy and Benchmark for Code Hallucination in Large Language Models](https://arxiv.org/abs/2609.03267)
...
### [16] [TIPCODER: Reinforcement Learning Boosted Test-time Instruction Proposer for Code Generation](https://arxiv.org/abs/2609.03309)
...
### [17] [The Psychological Costs of Artificial Intelligence Adoption in Software Engineering](https://arxiv.org/abs/2609.03456)
...
### [18] [Code Transformation Rule Synthesis using LLMs: Potential and Limits](https://arxiv.org/abs/2609.03592)
...
### [19] [Can LLMs Extract Architectural Design Decisions from Source Code Commits? - A Preliminary Exploratory Study](https://arxiv.org/abs/2609.03721)
...
### [20] [No One Left Behind: Cross-Level Analysis for Sustainable Software Engineering](https://arxiv.org/abs/2609.03861)
...
### [21] [LabelMate: An LLM-Driven Framework for Refined Issue Report Labeling](https://arxiv.org/abs/2609.04055)
...
### [22] [When Models Edit Too Much: On the Fidelity of Minimal Code Edits](https://arxiv.org/abs/2609.04061)
...
### [23] [ATIBA: Grounded Integrity and Quality Checking for Research Papers](https://arxiv.org/abs/2609.04123)
...
### [24] [SWE-Gate: Passing Functional Tests Is Not Enough for Software Engineering Agents](https://arxiv.org/abs/2609.04167)
...
### [25] [The Illusion of Independent Quorums: Epistemic Fault Domains and Correlated Cognitive Failures in Agentic Quorums](https://arxiv.org/abs/2609.02925)
*Jun He,Deying Yu*
...
### [26] [Fully Fluctuating Sleepy Consensus from Minimal Assumptions](https://arxiv.org/abs/2609.03063)
...
### [27] [Skywing: A Platform for Decentralized Mathematical Computing in Unreliable Environments](https://arxiv.org/abs/2609.03145)
...
### [28] [BASP: Communication-Efficient Batch-Aware Sequence Parallelism for LLM Training](https://arxiv.org/abs/2609.03151)
...
### [29] [Carbon-aware Resource Management for Latency-Sensitive Cloud Computing Environments: A Taxonomy and Future Directions](https://arxiv.org/abs/2609.03270)
...
### [30] [A Technique for Load Shifting Low-latency Applications in Multi-Region Renewables Harvesting via SMT Core Pooling](https://arxiv.org/abs/2609.03297)
...
### [31] [Lantern: Finding Committable Transactions via Back-Propagation on DAGs](https://arxiv.org/abs/2609.03315)
...
### [32] [Iapetus: Content-Aware Hierarchical Scheduling for Collaborative ViT Inference in LEO Satellite Networks](https://arxiv.org/abs/2609.03318)
...
### [34] [Latency-Aware Orchestration for Multi-Agent LLM Workflows on Heterogeneous GPUs](https://arxiv.org/abs/2609.03335)
...
### [35] [JuPyLive: Seamless Migration of Jupyter Notebook Resources from Laptop to HPC](https://arxiv.org/abs/2609.03562)
...
### [36] [Every Kernel Is a Join: Automatic Multi-GPU Parallelism for AI Computations in Einsummable](https://arxiv.org/abs/2609.03905)
...
### [37] [Barnacle: Adaptive Multi-Leader Scheduling for DAG-Based Consensus](https://arxiv.org/abs/2609.03978)
...
### [38] [Para-Pipe: Exploiting Hierarchical Operator Parallelism of ML Computational Graphs on SoCs](https://arxiv.org/abs/2609.04168)
...
### [39] [Efficient Co-simulator Integration with Application to Smart Grids](https://arxiv.org/abs/2609.03118)
...
### [40] [Feasible but Not Safe: Constraint Violations and Report-Channel Attacks in Learned Cell-Free ISAC Association](https://arxiv.org/abs/2609.03147)
...
### [41] [Bringing dApps to OCUDU: An E3 Controller for Real-Time Open RAN Intelligence](https://arxiv.org/abs/2609.03162)
...
### [42] [Indirect Estimation of SINR via SSB and CSI-RS RSRP in 5G NR](https://arxiv.org/abs/2609.03488)
...
### [43] [A Semantic-Aware Multiple Access Scheme Leveraging Spatial Redundancy for Uplink-Dominant Network Services](https://arxiv.org/abs/2609.03559)
...
### [44] [From Prior-Guided Heuristics to Deployable Agents: Accelerating Demonstration-Driven Reinforcement Learning for Deadline-Constrained Network Control](https://arxiv.org/abs/2609.03590)
...
### [45] [Employing the Structural Power to Achieve Supply-Demand Balanced Payment Channel Networks](https://arxiv.org/abs/2609.03600)
...
### [46] [Is Collision-Free Backoff Worth It in Wi-Fi?](https://arxiv.org/abs/2609.03817)
...
### [47] [Practical Threshold-based Tree Edit Distance Lower-Bounds](https://arxiv.org/abs/2609.03078)
...
### [48] [What Happens When the Model Eats the Stack? Rethinking the Research Agenda for Data Agents to Withstand the Bitter Lesson](https://arxiv.org/abs/2609.03141)
...
### [49] [Does SRL Pave the Road to Explainable Reasoning? Lessons Learned from an Implementer's Perspective](https://arxiv.org/abs/2609.03441)
...
### [50] [KnowFeat: Knowledge-Guided Feature Engineering via LLM Agents](https://arxiv.org/abs/2609.03529)
...
### [51] [Tree Databases](https://arxiv.org/abs/2609.03538)
*Nicolas Spyratos*
...
### [52] [Convolution Sum-Product Queries](https://arxiv.org/abs/2609.03672)
...
### [53] [Aker: Density-Aware Approximate Caching for Vector Search (Extended Version)](https://arxiv.org/abs/2609.03712)
...
### [54] [From Data Querying to Data Investigations: Rethinking Natural Language Interfaces for Databases](https://arxiv.org/abs/2609.03898)
...
### [55] [Property Testing for Recursive Query Languages](https://arxiv.org/abs/2609.03908)
