...
### [1] [When to Use Wireless Challenge-Response Physical Layer Authentication: Design of a Measurable Guideline for OFDM](https://arxiv.org/abs/2605.06750)
...
### [2] [Toward Quantum-Safe 6G: Experimental Evaluation of Post-Quantum Cryptography Techniques](https://arxiv.org/abs/2605.06881)
...
### [3] [From Map-and-Encap to BIER: Observations on Network Routing Scalability](https://arxiv.org/abs/2605.07071)
...
### [4] [Unconsented Sensing: A Sociotechnical Governance Framework for 6G ISAC](https://arxiv.org/abs/2605.07328)
*Anass Sedrati*
...
### [5] [Suitability of the Data Distribution Service for Next-Generation Ethernet-Based Agricultural Machinery Networking](https://arxiv.org/abs/2605.07742)
...
### [6] [Regulating Branch Parallelism in LLM Serving](https://arxiv.org/abs/2605.06914)
...
### [7] [On Similarity of Computational Kernels in our Codes and Proxies](https://arxiv.org/abs/2605.06968)
...
### [8] [Deadline-Driven Hierarchical Agentic Resource Sharing for AI Services and RAN Functions in AI-RAN](https://arxiv.org/abs/2605.07547)
...
### [9] [FATE: Future-State-Aware Scheduling for Heterogeneous LLM Workflows](https://arxiv.org/abs/2605.07238)
...
### [11] [MERBIT: A GPU-Based SpMV Method for Iterative Workloads](https://arxiv.org/abs/2605.07391)
...
### [12] [RcLLM: Accelerating Generative Recommendation via Beyond-Prefix KV Caching](https://arxiv.org/abs/2605.07443)
...
### [13] [HexiSeq: Accommodating Long Context Training of LLMs over Heterogeneous Hardware](https://arxiv.org/abs/2605.07569)
...
### [14] [Stencil Computations on Tenstorrent Wormhole](https://arxiv.org/abs/2605.07599)
...
### [15] [Dooly: Configuration-Agnostic, Redundancy-Aware Profiling for LLM Inference Simulation](https://arxiv.org/abs/2605.07985)
...
### [16] [EMRGF: A Practitioner Framework for Governance-Driven Enterprise Technology Modernization](https://arxiv.org/abs/2605.06703)
*Harveen Punihani*
...
### [17] [The Single-File Test: A Longitudinal Public-Interface Evaluation of First-Output LLM Web Generation with Social Reach Tracking](https://arxiv.org/abs/2605.06707)
...
### [18] [Agentic Coding Needs Proactivity, Not Just Autonomy](https://arxiv.org/abs/2605.06717)
...
### [19] [A Self-Healing Framework for Reliable LLM-Based Autonomous Agents](https://arxiv.org/abs/2605.06737)
...
### [20] [ScarfBench: A Benchmark for Cross-Framework Application Migration in Enterprise Java](https://arxiv.org/abs/2605.06754)
...
### [21] [Analyzing the Adoption of Database Management Systems Throughout the History of Open Source Projects](https://arxiv.org/abs/2605.06817)
...
### [22] [Guidelines for Cultivating a Sense of Belonging to Reduce Developer Burnout](https://arxiv.org/abs/2605.06827)
...
### [23] [SmellBench: Evaluating LLM Agents on Architectural Code Smell Repair](https://arxiv.org/abs/2605.07001)
...
### [24] [From Assistance to Agency: Rethinking Autonomy and Control in CI/CD Pipelines](https://arxiv.org/abs/2605.07062)
...
### [25] [RepoZero: Can LLMs Generate a Code Repository from Scratch?](https://arxiv.org/abs/2605.07122)
...
### [26] [Low-code and no-code with BESSER to create and deploy smart web applications](https://arxiv.org/abs/2605.07376)
...
### [27] [Exploring CoCo Challenges in ML Engineering Teams: Insights From the Semiconductor Industry](https://arxiv.org/abs/2605.07389)
...
### [28] [Boosting Automatic Java-to-Cangjie Translation with Multi-Stage LLM Training and Error Repair](https://arxiv.org/abs/2605.07403)
...
### [29] [Prompt Engineering Strategies for LLM-based Qualitative Coding of Psychological Safety in Software Engineering Communities: A Controlled Empirical Study](https://arxiv.org/abs/2605.07422)
...
### [30] [MASPrism: Lightweight Failure Attribution for Multi-Agent Systems Using Prefill-Stage Signals](https://arxiv.org/abs/2605.07509)
...
### [31] [Can LLMs Solve Science or Just Write Code? Evaluating Quantum Solver Generation](https://arxiv.org/abs/2605.07525)
...
### [32] [System Test Generation for Virtual Reality Applications using Scenario Models](https://arxiv.org/abs/2605.07534)
...
### [33] [Characterizing and Mitigating False-Positive Bug Reports in the Linux Kernel](https://arxiv.org/abs/2605.07678)
...
### [34] [SafeTune: Search-based Harmfulness Minimisation for Large Language Models](https://arxiv.org/abs/2605.07709)
...
### [35] [The AI-Native Large-Scale Agile Software Development Manifesto](https://arxiv.org/abs/2605.07717)
...
### [36] [SARC: A Governance-by-Architecture Framework for Agentic AI Systems](https://arxiv.org/abs/2605.07728)
*Gaston Besanson*
...
### [37] [Securing the Dark Matter: A Semantic-Enhanced Neuro-Symbolic Framework for Supply Chain Analysis of Opaque Industrial Software](https://arxiv.org/abs/2605.07737)
...
### [38] [Coding Agents Don't Know When to Act](https://arxiv.org/abs/2605.07769)
...
### [39] [Bridging the Programming Language Gap: Constructing a Multilingual Shared Semantic Space through AST Unification and Graph Matching](https://arxiv.org/abs/2605.07788)
...
### [40] [Unsafe by Flow: Uncovering Bidirectional Data-Flow Risks in MCP Ecosystem](https://arxiv.org/abs/2605.07836)
...
### [41] [Evaluating Design Conformance Through Trace Comparison](https://arxiv.org/abs/2605.07909)
...
### [42] [Similar Pattern Annotation via Retrieval Knowledge for LLM-Based Test Code Fault Localization](https://arxiv.org/abs/2605.07957)
...
### [43] [Collaborator or Assistnat? How AI Coding Agents Partition Work Across Pull Request Lifecycles](https://arxiv.org/abs/2605.08017)
...
### [44] [EULER-ADAS: Energy-Efficient & SIMD-Unified Logarithmic-Posit Engine for Precision-Reconfigurable Approximate ADAS Acceleration](https://arxiv.org/abs/2605.06875)
...
### [45] [CARMEN: CORDIC-Accelerated Resource-Efficient Multi-Precision Inference Engine for Deep Learning](https://arxiv.org/abs/2605.06878)
...
### [46] [Bridging the Last Mile of Circuit Design: PostEDA-Bench, a Hierarchical Benchmark for PPA Convergence and DRC Fixing](https://arxiv.org/abs/2605.06936)
...
### [47] [EDA-Schema-V2: A Multimodal Schema, Open Datasets, and Benchmarks for Machine Learning in Digital Physical Design](https://arxiv.org/abs/2605.06952)
...
### [48] [TransDot: An Area-efficient Reconfigurable Floating-Point Unit for Trans-Precision Dot-Product Accumulation for FPGA AI Engines](https://arxiv.org/abs/2605.07245)
...
### [49] [TREA: Low-precision Time-Multiplexed, Resource-Efficient Edge Accelerator for Object Detection and Classification](https://arxiv.org/abs/2605.07321)
...
### [50] [Effective and Memory-Efficient Alternatives to ECC for Reliable Large-Scale DNNs](https://arxiv.org/abs/2605.07417)
...
### [51] [Accelerating Precise End-to-End Simulation: Latency-Sensitive Many-core System Modeling](https://arxiv.org/abs/2605.07750)
...
### [52] [AccelSync: Verifying Synchronization Coverage in Accelerator Pipeline Programs](https://arxiv.org/abs/2605.07881)
...
### [53] [Scalable Active Metamaterials for Shape-Morphing](https://arxiv.org/abs/2605.07030)
...
### [54] [Accelerated and data-efficient flow prediction in stirred tanks via physics-informed learning](https://arxiv.org/abs/2605.07444)
...
### [55] [Exploring the non-convexity in machine learning using quantum-inspired optimization](https://arxiv.org/abs/2605.07947)
