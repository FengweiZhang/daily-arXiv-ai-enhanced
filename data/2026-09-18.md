...
### [7] [From Corridor Selection to Earthwork: A Multi-Stage Framework for Automated Road Design via Steiner Trees and Convex Optimization](https://arxiv.org/abs/2609.19350)
...
### [8] [An Insurance Broker for Every Small Business: The Economics of Exceptional Care at Scale](https://arxiv.org/abs/2609.19586)
...
### [9] [Topology optimization with buckling constraints: Adaptive eigenvalue aggregation and modality identification](https://arxiv.org/abs/2609.19603)
...
### [10] [SabreAgent: Language Models at Design Time for Lost-Sales Inventory Control](https://arxiv.org/abs/2609.19760)
...
### [11] [Efficiently Linking Unstructured Data for Multi-step Reasoning](https://arxiv.org/abs/2609.19491)
...
### [12] [A Functional Pilot for Certified Freshness-Aware Semantic--Spatial Range Retrieval](https://arxiv.org/abs/2609.19855)
*Taimoor Ahmad*
...
### [13] [Resolution limits for process comparison from event data](https://arxiv.org/abs/2609.20489)
...
### [36] [Detecting Soft Errors in Parallel Software with LLM-tuned Instruction Duplication](https://arxiv.org/abs/2609.19531)
...
### [37] [Syndrome Decoding for Silent Data Corruption in Quantized Integer GPU Arithmetic](https://arxiv.org/abs/2609.19743)
...
### [38] [Sketching the Error, Not the Product: Post Hoc Fault Recovery for Half Precision GPU Matrix Multiplication](https://arxiv.org/abs/2609.19758)
*Pranav Napolean,Vikas Srivastava,Napolean Periathambi*
...
### [39] [Safe Exploration of Arbitrary Dynamic Dangerous Networks](https://arxiv.org/abs/2609.19845)
...
### [40] [Xronos: Heterogeneity-Aware Tensor Parallelism for Collaborative LLM Fine-Tuning on Edge CPUs](https://arxiv.org/abs/2609.19909)
...
### [41] [The Life of a Token: from Words to Bits on the Wire](https://arxiv.org/abs/2609.19924)
...
### [42] [VERA: Reinforcement Learning for Dynamic Memory Scaling of HPC Workloads in Kubernetes](https://arxiv.org/abs/2609.19936)
...
### [43] [P-GADMM: Parallel Group-Based ADMM for Asynchronous Optimization in Heterogeneous Edge Networks](https://arxiv.org/abs/2609.20006)
...
### [44] [Distributed Edge Inference: an Experimental Study on Multiview Detection](https://arxiv.org/abs/2609.20009)
...
### [45] [The Price of Decentralization, Paid Twice: A Latency Floor and a Minimal Subsidy from a Geographic Decentralization Invariant](https://arxiv.org/abs/2609.20322)
*Ruiyang Zhang*
...
### [46] [Accelerating Sharded Data Parallelism at Scale with Federated Learning](https://arxiv.org/abs/2609.20359)
...
### [47] [A Kubernetes-Native Request Router for Quality-Aware Inference Serving in the Computing Continuum](https://arxiv.org/abs/2609.20497)
...
### [48] [PixelFlow: Token-Level Workload Management for Efficient Distributed DiT Serving](https://arxiv.org/abs/2609.20723)
