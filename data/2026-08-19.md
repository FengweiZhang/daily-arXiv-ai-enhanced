...
### [7] [Brief Announcement: Fair Binding for Hidden-State Authorization in Byzantine SMR](https://arxiv.org/abs/2608.17349)
*Arnab Mallick*
...
### [8] [Generalizing and accelerating consistency checking for non-transactional distributed storage systems](https://arxiv.org/abs/2608.17388)
...
### [9] [Optimal Adaptive Multi-Valued Byzantine Agreement](https://arxiv.org/abs/2608.17552)
...
### [10] [Counting in Population Protocols on Graphs](https://arxiv.org/abs/2608.17590)
...
### [11] [Bounded-State Restoration: Decoupling Local Restore Capacity from External LLM State](https://arxiv.org/abs/2608.17826)
*Zixuan Li*
...
### [12] [Multivalued Consensus: General Adversaries Require More Communication](https://arxiv.org/abs/2608.17998)
...
### [13] [Minimizing Commit Rules for DAG-based Atomic Broadcast](https://arxiv.org/abs/2608.18029)
...
### [14] [Reduced-Order Physics-Informed Neural Network with Adaptive Basis Refinement for Structural Identification](https://arxiv.org/abs/2608.17131)
...
### [15] [Modeling the Hydrodynamics in the Oslofjord using ADCIRC](https://arxiv.org/abs/2608.17140)
...
### [16] [Information fusion and machine learning for sensitivity analysis using physics knowledge and experimental data](https://arxiv.org/abs/2608.17248)
...
### [17] [Adaptive surrogate modeling for high-dimensional spatio-temporal output](https://arxiv.org/abs/2608.17250)
...
### [18] [A multi-level preprocessing and modelling framework for spectral imaging of microplastics](https://arxiv.org/abs/2608.17697)
...
### [19] [Overlap-free multi-material topology optimization for minimum compliance in two and three dimensions by level-set-based negative-mapping interpolation](https://arxiv.org/abs/2608.17963)
...
### [20] [SeqFeed: Improving Agentic RTL Code Generation with Sequential Behavior Feedback](https://arxiv.org/abs/2608.16934)
...
### [21] [DTX: A Throughput-First Training Accelerator for Diffusion and Transformer Models](https://arxiv.org/abs/2608.16953)
*Shashank*
...
### [22] [RENESIS: Energy-Aware Synthesis of Adiabatic Logic from Irreversible Netlists](https://arxiv.org/abs/2608.17139)
*Mitchell A. Thornton*
...
### [23] [The Road Less Traveled: Congestion-Aware NoC Placement and Packet Routing for FPGAs](https://arxiv.org/abs/2608.17266)
...
### [24] [NeuroAbs: A Neuro-Symbolic RTL Abstraction Framework for Property Checking Acceleration](https://arxiv.org/abs/2608.17304)
...
### [25] [ETHEREAL: A 25.6-$μ$s/inf. Low-latency Event-driven Graph-neural-network Processor for High-resolution Vision at the Edge](https://arxiv.org/abs/2608.17787)
...
### [26] [ESR-HGNN: Eliminating Semantic Redundancy for Efficient Mini-batch HGNN Inference](https://arxiv.org/abs/2608.17865)
...
### [27] [Rerootable Hypertree Decompositions](https://arxiv.org/abs/2608.17853)
...
### [28] [ORCA: Observability-Grounded Program Repair for Microservice Incidents](https://arxiv.org/abs/2608.17018)
...
### [29] [LadderTeam: Dual-Agent Laddering Elicitation Framework](https://arxiv.org/abs/2608.17029)
...
### [30] [A Multi-Surface Consistency Audit of Software Citation Metadata](https://arxiv.org/abs/2608.17159)
*Pengyin Shan*
...
### [31] [Grounding AI Agents in Contracts: An Empirical Evaluation of Spec-Driven Test Generation](https://arxiv.org/abs/2608.17177)
...
### [32] [Graphectory Viewer: A Tool for Process-Centric Analysis of Agentic Software Trajectories](https://arxiv.org/abs/2608.17195)
...
### [33] [Oracles That Cannot Fail: Anchoring and the Expectation That Moves With the Fault](https://arxiv.org/abs/2608.17214)
*Arquimedes Canedo*
...
### [34] [SNIPTEST: Fuzzing Multi-Level Code Slices for Validating Vulnerabilities](https://arxiv.org/abs/2608.17396)
...
### [35] [COMMITGUARD: Differential Slice Fuzzing for Commit-Induced Bug Detection](https://arxiv.org/abs/2608.17401)
...
### [36] [Beyond FLOPs: Energy-Aware Knowledge Distillation for Sustainable LLMs on Code-Related Task](https://arxiv.org/abs/2608.17515)
...
### [37] [REST API Testing with Verified LLM-Inferred Dependencies and Response-Driven Refinement](https://arxiv.org/abs/2608.17546)
...
### [38] [Unified Message Model for Heterogeneous Serial Data Exchange Protocols](https://arxiv.org/abs/2608.17642)
...
### [42] [SpecTrum: Specification-Guided Differential Fuzzing for Ethereum Consensus Clients](https://arxiv.org/abs/2608.17738)
...
### [43] [Reshaping the SDLC for Data- and AI-Centric Systems](https://arxiv.org/abs/2608.17824)
*Mamdouh Alenezi*
...
### [44] [What Does It Mean and Why Should I Bother? Motivating Students to Write Better Commit Messages](https://arxiv.org/abs/2608.17993)
...
### [45] [The Polyglot's Dilemma: Conformance Testing a Dozen Specs in as Many Languages](https://arxiv.org/abs/2608.18039)
