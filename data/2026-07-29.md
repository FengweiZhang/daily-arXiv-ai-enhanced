...
### [11] [Enhancing Error Detection Performance through Parallel CRC Computation on Multi-Core Architectures](https://arxiv.org/abs/2607.24849)
...
### [12] [Spanergy: Energy-aware Distributed Tracing for Microservices](https://arxiv.org/abs/2607.24902)
...
### [13] [QCOEM: Quantum Cloud Orchestration with Evolutionary Multi-Objective Optimization](https://arxiv.org/abs/2607.25358)
...
### [14] [CW-Ghost: Search-Free Granularity Selection for Helper-Thread Prefetching via Capacity Windows](https://arxiv.org/abs/2607.25363)
...
### [15] [WASP: A Configurable Framework for Portable Stateful Serverless Applications](https://arxiv.org/abs/2607.25493)
...
### [16] [PowerScale: Energy-Efficient Geo-Distributed Model Training with Federated Datacenter Power](https://arxiv.org/abs/2607.25650)
...
### [17] [Hermes: Low Tail-Latency Via Prefix Consensus](https://arxiv.org/abs/2607.25916)
...
### [18] [Prediction of experimental excited-state absorption spectra by using vibronic transition calculations: Its practical application to a π-conjugated molecule](https://arxiv.org/abs/2607.25247)
...
### [19] [Beyond "What to Retrieve": Uncertainty in Retrieval-Augmented Code Generation](https://arxiv.org/abs/2607.24884)
...
### [20] [Characterizing Structural Testability in JavaScript: An Empirical Study](https://arxiv.org/abs/2607.24965)
...
### [21] [Preliminary Guidelines for Using and Evaluating GenAI Tools to Support Systematic Literature Reviews](https://arxiv.org/abs/2607.24991)
...
### [22] [Authoring Agent Skills: A Software-Engineering Approach](https://arxiv.org/abs/2607.25032)
*Giuseppe Destefanis*
...
### [23] [What Motivates Whom? A Survey of Newcomers to OSS and Experienced OSS Practitioners](https://arxiv.org/abs/2607.25126)
...
### [24] [Learning from 53.6K Real-World Developer Edits of AI-Generated Code](https://arxiv.org/abs/2607.25130)
...
### [25] [Specification-Driven DevOps for Multi-Service Environments](https://arxiv.org/abs/2607.25141)
...
### [26] [NFR-to-Code Traceability in a Blockchain-IoT System: An Empirical Study](https://arxiv.org/abs/2607.25325)
...
### [27] [Specula: Scaling formal specifications for autonomous model checking of system code](https://arxiv.org/abs/2607.25333)
...
### [28] [CodeNib: A Multi-View Data System for Serving Repository Context to Coding Agents](https://arxiv.org/abs/2607.25431)
...
### [29] [Repositories, Contributors, and Continuity: An Empirical Study of Foundational Quantum Software](https://arxiv.org/abs/2607.25437)
...
### [30] [Input Relation Prompting for Metamorphic Testing on Query-Based Systems](https://arxiv.org/abs/2607.25603)
...
### [31] [SkillGate: Cost Efficient Runtime Malicious Skill File Detection in Coding Agents](https://arxiv.org/abs/2607.25619)
...
### [32] [An Empirical Study of Model Context Protocol Applications](https://arxiv.org/abs/2607.25635)
...
### [33] [KQFuzz: Knowledge-Guided Fuzzing for Quantum Libraries via Large Language Models](https://arxiv.org/abs/2607.25647)
...
### [34] [Delta Debugging for Cyber-Physical Systems with Flaky Test Executions](https://arxiv.org/abs/2607.25695)
...
### [35] [WarmTuner: Program-Specific Warm Starts for Compiler Autotuning via Offline-to-Online Reinforcement Learning](https://arxiv.org/abs/2607.25831)
...
### [36] [Rethinking Training Data for Generating Code Review Comments](https://arxiv.org/abs/2607.25851)
...
### [37] [How Do LLMs Read Bug Reports? An Empirical Study of Attention in LLMs for Automated Program Repair](https://arxiv.org/abs/2607.25873)
...
### [38] [CONQuER: Hardware-Aware Mixed-Precision Quantisation with Online-Calibrated Surrogates](https://arxiv.org/abs/2607.25884)
...
### [39] [RSIBench-Data: Benchmarking Data-Centric Research for Recursive Self-Improvement](https://arxiv.org/abs/2607.25886)
...
### [40] [A Low-Cost Human-in-the-Loop Investigation of Toxicity on GitHub at Scale](https://arxiv.org/abs/2607.25946)
...
### [41] [RepoReasoner: Evaluating Repository-Level Code Reasoning Ability of Long-Context Language Models](https://arxiv.org/abs/2607.25996)
...
### [42] [VClare: Resolving Imperfect Specifications in LLM-Based Verilog Generation](https://arxiv.org/abs/2607.24854)
...
### [43] [Formalization and quantitative metrics for functional stability of edge computing systems](https://arxiv.org/abs/2607.24895)
*Oleksii S. Bychkov*
...
### [44] [VPR-Evolve: Multi-Agent-Driven Algorithm Evolution for FPGA Place and Route](https://arxiv.org/abs/2607.24998)
...
### [45] [Mitigating the Impact of Retention Loss on Inference Accuracy in 65 nm Single-Poly Floating-Gate Analog In-Memory Computing](https://arxiv.org/abs/2607.25058)
...
### [46] [Beyond Prefill-Decode Disaggregation: Dissecting LLM Inference for Heterogeneous Platforms via Dynamic Operator Scheduling](https://arxiv.org/abs/2607.25498)
...
### [47] [At-the-Roofline Sparse Tensor Contractions on Vector Processors for Transformer Inference](https://arxiv.org/abs/2607.25504)
...
### [48] [MDTransformer: A Hardware-Software Co-Design of Mode-Division Photonic Transformer Accelerator with Inverse-Designed Coherent Crossbar](https://arxiv.org/abs/2607.26016)
...
### [49] [AuthentiCity: A Multi-Source Provenance-Aware Knowledge Graph and Benchmark for 3D City Models](https://arxiv.org/abs/2607.25243)
...
### [50] [Data Quality Profiling at Scale with Progressive Sampling: A Benchmark for Data-Centric AI Pipelines](https://arxiv.org/abs/2607.25356)
*Laure Berti-Equille*
...
### [51] [MemLens: A Value-Aware Memory Management System with Interactive Analytics for LLM-based Agents](https://arxiv.org/abs/2607.25992)
