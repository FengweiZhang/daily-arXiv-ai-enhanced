...
### [19] [Vibe Coding: Practice, Performance, Productivity, and Risk -A State-of-the-Art Review](https://arxiv.org/abs/2608.20446)
...
### [20] [Making Deployments Safe at Meta: Health Checks for Continuous Change-Safety](https://arxiv.org/abs/2608.20513)
...
### [21] [Testing and Evaluation of Agentic AI Systems In Military Command and Control](https://arxiv.org/abs/2608.20597)
...
### [22] [Behavior Specification-Guided Program Synthesis for Binary Deobfuscation](https://arxiv.org/abs/2608.20628)
...
### [23] [Toward Understanding Operating System Defects](https://arxiv.org/abs/2608.20643)
...
### [24] [Temporal Validity on Real Software Histories: Eliminating Stale-Fact Errors in Code-Assistant Memory over GitHub Fixes](https://arxiv.org/abs/2608.20685)
*Neeraj Yadav*
...
### [25] [An Extensive Empirical Study on Code Translation Technique](https://arxiv.org/abs/2608.20776)
...
### [26] [AI with Authority, from Application to Silicon](https://arxiv.org/abs/2608.21356)
*Jason Hickey*
...
### [27] [BC-Bench: Evaluating Agentic Engineering in a Domain-Specific Language for ERP](https://arxiv.org/abs/2608.20851)
...
### [28] [Beyond the Traceback: Using LLMs for Adaptive Explanations of Programming Errors](https://arxiv.org/abs/2608.20896)
...
### [29] [Generation of Web Apps with Agentic IDEs: An Empirical Assessment](https://arxiv.org/abs/2608.20903)
...
### [30] [Spike-Killer: Evidence-Gated LLM Assistance for Safe Performance Diagnosis on a Real Windows Workstation](https://arxiv.org/abs/2608.21069)
...
### [31] [Trustworthy RAG: An Evaluation Agent for Detecting Misinformation and Knowledge Poisoning in Generative AI Systems](https://arxiv.org/abs/2608.21095)
...
### [32] [On the Time and Frequency Domain Representations of Signals for CPS Specification](https://arxiv.org/abs/2608.21167)
...
### [34] [The Substitution Escrow Threshold: When "Compatible With" Becomes Safe Enough to Buy](https://arxiv.org/abs/2608.21221)
*Amadeus Brandes*
...
### [35] [Human-AI Collaboration in Requirements Engineering: Evidence of the Negative Effect of LLMs on Requirements Inspection](https://arxiv.org/abs/2608.21298)
...
### [36] [Beyond Fault Localization: A Trajectory-Level Study of LLM Agents for Microservice Root Cause Analysis](https://arxiv.org/abs/2608.21310)
...
### [37] [AI-to-AI Code Reviews of GitHub Pull Requests](https://arxiv.org/abs/2608.21311)
...
### [38] [Natural-Language Workflows Are Not Software Yet: Artifact-Driven Compilation for Reliable Agent Execution](https://arxiv.org/abs/2608.21341)
...
### [39] [Event-triggered Implicit Perturbation for Zeroth-Order Fine-Tuning of Spiking Transformers](https://arxiv.org/abs/2608.21223)
...
### [40] [SPICE: Speculative Prefetching with Low-Rank Expert Surrogates and Heterogeneous Orchestration for MoE Inference Acceleration](https://arxiv.org/abs/2608.21240)
...
### [41] [Assessing Triple Modular Redundancy for Wide-Link, Low-Latency NoC Routers: Reliability and Physical Design Challenges](https://arxiv.org/abs/2608.21288)
...
### [42] [Towards Traffic Modelling of Multi-Agent Systems: The Role of Coordination Topology](https://arxiv.org/abs/2608.20494)
...
### [43] [Making Time-Sensitive Networking Deployable: A Comprehensive Lifecycle Architecture](https://arxiv.org/abs/2608.20500)
...
### [44] [Fluid-Dynamic Interference Modeling for LEO Mega-Constellations: A Spatiotemporal Kinetic Field Approach](https://arxiv.org/abs/2608.20651)
...
### [45] [Mitigating Proxy-Induced Traffic Drift in Website Fingerprinting via Model-Agnostic Traffic Tailoring](https://arxiv.org/abs/2608.20692)
...
### [46] [Orchra: Stateful-aware Cross-slice Workload Migrations in the 6G Control Plane](https://arxiv.org/abs/2608.20893)
...
### [47] [An Imaging-Informed Reaction-Diffusion Model of Infarct Growth](https://arxiv.org/abs/2608.20935)
...
### [48] [Broadband Stable Calderón-Preconditioned Vector-Potential-Only Integral Equations for PEC Scattering](https://arxiv.org/abs/2608.20993)
...
### [49] [Techno-Economic Analysis of Repurposing Abandoned Oil Wells for Geothermal Energy Extraction Using Physics-Informed Neural Networks](https://arxiv.org/abs/2608.21092)
