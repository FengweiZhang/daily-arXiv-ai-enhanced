...
### [6] [Field-Deployable RF Capture System for Indoor, Outdoor, and Foliage Environments](https://arxiv.org/abs/2607.01368)
...
### [7] [Physically-Aware Preemptive Virtual Channels for Deadlock-Free AXI Networks-on-Chip](https://arxiv.org/abs/2607.01430)
...
### [8] [MxGLUT: A Reconfigurable LUT-Centric Broadcast Dataflow Accelerator for Mixed-Precision GEMM](https://arxiv.org/abs/2607.01607)
...
### [9] [3DLS: A 3D Logic-Stacked Architecture for Disaggregated LLM Serving](https://arxiv.org/abs/2607.01617)
...
### [10] [Approximate Attention Weighting for Sustainable FPGA-Based Vision Transformer Inference](https://arxiv.org/abs/2607.01798)
...
### [11] [Probabilistic Memory for Trustworthy Edge Intelligence](https://arxiv.org/abs/2607.02465)
...
### [12] [Benchmarking Code Improvement with Progressive, Adaptive, and Interactive Feedback](https://arxiv.org/abs/2607.01360)
...
### [13] [GPUAlert: A Zero-Instrumentation Process-Boundary Monitor for Diagnosing GPU Training-Job Failures](https://arxiv.org/abs/2607.01409)
...
### [14] [Adoption and Impact of Command-Line AI Coding Agents: A Study of Microsoft's Early 2026 Rollout of Claude Code and GitHub Copilot CLI](https://arxiv.org/abs/2607.01418)
...
### [15] [From Anatomy to Smells: An Empirical Study of SKILL.md in Agent Skills](https://arxiv.org/abs/2607.01456)
...
### [16] [Insights from GitHub Community on the Matter Standard: Developer Perspectives and Challenges](https://arxiv.org/abs/2607.01494)
...
### [17] [Kani: A Model Checker for Rust](https://arxiv.org/abs/2607.01504)
...
### [18] [A Capacity-Aware Parr Model for Agile Projects](https://arxiv.org/abs/2607.01562)
*Pedro E. Colla*
...
### [19] [A Single Patch Is Not Enough: Deterministic Fusion of Repair Candidates](https://arxiv.org/abs/2607.01597)
...
### [20] [AgentFlow: Building Agent Dependency Graphs for Static Analysis of Agent Programs](https://arxiv.org/abs/2607.01640)
...
### [21] [When Agents Do Not Stop: Uncovering Infinite Agentic Loops in LLM Agents](https://arxiv.org/abs/2607.01641)
...
### [22] [Refploit: Facilitating Exploit Construction via Code-Agent Trajectory Repair](https://arxiv.org/abs/2607.01760)
...
### [23] [KRCA: An Efficient Root Cause Analysis System in Hyper-Scale Microservice Systems via Agentic AI](https://arxiv.org/abs/2607.01788)
...
### [24] [Archer: Towards Agentic Review for Compiler Optimizations](https://arxiv.org/abs/2607.01808)
*Yunbo Ni,Shaohua Li*
...
### [25] [Decoupling Code Complexity from Newcomer Participation: A Causal Study of AI Coding Agent Adoption in OSS](https://arxiv.org/abs/2607.01810)
...
### [26] [Understanding Software Defect Prediction: A Large-scale Empirical Study Across Uncertainty Quantification and Performance Evaluation](https://arxiv.org/abs/2607.01842)
...
### [27] [Technical Debt Friction for Maintenance Prioritization: An Industrial Multi-Case Study](https://arxiv.org/abs/2607.01850)
...
### [28] [Regression Accumulation in Multi-Turn LLM Programming Conversations](https://arxiv.org/abs/2607.01855)
...
### [29] [An Exploratory Study on LLM-Generated Code and Comments in Code Repositories](https://arxiv.org/abs/2607.01867)
...
### [30] [Understanding Build Reproducibility in the F-Droid Ecosystem](https://arxiv.org/abs/2607.01890)
...
### [33] [Underspecification does not imply Incoherence: The Risks of Semantic Collapse in Coding Models](https://arxiv.org/abs/2607.01953)
...
### [34] [Epic-Organized vs. Requirement-Aligned Gherkin: An Empirical Evaluation of LLM-Based Acceptance Criteria Generation](https://arxiv.org/abs/2607.01980)
...
### [35] [Benchmarking Quantum Software Testing with Scalable Quantum Programs](https://arxiv.org/abs/2607.02029)
...
### [36] [Mitigating Package Hallucinations in Large Language Models via Model Editing](https://arxiv.org/abs/2607.02052)
...
### [37] [Prompt Coverage Adequacy](https://arxiv.org/abs/2607.02057)
...
### [38] [File-Level Copying Is an Implicit Dependency in Open Source](https://arxiv.org/abs/2607.02059)
...
### [39] [Coding Agents Are Guessing: Measuring Action-Boundary Violations in Underspecified DevOps Instructions](https://arxiv.org/abs/2607.02294)
...
### [40] [Guiding Human Validation of LLM-Generated Code via Verifiable Literate Programming](https://arxiv.org/abs/2607.02333)
...
### [41] [Developers' Experience with Generative AI Beyond Productivity Assessment -- Insights from an Empirical Mixed-Methods Field Study](https://arxiv.org/abs/2607.02337)
...
### [42] [SkillFuzz: Fuzzing Skill Composition for Implicit Intents Discovery in Open Skill Marketplaces](https://arxiv.org/abs/2607.02345)
...
### [43] [Understanding Agent-Based Patching of Compiler Missed Optimizations](https://arxiv.org/abs/2607.02370)
...
### [44] [Reasoning effort, not tool access, buys first-try reliability in agentic code generation: an observational study](https://arxiv.org/abs/2607.02436)
*Achint Mehta*
...
### [45] [HTTP REST API Structure Learning](https://arxiv.org/abs/2607.02442)
*Ran Dubin,Amit Dvir*
...
### [46] [TestEvo-Bench: An Executable and Live Benchmark for Test and Code Co-Evolution](https://arxiv.org/abs/2607.02469)
...
### [47] [HYPIC: Accelerating Hybrid-Attention LLM Serving with Position-Independent Caching](https://arxiv.org/abs/2607.01299)
...
### [48] [OmniPilot: An Uncertainty-Aware LLM Inference Advisor for Heterogeneous GPU Clusters](https://arxiv.org/abs/2607.01579)
...
### [49] [Arachne: Orchestrating Cascades for Efficient Text-to-Video Model Training](https://arxiv.org/abs/2607.01701)
...
### [50] [Exploiting Task-Based Parallelism for the Red-Black Gauss-Seidel Method on 2D Grids](https://arxiv.org/abs/2607.01735)
...
### [51] [HCMS: Head-Chunked Multi-Stream Pipeline for Communication-Computation Overlap in Long-Sequence Parallel Attention](https://arxiv.org/abs/2607.01817)
...
### [56] [Securing People and their Machines Against Major Faults](https://arxiv.org/abs/2607.02304)
...
### [57] [Elasticity in Parallel Sparse Triangular Solve](https://arxiv.org/abs/2607.02324)
...
### [58] [WattGPU: Predicting Inference Power and Latency on Unseen GPUs and LLMs](https://arxiv.org/abs/2607.02391)
...
### [59] [FlintKV: A Fast Durable Storage Engine for Modern Databases](https://arxiv.org/abs/2607.02401)
...
### [60] [TO-Master: an LLM-agent framework for automated topology optimization](https://arxiv.org/abs/2607.01812)
