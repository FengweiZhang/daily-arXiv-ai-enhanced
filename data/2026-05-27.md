...
### [2] [From user-understandable to technical process model: a model-driven approach using cuta4bpm](https://arxiv.org/abs/2605.26117)
...
### [3] [VISTA: An End-to-End Benchmark for Visual Spec-to-Web-App Coding Agents](https://arxiv.org/abs/2605.26144)
...
### [4] [Augment Engineering: A Methodology for Multi-Tool AI Orchestration Across Professional Domains](https://arxiv.org/abs/2605.26146)
*Elias Calboreanu*
...
### [5] [Gamified Requirement Elicitation for a Multi-Modal Decision Support System. The Case of SYNCHROMODE](https://arxiv.org/abs/2605.26164)
...
### [6] [A Universal Cliff and a Design Fingerprint: Cross-Section Defect Detection Under LLM Orchestration](https://arxiv.org/abs/2605.26174)
*Hiroki Fukui*
...
### [7] [RepoMirage: Probing Repository Context Reasoning in Code Agents with Perturbations](https://arxiv.org/abs/2605.26177)
...
### [8] [SetupX: Can LLM Agents Learn from Past Failures in Functionality-Correct Code Repository Setup?](https://arxiv.org/abs/2605.26186)
...
### [9] [Workflow Closure Is Not Scientific Closure in Auto-Research Systems](https://arxiv.org/abs/2605.26200)
...
### [10] [Verus-SpecGym: An Agentic Environment for Evaluating Specification Autoformalization](https://arxiv.org/abs/2605.26457)
...
### [11] [Testing Agentic Workflows with Structural Coverage Criteria](https://arxiv.org/abs/2605.26521)
...
### [12] [TrajAudit: Automated Failure Diagnosis for Agentic Coding Systems](https://arxiv.org/abs/2605.26563)
...
### [13] [Energy-Aware Decision Making in Software Stack Upgrades](https://arxiv.org/abs/2605.26609)
...
### [14] [Software Engineering Podcasts: An Empirical Study of Their Potential as a Research Resource](https://arxiv.org/abs/2605.26793)
...
### [15] [HTMLCure: Turning Browser Experience into State Guided Repair for Interactive HTML](https://arxiv.org/abs/2605.26807)
...
### [16] [On the GitHub Actions Language: Usage, Evolution, and Workflow Reliability](https://arxiv.org/abs/2605.26825)
...
### [17] [LLM-based Mockless Unit Test Generation for Java](https://arxiv.org/abs/2605.26851)
...
### [18] [Strategies for Guiding LLMs to Use Software Design Patterns: A Case of Singleton](https://arxiv.org/abs/2605.26898)
...
### [19] [EviACT: An Evidence-to-Action Framework for Agentic Program Repair](https://arxiv.org/abs/2605.27238)
...
### [20] [Governed Evolution of Agent Runtimes through Executable Operational Cognition](https://arxiv.org/abs/2605.27328)
...
### [21] [EdgeFlow: Edge-Map Augmented VLM-Based Flowchart Processing for Industrial Requirements Engineering](https://arxiv.org/abs/2605.27332)
...
### [22] [Device Context Protocol: A Compact, Safety-First Architecture for LLM-Driven Control of Constrained Devices](https://arxiv.org/abs/2605.26159)
*Dongxu Yang*
...
### [23] [mmDiff: A Noise-Robust Differentiable Ray-Tracing Framework for mmWave Scene Calibration and Channel Prediction](https://arxiv.org/abs/2605.26406)
...
### [24] [SLA-Aware Traffic Steering in Hybrid TN-NTN 5G Backhaul: A Potential Game Approach](https://arxiv.org/abs/2605.26673)
...
### [25] [Birkhoff Decompositions and Photonic Interconnects Wait! Don't Forget the Compute!](https://arxiv.org/abs/2605.26845)
...
### [26] [Extreme-Scale Interconnection Networks](https://arxiv.org/abs/2605.26960)
...
### [27] [GENESIS: Harnessing AI Agents for Autonomous 6G RAN Synthesis, Research, and Testing](https://arxiv.org/abs/2605.27360)
...
### [28] [Generalized Range Filtering Approximate Nearest Neighbor Search: Containment and Overlap [Technical Report]](https://arxiv.org/abs/2605.26474)
...
### [29] [RT-RkNN: Reverse k Nearest Neighbor Queries as a Graphics Ray Casting Problem](https://arxiv.org/abs/2605.26671)
...
### [30] [Knowledge Graphs as the Missing Data Layer for LLM-Based Industrial Asset Operations](https://arxiv.org/abs/2605.26874)
...
### [31] [Xe-Forge: Multi-Stage LLM-Powered Kernel Optimization for Intel GPU](https://arxiv.org/abs/2605.26118)
...
### [32] [Edge AI Deployment Beyond Models: A BSP-Aware Systems Framework for Industrial Embedded Platforms](https://arxiv.org/abs/2605.26119)
*Pitchai Muthu M*
...
### [33] [Semantic-aware Token Selection and Resource Optimization for Communication-efficient Split Federated Fine-tuning in Edge Intelligence](https://arxiv.org/abs/2605.26120)
...
### [34] [Agentic AI Workload Characteristics](https://arxiv.org/abs/2605.26297)
...
### [35] [Totoro$^+$: An Adaptive and Scalable Edge Federated Learning System](https://arxiv.org/abs/2605.26323)
...
### [36] [GridPilot: Real-Time Grid-Responsive Control for AI Supercomputers](https://arxiv.org/abs/2605.26384)
...
### [37] [Revisiting Bruck: Phase-Efficient All-to-All Communication in Reconfigurable Networks](https://arxiv.org/abs/2605.26930)
...
### [38] [Characterization-Guided GPU Fault Resilience in NVIDIA MPS](https://arxiv.org/abs/2605.26461)
...
### [39] [Autonomic Federated-Market Orchestration for the Edge-Cloud Continuum](https://arxiv.org/abs/2605.27106)
...
### [40] [StreamSplit: Continuous Audio Representation Learning via Uncertainty-Guided Adaptive Splitting](https://arxiv.org/abs/2605.26523)
...
### [41] [A Formal Semantics of C with OpenMP Parallelism](https://arxiv.org/abs/2605.26527)
...
### [42] [Reducing Internal State in Eigenvalue-Only Divide-and-Conquer Tridiagonal Eigensolvers](https://arxiv.org/abs/2605.26599)
...
### [43] [Nonlinear spectral clustering with C++ GraphBLAS](https://arxiv.org/abs/2605.26975)
...
### [44] [LearnedCache: An eBPF-Integrated Perceptron-Based Eviction Policy for the Linux Page Cache](https://arxiv.org/abs/2605.26168)
*Zejia Qi*
...
### [45] [Advances in polyconvex anisotropic hyperelasticity](https://arxiv.org/abs/2605.27011)
