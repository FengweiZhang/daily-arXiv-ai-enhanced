...
### [12] [Hand-Written PTX Tensor-Core GEMM Kernels: A Multi-Precision Study on NVIDIA L4](https://arxiv.org/abs/2608.10103)
...
### [13] [What Actually Serializes GPU LZ77 Decode: Three Decoders, Three Mechanisms, and an Encode-Time Lever That Removes the Last One](https://arxiv.org/abs/2608.10188)
*Yakiv Shavidze*
...
### [14] [FaCTz: Fast Critical-Point and Topology-Aware GPU Compression for Scientific Vector Fields](https://arxiv.org/abs/2608.10586)
...
### [15] [ClusterBench: A Framework for Cluster-Wide Continuous Benchmarking and Regression Testing](https://arxiv.org/abs/2608.10956)
...
### [16] [Workflow Cards: Structured Summaries of Workflow Executions Using Provenance Data](https://arxiv.org/abs/2608.11022)
...
### [17] [SCOUT: Symmetric Consensus Outlier Detection for Failure Localization in LLM Pre-Training](https://arxiv.org/abs/2608.11034)
*Zhuang Wang*
...
### [18] [Scheduling Mixed RL Rollouts Beyond Prefix Locality](https://arxiv.org/abs/2608.11152)
...
### [19] [AI Query Compilation for Unified and Optimized Execution](https://arxiv.org/abs/2608.10139)
...
### [20] [Time to Move on: Querying without Nulls and Bags](https://arxiv.org/abs/2608.10863)
...
### [21] [Property Graph Techniques in Relational Databases](https://arxiv.org/abs/2608.11001)
...
### [22] [Monophonic Audio Synthesizer Using FPGAs](https://arxiv.org/abs/2608.10116)
...
### [23] [CARB: A Characterization-Guided Framework for CNN Inference Cost Prediction and Deployment Screening](https://arxiv.org/abs/2608.10506)
...
### [24] [Adaptive Matrix Multiplication for Dynamic Shapes on Ascend NPUs](https://arxiv.org/abs/2608.10803)
...
### [25] [You Only Charge Once 2.0 : A End-to-End Analog Computing-in-Memory Architecture with Reconfigurable Switched Capacitors](https://arxiv.org/abs/2608.11116)
...
### [26] [When and Where Faults Matter: A Study of Transient Errors in CKKS Multiplication](https://arxiv.org/abs/2608.11147)
...
### [27] [On the Sensitivity to Errors in Homomorphic Computing: Single Transient Bit-flip Client-side Error Characterization](https://arxiv.org/abs/2608.11155)
...
### [28] [N2NMatcher: Towards Inlining-Resilient Binary Decomposition and Module Matching](https://arxiv.org/abs/2608.10043)
...
### [29] [Exploring Semantic Stability Across Reviews in the Linux Kernel](https://arxiv.org/abs/2608.10101)
...
### [30] [One Recipe, Many Harnesses: What Self-Evolution Encodes Across Languages and Models](https://arxiv.org/abs/2608.10178)
...
### [31] [Bias Smells in AI Software Development: Recognizing Potential Sources of Fairness Debt](https://arxiv.org/abs/2608.10248)
...
### [32] [Enhancing Reliability of Symbolic Execution Tools for Smart Contract Analysis through Rule-Based False Positive Reduction](https://arxiv.org/abs/2608.10265)
...
### [33] [Comprendia: AI-Augmented Code Comprehension](https://arxiv.org/abs/2608.10290)
...
### [34] [Does the way we write a theory change the program an LLM builds from it? A prospective randomized study of renderer format in LLM theory-to-program translation](https://arxiv.org/abs/2608.10314)
*Andre Panossian*
...
### [35] [Do Personalized Skills Help Coding Agents? An Empirical Study of Developer Interaction Histories](https://arxiv.org/abs/2608.10319)
...
### [36] [Persistent Recursive Worlds Enable Autonomous Software Evolution](https://arxiv.org/abs/2608.10450)
...
### [37] [CausalRepair: Bridging the Causality Gap in Large Language Model-Based Automated Program Repair via Dual-Slicing](https://arxiv.org/abs/2608.10613)
...
### [38] [A Study of Cursorrules Files in GitHub Open Source Projects](https://arxiv.org/abs/2608.10622)
...
### [39] [LLM Ensemble Fault Classification for Automotive HiL Validation](https://arxiv.org/abs/2608.10710)
...
### [40] [Conflict Extraction in Probabilistic Datalog Analyses](https://arxiv.org/abs/2608.10755)
...
### [41] [Extending Triple Graph Grammars to Formalize Complex View Definitions on Families of Models - Long Version](https://arxiv.org/abs/2608.10785)
...
### [42] [From Pattern Detection to Composition Analysis in Quantum Software](https://arxiv.org/abs/2608.10882)
...
### [43] [GitSkills: A Dataset of Agent Skills on GitHub](https://arxiv.org/abs/2608.10906)
...
### [44] [Understanding the Architecture of Coding Agents: An Exploratory Study Using a Research Prototype](https://arxiv.org/abs/2608.10934)
*Marco Tulio Valente*
...
### [45] [Agentic Configuration Management (ACM): A Reference Configuration Model for Governed Agentic Systems](https://arxiv.org/abs/2608.11166)
...
### [46] [MemSpec: Memory-Aware Runtime for Adaptive Draft Scheduling in Speculative Decoding on Edge Devices](https://arxiv.org/abs/2608.10362)
...
### [47] [Spatio-Temporal Scheduling for Robust and Efficient Multi-Transmitter Wireless Power Transfer](https://arxiv.org/abs/2608.10391)
...
### [48] [Link-adaptive digital twin for robust physical-layer modeling in hybrid-amplified ultra-wideband optical networks](https://arxiv.org/abs/2608.10517)
...
### [49] [Benchmarking LLM-Guided Control-Plane Policies for Backend Fault Isolation in HAProxy](https://arxiv.org/abs/2608.10532)
...
### [50] [An Asynchronous Triggered MAC Protocol for Underwater Acoustic Networks](https://arxiv.org/abs/2608.10533)
...
### [51] [ImpactHO: Importance-Aware KV Cache Transfer for Multi-User Edge LLM Handover](https://arxiv.org/abs/2608.10545)
...
### [52] [Sensing in Low-altitude Wireless Networks: Systems, Techniques, and Developments](https://arxiv.org/abs/2608.10555)
...
### [53] [Conversational Orchestration for Organic 6G](https://arxiv.org/abs/2608.10714)
...
### [54] [Measuring the End-to-End Resilience of Application Deployments in Real-World Communication Networks with DRACO](https://arxiv.org/abs/2608.10611)
...
### [55] [User Satisfaction-Aware Resource Allocation with Prospect-Theoretic Utility for Multimedia Streaming](https://arxiv.org/abs/2608.10625)
...
### [56] [Media-over-Multipath-QUIC for Realtime Video Applications](https://arxiv.org/abs/2608.10741)
...
### [57] [Energy-Efficient Joint Optimization of VLC and Fog Computing Resources Allocation](https://arxiv.org/abs/2608.10752)
...
### [58] [Multi-UAV Tracking Evaluation Using 5G Uplink Signals on an O-RAN ISAC Simulation Testbed](https://arxiv.org/abs/2608.10784)
...
### [59] [A Systematic Sample Size Analysis of ML-Based Path Loss Prediction for LPWAN](https://arxiv.org/abs/2608.11083)
