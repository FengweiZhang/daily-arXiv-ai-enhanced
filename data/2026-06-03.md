...
### [1] [LAANN: I/O-Aware Look-Ahead Search for Disk-Based Approximate Nearest Neighbor Search](https://arxiv.org/abs/2606.02784)
...
### [2] [The Case for Text-to-SQL Friendly Logical Database Design](https://arxiv.org/abs/2606.03145)
...
### [3] [Cost-Aware Optimization for Agentic Query Execution](https://arxiv.org/abs/2606.03152)
...
### [4] [CAPER: Clause-Aligned Process Supervision for Text-to-SQL](https://arxiv.org/abs/2606.03327)
...
### [5] [Workload acceleration by optimizing materialized view selection using local search](https://arxiv.org/abs/2606.03772)
...
### [6] [Formalizing all indexed mathematics as a benchmark for general reasoning, with the example of implementing dilatations of categories](https://arxiv.org/abs/2606.03835)
*A. Mayeux*
...
### [7] [MLSkip: Data Skipping for ML Filters via Lightweight Metadata](https://arxiv.org/abs/2606.03946)
...
### [8] [Agent libOS: A Library-OS-Inspired Runtime for Long-Running, Capability-Controlled LLM Agents](https://arxiv.org/abs/2606.03895)
*Yingqi Zhang*
...
### [9] [GreenGNN: Energy-Aware Windowed Communication Optimization for Distributed GNN Training](https://arxiv.org/abs/2606.02916)
...
### [10] [FOLD: Fuzzy Online Deduplication for Very Large Evolving Datasets via Approximate Nearest Neighbor Search](https://arxiv.org/abs/2606.03001)
...
### [11] [Brief Announcement: Generative Markov Model for Distributed Computing Systems](https://arxiv.org/abs/2606.03061)
...
### [13] [Predicting Lakehouse Performance in Clouds: An Empirical Exploration of Query Runtime Variance](https://arxiv.org/abs/2606.03464)
...
### [14] [Fast TetraBFT: Optimizing Latency Where It Matters](https://arxiv.org/abs/2606.03754)
...
### [15] [E2LLM: Towards Efficient LLM Serving in Heterogeneous Edge/Fog Environments](https://arxiv.org/abs/2606.03770)
...
### [16] [Rain: RDMA-assisted In-Network Scheduling for Microsecond-scale Workloads](https://arxiv.org/abs/2606.03352)
...
### [17] [Throughput Optimization for Multi-AP IEEE P802.11bq Networks Based on Combinatorial Multi-Armed Bandits](https://arxiv.org/abs/2606.03528)
...
### [18] [Applying Two-Grid Preconditioner for Subsurface Flow Simulation using Attention-enhanced Hybrid Network to Accelerate Multiscale Discretization in High-contrast Media](https://arxiv.org/abs/2606.02582)
...
### [21] [Streami: An MPI Data-Parallel Library to Compute Field Lines on GPUs](https://arxiv.org/abs/2606.02627)
...
### [22] [Critical evaluation of PINN for FWD inverse analysis and differentiable FEM as an alternative](https://arxiv.org/abs/2606.03210)
...
### [23] [GROSS: German Rail Open-Source SUMO Scenario](https://arxiv.org/abs/2606.03282)
...
### [25] [Heterogeneous Mapping for Analog In-Memory Computing Accelerators: A Unified Workflow](https://arxiv.org/abs/2606.02672)
*Corey Lammie*
...
### [26] [CRAM-ER: Error-Resilient Spintronic Computational Random Access Memory for Scalable In-Memory Computation](https://arxiv.org/abs/2606.02781)
...
### [27] [Fast Transformer Inference on ARM-Based HMPSoCs](https://arxiv.org/abs/2606.02836)
...
### [28] [Multi-Segment Attention: Enabling Efficient KV-Cache Management for Faster Large Language Model Serving](https://arxiv.org/abs/2606.02964)
...
### [29] [ZK-Flex: A Flexible and Scalable Framework for Accelerating Zero-Knowledge Proofs](https://arxiv.org/abs/2606.03046)
...
### [30] [ACRONYM: Accelerated Approximate Nearest Neighbor Search in Memory for Dynamic Vector Databases](https://arxiv.org/abs/2606.03151)
...
### [31] [Acceptance-Test-Driven Evaluation Protocols for Business-Centric LLM Systems](https://arxiv.org/abs/2606.02755)
*Eric Liang*
...
### [32] [Report on the Designing Accountable Software Systems Workshop](https://arxiv.org/abs/2606.02804)
...
### [33] [Many a Little Makes a Mickle: A Code-Centric Empirical Study of Data Minimization Principle in Android App Development](https://arxiv.org/abs/2606.02960)
...
### [34] [SPOQ: Specialist Orchestrated Queuing for Multi-Agent Software Engineering](https://arxiv.org/abs/2606.03115)
...
### [35] [AlgoTouch: An Execution-Centered Approach to Incremental Construction of Imperative Programs](https://arxiv.org/abs/2606.03349)
...
### [36] [Neural Change Prediction: Relating Software Changes to Their Effects and Vice Versa](https://arxiv.org/abs/2606.03378)
...
### [37] [Human-AI Collaboration and the Transformation of Software Engineering Work](https://arxiv.org/abs/2606.03394)
*Mamdouh Alenezi*
...
### [38] [Multi-Modal Assessment of Road Roughness Using Smartphone Applications, Acceleration, and Passenger Ratings](https://arxiv.org/abs/2606.03427)
...
### [39] [Making Embodied AI Reliable: A Community Agenda from Testing to Formal Verification](https://arxiv.org/abs/2606.03593)
...
### [40] [DDOR: Delta Debugging for Explainable Overrefusal Testing and Repair](https://arxiv.org/abs/2606.03601)
...
### [41] [Can AI be Easy? Lessons Learned from the EZR.py Toolkit](https://arxiv.org/abs/2606.03640)
...
### [42] [An AutomationML Domain Library for the Formalized Process Description](https://arxiv.org/abs/2606.03691)
...
### [43] [Agentic Generation and Evolution of Knowledge Models](https://arxiv.org/abs/2606.03662)
...
### [44] [FLARE: Fine-Grained Diagnostic Feedback for LLM Code Refinement](https://arxiv.org/abs/2606.03852)
...
### [45] [Automated Repair of Requirements for Cyber-Physical Systems in Simulink Requirements Tables](https://arxiv.org/abs/2606.03870)
...
### [46] [The Impact of Configuring Agentic AI Coding Tools on Build-vs-Buy Decisions: A Study Protocol](https://arxiv.org/abs/2606.03907)
