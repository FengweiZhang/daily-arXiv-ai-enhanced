...
### [8] [DeltaBox: Scaling Stateful AI Agents with Millisecond-Level Sandbox Checkpoint/Rollback](https://arxiv.org/abs/2605.22781)
...
### [9] [Requirements Perception Gap across Stakeholders: A Comparative Survey of Aged Care Digital Health Software](https://arxiv.org/abs/2605.21495)
...
### [10] [Articulate but Wrong: Self-Review Failures in LLM-Based Code Modernization](https://arxiv.org/abs/2605.21537)
...
### [11] [RefusalBench: Why Refusal Rate Misranks Frontier LLMs on Biological Research Prompts](https://arxiv.org/abs/2605.21545)
...
### [12] [A Dataset of Reproducible Flaky-Test Failures](https://arxiv.org/abs/2605.21677)
...
### [13] [The 2nd Workshop on Agile Practice & Research: A Summary and Call For Research](https://arxiv.org/abs/2605.21690)
...
### [14] [PITMuS: A Tool for Automated Bug Dataset Generation via Source-Level Mutant Reconstruction](https://arxiv.org/abs/2605.21930)
...
### [15] [Deterministic vs. Probabilistic Summarisation: An Empirical Trade-off Study in Design Pattern Centric Java Code](https://arxiv.org/abs/2605.21943)
...
### [16] [From Patches to Trajectories: Privileged Process Supervision for Software-Engineering Agents](https://arxiv.org/abs/2605.21996)
...
### [17] [Finding Missing Input Validation in TEEs via LLM-Assisted Symbolic Execution](https://arxiv.org/abs/2605.22058)
...
### [18] [Automated Repair of TEE Partitioning Issues via DSL-Guided and LLM-Assisted Patching](https://arxiv.org/abs/2605.22087)
...
### [19] [SWE-Mutation: Can LLMs Generate Reliable Test Suites in Software Engineering?](https://arxiv.org/abs/2605.22175)
...
### [20] [An Architecture for Decentralised Deployment and Operation of Blockchain Applications](https://arxiv.org/abs/2605.22239)
...
### [21] [At What Cost? Software Developers' Well-Being in the Age of GenAI](https://arxiv.org/abs/2605.22349)
...
### [22] ["Refactoring Runaway": Understanding and Mitigating Tangled Refactorings in Coding Agents for Issue Resolution](https://arxiv.org/abs/2605.22526)
...
### [23] [Why Are Agentic Pull Requests Merged or Rejected? An Empirical Study](https://arxiv.org/abs/2605.22534)
...
### [24] [Contractual Skills: A GovernSpec Design Framework for Enterprise AI Agents](https://arxiv.org/abs/2605.22634)
*Ting Liu*
...
### [25] [FAME: Failure-Aware Mixture-of-Experts for Message-Level Log Anomaly Detection](https://arxiv.org/abs/2605.22779)
...
### [26] [An Open-Source Framework to Emulate Delay and Disruption Tolerant Networks for International Space Station Communication](https://arxiv.org/abs/2605.21624)
...
### [27] [Lost in the Prefix: Revisiting IP Geolocation Accuracy Across Networks and Geographies](https://arxiv.org/abs/2605.21937)
...
### [28] [Toward Realistic Wi-Fi Fault Diagnosis: A Multi-Modal Benchmark](https://arxiv.org/abs/2605.22008)
...
### [29] [Latency in Real-Time 3D Volumetric Streaming: A Comprehensive Study](https://arxiv.org/abs/2605.22131)
...
### [30] [Impact of Atmospheric Turbulence and Pointing Error on Earth Observation](https://arxiv.org/abs/2605.22268)
...
### [31] [Throughput and Delay Performance of Slotted Aloha in SmartBANs under Saturation Conditions](https://arxiv.org/abs/2605.22317)
...
### [32] [Eliminating Premature Termination in Multihop Rendezvous for Cognitive Radio-based Emergency Response Network](https://arxiv.org/abs/2605.22325)
...
### [33] [EnCoR: An end-to-end architecture for simplifying cellular networks](https://arxiv.org/abs/2605.22524)
...
### [34] [SCALE: Sensitivity-Aware Federated Unlearning with Information Freshness Optimization for Mobile Edge Computing](https://arxiv.org/abs/2605.22589)
...
### [35] [An intensive vRAN deployment with OpenAirInterface](https://arxiv.org/abs/2605.22638)
...
### [36] [Zero-shot adaptation to order book dynamics](https://arxiv.org/abs/2605.21707)
*Arip Asadulaev*
...
### [37] [SDFStent: Real-time interactive virtual stenting via SDF deformation fields](https://arxiv.org/abs/2605.22009)
...
### [38] [A Generative Adversarial Graph Neural Network for Synthetic Time Series Data](https://arxiv.org/abs/2605.22215)
...
### [39] [LineageFlow: Flow Matching for High-Fidelity Family-Aware Protein Sequence Generation](https://arxiv.org/abs/2605.22252)
...
### [40] [Dynamic Hypergraph Representation Learning for Multivariate Time Series without Prior Knowledge](https://arxiv.org/abs/2605.22540)
*Marco Gregnanin,Johannes De Smedt,Giorgio Gnecco,Maurizio Parton*
...
### [41] [Therm-FM: Foundation Model is ALL YOU NEED for 3D-ICs Thermal Simulation](https://arxiv.org/abs/2605.22663)
...
### [42] [CompPow: A Case for Component-level GPU Power Management](https://arxiv.org/abs/2605.21847)
...
### [43] [Emerging memory technologies at room/cryogenic temperature](https://arxiv.org/abs/2605.21912)
