...
### [12] [Hydra: Phase-Aware Workload Characterization of LLM Inference across Edge SoC Generations, Backends, and Quantization Levels](https://arxiv.org/abs/2608.25053)
...
### [13] [FLINT: Efficiently Leveraging High Bandwidth Flash for Capacity-Scalable LLM Inference Acceleration](https://arxiv.org/abs/2608.25062)
...
### [14] [An Open-Source Benchmark Suite of 3D-IC Testcases](https://arxiv.org/abs/2608.25155)
...
### [15] [BOOSTEDSOSA: Accelerated Inferencing for Low Variance Stochastic Online Scheduling](https://arxiv.org/abs/2608.25346)
...
### [16] [APT: Accelerating Diffusion Transformers via Attention Probability-Guided Pruning and Quantization](https://arxiv.org/abs/2608.25380)
...
### [17] [Syn2Logic: End-to-End Neuromorphic Design Automation](https://arxiv.org/abs/2608.25536)
*Artur Podobas*
...
### [18] [Integrated Hardware Annealing based on Langevin Dynamics for Ising Machines](https://arxiv.org/abs/2608.26100)
...
### [19] [Secret MCP: Evidence-Bounded and Context-Isolated Design Specification Generation from Web Screenshots](https://arxiv.org/abs/2608.24944)
*Yeongjin Jo*
...
### [20] [The Evolution of Binary Decompilation in the Modern Era: A Taxonomy, Literature Review, and Future Perspectives](https://arxiv.org/abs/2608.24955)
...
### [21] [Evaluating and Preventing Security Smells in AI-Generated Ansible Code](https://arxiv.org/abs/2608.24962)
...
### [22] [ARISMA: Guidelines for AI- and LLM-Assisted Systematic Reviews, Scoping Reviews, and Mapping Studies](https://arxiv.org/abs/2608.25050)
...
### [23] [Model-Based Agentic Software Engineering](https://arxiv.org/abs/2608.25174)
...
### [24] [SPECMINE: A Large-Scale Corpus of Spec-Driven Development Artifacts](https://arxiv.org/abs/2608.25202)
...
### [25] [A Few Pages of Markdown: Committed AI Configuration and Lower Quality Cost after Coding-Agent Adoption](https://arxiv.org/abs/2608.25241)
...
### [26] [Metis: Typed Runtime Mediation for Tool-Using Software Agents](https://arxiv.org/abs/2608.25322)
*Jun Yu*
...
### [27] [Point-in-Time Audit Before Alpha: Public-Archive Availability and a Negative Matched-Budget Study on BTC Perpetual Futures](https://arxiv.org/abs/2608.25348)
...
### [28] [Retry Amplification in Distributed Systems: A Systematic Analysis of Retry Policies and Their Role in Cascading Failures](https://arxiv.org/abs/2608.25403)
...
### [29] [RotDroid: Cross-Orientation State Equivalence Testing for Detecting GUI Rotation Bugs in Android Apps](https://arxiv.org/abs/2608.25425)
*Mengdi Qin,Bo Jiang*
...
### [30] [A Hybrid Usability Approach for Rating Evaluation of M-Commerce Applications](https://arxiv.org/abs/2608.25550)
...
### [31] [From General Agents to RCA Experts: A Self-Evolving Harness for Root Cause Analysis](https://arxiv.org/abs/2608.25661)
...
### [32] [Predicting Struggling Students in CS1 Programming Using Keystroke-Level Editing Features](https://arxiv.org/abs/2608.25769)
...
### [33] [Beyond the Editing Canvas: Evidence Divergence in OOXML-to-LLM Ingestion](https://arxiv.org/abs/2608.25880)
...
### [34] [Answer Is Cheap, Show Me the Evidence! Augmenting Automated Vulnerability Assessment with Evidence](https://arxiv.org/abs/2608.25905)
...
### [35] [XREPOTEST: Benchmarking Multilingual Repository-Level Unit Test Generation for Large Language Models](https://arxiv.org/abs/2608.25939)
...
### [36] [Vulnerable Code Search: Transferable Attack for Code Language Models](https://arxiv.org/abs/2608.26031)
...
### [37] [Probabilistic Performance Analysis of Parallel Signature Search Strategies in Multi-Level Tree Networks](https://arxiv.org/abs/2608.25087)
...
### [38] [Hierarchical Shared Memory-Aware Optimization for TRSM on GPU Platforms](https://arxiv.org/abs/2608.25469)
...
### [39] [psRL: Efficient Training for Agentic AI via Training-Time Prefix Sharing](https://arxiv.org/abs/2608.25683)
...
### [40] [An Oversubscription and Service Pricing Exploitation-Based Profit Maximization Framework for Industry Cloud Resource Management](https://arxiv.org/abs/2608.25712)
...
### [41] [A Spatially-Aware Publish-Subscribe Middleware for IoT Applications](https://arxiv.org/abs/2608.25728)
...
### [42] [REE-TM: Reliable and Energy-Efficient Traffic Management Model for Diverse Cloud Workloads](https://arxiv.org/abs/2608.25747)
...
### [43] [Quantum Blackhole Learning-Optimized Hadamard Neural Network Model for Dynamic Resource Reservation in Industry Clouds](https://arxiv.org/abs/2608.25754)
...
### [44] [Scalable Multi-GPU Simulation of 3D Multicellular Growth with RNN-Based Workload Balancing](https://arxiv.org/abs/2608.25890)
...
### [45] [Slasher: Power Flexibility for Cloud Datacenters](https://arxiv.org/abs/2608.26021)
...
### [46] [Analyzing and Reducing Search Quality Differences in Vector Similarity Search](https://arxiv.org/abs/2608.25185)
...
### [47] [Bolt-on, Verifiable Provenance for LLM-Powered Data Processing](https://arxiv.org/abs/2608.25210)
...
### [48] [DBcover: A White-box SQL Test Generation Framework for Coverage Improvement](https://arxiv.org/abs/2608.25573)
...
### [49] [PolyMemDB: A Polyglot Database System for AI Memory Management](https://arxiv.org/abs/2608.25577)
*Yu Wang,Jiaheng Lu*
...
### [50] [MetaSieve: Faster Relational Deep Learning through SQL-Based Metapath Selection](https://arxiv.org/abs/2608.25903)
...
### [51] [FABRICA: Agentic CUDA-to-CSL Translation and Optimization for Wafer-Scale Systems](https://arxiv.org/abs/2608.25124)
...
### [52] [RWA-PoB: A Credential-Based Proof-of-Backing Framework for Tokenized U.S. Treasury Products](https://arxiv.org/abs/2608.25269)
...
### [53] [Forecasting Global Volatility Across Asynchronous Markets: Incremental Accuracy from Constrained Cross-Market Attention](https://arxiv.org/abs/2608.25369)
...
### [54] [Unlocking Multimodal Protein Language Models at Inference Time](https://arxiv.org/abs/2608.25855)
...
### [55] [Efficient tensor bases for pairwise comparisons](https://arxiv.org/abs/2608.25923)
