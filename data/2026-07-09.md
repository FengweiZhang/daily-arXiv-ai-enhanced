...
### [1] [EvoOMG: An Evolution-Oriented Multi-Agent Guidance Framework for Heterogeneous Legacy-and-MLO Wi-Fi Networks](https://arxiv.org/abs/2607.07045)
...
### [2] [How the Fusion of Onboard Sensors and V2X Data can Improve (or not) the Cooperative Perception of Connected Automated Vehicles](https://arxiv.org/abs/2607.07114)
...
### [3] [Unveiling TCP BBR Dominance in Starlink Internet: Experimental Insights and Analysis](https://arxiv.org/abs/2607.07133)
...
### [4] [Small Language Model-based Control for BBR over Low Earth Orbit Satellite Internet](https://arxiv.org/abs/2607.07142)
*Rakshitha De Silva,Shiva Raj Pokhrel,Jonathan Kua*
...
### [5] [PHaul: A PPO-based forwarding agent for Sub6 enhanced Integrated Access and Backhaul networks](https://arxiv.org/abs/2607.07584)
...
### [6] [HiFuzz: Hierarchical Reinforcement Learning for Semantic-Aware and Adaptive CPU Fuzzing](https://arxiv.org/abs/2607.06619)
...
### [7] [Vectorizing Quantum Control: A RISC-V Vector Extension Architecture for Scalable Qubit Systems](https://arxiv.org/abs/2607.07372)
...
### [8] [ATLAS: Automated HLS for DL-Optimized FPGAs](https://arxiv.org/abs/2607.07643)
...
### [9] [Pre-Training on Software Engineering Texts: Effects on Domain Adaptation and General-Language Understanding](https://arxiv.org/abs/2607.06613)
...
### [10] [Reliable and Developer-Aligned Evaluation of Agents for Software Engineering](https://arxiv.org/abs/2607.06713)
...
### [12] [Scaling Author Identity Disambiguation to the World of Code: A Methodology](https://arxiv.org/abs/2607.06920)
*Audris Mockus*
...
### [15] [The Poisoned Chalice of LLM Evaluation Report](https://arxiv.org/abs/2607.07481)
...
### [16] [Holistic B2X Mobile Application Development -- A Reference Model](https://arxiv.org/abs/2607.07511)
...
### [17] [Rethinking Code Performance Benchmarks for LLMs](https://arxiv.org/abs/2607.07619)
...
### [18] [Breaking Database Lock-in: Agentic Regeneration of High Performance Storage Readers for Database Bypass](https://arxiv.org/abs/2607.07696)
...
### [19] [Seekable OCI: Lazy-Loading Container Images via Range-Request Indexing](https://arxiv.org/abs/2607.06868)
...
### [20] [Voltron: Enabling Elastic Multi-Device Execution of LLM Inference for Empowered Edge Intelligence](https://arxiv.org/abs/2607.07046)
...
### [21] [Topological Signatures of Diffusive Release in Porous Media](https://arxiv.org/abs/2607.07061)
*Donghan Kim*
...
### [22] [Accelerating Industrial Finite Element Simulations of Electric Machines based on Runtime Analysis](https://arxiv.org/abs/2607.07514)
