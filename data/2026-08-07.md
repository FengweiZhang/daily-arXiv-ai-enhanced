...
### [1] [Discrete energy as an exact label-free training objective for finite-element surrogates](https://arxiv.org/abs/2608.05437)
...
### [2] [Variable-Horizon Workforce Demand Forecasting with an Aggregate Demand Constraint for Construction Workforce Planning](https://arxiv.org/abs/2608.05551)
...
### [3] [A Label-Free Physics-to-Data Acceleration Framework for Parametric Time-Dependent PDEs with Latent-Space Differential-Operator Learning](https://arxiv.org/abs/2608.05554)
...
### [4] [A hybrid s-version isogeometric strategy for dynamic crack propagation in 2D and 3D problems](https://arxiv.org/abs/2608.05589)
...
### [5] [Benefits of Shifting Passenger Traffic from Air to Rail: A Case Study of California High-Speed Rail](https://arxiv.org/abs/2608.05636)
...
### [6] [Hyperelastic Membranes with Implicitly Defined, Continuously Embedded Fibers](https://arxiv.org/abs/2608.05717)
...
### [7] [Accurate simulation of delamination with a resin-rich layer-dependent penalty stiffness based on structural cohesive elements](https://arxiv.org/abs/2608.05881)
...
### [8] [Quantitative Analysis of Media Bias and Stock Price Dynamics: The 2020 Shock](https://arxiv.org/abs/2608.05899)
...
### [9] [Local-Global Feature Mixer and Trend-Guided Consistent Learning for Remaining Useful Life Prediction of Rotating Machinery](https://arxiv.org/abs/2608.05925)
...
### [17] [Towards a Risk Assessment of Malicious Skill Files in Coding Agents](https://arxiv.org/abs/2608.05223)
...
### [18] [Improving Debugging in Verification-Aware Languages Through Automated Fault Localization: A Case Study in Dafny](https://arxiv.org/abs/2608.05399)
...
### [19] [Reasoning from Traces: Divergence-Guided Agentic Repair of WebAssembly Discrepancies](https://arxiv.org/abs/2608.05521)
...
### [20] [Exploring Dependence, Overreliance, and Addiction Related Behaviors Associated with Large Language Model Use Among Software Engineers](https://arxiv.org/abs/2608.05561)
...
### [21] [JTA: Joint Testability Architecture for Scenario-Based Validation of Safety-Critical Software](https://arxiv.org/abs/2608.05594)
...
### [22] [Towards Competence-Based Management for Open Source Software Projects](https://arxiv.org/abs/2608.05599)
...
### [23] [Keeping Models and Code in Sync: Roundtrip Engineering for Tactical Domain-Driven Design](https://arxiv.org/abs/2608.05612)
...
### [24] [Agent-Based Test Assertion Generation via Diverse Perspective Aggregation](https://arxiv.org/abs/2608.05822)
...
### [25] [CodeGrep: An RL-Trained Retrieval Agent for LLM Coding Agents](https://arxiv.org/abs/2608.05886)
...
### [26] [Mapping the Emerging Curriculum for AI-Assisted Software Engineering via Syllabus Analysis](https://arxiv.org/abs/2608.05898)
...
### [27] [Escaping the Self-Repair Trap: Improving Test Oracle Generation via Dual-Context Awareness](https://arxiv.org/abs/2608.05917)
...
### [28] [Expertise-Based Developer Assignment for Long-Term Software Components in Open-Source Projects](https://arxiv.org/abs/2608.05919)
...
### [29] [Sensor-Level Fault Diagnosis for Automotive Software Validation Using Large Language Models](https://arxiv.org/abs/2608.05921)
...
### [30] [AgentExecutor: Partial Code Execution via Agentic Context Generation](https://arxiv.org/abs/2608.05959)
...
### [31] [LangChoiceBench: Measuring and Explaining Programming-Language Choice in LLMs](https://arxiv.org/abs/2608.06041)
...
### [32] [In Terms of Explainability: Refining Requirements for Self-Explainable Systems](https://arxiv.org/abs/2608.06049)
...
### [33] [DCAS: Decoupling CLI Agent Scaffolding to Internalize Planning across Scaffolds](https://arxiv.org/abs/2608.06113)
...
### [34] [Learning Globally Reusable Skills for Coding Agents](https://arxiv.org/abs/2608.06153)
...
### [35] [Predicting Agile Success: The Critical Few Factors](https://arxiv.org/abs/2608.06228)
...
### [36] [Automatic Translation of Unstructured Requirements into Linear Temporal Logic through Large Language Models](https://arxiv.org/abs/2608.06287)
...
### [43] [EdgeXpert: An Edge Device for Memory-Efficient LLM Inference with Mixture-of-Experts and Speculative Decoding](https://arxiv.org/abs/2608.05303)
...
### [44] [PowerScope: ML-based Intra-Cycle Power Estimation](https://arxiv.org/abs/2608.05339)
...
### [45] [PLoRA: An NDP-Enhanced Pooled-Memory System for Cost-Efficient Multi-LoRA Serving](https://arxiv.org/abs/2608.05483)
...
### [46] [Zero-Instruction Sensor Reads: Register-Mapped Peripherals and Hardware PWM on a Five-Stage Soft Processor](https://arxiv.org/abs/2608.05638)
*Nathanael Ren*
...
### [47] [An Open-Source Power Measurement Platform for System-Level Semiconductor Testing](https://arxiv.org/abs/2608.05888)
...
### [48] [Automated Synthesis of Heterogeneous, Hierarchical, Scoped Coherence Protocols](https://arxiv.org/abs/2608.05965)
...
### [49] [Breaking Memory Bottlenecks in Quantum Control Systems for More Precise Experiments and Higher Throughput Computing](https://arxiv.org/abs/2608.06318)
...
### [50] [Multi-Agent Transformer for Queue-Level XR Traffic Scheduling in TSN Networks](https://arxiv.org/abs/2608.05340)
...
### [51] [Multi-Agent Reinforcement Learning for Online Traffic Scheduling in Time-Sensitive Application](https://arxiv.org/abs/2608.05346)
*Marcos Carvalho,Fatih Temiz,Shavbo Salehi,Melike Erol-Kantarci,Daniel F. Macedo*
...
### [52] [DTMC-Based Analysis and Scheduling for Periodic Flows with Proactive HARQ](https://arxiv.org/abs/2608.05639)
...
### [53] [Closed-Loop Decision-Focused Learning for User-Aware Cloud Orchestration under Uncertainty](https://arxiv.org/abs/2608.05735)
...
### [54] [5G ISAC-Based UAV Detection and 3-D Tracking Using Uplink Sounding Reference Signals on an End-to-End O-RAN Simulation Testbed](https://arxiv.org/abs/2608.05826)
...
### [55] [BALANCE: Hybrid Autoregressive-Speculative LLM Inference in Wireless Edge Networks](https://arxiv.org/abs/2608.05926)
...
### [56] [ML-for-ML](https://arxiv.org/abs/2608.06046)
...
### [57] [MARS: Multipath Adaptive Reliable Service](https://arxiv.org/abs/2608.06101)
...
### [58] [MultiMoQ: Multi-Access Media-Over-QUIC for Robust Immersive Video Streaming](https://arxiv.org/abs/2608.06102)
...
### [59] [From Passive Mirrors to Active Agents: Holonic Digital Twins for Physical AI over Networks](https://arxiv.org/abs/2608.06227)
