...
### [2] [KPI2KVI: A Multi Agent Workflow for Calculating Key Value Indicators from Service Descriptions](https://arxiv.org/abs/2605.22825)
...
### [3] [Intercloud: Eventual Consistency for Decentralised Economies via Chilling-Effect Consensus](https://arxiv.org/abs/2605.22830)
*Gregory Magarshak*
...
### [4] [Monte Cimone v3: Where RISC-V Stands in High-Performance Computing](https://arxiv.org/abs/2605.22831)
...
### [5] [Mathematical Foundations for Peer-to-Peer Lattice Computation](https://arxiv.org/abs/2605.22832)
*Danil Gorinevski*
...
### [6] [ObjectCache: Layerwise Object-Storage Retrieval for KV Cache Reuse](https://arxiv.org/abs/2605.22850)
...
### [7] [Budgeted Dynamic Trace Structures for Token-Efficient Sequential Computation](https://arxiv.org/abs/2605.22879)
...
### [8] [Orbax: Distributed Checkpointing with JAX](https://arxiv.org/abs/2605.23066)
...
### [9] [XWind: A Cross-site Router for Large Language Model Inference Serving at Renewable Energy Farms](https://arxiv.org/abs/2605.23348)
...
### [10] [AlignedServe: Orchestrating Prefix-aware Batching to Build a High-throughput and Computing-efficient LLM Serving System](https://arxiv.org/abs/2605.23389)
...
### [11] [Multi-Round Visibility: A Post-Consensus Ordering Layer for DAG-Based BFT](https://arxiv.org/abs/2605.23432)
...
### [12] [Multi-Factor Trust-Driven Secure Communication Model for Cloud-Based Digital Twins](https://arxiv.org/abs/2605.23566)
...
### [13] [Herring: Parallel Batch-Order-Fairness on DAG-based Blockchain Consensus](https://arxiv.org/abs/2605.23648)
...
### [14] [AMP: Arc Multi-Proposer Protocol with Bounded Inclusion Guarantees](https://arxiv.org/abs/2605.23677)
...
### [15] [Flare: Leveraging Serverless Elasticity to Absorb Microservice Load Spikes](https://arxiv.org/abs/2605.23707)
...
### [16] [HyperParallel-MoE: Multi-Core Interleaved Scheduling for Fast MoE Training on Ascend NPUs](https://arxiv.org/abs/2605.23764)
...
### [17] [Enhancing Energy Efficiency in Scientific Workflows through CFD based PIVAEs](https://arxiv.org/abs/2605.23850)
...
### [18] [ACALSim: A Scalable Parallel Simulation Framework for High-Performance System Design Space Exploration](https://arxiv.org/abs/2605.22936)
...
### [19] [MASQ: Accelerating Masked Diffusion via Stage-Wise Multi-Precision Quantization](https://arxiv.org/abs/2605.23226)
...
### [20] [NASiC: 3D NAND-based CAM-Selected Multibit CIM Architecture for Efficient On-Device Mixture-of-Experts LLM Inference](https://arxiv.org/abs/2605.23294)
...
### [21] [DAE4HLS: Exposing Memory-Level Parallelism for High-Level Synthesis using Explicit Decoupling](https://arxiv.org/abs/2605.23549)
...
### [22] [To Overlay or to Customize? Revisiting Architectural Choices in Heterogeneous Systems](https://arxiv.org/abs/2605.23630)
...
### [23] [DORA: Dataflow-Instruction Orchestration Architecture for DNN Acceleration](https://arxiv.org/abs/2605.23833)
...
### [24] [Expressive Power of Deep Homomorphism Networks over Relational Databases](https://arxiv.org/abs/2605.22852)
...
### [25] [Measuring Database Unfairness via Dependency Quantification Under Differential Privacy](https://arxiv.org/abs/2605.22952)
...
### [26] [Conceptual Schema Inference for Tabular Datasets using Large Language Models](https://arxiv.org/abs/2605.23105)
...
### [27] [BCTuner: LLM-Guided Monte Carlo Tree Search for Efficient Blockchain Knob Tuning](https://arxiv.org/abs/2605.23280)
...
### [28] [A Pragmatic Approach to Learned Indexing in RocksDB: Targeted Optimizations with Minimal System Modification](https://arxiv.org/abs/2605.23815)
...
### [29] [CHRONOS: Temporally-Aware Multi-Agent Coordination for Evolving Data Marketplaces](https://arxiv.org/abs/2605.23887)
*Joydeep Chandra*
...
### [30] [DRL-Driven Edge-Aware Utility Optimization for Multi-Slice 6G Networks](https://arxiv.org/abs/2605.23056)
...
### [31] [Combined Radar and Magnetometer Sensor Network with LoRa-Mediated Awareness for Wildlife-Vehicle Collision Prevention: A Monte Carlo Analysis](https://arxiv.org/abs/2605.23117)
...
### [32] [Orchestrating Data Collection and Computation in Green IoT Networks](https://arxiv.org/abs/2605.23152)
...
### [33] [Purification Strategy Optimization for Entanglement Routing in Quantum Networks](https://arxiv.org/abs/2605.23331)
...
### [34] [Experimental Evaluation of LPWAN Technologies: mioty, LoRaWAN, Sigfox, NB-IoT, and LTE-M in Deep Indoor Environments](https://arxiv.org/abs/2605.23483)
...
### [35] [Sea Trial Validation of the ROS-DESERT Middleware with Autonomous Underwater Vehicles](https://arxiv.org/abs/2605.23553)
...
### [36] [SDNator is Not Another SDN Controller: Enabling Extensible Data-Driven Control in Cyber-Physical Systems](https://arxiv.org/abs/2605.23816)
...
### [37] [Cross-attention-based bipartite graph neural network for coupled nodal and elemental field prediction in large-deformation sheet material forming](https://arxiv.org/abs/2605.22845)
...
### [38] [From Simulation to Discovery: AI Enabled Probabilistic Emulation of Mechanistic Crop Systems](https://arxiv.org/abs/2605.22848)
...
### [39] [Effective information gathering for ore estimation, evaluation and perspectives on adaptive sampling](https://arxiv.org/abs/2605.23172)
...
### [40] [DeFi Yield Aggregators: Analysing Investment Strategies and Structural Dependencies](https://arxiv.org/abs/2605.23298)
...
### [41] [Bayesian Extreme Value Theory with Hawkes-AR-Gumbel Dependence for Extreme CVaR Estimation in Operational Risk](https://arxiv.org/abs/2605.23353)
...
### [42] [GeoCycler: Reward-Aligned 3D Diffusion for Constraint-Conditioned Cyclic Peptide Design](https://arxiv.org/abs/2605.23407)
...
### [43] [LiveFigure: Generating Editable Scientific Illustration with VLM Agents](https://arxiv.org/abs/2605.23527)
...
### [44] [Operator Learning for Reconstructing Flow Fields from Sparse Measurements: a Language Model Approach](https://arxiv.org/abs/2605.23712)
...
### [45] [LLM Code Smells: A Taxonomy and Detection Approach](https://arxiv.org/abs/2605.22976)
...
### [46] [Finding Performance Issues in Database Systems by Exploiting Dormant Code Paths](https://arxiv.org/abs/2605.22992)
...
### [47] [On the Reliability of Code Comprehension Proxies](https://arxiv.org/abs/2605.23008)
...
### [48] [A measurement substrate for agentic Kubernetes operations: Methodology and a case study in retrieval-compounding falsification](https://arxiv.org/abs/2605.23058)
...
### [49] [Security of LLM-generated Code: A Comparative Analysis](https://arxiv.org/abs/2605.23091)
...
### [50] [Philosophical Dispositions as Behavioral Constraints for AI-Assisted Code Review: An Empirical Study](https://arxiv.org/abs/2605.23108)
*Kaushal Bansal*
...
### [51] [The Impact of AI Coding Assistants on Software Engineering: A Longitudinal Study](https://arxiv.org/abs/2605.23135)
...
### [52] [AI Assurance: A Comprehensive Testing Strategy for Enterprise AI Systems](https://arxiv.org/abs/2605.23459)
...
### [53] [MISRust: Mapping MISRA-C++ Coding Guidelines to the Rust Programming Language](https://arxiv.org/abs/2605.23490)
