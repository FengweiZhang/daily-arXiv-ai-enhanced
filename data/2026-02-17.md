...
### [4] [Intent-driven Diffusion-based Path for Mobile Data Collector in IoT-enabled Dense WSNs](https://arxiv.org/abs/2602.13277)
...
### [5] [Enhancing NOMA Handover Performance Using Hybrid AI-Driven Modulated Deterministic Sequences](https://arxiv.org/abs/2602.13202)
...
### [6] [SIDSense: Database-Free TV White Space Sensing for Disaster-Resilient Connectivity](https://arxiv.org/abs/2602.13542)
...
### [7] [Adversarial Network Imagination: Causal LLMs and Digital Twins for Proactive Telecom Mitigation](https://arxiv.org/abs/2602.13203)
...
### [8] [Hybrid Secure Routing in Mobile Ad-hoc Networks (MANETSs)](https://arxiv.org/abs/2602.13204)
...
### [9] [Reinforcement Learning-Enabled Dynamic Code Assignment for Ultra-Dense IoT Networks: A NOMA-Based Approach to Massive Device Connectivity](https://arxiv.org/abs/2602.13205)
...
### [10] [Toward Resource-Efficient Collaboration of Large AI Models in Mobile Edge Networks](https://arxiv.org/abs/2602.13206)
...
### [11] [A Safety-Constrained Reinforcement Learning Framework for Reliable Wireless Autonomy](https://arxiv.org/abs/2602.13207)
...
### [12] [Large Language Model (LLM)-enabled Reinforcement Learning for Wireless Network Optimization](https://arxiv.org/abs/2602.13210)
...
### [13] [An Overlay Multicast Routing Method Based on Network Situational Aware-ness and Hierarchical Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2602.13211)
...
### [14] [Network-Adaptive Cloud Preprocessing for Visual Neuroprostheses](https://arxiv.org/abs/2602.13216)
...
### [15] [An Agentic AI Control Plane for 6G Network Slice Orchestration, Monitoring, and Trading](https://arxiv.org/abs/2602.13227)
...
### [16] [Pocket RAG: On-Device RAG for First Aid Guidance in Offline Mobile Environment](https://arxiv.org/abs/2602.13229)
...
### [17] [An Explainable Failure Prediction Framework for Neural Networks in Radio Access Networks](https://arxiv.org/abs/2602.13231)
...
### [18] [Securing SIM-Assisted Wireless Networks via Quantum Reinforcement Learning](https://arxiv.org/abs/2602.13238)
...
### [28] [Multi-Modal Sensing and Fusion in mmWave Beamforming for Connected Vehicles: A Transformer Based Framework](https://arxiv.org/abs/2602.13606)
...
### [29] [Parametric-Sensitivity Aware Retransmission for Efficient AI Downloading](https://arxiv.org/abs/2602.13607)
...
### [40] [TEG: Exascale Cluster Governance via Non-Equilibrium Thermodynamics and Langevin Dynamics](https://arxiv.org/abs/2602.13789)
*Zhengyan Chu*
...
### [41] [ML-ECS: A Collaborative Multimodal Learning Framework for Edge-Cloud Synergies](https://arxiv.org/abs/2602.14107)
...
### [42] [Floe: Federated Specialization for Real-Time LLM-SLM Inference](https://arxiv.org/abs/2602.14302)
...
### [43] [Efficient Multi-round LLM Inference over Disaggregated Serving](https://arxiv.org/abs/2602.14516)
...
### [44] [Evaluation of Dynamic Vector Bin Packing for Virtual Machine Placement](https://arxiv.org/abs/2602.14704)
...
### [45] [A Survey of Code Review Benchmarks and Evaluation Practices in Pre-LLM and LLM Era](https://arxiv.org/abs/2602.13377)
...
### [46] [InEx-Bug: A Human Annotated Dataset of Intrinsic and Extrinsic Bugs in the NPM Ecosystem](https://arxiv.org/abs/2602.13400)
...
### [47] [Execution-State-Aware LLM Reasoning for Automated Proof-of-Vulnerability Generation](https://arxiv.org/abs/2602.13574)
...
### [48] [From What to How: Bridging User Requirements with Software Development Using Large Language Models](https://arxiv.org/abs/2602.13611)
...
### [49] [VeriSBOM: Secure and Verifiable SBOM Sharing Via Zero-Knowledge Proofs](https://arxiv.org/abs/2602.13682)
...
### [50] [ARC: Compiling Hundreds of Requirement Scenarios into A Runnable Web System](https://arxiv.org/abs/2602.13723)
...
### [51] [Impacts of Generative AI on Agile Teams' Productivity: A Multi-Case Longitudinal Study](https://arxiv.org/abs/2602.13766)
...
### [52] [Impostor Phenomenon as Human Debt: A Challenge to the Future of Software Engineering](https://arxiv.org/abs/2602.13767)
...
### [53] [A Quasi-Experimental Evaluation of Coaching to Mitigate the Impostor Phenomenon in Early-Career Software Engineers](https://arxiv.org/abs/2602.13774)
...
### [54] [Constructive Patterns for Human-Centered Tech Hiring](https://arxiv.org/abs/2602.13845)
...
### [55] [CodeGlance: Understanding Code Reasoning Challenges in LLMs through Multi-Dimensional Feature Analysis](https://arxiv.org/abs/2602.13962)
...
### [56] [ATTest: Agent-Driven Tensor Testing for Deep Learning Library Modules](https://arxiv.org/abs/2602.13987)
...
### [57] [Every Maintenance Has Its Exemplar: The Future of Software Maintenance through Migration](https://arxiv.org/abs/2602.14046)
...
### [58] [LongCLI-Bench: A Preliminary Benchmark and Study for Long-horizon Agentic Programming in Command-Line Interfaces](https://arxiv.org/abs/2602.14337)
...
### [59] [An Empirical Study of the Evolution of GitHub Actions Workflows](https://arxiv.org/abs/2602.14572)
...
### [60] [Automated Classification of Source Code Changes Based on Metrics Clustering in the Software Development Process](https://arxiv.org/abs/2602.14591)
*Evgenii Kniazev*
...
### [61] [Consistent or Sensitive? Automated Code Revision Tools Against Semantics-Preserving Perturbations](https://arxiv.org/abs/2602.14595)
...
### [62] [The Value of Effective Pull Request Description](https://arxiv.org/abs/2602.14611)
...
### [63] [Model Context Protocol (MCP) Tool Descriptions Are Smelly! Towards Improving AI Agent Efficiency with Augmented MCP Tool Descriptions](https://arxiv.org/abs/2602.14878)
...
### [64] [ORAP: Optimized Row Access Prefetching for Rowhammer-mitigated Memory](https://arxiv.org/abs/2602.13434)
...
### [65] [Implementation and Performance Evaluation of CMOS-integrated Memristor-driven Flip-flop Circuits](https://arxiv.org/abs/2602.13825)
...
### [66] [ABI: A tightly integrated, unified, sparsity-aware, reconfigurable, compute near-register file/cache GPU architecture with light-weight softmax for deep learning, linear algebra, and Ising compute](https://arxiv.org/abs/2602.14262)
...
### [67] [Scope: A Scalable Merged Pipeline Framework for Multi-Chip-Module NN Accelerators](https://arxiv.org/abs/2602.14393)
...
### [68] [LoPace: A Lossless Optimized Prompt Accurate Compression Engine for Large Language Model Applications](https://arxiv.org/abs/2602.13266)
*Aman Ulla*
...
### [69] [MergePipe: A Budget-Aware Parameter Management System for Scalable LLM Merging](https://arxiv.org/abs/2602.13273)
...
### [70] [Arming Data Agents with Tribal Knowledge](https://arxiv.org/abs/2602.13521)
...
### [71] [TabTracer: Monte Carlo Tree Search for Complex Table Reasoning with Large Language Models](https://arxiv.org/abs/2602.14089)
...
### [72] [Towards a Hybrid Quantum-Classical Computing Framework for Database Optimization Problems in Real Time Setup](https://arxiv.org/abs/2602.14263)
...
### [73] [Qute: Towards Quantum-Native Database](https://arxiv.org/abs/2602.14699)
...
### [74] [A Unified Mathematical Framework for Distributed Data Fabrics: Categorical Hypergraph Models](https://arxiv.org/abs/2602.14708)
...
### [75] [NFT Games: an Empirical Look into the Play-to-Earn Model](https://arxiv.org/abs/2602.13882)
...
### [76] [Simultaneous analysis of curved Kirchhoff beams and Kirchhoff--Love shells embedded in bulk domains](https://arxiv.org/abs/2602.14566)
...
### [77] [Identification of random material properties as stochastic inversion problem](https://arxiv.org/abs/2602.14684)
