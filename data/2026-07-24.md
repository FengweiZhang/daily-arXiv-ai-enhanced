...
### [1] [A generalized shape function approach for multimaterial topology optimization](https://arxiv.org/abs/2607.20784)
...
### [2] [Chemical Chain-of-Thought Functions as a Hallucination-Prone Molecular Scratchpad](https://arxiv.org/abs/2607.20935)
...
### [3] [EuroFlood: a Python library and queryable index for the CEMS satellite-derived flood-depth archive of Europe](https://arxiv.org/abs/2607.21126)
*Jürgen Hackl*
...
### [4] [Verifier-First Evaluation of Agentic LLMs for Infrastructure-as-Code Generation](https://arxiv.org/abs/2607.20478)
*Mohamed Jouini*
...
### [5] [Transformer-Assisted LLM-Based Source Code Summarisation: to Enable More Secure Software Development](https://arxiv.org/abs/2607.20933)
...
### [6] [Maintenance Signals in AI-Assisted GitHub Repositories: Evidence from GenAI Adopters](https://arxiv.org/abs/2607.21079)
...
### [7] [Improving Communication of Changes in Model-Based Engineering with Model-Independent Change Descriptions](https://arxiv.org/abs/2607.21084)
...
### [8] [Information is all you need: Requirements Engineering Quality Reframed](https://arxiv.org/abs/2607.21319)
...
### [9] [Teaching Business Process Modeling to Leverage Soft Skills of Computing Students](https://arxiv.org/abs/2607.21344)
...
### [10] [Toward Federated Cognitive Digital Twins over the Edge-to-Cloud Continuum](https://arxiv.org/abs/2607.21357)
...
### [11] [From Resource Flow to Executable Tests: Petri-Net-Guided LLM Test Generation for Concurrent Stateful Rust APIs](https://arxiv.org/abs/2607.21530)
...
### [14] [PortLBM: A Portable Lattice Boltzmann Tool Leveraging SYCL on AMD, NVIDIA, and Intel GPUs](https://arxiv.org/abs/2607.20650)
...
### [15] [A Framework for Reputation Aware Uninorm-driven Consensus Algorithms for Blockchain Networks](https://arxiv.org/abs/2607.20700)
...
### [16] [The Consensus Number of Untraceable Cryptocurrencies](https://arxiv.org/abs/2607.20929)
...
### [17] [Multimmit: Extending Blocks for Faster Finality](https://arxiv.org/abs/2607.21021)
...
### [18] [Solving Large Traveling Salesman Problems (TSPs) by a Recursive Clustering Algorithm and a Scalable FPGA-Based Implementation](https://arxiv.org/abs/2607.21182)
...
### [19] [Controlled Periodic Synchronization for Efficient Data-Parallel Training](https://arxiv.org/abs/2607.21224)
...
### [20] [Demonstrating GenDB: Instance-Optimized and Customized Query Processing Code Generation via LLM Agents](https://arxiv.org/abs/2607.20630)
...
### [21] [DMG: A Scalable and Efficient Memory-Disaggregated Graph Processing System](https://arxiv.org/abs/2607.20881)
...
### [22] [A Logic-based Temporal Cohort Discovery Engine: Algorithms, Indices, and Experimental Results on the National Sleep Research Resource](https://arxiv.org/abs/2607.21377)
...
### [23] [Cross-Domain Generalization in Optical Networks via Joint Contrastive and Classification Learning](https://arxiv.org/abs/2607.20666)
...
### [24] [Update the Unseen Only: Minimizing AoI for Collaborative Perception through Online Learning](https://arxiv.org/abs/2607.20967)
...
### [25] [Large Language Model Assisted Intent-Based Satellite-Integrated Access and Backhaul FWA for Rural Areas](https://arxiv.org/abs/2607.21272)
...
### [26] [Empowering Rural Areas with Multi-radio Microwave Backhaul Supported by Digital Twin for 5G IAB-based FWA](https://arxiv.org/abs/2607.21310)
*Anselme Ndikumana,Kim Khoa Nguyen,Adel Larabi,Mohamed Cheriet*
...
### [27] [DISCO: Distributed Spectrum Compliance and Orchestration for Scalable IoT Coexistence](https://arxiv.org/abs/2607.21387)
...
### [28] [Out-of-Distribution Detection in Wireless Multimodal Foundation Models for 6G ISAC](https://arxiv.org/abs/2607.21455)
