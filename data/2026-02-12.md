...
### [6] [Making Databases Faster with LLM Evolutionary Sampling](https://arxiv.org/abs/2602.10387)
...
### [7] [Benchmarking Large Language Models for Knowledge Graph Validation](https://arxiv.org/abs/2602.10748)
...
### [8] [GraphSeek: Next-Generation Graph Analytics with LLMs](https://arxiv.org/abs/2602.11052)
...
### [9] [Cross-Sectional Asset Retrieval via Future-Aligned Soft Contrastive Learning](https://arxiv.org/abs/2602.10711)
...
### [10] [KORAL: Knowledge Graph Guided LLM Reasoning for SSD Operational Analysis](https://arxiv.org/abs/2602.10246)
...
### [11] [Execution-Centric Characterization of FP8 Matrix Cores, Asynchronous Execution, and Structured Sparsity on AMD MI300A](https://arxiv.org/abs/2602.10262)
...
### [12] [Flash-SD-KDE: Accelerating SD-KDE with Tensor Cores](https://arxiv.org/abs/2602.10378)
...
### [13] [Computing Least Fixed Points with Overwrite Semantics in Parallel and Distributed Systems](https://arxiv.org/abs/2602.10486)
...
### [14] [BOute: Cost-Efficient LLM Serving with Heterogeneous LLMs and GPUs via Multi-Objective Bayesian Optimization](https://arxiv.org/abs/2602.10729)
...
### [15] [Fine-Tuning GPT-5 for GPU Kernel Generation](https://arxiv.org/abs/2602.11000)
...
### [16] [Min-Sum Uniform Coverage Problem by Autonomous Mobile Robots](https://arxiv.org/abs/2602.11125)
...
### [18] [EvoCodeBench: A Human-Performance Benchmark for Self-Evolving LLM-Driven Coding Systems](https://arxiv.org/abs/2602.10171)
...
### [19] [TestExplora: Benchmarking LLMs for Proactive Bug Discovery via Repository-Level Test Generation](https://arxiv.org/abs/2602.10471)
...
### [20] [From Prompt-Response to Goal-Directed Systems: The Evolution of Agentic AI Software Architecture](https://arxiv.org/abs/2602.10479)
*Mamdouh Alenezi*
...
### [21] [Consistency Meets Verification: Enhancing Test Generation Quality in Large Language Models Without Ground-Truth Solutions](https://arxiv.org/abs/2602.10522)
...
### [22] [Theory of Troubleshooting: The Developer's Cognitive Experience of Overcoming Confusion](https://arxiv.org/abs/2602.10540)
...
### [23] [ISD-Agent-Bench: A Comprehensive Benchmark for Evaluating LLM-based Instructional Design Agents](https://arxiv.org/abs/2602.10620)
...
### [24] [Assessing Vision-Language Models for Perception in Autonomous Underwater Robotic Software](https://arxiv.org/abs/2602.10655)
...
### [25] [Hidden Licensing Risks in the LLMware Ecosystem](https://arxiv.org/abs/2602.10758)
...
### [26] [VulReaD: Knowledge-Graph-guided Software Vulnerability Reasoning and Detection](https://arxiv.org/abs/2602.10787)
...
### [27] [PELLI: Framework to effectively integrate LLMs for quality software generation](https://arxiv.org/abs/2602.10808)
...
### [28] [Deriving and Validating Requirements Engineering Principles for Large-Scale Agile Development: An Industrial Longitudinal Study](https://arxiv.org/abs/2602.10972)
...
### [29] [FeatureBench: Benchmarking Agentic Coding for Complex Feature Development](https://arxiv.org/abs/2602.10975)
...
### [30] [Scaling Routers with In-Package Optics and High-Bandwidth Memories](https://arxiv.org/abs/2602.10505)
...
### [31] [SplitCom: Communication-efficient Split Federated Fine-tuning of LLMs via Temporal Compression](https://arxiv.org/abs/2602.10564)
...
### [32] [Supercharging Packet-level Network Simulation of Large Model Training via Memoization and Fast-Forwarding](https://arxiv.org/abs/2602.10615)
...
### [33] [Security, Privacy and System-Level Resillience of 6G End-to-End System: Hexa-X-II Perspective](https://arxiv.org/abs/2602.10734)
...
### [34] [Less is More: The Dilution Effect in Multi-Link Wireless Sensing](https://arxiv.org/abs/2602.10823)
...
### [35] [AI Infrastructure Sovereignty](https://arxiv.org/abs/2602.10900)
*Sergio Cruzes*
...
### [36] [A Robust Optimization Approach for Regenerator Placement in Fault-Tolerant Networks Under Discrete Cost Uncertainty](https://arxiv.org/abs/2602.11058)
...
### [37] [WHEREIS: IP Address Registration Geo-Consistency](https://arxiv.org/abs/2602.11102)
