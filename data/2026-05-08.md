...
### [1] [Marking strategies for adaptive mesh refinement: An efficiency-focused benchmark study for steady solid and fluid mechanics problems](https://arxiv.org/abs/2605.05234)
...
### [2] [Scenario-driven optimization of passive vehicle suspensions: explaining the effectiveness of asymmetric damping](https://arxiv.org/abs/2605.05235)
...
### [3] [A Comparison of Massively Parallel Performance Portable Particle-in-Cell schemes for electrostatic kinetic plasma simulations](https://arxiv.org/abs/2605.05469)
...
### [4] [Discrete Elastic Ribbons: A Unified Discrete Differential Geometry Framework for One-Dimensional Energy Models](https://arxiv.org/abs/2605.05529)
...
### [5] [Duplicate-Aware Shift-and-Lift Carleman Linearization:Structure, Complexity, and Comparative Evaluation](https://arxiv.org/abs/2605.05901)
...
### [6] [Quantum Optimization for Electromagnetics: Physics-Informed QAOA for Reconfigurable Intelligent Surfaces](https://arxiv.org/abs/2605.06048)
...
### [7] [Adaptive Coordinate Transforms for Neural Operators](https://arxiv.org/abs/2605.06203)
...
### [8] [Anatomy of a Query: W5H Dimensions and FAR Patterns for Text-to-SQL Evaluation](https://arxiv.org/abs/2605.05525)
...
### [9] [An Extensible and Verifiable Language for Query Rewrite Rules](https://arxiv.org/abs/2605.05536)
...
### [10] [Beyond Static Policies: Exploring Dynamic Policy Selection for Single-Thread Performance Optimization](https://arxiv.org/abs/2605.05471)
...
### [11] [Towards Compute-Aware In-Switch Computing for LLMs Tensor-Parallelism on Multi-GPU Systems](https://arxiv.org/abs/2605.05628)
...
### [12] [TokenStack: A Heterogeneous HBM-PIM Architecture and Runtime for Efficient LLM Inference](https://arxiv.org/abs/2605.05639)
...
### [13] [MoE-Hub: Taming Software Complexity for Seamless MoE Overlap with Hardware-Accelerated Communication on Multi-GPU Systems](https://arxiv.org/abs/2605.05888)
...
### [14] [LLM-Driven Design Space Exploration of FPGA-based Accelerators](https://arxiv.org/abs/2605.05920)
...
### [15] [A virtually connected probabilistic computer as a solver for higher-order, densely connected, or reconfigurable combinatorial optimisation problems](https://arxiv.org/abs/2605.06037)
...
### [16] [XtraMAC: An Efficient MAC Architecture for Mixed-Precision LLM Inference on FPGA](https://arxiv.org/abs/2605.06052)
...
### [17] [PoTAcc: A Pipeline for End-to-End Acceleration of Power-of-Two Quantized DNNs](https://arxiv.org/abs/2605.06082)
...
### [19] [DADL: A Declarative Description Language for Enterprise Tool Libraries in LLM Agent Systems](https://arxiv.org/abs/2605.05247)
*Axel Dunkel*
...
### [20] [Automated Population-Level Audit Assurance via AI-Based Document Intelligence](https://arxiv.org/abs/2605.05252)
...
### [21] [PARNESS: A Paper Harness for End-to-End Automated Scientific Research with Dynamic Workflows, Full-Text Indexing, and Cross-Run Knowledge Accumulation](https://arxiv.org/abs/2605.05258)
...
### [22] [Bridging Generation and Training: A Systematic Review of Quality Issues in LLMs for Code](https://arxiv.org/abs/2605.05267)
...
### [23] [Mise en Place for Agentic Coding: Deliberate Preparation as Context Engineering Methodology](https://arxiv.org/abs/2605.05400)
*Andrew Zigler*
...
### [24] [Is this Build Failure Related to my Patch? An Empirical Study of Unrelated Build Failures in Continuous Integration](https://arxiv.org/abs/2605.05564)
...
### [25] [Operationalizing Ethics for AI Agents: How Developers Encode Values into Repository Context Files](https://arxiv.org/abs/2605.05584)
...
### [26] [An Empirical Study of Proactive Coding Assistants in Real-World Software Development](https://arxiv.org/abs/2605.05700)
...
### [27] [From Chat to Interview: Agentic Requirements Elicitation with an Experience Ontology](https://arxiv.org/abs/2605.05828)
...
### [28] [On Fixing Insecure AI-Generated Code through Model Fine-Tuning and Prompting Strategies](https://arxiv.org/abs/2605.05867)
...
### [29] [Evaluating Non-English Developer Support in Machine Learning for Software Engineering](https://arxiv.org/abs/2605.05902)
...
### [30] [Exploring the Effectiveness of Abstract Syntax Tree Patterns for Algorithm Recognition](https://arxiv.org/abs/2605.06098)
...
### [31] [Schedule-and-Calibrate: Utility-Guided Multi-Task Reinforcement Learning for Code LLMs](https://arxiv.org/abs/2605.06111)
...
### [32] [Breaking, Stale, or Missing? Benchmarking Coding Agents on Project-Level Test Evolution](https://arxiv.org/abs/2605.06125)
...
### [33] [BUILD-AND-FIND: An Effort-Aware Protocol for Evaluating Agent-Managed Codebases](https://arxiv.org/abs/2605.06136)
*Jhen-Ke Lin*
...
### [34] [Modeling Dependency-Propagated Ecosystem Impact of Changes in Maintenance Activities: Evaluating Support Strategies in the PyPI Network](https://arxiv.org/abs/2605.06164)
...
### [35] [Teaching LLMs Program Semantics via Symbolic Execution Traces](https://arxiv.org/abs/2605.06184)
...
### [36] [SiblingRepair: Sibling-Based Multi-Hunk Repair with Large Language Models](https://arxiv.org/abs/2605.06209)
...
### [37] [Correct Code, Vulnerable Dependencies: A Large Scale Measurement Study of LLM-Specified Library Versions](https://arxiv.org/abs/2605.06279)
...
### [38] [Constraint Decay: The Fragility of LLM Agents in Backend Code Generation](https://arxiv.org/abs/2605.06445)
...
### [39] [To What Extent Does Agent-generated Code Require Maintenance? An Empirical Study](https://arxiv.org/abs/2605.06464)
...
### [40] [Nitsum: Serving Tiered LLM Requests with Adaptive Tensor Parallelism](https://arxiv.org/abs/2605.05467)
...
### [41] [EdgeServing: Deadline-Aware Multi-DNN Serving at the Edge](https://arxiv.org/abs/2605.05527)
...
### [42] [A Scalable Digital Twin Framework for Energy Optimization in Data Centers](https://arxiv.org/abs/2605.05581)
...
### [43] [Irminsul: MLA-Native Position-Independent Caching for Agentic LLM Serving](https://arxiv.org/abs/2605.05696)
...
### [44] [LLM-Enhanced Deep Reinforcement Learning for Task Offloading in Collaborative Edge Computing](https://arxiv.org/abs/2605.05727)
...
### [45] [Relay Buffer Independent Communication over Pooled HBM for Efficient MoE Inference on Ascend](https://arxiv.org/abs/2605.06055)
...
### [46] [FalconGEMM: Surpassing Hardware Peaks with Lower-Complexity Matrix Multiplication](https://arxiv.org/abs/2605.06057)
...
### [47] [Tackling the Data-Parallel Load Balancing Bottleneck in LLM Serving: Practical Online Routing at Scale](https://arxiv.org/abs/2605.06113)
...
### [48] [CCL-Bench 1.0: A Trace-Based Benchmark for LLM Infrastructure](https://arxiv.org/abs/2605.06544)
...
### [49] [TACO: A Toolsuite for the Verification of Threshold Automata](https://arxiv.org/abs/2605.06118)
...
### [50] [ResiHP: Taming LLM Training Failures with Dynamic Hybrid](https://arxiv.org/abs/2605.06374)
...
### [51] [ADELIA: Automatic Differentiation for Efficient Laplace Inference Approximations](https://arxiv.org/abs/2605.06392)
...
### [52] [ROSE: Rollout On Serving GPUs via Cooperative Elasticity for Agentic RL](https://arxiv.org/abs/2605.06534)
...
### [53] [SixGman: An Open-Source Planner for Fixed 6G Hierarchical Optical Access-Core Networks](https://arxiv.org/abs/2605.05763)
...
### [54] [Bridging the 6G Gap: Scaling Sustainable ROADM-Based IP-over-WDM via DSCM-Enabled Point-to-Multipoint Designs](https://arxiv.org/abs/2605.05793)
...
### [55] [Comparative Analysis of Direct-to-Cell (D2C) and 3GPP Non-Terrestrial Networks (NTN) for Global Connectivity](https://arxiv.org/abs/2605.05843)
...
### [56] [A Disaster-Aware Integrated TN-NTN System-Level Simulator for Resilient 6G Wireless Networks](https://arxiv.org/abs/2605.05852)
*Donglin Wang,Anjie Qiu,Qiuheng Zhou,Hans D. Schotten*
...
### [57] [FluxShard: Motion-Aware Feature Cache Reuse for Collaborative Video Analytics in Mobile Edge Computing](https://arxiv.org/abs/2605.06027)
...
### [58] [Temporal Spectral Noise-Floor Adaptation for Error-Intolerant Trigger Integrity in IoT Mesh Networks](https://arxiv.org/abs/2605.06338)
...
### [59] [Edge Triggering in IoT Mesh Networks: A Comparative Monte Carlo Study of Seven Detection Algorithms](https://arxiv.org/abs/2605.06358)
*Sergii Makovetskyi,Lars Thomsen*
...
### [60] [Delay-Robust Deep Reinforcement Learning for Ranging-Free Channel Access under Mobility in Underwater Acoustic Networks](https://arxiv.org/abs/2605.06536)
