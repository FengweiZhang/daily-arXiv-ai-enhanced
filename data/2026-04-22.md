...
### [1] [Maritime Connectivity Vulnerability Index: Construction, Patterns, and Validation Across 185 Economies, 2006-2025](https://arxiv.org/abs/2604.18767)
...
### [2] [Multiscale Structural Reliability Analysis in high dimensions with Tensor Trains and Physics-Augmented Neural Networks](https://arxiv.org/abs/2604.18776)
...
### [3] [An Implicit Compact-Kernel Material Point Method for Computational Solid Mechanics](https://arxiv.org/abs/2604.18917)
...
### [4] [Mass Matrix Assembly on Tensor Cores for Implicit Particle-In-Cell Methods](https://arxiv.org/abs/2604.19286)
...
### [5] [Wildfires Quasi-Implicit Alternative-Direction Simulations using Isogeometric Finite Element Method](https://arxiv.org/abs/2604.19370)
...
### [6] [From Business Problems to AI Solutions: Where Does Transformation Support Fail](https://arxiv.org/abs/2604.18770)
...
### [7] [Structural Verification for Reliable EDA Code Generation without Tool-in-the-Loop Debugging](https://arxiv.org/abs/2604.18834)
...
### [8] [Human-Machine Co-Boosted Bug Report Identification with Mutualistic Neural Active Learning](https://arxiv.org/abs/2604.18862)
...
### [9] [From Particles to Perils: SVGD-Based Hazardous Scenario Generation for Autonomous Driving Systems Testing](https://arxiv.org/abs/2604.18918)
...
### [10] [Proactive Detection of GUI Defects in Multi-Window Scenarios via Multimodal Reasoning](https://arxiv.org/abs/2604.19081)
...
### [11] [MUCOCO: Automated Consistency Testing of Code LLMs](https://arxiv.org/abs/2604.19086)
...
### [12] [Towards More Empathic Programming Environments: An Experimental Empathic AI-Enhanced IDE](https://arxiv.org/abs/2604.19142)
...
### [13] [Cascaded Code Editing: Large-Small Model Collaboration for Effective and Efficient Code Editing](https://arxiv.org/abs/2604.19201)
...
### [14] [iCoRe: An Iterative Correlation-Aware Retriever for Bug Reproduction Test Generation](https://arxiv.org/abs/2604.19224)
...
### [15] [DebugRepair: Enhancing LLM-Based Automated Program Repair via Self-Directed Debugging](https://arxiv.org/abs/2604.19305)
...
### [16] [Improving LLM-Driven Test Generation by Learning from Mocking Information](https://arxiv.org/abs/2604.19315)
...
### [17] [Systematic Detection of Energy Regression and Corresponding Code Patterns in Java Projects](https://arxiv.org/abs/2604.19373)
...
### [19] [CASCADE: Detecting Inconsistencies between Code and Documentation with Automatic Test Generation](https://arxiv.org/abs/2604.19400)
...
### [20] [Crash-free Deductive Verifiers](https://arxiv.org/abs/2604.19448)
...
### [21] [On Reasoning-Centric LLM-based Automated Theorem Proving](https://arxiv.org/abs/2604.19558)
...
### [22] [PlayCoder: Making LLM-Generated GUI Code Playable](https://arxiv.org/abs/2604.19742)
...
### [23] [Direction-Dependent Path Loss Modeling in Olive Orchards for Precision Agriculture](https://arxiv.org/abs/2604.19427)
...
### [24] [Revisiting and Expanding the IPv6 Network Periphery: Global-Scale Measurement and Security Analysis](https://arxiv.org/abs/2604.19487)
...
### [25] [ZODIAC: Zero-shot Offline Diffusion for Inferring Multi-xApps Conflicts in Open Radio Access Networks](https://arxiv.org/abs/2604.19610)
...
### [26] [HadAgent: Harness-Aware Decentralized Agentic AI Serving with Proof-of-Inference Blockchain Consensus](https://arxiv.org/abs/2604.18614)
...
### [27] [Locality, Not Spectral Mixing, Governs Direct Propagation in Distributed Offline Dynamic Programming](https://arxiv.org/abs/2604.18615)
*Ibne Farabi Shihab*
...
### [28] [Ocean: Fast Estimation-Based Sparse General Matrix-Matrix Multiplication on GPU](https://arxiv.org/abs/2604.19004)
...
### [29] [YAIFS: Yet (not) Another Intelligent Fog Simulator: A Framework for Agent-Driven Computing Continuum Modeling & Simulation](https://arxiv.org/abs/2604.19181)
...
### [30] [UniEP: Unified Expert-Parallel MoE MegaKernel for LLM Training](https://arxiv.org/abs/2604.19241)
...
### [31] [A Simple Communication Scheme for Distributed Fast Multipole Methods](https://arxiv.org/abs/2604.19243)
*Srinath Kailasa*
...
### [32] [POLAR-PIC: A Holistic Framework for Matrixized PIC with Co-Designed Compute, Layout, and Communication](https://arxiv.org/abs/2604.19337)
...
### [33] [CROWDio: A Practical Mobile Crowd Computing Framework with Developer-Oriented Design, Adaptive Scheduling, and Fault Resilience](https://arxiv.org/abs/2604.19363)
...
### [34] [Minimizing Intellectual Property Risks via Self-Stabilizing Algorithms](https://arxiv.org/abs/2604.19454)
...
### [35] [DPC: A Distributed Page Cache over CXL](https://arxiv.org/abs/2604.19494)
...
### [36] [ReaLB: Real-Time Load Balancing for Multimodal MoE Inference](https://arxiv.org/abs/2604.19503)
...
### [37] [The Public Health and Environmental Surveillance Open Data Model (PHES-ODM) Version 3: An Open, Relational Data Model and Interoperability Framework for Wastewater Surveillance](https://arxiv.org/abs/2604.18762)
...
### [38] [Heuristic Search Space Partitioning for Low-Latency Multi-Tenant Cloud Queries](https://arxiv.org/abs/2604.19057)
...
### [39] [LIVE: Learnable Monotonic Vertex Embedding for Efficient Exact Subgraph Matching (Technical Report)](https://arxiv.org/abs/2604.19116)
...
### [40] [Demonstrating Online Schema Alignment in Decentralized Knowledge Graphs Querying](https://arxiv.org/abs/2604.19205)
...
### [41] [Optimizing Branch Predictor for Graph Applications](https://arxiv.org/abs/2604.18698)
...
### [42] [CHICO-Agent: An LLM Agent for the Cross-layer Optimization of 2.5D and 3D Chiplet-based Systems](https://arxiv.org/abs/2604.18764)
...
### [43] [A Comparative Analysis of ARM and x86-64 Laptop-Class Processors: Architecture, Assembly-Level Performance, and Energy Efficiency](https://arxiv.org/abs/2604.18896)
...
### [44] [ChipLight: Cross-Layer Optimization of Chiplet Design with Optical Interconnects for LLM Training](https://arxiv.org/abs/2604.18909)
...
### [45] [Design Rules for Extreme-Edge Scientific Computing on AI Engines](https://arxiv.org/abs/2604.19106)
...
### [46] [Energy Efficient LSTM Accelerators for Embedded FPGAs through Parameterised Architecture Design](https://arxiv.org/abs/2604.19293)
