...
### [7] [Communication Requirements for Linearizable Registers](https://arxiv.org/abs/2604.05862)
...
### [8] [JZ-Tree: GPU friendly neighbour search and friends-of-friends with dual tree walks in JAX plus CUDA](https://arxiv.org/abs/2604.05885)
...
### [9] [GTaP: A GPU-Resident Fork-Join Task-Parallel Runtime with a Pragma-Based Interface](https://arxiv.org/abs/2604.05982)
...
### [10] [CoStream: Codec-Guided Resource-Efficient System for Video Streaming Analytics](https://arxiv.org/abs/2604.06036)
...
### [11] [Fine-Grained Power and Energy Attribution on AMD GPU/APU-Based Exascale Nodes](https://arxiv.org/abs/2604.06056)
...
### [12] [Towards Predicting Multi-Vulnerability Attack Chains in Software Supply Chains from Software Bill of Materials Graphs](https://arxiv.org/abs/2604.04977)
...
### [13] [Measuring the Permission Gate: A Stress-Test Evaluation of Claude Code's Auto Mode](https://arxiv.org/abs/2604.04978)
...
### [14] [Squeez: Task-Conditioned Tool-Output Pruning for Coding Agents](https://arxiv.org/abs/2604.04979)
*Ádám Kovács*
...
### [15] [Architecture Without Architects: How AI Coding Agents Shape Software Architecture](https://arxiv.org/abs/2604.04990)
...
### [17] [Models as Values in a Model Expression Algebra: A Functional Approach to Model Driven Engineering](https://arxiv.org/abs/2604.05001)
...
### [18] [Scaling Coding Agents via Atomic Skills](https://arxiv.org/abs/2604.05013)
...
### [19] [Typify: A Lightweight Usage-driven Static Analyzer for Precise Python Type Inference](https://arxiv.org/abs/2604.05067)
...
### [20] [Nidus: Externalized Reasoning for AI-Assisted Engineering](https://arxiv.org/abs/2604.05080)
*Danil Gorinevski*
...
### [21] [Edit, But Verify: An Empirical Audit of Instructed Code-Editing Benchmarks](https://arxiv.org/abs/2604.05100)
...
### [22] [A Multi-Agent Framework for Automated Exploit Generation with Constraint-Guided Comprehension and Reflection](https://arxiv.org/abs/2604.05130)
...
### [23] [Compiled AI: Deterministic Code Generation for LLM-Based Workflow Automation](https://arxiv.org/abs/2604.05150)
...
### [24] [Planning to Explore: Curiosity-Driven Planning for LLM Test Generation](https://arxiv.org/abs/2604.05159)
...
### [25] [Corporate Training in Brazilian Software Engineering: A Qualitative Study of Useful Learning Experiences](https://arxiv.org/abs/2604.05209)
...
### [26] [Corporate Training in Brazilian Software Engineering: A Quantitative Study of Professional Perceptions](https://arxiv.org/abs/2604.05263)
...
### [27] [Spec Kit Agents: Context-Grounded Agentic Workflows](https://arxiv.org/abs/2604.05278)
...
### [28] [FLARE: Agentic Coverage-Guided Fuzzing for LLM-Based Multi-Agent Systems](https://arxiv.org/abs/2604.05289)
...
### [29] [On the Role of Fault Localization Context for LLM-Based Program Repair](https://arxiv.org/abs/2604.05481)
...
### [30] [SCOPE: A Dataset of Stereotyped Prompts for Counterfactual Fairness Assessment of LLMs](https://arxiv.org/abs/2604.05555)
...
### [31] [An Iterative Test-and-Repair Framework for Competitive Code Generation](https://arxiv.org/abs/2604.05560)
...
### [32] [Bias Ahead: Sensitive Prompts as Early Warnings for Fairness in Large Language Models](https://arxiv.org/abs/2604.05575)
...
### [33] [Understanding: reframing automation and assurance](https://arxiv.org/abs/2604.05662)
*Robin Bloomfield*
...
### [34] [SemLink: A Semantic-Aware Automated Test Oracle for Hyperlink Verification using Siamese Sentence-BERT](https://arxiv.org/abs/2604.05711)
...
### [35] [An End-to-End Approach for Fixing Concurrency Bugs via SHB-Based Context Extractor](https://arxiv.org/abs/2604.05753)
...
### [36] [CAKE: Cloud Architecture Knowledge Evaluation of Large Language Models](https://arxiv.org/abs/2604.05755)
...
### [37] [An Empirical Study of Perceptions of General LLMs and Multimodal LLMs on Hugging Face](https://arxiv.org/abs/2604.05782)
...
### [38] [Reinforcement Learning with Negative Tests as Completeness Signal for Formal Specification Synthesis](https://arxiv.org/abs/2604.05820)
...
### [39] [Proof of Concept as a First-Class Architectural Decision Instrument](https://arxiv.org/abs/2604.05835)
...
### [40] [Evolutionary Optimization of AI-Collapsed Software Development Stacks: Labor Tipping Points and Workforce Realignment](https://arxiv.org/abs/2604.05948)
*Matthew H. Kilbane*
...
### [41] [Does Pass Rate Tell the Whole Story? Evaluating Design Constraint Compliance in LLM-based Issue Resolution](https://arxiv.org/abs/2604.05955)
...
### [42] [QiMeng-PRepair: Precise Code Repair via Edit-Aware Reward Optimization](https://arxiv.org/abs/2604.05963)
...
### [43] [Sparse Autoencoders as a Steering Basis for Phase Synchronization in Graph-Based CFD Surrogates](https://arxiv.org/abs/2604.04946)
...
### [44] [AI-Driven Modular Services for Accessible Multilingual Education in Immersive Extended Reality Settings: Integrating Speech Processing, Translation, and Sign Language Rendering](https://arxiv.org/abs/2604.05591)
...
### [45] [INTERACT: An AI-Driven Extended Reality Framework for Accesible Communication Featuring Real-Time Sign Language Interpretation and Emotion Recognition](https://arxiv.org/abs/2604.05605)
...
### [46] [Adaptive Material Fingerprinting for the fast discovery of polyconvex feature combinations in isotropic and anisotropic hyperelasticity](https://arxiv.org/abs/2604.05698)
