...
### [3] [CHRONO-RESOLUTION: A Dependency Resolution Dataset at Release Points for npm, PyPI, and crates.io Packages](https://arxiv.org/abs/2607.15315)
...
### [4] [Two-Path Status Verification for Outbound Enterprise Messaging Pipelines: Webhook and Scheduled Polling Fallback Architecture](https://arxiv.org/abs/2607.15529)
*Devam Gupta*
...
### [5] [Understanding Agent-Reactive Bugs at the Model-Harness Boundary: An Empirical Study of LLM Agent Issue Reports](https://arxiv.org/abs/2607.15684)
...
### [6] [Verified LLM-Driven Synthesis for Concept Design](https://arxiv.org/abs/2607.15718)
*Alcino Cunha*
...
### [7] [GapForge: Directed Compiler Fuzzing via Coverage-Gap Analysis](https://arxiv.org/abs/2607.15762)
...
### [8] [Making Agent-Mediated Contributions Governable: A Project-Level Governance Manifest for Open-Source AI Collaboration](https://arxiv.org/abs/2607.15769)
...
### [9] [READU: Inconsistency-Driven Just-in-Time Detection and Repair of README Bugs](https://arxiv.org/abs/2607.15780)
...
### [10] [In the Driver's Seat: A Multi-Company Study on the Reality of Autonomous Driving System Testing](https://arxiv.org/abs/2607.15820)
...
### [11] [Agentic Synthesis against Counterexample-Supplemented Sketches](https://arxiv.org/abs/2607.15854)
...
### [12] [Trans-Domain Digital Twin: Conceptual Foundations, Architecture, and Research Outlook](https://arxiv.org/abs/2607.15908)
*Mansoorali Amiri*
...
### [13] [TARS: A Theory-of-Mind Agent for Personalized In-IDE Code Comprehension](https://arxiv.org/abs/2607.15948)
...
### [14] [DiffTestGen: Change-Directed LLM-Based Testing for Exposing Behavioral Differences](https://arxiv.org/abs/2607.16024)
...
### [15] [What Does It Take to Research with AI? A Rapid Review of Competencies to Train LLM-Literate Researchers](https://arxiv.org/abs/2607.16083)
...
### [16] [Comparison of Energy System Optimization Software and Evaluation of Selected Frameworks](https://arxiv.org/abs/2607.16121)
...
### [17] [RTL-Sequencer: Towards Scalable RTL Timing Prediction with the Sequence-based Paradigm](https://arxiv.org/abs/2607.15830)
...
### [18] [DSTAR: Accelerating Diffusion Transformers via Spatial and Temporal Redundancy Reduction](https://arxiv.org/abs/2607.15846)
...
### [19] [From Patterns to Parsers: Automatic Generation of Efficient Hardware Parsers for FPGAs](https://arxiv.org/abs/2607.16058)
...
### [20] [ADASCALE: An Adaptive Scaling and Placement Framework for Microservices Under Dynamics](https://arxiv.org/abs/2607.15681)
...
### [21] [Split-Aware Function Placement with Availability Guarantees and Optical Provisioning in vRANs](https://arxiv.org/abs/2607.15816)
...
### [22] [App-Based Performance Characterization of Cellular and Wi-Fi Networks in Dense Stadium Deployments](https://arxiv.org/abs/2607.16008)
...
### [23] [LLM-Powered Agentic AI for 5G/6G Networks: A Tutorial and Survey on Architectures, Protocols, and Standardization](https://arxiv.org/abs/2607.16066)
...
### [24] [FSZ: Breaking the Prediction-Throughput Trade-off in GPU Lossy Compression](https://arxiv.org/abs/2607.15413)
*Jiajun Huang*
...
### [25] [Scalable LLM Agent Tool Access in the Cloud](https://arxiv.org/abs/2607.15593)
...
### [26] [JoyNexus: Service-Oriented Multi-Tenant Post-Training for VLA Models](https://arxiv.org/abs/2607.16074)
...
### [27] [Every Microsecond Matters: Achieving Near Speed-of-Light Latency in GPU Collectives](https://arxiv.org/abs/2607.16100)
