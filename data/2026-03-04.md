...
### [9] [RIVA: Leveraging LLM Agents for Reliable Configuration Drift Detection](https://arxiv.org/abs/2603.02345)
...
### [10] [Fuzzing Microservices in Face of Intrinsic Uncertainties](https://arxiv.org/abs/2603.02551)
...
### [11] [His2Trans: A Skeleton First Framework for Self Evolving C to Rust Translation with Historical Retrieval](https://arxiv.org/abs/2603.02617)
...
### [12] [ICSE 2023 Sustainability Report](https://arxiv.org/abs/2603.02694)
...
### [13] [Reducing Labeling Effort in Architecture Technical Debt Detection through Active Learning and Explainable AI](https://arxiv.org/abs/2603.02944)
...
### [14] [SEALing the Gap: A Reference Framework for LLM Inference Carbon Estimation via Multi-Benchmark Driven Embodiment](https://arxiv.org/abs/2603.02949)
...
### [15] [It's Alive! What a Live Object Environment Changes in Software Engineering Practice](https://arxiv.org/abs/2603.02987)
...
### [16] [A Practical Guide for Establishing a Technical Debt Management Process (Preprint)](https://arxiv.org/abs/2603.03085)
...
### [17] [RippleGUItester: Change-Aware Exploratory Testing](https://arxiv.org/abs/2603.03121)
...
### [18] [Type-Aware Retrieval-Augmented Generation with Dependency Closure for Solver-Executable Industrial Optimization Modeling](https://arxiv.org/abs/2603.03180)
...
### [19] [Pecker: Bug Localization Framework for Sequential Designs via Causal Chain Reconstruction](https://arxiv.org/abs/2603.02583)
...
### [20] [Ouroboros: Wafer-Scale SRAM CIM with Token-Grained Pipelining for Large Language Model Inference](https://arxiv.org/abs/2603.02737)
...
### [21] [Changing the Game: The Bounce-Bind Ising Machine](https://arxiv.org/abs/2603.02771)
...
### [22] [SpecLoop: An Agentic RTL-to-Specification Framework with Formal Verification Feedback Loop](https://arxiv.org/abs/2603.02895)
...
### [23] [Integrating Health Sensing into Cellular Networks: Human Sleep Monitoring Using 5G Signals](https://arxiv.org/abs/2603.02558)
...
### [24] [RegTrack: Uncovering Global Disparities in Third-party Advertising and Tracking](https://arxiv.org/abs/2603.02679)
...
### [25] [GPR Hierarchical Synergistic Framework for Multi-Access MPQUIC in SAGINs](https://arxiv.org/abs/2603.02740)
...
### [26] [Energy Efficient Point-to-Point PON-based Architecture for the Backhaul of a VLC System](https://arxiv.org/abs/2603.02784)
...
### [27] [Exploiting Repetitions and Interference Cancellation for the 6G-V2X Sidelink Autonomous Mode](https://arxiv.org/abs/2603.03039)
...
### [28] [CUCo: An Agentic Framework for Compute and Communication Co-design](https://arxiv.org/abs/2603.02376)
...
### [29] [Why Atomicity Matters to AI/ML Infrastructure: Snapshots, Firmware Updates, and the Cost of the Forward-In-Time-Only Category Mistake](https://arxiv.org/abs/2603.02603)
*Paul Borrill*
...
### [30] [Scalable Mesh Coupling for Atmospheric Wave Simulation](https://arxiv.org/abs/2603.02971)
...
### [31] [Undecided State Dynamics with Many Opinions](https://arxiv.org/abs/2603.02636)
...
### [32] [MuxTune: Efficient Multi-Task LLM Fine-Tuning in Multi-Tenant Datacenters via Spatial-Temporal Backbone Multiplexing](https://arxiv.org/abs/2603.02885)
...
### [33] [Dynamic Contract Analysis for Parallel Programming Models](https://arxiv.org/abs/2603.03023)
...
### [34] [Serverless Abstractions for Short-Running, Lightweight Streams](https://arxiv.org/abs/2603.03089)
...
### [35] [Molecular Dynamics Simulations Reveal PolyQ-Length-Dependent Conformational Changes in Huntingtin Exon-1: Implications for Environmental Co-Solvent Modulation of Aggregation-Prone States](https://arxiv.org/abs/2603.02572)
...
### [36] [A phase-field framework for anisotropic viscoelastic-viscoplastic fracture in short fiber-reinforced polymers in hygrothermal environments](https://arxiv.org/abs/2603.02826)
