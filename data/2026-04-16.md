...
### [11] [LLM-Driven Large-Scale Spectrum Access](https://arxiv.org/abs/2604.13132)
...
### [12] [The Missing Pillar in Quantum-Safe 6G: Regulation and Global Compliance](https://arxiv.org/abs/2604.13314)
*Adnan Aijaz*
...
### [13] [Cross-Domain Query Translation for Network Troubleshooting: A Multi-Agent LLM Framework with Privacy Preservation and Self-Reflection](https://arxiv.org/abs/2604.13353)
...
### [14] [Agentic Open RAN: A Deterministic and Auditable Framework for Intent-Driven Radio Control](https://arxiv.org/abs/2604.13384)
...
### [15] [Autoencoder-Based CSI Compression for Beyond Wi-Fi 8 Coordinated Beamforming](https://arxiv.org/abs/2604.13500)
...
### [16] [Look One Step Ahead: Forward-Looking Incentive Design with Strategic Privacy for Proactive Service Provisioning over Air-Ground Integrated Edge Networks](https://arxiv.org/abs/2604.13635)
...
### [18] [Don't Let AI Agents YOLO Your Files: Shifting Information and Control to Filesystems for Agent Safety and Autonomy](https://arxiv.org/abs/2604.13536)
...
### [19] [Event Tensor: A Unified Abstraction for Compiling Dynamic Megakernel](https://arxiv.org/abs/2604.13327)
...
### [20] [PackSELL: A Sparse Matrix Format for Precision-Agnostic High-Performance SpMV](https://arxiv.org/abs/2604.13433)
...
### [21] [SAKURAONE: An Open Ethernet-Based AI HPC System and Its Observed Workload Dynamics in a Single-Tenant LLM Development Environment](https://arxiv.org/abs/2604.13600)
...
### [22] [OffloadFS: Leveraging Disaggregated Storage for Computation Offloading](https://arxiv.org/abs/2604.13743)
...
### [23] [Tensor Memory Engine: On-the-fly Data Reorganization for Ideal Locality](https://arxiv.org/abs/2604.13319)
...
### [24] [Cross-Layer Co-Optimized LSTM Accelerator for Real-Time Gait Analysis](https://arxiv.org/abs/2604.13543)
...
### [25] [GEM3D CIM General Purpose Matrix Computation Using 3D Integrated SRAM eDRAM Hybrid Compute In Memory on Memory Architecture](https://arxiv.org/abs/2604.13969)
...
### [26] [An ASIC Emulated Oscillator Ising/Potts Machine Solving Combinatorial Optimization Problems](https://arxiv.org/abs/2604.14027)
...
### [27] [Early-Warning Learner Satisfaction Forecasting in MOOCs via Temporal Event Transformers and LLM Text Embeddings](https://arxiv.org/abs/2604.13241)
...
### [28] [Cross-Platform Domain Adaptation for Multi-Modal MOOC Learner Satisfaction Prediction](https://arxiv.org/abs/2604.13247)
...
### [29] [From Brain Models to Executable Digital Twins: Execution Semantics and Neuro-Neuromorphic Systems](https://arxiv.org/abs/2604.13574)
*Alexandre Muzy*
...
### [30] [mosaiks are made of tesserae: GUI design for a co-simulation framework](https://arxiv.org/abs/2604.13690)
...
### [31] [An End-to-end Building Load Forecasting Framework with Patch-based Information Fusion Network and Error-weighted Adaptive Loss](https://arxiv.org/abs/2604.13714)
...
### [32] [Stable Long-Horizon Neural ODE Reduced-Order Models via Learned Feedback for Biological Growth and Remodeling](https://arxiv.org/abs/2604.13820)
...
### [33] [ECM Contracts: Contract-Aware, Versioned, and Governable Capability Interfaces for Embodied Agents](https://arxiv.org/abs/2604.13097)
...
### [34] [Contract-Coding: Towards Repo-Level Generation via Structured Symbolic Paradigm](https://arxiv.org/abs/2604.13100)
...
### [35] [Building Trust in the Skies: A Knowledge-Grounded LLM-based Framework for Aviation Safety](https://arxiv.org/abs/2604.13101)
...
### [36] [CCCE: A Continuous Code Calibration Engine for Autonomous Enterprise Codebase Maintenance via Knowledge Graph Traversal and Adaptive Decision Gating](https://arxiv.org/abs/2604.13102)
...
### [37] [Fairness in Multi-Agent Systems for Software Engineering: An SDLC-Oriented Rapid Review](https://arxiv.org/abs/2604.13103)
...
### [38] [Learning from Change: Predictive Models for Incident Prevention in a Regulated IT Environment](https://arxiv.org/abs/2604.13462)
...
### [39] [Can Coding Agents Be General Agents?](https://arxiv.org/abs/2604.13107)
...
### [40] [Applying an Agentic Coding Tool for Improving Published Algorithm Implementations](https://arxiv.org/abs/2604.13109)
*Worasait Suwannik*
...
### [41] [The Code Whisperer: LLM and Graph-Based AI for Smell and Vulnerability Resolution](https://arxiv.org/abs/2604.13114)
...
### [42] [Modeling and Simulation Based Engineering in the Context of Cyber-Physical Systems](https://arxiv.org/abs/2604.13118)
*Alexandre Muzy*
...
### [43] [AgentForge: Execution-Grounded Multi-Agent LLM Framework for Autonomous Software Engineering](https://arxiv.org/abs/2604.13120)
...
### [44] [How Developers Adopt, Use, and Evolve CI/CD Caching: An Empirical Study on GitHub Actions](https://arxiv.org/abs/2604.13129)
...
### [45] [Comprehension Debt in GenAI-Assisted Software Engineering Projects](https://arxiv.org/abs/2604.13277)
...
### [46] [The Cognitive Circuit Breaker: A Systems Engineering Framework for Intrinsic AI Reliability](https://arxiv.org/abs/2604.13417)
*Jonathan Pan*
...
### [47] [From Exploration to Specification: LLM-Based Property Generation for Mobile App Testing](https://arxiv.org/abs/2604.13463)
...
### [48] [TORAI: Unsupervised Fine-grained RCA using Multi-Source Telemetry Data](https://arxiv.org/abs/2604.13522)
...
### [49] [WebMAC: A Multi-Agent Collaborative Framework for Scenario Testing of Web Systems](https://arxiv.org/abs/2604.13559)
...
### [50] [V2E: Validating Smart Contract Vulnerabilities through Profit-driven Exploit Generation and Execution](https://arxiv.org/abs/2604.13611)
...
### [51] [Figma2Code: Automating Multimodal Design to Code in the Wild](https://arxiv.org/abs/2604.13648)
...
### [52] [Debugging Performance Issues in WebAssembly Runtimes via Mutation-based Inference](https://arxiv.org/abs/2604.13693)
...
### [53] [On the Effectiveness of Context Compression for Repository-Level Tasks: An Empirical Investigation](https://arxiv.org/abs/2604.13725)
...
### [54] [Zero-shot Evaluation of Deep Learning for Java Code Clone Detection](https://arxiv.org/abs/2604.13783)
*Thomas S. Heinze*
...
### [55] [A Universal Textual Merge Strategy Based on Tokens for Version Control Systems](https://arxiv.org/abs/2604.13813)
...
### [56] [Sentiment analysis for software engineering: How far can zero-shot learning (ZSL) go?](https://arxiv.org/abs/2604.13826)
...
### [57] [Towards Enabling An Artificial Self-Construction Software Life-cycle via Autopoietic Architectures](https://arxiv.org/abs/2604.13934)
...
### [58] [CollabCoder: Plan-Code Co-Evolution via Collaborative Decision-Making for Efficient Code Generation](https://arxiv.org/abs/2604.13946)
...
### [59] [Learned or Memorized ? Quantifying Memorization Advantage in Code LLMs](https://arxiv.org/abs/2604.13997)
...
### [60] [Analysis of Commit Signing on Github](https://arxiv.org/abs/2604.14014)
...
### [61] [Log-based vs Graph-based Approaches to Fault Diagnosis](https://arxiv.org/abs/2604.14019)
...
### [62] [Large Language Models to Enhance Business Process Modeling: Past, Present, and Future Trends](https://arxiv.org/abs/2604.14034)
