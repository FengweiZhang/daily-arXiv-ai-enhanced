...
### [2] [Exploring Multiple Converged States of Network Configurations](https://arxiv.org/abs/2603.03638)
...
### [3] [Agentic Peer-to-Peer Networks: From Content Distribution to Capability and Action Sharing](https://arxiv.org/abs/2603.03753)
...
### [4] [Selecting Offline Reinforcement Learning Algorithms for Stochastic Network Control](https://arxiv.org/abs/2603.03932)
...
### [5] [Optimal Short Video Ordering and Transmission Scheduling for Reducing Video Delivery Cost in Peer-to-Peer CDNs](https://arxiv.org/abs/2603.03938)
...
### [6] [Zigbee vs. Matter over Thread: Understanding IoT Protocol Performance in Practice](https://arxiv.org/abs/2603.04221)
...
### [7] [A Constrained RL Approach for Cost-Efficient Delivery of Latency-Sensitive Applications](https://arxiv.org/abs/2603.04353)
...
### [8] [Service Function Chain Routing in LEO Networks Using Shortest-Path Delay Statistical Stability](https://arxiv.org/abs/2603.04361)
...
### [9] [LLM-supported 3D Modeling Tool for Radio Radiance Field Reconstruction](https://arxiv.org/abs/2603.04368)
...
### [10] [A DualPI2 Module for Mahimahi: Behavioral Characterization and Cross-Platform Analysis](https://arxiv.org/abs/2603.04381)
...
### [11] [stratum: A System Infrastructure for Massive Agent-Centric ML Workloads](https://arxiv.org/abs/2603.03589)
...
### [12] [GraphLake: A Purpose-Built Graph Compute Engine for Lakehouse](https://arxiv.org/abs/2603.03705)
...
### [13] [Towards Effective Orchestration of AI x DB Workloads](https://arxiv.org/abs/2603.03772)
...
### [14] [Efficient Query Rewrite Rule Discovery via Standardized Enumeration and Learning-to-Rank](https://arxiv.org/abs/2603.04169)
...
### [15] [Scalable Join Inference for Large Context Graphs](https://arxiv.org/abs/2603.04176)
...
### [16] [Publication and Maintenance of Relational Data in Enterprise Knowledge Graphs (Revised Version)](https://arxiv.org/abs/2603.04184)
...
### [17] [SpotIt+: Verification-based Text-to-SQL Evaluation with Database Constraints](https://arxiv.org/abs/2603.04334)
...
### [18] [Engineering a Governance-Aware AI Sandbox: Design, Implementation, and Lessons Learned](https://arxiv.org/abs/2603.03394)
...
### [19] [Review Beats Planning: Dual-Model Interaction Patterns for Code Synthesis](https://arxiv.org/abs/2603.03406)
*Jan Miller*
...
### [20] [Semantic Neighborhood Density and Eye Gaze Time in Human Programmer Attention](https://arxiv.org/abs/2603.03566)
...
### [21] [CONCUR: Benchmarking LLMs for Concurrent Code Generation](https://arxiv.org/abs/2603.03683)
...
### [22] [SWE-CI: Evaluating Agent Capabilities in Maintaining Codebases via Continuous Integration](https://arxiv.org/abs/2603.03823)
...
### [23] [Empirical Studies on Adversarial Reverse Engineering with Students](https://arxiv.org/abs/2603.03875)
...
### [24] [LoRA-MME: Multi-Model Ensemble of LoRA-Tuned Encoders for Code Comment Classification](https://arxiv.org/abs/2603.03959)
...
### [25] [CodeTaste: Can LLMs Generate Human-Level Code Refactorings?](https://arxiv.org/abs/2603.04177)
...
### [26] [Code Fingerprints: Disentangled Attribution of LLM-Generated Code](https://arxiv.org/abs/2603.04212)
...
### [27] [FeedAIde: Guiding App Users to Submit Rich Feedback Reports by Asking Context-Aware Follow-Up Questions](https://arxiv.org/abs/2603.04244)
...
### [28] [LikeThis! Empowering App Users to Submit UI Improvement Suggestions Instead of Complaints](https://arxiv.org/abs/2603.04245)
...
### [29] [Accelerating OpenPangu Inference on NPU via Speculative Decoding](https://arxiv.org/abs/2603.03383)
...
### [30] [Bisynchronous FIFOs and the FITO Category Mistake: Silicon-Proven Interaction Primitives for Distributed Coordination](https://arxiv.org/abs/2603.03470)
*Paul Borrill*
...
### [31] [SENTINEL: Stagewise Integrity Verification for Pipeline Parallel Decentralized Training](https://arxiv.org/abs/2603.03592)
...
### [32] [HyperParallel: A Supernode-Affinity AI Framework](https://arxiv.org/abs/2603.03731)
...
### [33] [The Ghost in the Datacenter: Link Flapping, Topology Knowledge Failures, and the FITO Category Mistake](https://arxiv.org/abs/2603.03736)
*Paul Borrill*
...
### [34] [Exploring Challenges in Developing Edge-Cloud-Native Applications Across Multiple Business Domains](https://arxiv.org/abs/2603.03738)
...
### [35] [The Semantic Arrow of Time, Part II: The Semantics of Open Atomic Ethernet](https://arxiv.org/abs/2603.03743)
*Paul Borrill*
...
### [36] [A framework to reason about consistency and atomicity guarantees in a sparsely-connected, partially-replicated peer-to-peer system](https://arxiv.org/abs/2603.03899)
...
### [37] [Lambdas at the Far Edge: a Tale of Flying Lambdas and Lambdas on Wheels](https://arxiv.org/abs/2603.04008)
...
### [38] [2-Coloring Cycles in One Round](https://arxiv.org/abs/2603.04235)
...
### [39] [ARMOR: Robust and Efficient CNN-Based SAR ATR through Model-Hardware Co-Design](https://arxiv.org/abs/2603.03598)
...
### [40] [CarbonPATH: Carbon-aware pathfinding and architecture optimization for chiplet-based AI systems](https://arxiv.org/abs/2603.03878)
...
### [41] [Joint Hardware-Workload Co-Optimization for In-Memory Computing Accelerators](https://arxiv.org/abs/2603.03880)
...
### [42] [Hyper-reduction-free reduced-order Newton solvers for projection-based model-order reduction of nonlinear dynamical systems](https://arxiv.org/abs/2603.03420)
...
### [43] [FusionCut: Boundary Representation (B-Rep) Based and Cloud-Ready Cutter Workpiece Engagement (CWE) for Virtual Machining](https://arxiv.org/abs/2603.03504)
...
### [44] [STRIDE: Post-Training LLMs to Reason and Refine Bio-Sequences via Edit Trajectories](https://arxiv.org/abs/2603.03573)
